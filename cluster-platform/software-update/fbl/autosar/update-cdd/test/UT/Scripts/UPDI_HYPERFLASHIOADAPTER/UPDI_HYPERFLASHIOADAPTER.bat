...
echo options C_DEFINE_LIST VCAST_UT=1 >> commands.tmp
...
echo environment build UPDI_HYPERFLASHIOADAPTER.env >> commands.tmp
echo /E:UPDI_HYPERFLASHIOADAPTER tools script run UPDI_HYPERFLASHIOADAPTER.tst >> commands.tmp
echo /E:UPDI_HYPERFLASHIOADAPTER execute batch >> commands.tmp
echo /E:UPDI_HYPERFLASHIOADAPTER reports custom management UPDI_HYPERFLASHIOADAPTER_management_report.html >> commands.tmp
