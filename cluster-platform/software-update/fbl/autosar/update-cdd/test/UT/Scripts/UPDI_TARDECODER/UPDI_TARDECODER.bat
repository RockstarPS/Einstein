...
echo environment build UPDI_TARDECODER.env >> commands.tmp
echo /E:UPDI_TARDECODER tools script run UPDI_TARDECODER.tst >> commands.tmp
echo /E:UPDI_TARDECODER execute batch >> commands.tmp
echo /E:UPDI_TARDECODER reports custom management UPDI_TARDECODER_management_report.html >> commands.tmp
