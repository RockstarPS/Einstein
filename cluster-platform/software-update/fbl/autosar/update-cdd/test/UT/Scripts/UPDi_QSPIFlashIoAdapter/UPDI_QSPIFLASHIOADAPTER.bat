...
echo environment build UPDI_QSPIFLASHIOADAPTER.env >> commands.tmp
echo /E:UPDI_QSPIFLASHIOADAPTER tools script run UPDI_QSPIFLASHIOADAPTER.tst >> commands.tmp
echo /E:UPDI_QSPIFLASHIOADAPTER execute batch >> commands.tmp
echo /E:UPDI_QSPIFLASHIOADAPTER reports custom management UPDI_QSPIFLASHIOADAPTER_management_report.html >> commands.tmp
