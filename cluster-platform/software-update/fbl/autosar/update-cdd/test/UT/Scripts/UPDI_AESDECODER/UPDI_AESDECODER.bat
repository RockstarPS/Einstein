...
echo environment build UPDI_AESDECODER.env >> commands.tmp
echo /E:UPDI_AESDECODER tools script run UPDI_AESDECODER.tst >> commands.tmp
echo /E:UPDI_AESDECODER execute batch >> commands.tmp
echo /E:UPDI_AESDECODER reports custom management UPDI_AESDECODER_management_report.html >> commands.tmp
