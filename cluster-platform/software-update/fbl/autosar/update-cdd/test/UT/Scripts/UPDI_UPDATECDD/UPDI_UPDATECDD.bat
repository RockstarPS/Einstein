...
echo environment build UPDI_UPDATECDD.env >> commands.tmp
echo /E:UPDI_UPDATECDD  tools update mcdc >> commands.tmp
echo /E:UPDI_UPDATECDD tools script run UPDI_UPDATECDD.tst >> commands.tmp
echo /E:UPDI_UPDATECDD execute batch >> commands.tmp
echo /E:UPDI_UPDATECDD reports custom management UPDI_UPDATECDD_management_report.html >> commands.tmp
