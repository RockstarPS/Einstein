...
echo environment build UPDI_BLOCKINSTALLER.env >> commands.tmp
echo /E:UPDI_BLOCKINSTALLER tools script run UPDI_BLOCKINSTALLER.tst >> commands.tmp
echo /E:UPDI_BLOCKINSTALLER execute batch >> commands.tmp
echo /E:UPDI_BLOCKINSTALLER reports custom management UPDI_BLOCKINSTALLER_management_report.html >> commands.tmp
