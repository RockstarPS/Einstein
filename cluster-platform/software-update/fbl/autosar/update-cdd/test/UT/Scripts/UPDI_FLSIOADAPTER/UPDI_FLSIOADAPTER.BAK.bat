...
echo environment build UPDI_FLSIOADAPTER.BAK.env >> commands.tmp
echo /E:UPDI_FLSIOADAPTER.BAK  tools update mcdc >> commands.tmp
echo /E:UPDI_FLSIOADAPTER.BAK tools script run UPDI_FLSIOADAPTER.BAK.tst >> commands.tmp
echo /E:UPDI_FLSIOADAPTER.BAK execute batch >> commands.tmp
echo /E:UPDI_FLSIOADAPTER.BAK reports custom management UPDI_FLSIOADAPTER.BAK_management_report.html >> commands.tmp
