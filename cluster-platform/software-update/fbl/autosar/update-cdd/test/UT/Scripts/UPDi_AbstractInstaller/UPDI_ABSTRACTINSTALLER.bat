...
echo environment build UPDI_ABSTRACTINSTALLER.env >> commands.tmp
echo /E:UPDI_ABSTRACTINSTALLER tools script run UPDI_ABSTRACTINSTALLER.tst >> commands.tmp
echo /E:UPDI_ABSTRACTINSTALLER execute batch >> commands.tmp
echo /E:UPDI_ABSTRACTINSTALLER reports custom management UPDI_ABSTRACTINSTALLER_management_report.html >> commands.tmp
