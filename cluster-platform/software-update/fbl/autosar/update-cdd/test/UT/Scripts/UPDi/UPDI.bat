...
echo environment build UPDI.env >> commands.tmp
echo /E:UPDI  tools update mcdc >> commands.tmp
echo /E:UPDI tools script run UPDI.tst >> commands.tmp
echo /E:UPDI execute batch >> commands.tmp
echo /E:UPDI reports custom management UPDI_management_report.html >> commands.tmp
