...
echo environment build UPDI_GIPIOADAPTER.env >> commands.tmp
echo /E:UPDI_GIPIOADAPTER tools script run UPDI_GIPIOADAPTER.tst >> commands.tmp
echo /E:UPDI_GIPIOADAPTER execute batch >> commands.tmp
echo /E:UPDI_GIPIOADAPTER reports custom management UPDI_GIPIOADAPTER_management_report.html >> commands.tmp
