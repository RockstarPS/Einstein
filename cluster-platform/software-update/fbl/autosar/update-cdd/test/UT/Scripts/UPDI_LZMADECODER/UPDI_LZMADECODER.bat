...
echo options C_DEFINE_LIST UPDd_MAX_PACKAGE_NAME_SIZE=64 UPDd_LOAD_BUFFER_SIZE=65536 UPDd_LZMA_MEMORY_POOL_SIZE=65536 VCAST_UT=1 >> commands.tmp
...
echo environment build UPDI_LZMADECODER.env >> commands.tmp
echo /E:UPDI_LZMADECODER tools script run UPDI_LZMADECODER.tst >> commands.tmp
echo /E:UPDI_LZMADECODER execute batch >> commands.tmp
echo /E:UPDI_LZMADECODER reports custom management UPDI_LZMADECODER_management_report.html >> commands.tmp
