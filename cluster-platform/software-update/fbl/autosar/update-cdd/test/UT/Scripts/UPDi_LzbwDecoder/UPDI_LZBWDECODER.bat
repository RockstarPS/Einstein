...
echo options C_DEFINE_LIST E_PENDING=2 cFalse=0 LAP_LOD__DECOMPRESSION_BUFFER_SIZE=8703 LIB_LZBW_DICTIONARY_SIZE=0 VCAST_UT=1 >> commands.tmp
...
echo environment build UPDI_LZBWDECODER.env >> commands.tmp
echo /E:UPDI_LZBWDECODER tools script run UPDI_LZBWDECODER.tst >> commands.tmp
echo /E:UPDI_LZBWDECODER execute batch >> commands.tmp
echo /E:UPDI_LZBWDECODER reports custom management UPDI_LZBWDECODER_management_report.html >> commands.tmp
