...
echo environment build UPDI_IOADAPTER.env >> commands.tmp
echo /E:UPDI_IOADAPTER  tools update mcdc >> commands.tmp
echo /E:UPDI_IOADAPTER tools script run UPDI_IOADAPTER.tst >> commands.tmp
echo /E:UPDI_IOADAPTER execute batch >> commands.tmp
echo /E:UPDI_IOADAPTER reports custom management UPDI_IOADAPTER_management_report.html >> commands.tmp
