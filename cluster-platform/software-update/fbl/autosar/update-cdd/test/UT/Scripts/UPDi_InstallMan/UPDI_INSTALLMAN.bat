...
echo environment build UPDI_INSTALLMAN.env >> commands.tmp
echo /E:UPDI_INSTALLMAN tools script run UPDI_INSTALLMAN.tst >> commands.tmp
echo /E:UPDI_INSTALLMAN execute batch >> commands.tmp
echo /E:UPDI_INSTALLMAN reports custom management UPDI_INSTALLMAN_management_report.html >> commands.tmp
