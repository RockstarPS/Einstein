...
echo environment build UPDI_UPDATEMAN.env >> commands.tmp
echo /E:UPDI_UPDATEMAN  tools update mcdc >> commands.tmp
echo /E:UPDI_UPDATEMAN tools script run UPDI_UPDATEMAN.tst >> commands.tmp
echo /E:UPDI_UPDATEMAN execute batch >> commands.tmp
echo /E:UPDI_UPDATEMAN reports custom management UPDI_UPDATEMAN_management_report.html >> commands.tmp
