...
echo options TESTABLE_SOURCE_DIR ..\..\..\..\..\programs\reference\einstein4.0\ti-am62x\bsw-gen\Project\Appl\GenData\Components\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR ..\..\..\..\..\programs\reference\einstein4.0\ti-am62x\vp-build\stubs\Bsw_Stubs\AsrGnrl\inc\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR ..\..\..\..\..\programs\reference\einstein4.0\ti-am62x\bsw-gen\Project\Appl\GenData\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR ..\..\..\..\..\programs\reference\einstein4.0\ti-am62x\vp-build\stubs\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR ..\..\..\lib\cmplib\src\src\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR ..\..\..\..\..\programs\reference\einstein4.0\ti-am62x\swc-gen\gen\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR ..\..\..\vautosar\sys\wdgm\src\WdgIf\src\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR ..\..\..\vautosar\sys\wdgm\src\WdgM\src\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR ..\..\..\vautosar\sys\mos\src\includes\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR ..\..\..\..\..\programs\reference\einstein4.0\ti-am62x\bsw-gen\bsw\os\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR ..\..\..\vautosar\sys\mos\src\hal\core\arm\cortexm4\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR .\stubs\ >> commands.tmp
echo environment build DMNMGR_UT.env >> commands.tmp
echo /E:DMNMGR_UT  tools update mcdc >> commands.tmp
echo /E:DMNMGR_UT tools script run DMNMGR_UT.tst >> commands.tmp
echo /E:DMNMGR_UT execute batch >> commands.tmp
echo /E:DMNMGR_UT reports custom management DMNMGR_UT_management_report.html >> commands.tmp
