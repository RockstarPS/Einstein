 ...
 *
 * \file Crypto_CbcEncrypt256.h
 *
 * \brief
 * CBC Encrypt256 header in M7
 *
 ...
 ******************************************************************************/
#ifndef CRYPTO_CBCEncrypt256_H
#define CRYPTO_CBCEncrypt256_H 1
#define CRYPTO_CBCEncrypt256_ENABLED 1
#define CBC_Encrypt256_SYNC_JOB_SUPPORT_ENABLE 1
#undef CBCEncrypt256_STRUPDFIN_ENABLE
/*==[Includes]================================================================*/
...
extern void Csm_SymEncrypt256CallbackNotification(Csm_ReturnType result);
extern void Csm_SymEncrypt256ServiceFinishNotification(void);
//extern void CySldIpc_Isr_IpcDrv_Cat2 (void);

/* Define Callback Notification functions for CSM */
#define CRYPTO_HSM_CSM_SYMEncrypt256_CALLBACK_NOTIF        Csm_SymEncrypt256CallbackNotification
/* Define Service Finish Notification functions for CSM */
#define CRYPTO_HSM_CSM_SYMEncrypt256_SERVICE_FINISH_NOTIF     Csm_SymEncrypt256ServiceFinishNotification
...
Crypto_She_SymEncrypt256ConfigType;
...
/**
 *********************************************************************************************
 ** \fn Crypto_She_SymEncrypt256Init
 **
 ** \brief Initialize CryShe block Encrypt256 module.
 **
 ** This function initializes the block Encrypt256 module. It has to be called 
 ** from Crypto_Init and before any services of the block Encrypt256 module are used.
 ** 
 ** \param [in] NONE
 ** 
...
/**
 *********************************************************************************************
 ** \fn Crypto_She_SymEncrypt256Start
 **
 ** \brief 
 ** 
 **
...
/**
 *********************************************************************************************
 ** \fn Crypto_She_SymEncrypt256Update
 **
 ** \brief 
 ** 
 **
...
/**
 *********************************************************************************************
 ** \fn Crypto_She_SymEncrypt256Finish
 **
 ** \brief 
 ** 
 **
...
/**
 *********************************************************************************************
 ** \fn Crypto_She_SymEncrypt256MainFunction
 **
 ** \brief 
 ** 
 **
 ...
 **
 ********************************************************************************************/
FUNC(void,CRY_CODE) Crypto_She_SymEncrypt256MainFunction(void);
/**
 *********************************************************************************************
 ** \fn Crypto_Hsm_SymEncrypt256Cancel
 **
 ** \brief 
 ** Cancels the Encrypt256ion job and releases she lock
 **
 ** \param [in] NONE
 ** 
 ** This function returns NONE
