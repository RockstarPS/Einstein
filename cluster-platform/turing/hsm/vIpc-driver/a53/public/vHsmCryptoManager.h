 ...
 */
/*!
 * \brief        The module shall use **vHsmCryptoMessageM7.h** data types.
 ...
 *****************************************************************************/
#define ENTRY(a,b) FUNC (void, CRY_CODE) b(uint8_t* cryptodata_addr,uint16_t payload_size);
CRYPTO_JOB_TABLE
#undef ENTRY
 ...
 **        [in] uint16_t payload_size
 *****************************************************************************/
#define ENTRY(a,b) void b(uint8_t* commanddata_addr,uint16_t payload_size);
COMMAND_JOB_TABLE
#undef ENTRY
