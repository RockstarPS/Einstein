...
extern uint64_t vHsmIpcBuffAddr_U32;
/******************************************************************************
 *  MACROS
 *****************************************************************************/
#define IPC_SRAMADDR_START        (vHsmIpcBuffAddr_U32)
#define IPC_SRAMADDR_END          (vHsmIpcBuffAddr_U32+0x2000)
#define IPC_SRAM_MAXSEGMENTSIZE    4
#define IPC_MAX_NUMBER_OF_BUFFERS  4
#define IPC_BYTES_PER_KB           1024

//extern uint32_t vHsmIpc_SramAdd;
