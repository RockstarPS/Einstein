...
echo options TESTABLE_SOURCE_DIR ..\..\..\..\..\..\..\..\programs\reference\einstein4.0\ti-am62x\hsm-app\vHsmCryptoApplication\r5\public\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR ..\..\..\..\..\..\..\..\programs\reference\einstein4.0\ti-am62x\hsm-cfg\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR ..\..\..\..\..\vIpc-driver\r5\public\ >> commands.tmp
echo environment build DLT_R5.env >> commands.tmp
echo /E:DLT_R5 tools script run DLT_R5.tst >> commands.tmp
echo /E:DLT_R5 execute batch >> commands.tmp
echo /E:DLT_R5 reports custom management DLT_R5_management_report.html >> commands.tmp
