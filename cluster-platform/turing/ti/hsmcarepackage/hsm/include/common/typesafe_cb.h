 ...
 * @param oktype: the type we allow
 ...
 * @param desttype: the type to cast to
 * @param ok1: the first type we allow
 * @param ok2: the second type we allow
 * @param ok3: the third type we allow
 * @param expr: the expression to cast
 *
 ...
 * @param rtype: the return type of the callback function
 * @param atype: the (pointer) type which the callback function expects.
 * @param fn: the callback function to cast
 * @param arg: the (pointer) argument to hand to the callback function.
 *
