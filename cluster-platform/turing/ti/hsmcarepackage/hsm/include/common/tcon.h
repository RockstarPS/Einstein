 ...
 * @param decls: the semi-colon separated list of type canaries.
 *
 ...
 * @param x: the structure containing the TCON.
 * @param canary: which canary to check against.
 * @param expr: the expression whose type must match the TCON (not evaluated)
 *
 ...
 * @param x: the structure containing the TCON.
 * @param canary: which canary to check against.
 * @param expr: the expression whose type must match &TCON (not evaluated)
 *
 ...
 * @param x: a structure containing the TCON.
 * @param canary: which canary to cast to.
