...
#define FEE_BSS_INTERNAL_NO_LOCK                    0x0U

#define FEE_BSS_INTERNAL_LOCK_SET_BIT               0x1U
#define FEE_BSS_EXTERNAL_LOCK_SET_BIT               0x2U

#define FEE_BSS_INTERNAL_LOCK_RELEASE_BIT           0xFEU
#define FEE_BSS_EXTERNAL_LOCK_RELEASE_BIT           0xFDU

#define FEE_HEADER_RESET_DURING_WRITE               0x1CU
#define FEE_HEADER_RESET_DURING_SEC_SWITCH          0x2CU
#define FEE_HEADER_RESET_DURING_ERASE               0x3CU
#define FEE_HEADER_RESET_DURING_IDLE                0xACU
#define FEE_HEADER_RESET_PATTERN                    0x3A5FUL
...
**************************************************************************/
EXTERN void Fee_SuspendInternalJob(void); 
...
**************************************************************************/
EXTERN void Fee_ResumeInternalJob(void); 

EXTERN Std_ReturnType Fee_LockInternalJob(boolean Status);
/**************************************************************************
