...
/**************************************************************************
Function name   : Std_ReturnType SNvM_Read(uint16 BlockNumber, uint16 BlockOffset, uint8* DataBufferPtr, uint16 Length);
...
**************************************************************************/
EXTERN Std_ReturnType SNvM_Read(uint16 BlockNumber, uint16 BlockOffset, uint8* DataBufferPtr, uint16 Length);
...
**************************************************************************/
Std_ReturnType SNvM_Write(uint16 BlockNumber, const uint8* DataBufferPtr);
