...
echo environment build ETHIF_VCAST_HT.env >> commands.tmp
echo /E:ETHIF_VCAST_HT tools script run ETHIF_VCAST_HT.tst >> commands.tmp
echo /E:ETHIF_VCAST_HT execute batch >> commands.tmp
echo /E:ETHIF_VCAST_HT reports custom management ETHIF_VCAST_HT_management_report.html >> commands.tmp
