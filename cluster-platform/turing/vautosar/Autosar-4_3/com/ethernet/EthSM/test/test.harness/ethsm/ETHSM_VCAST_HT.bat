...
echo options TESTABLE_SOURCE_DIR ..\..\..\..\TcpIp\include\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR ..\..\..\..\EthTrcv\include\ >> commands.tmp
echo environment build ETHSM_VCAST_HT.env >> commands.tmp
echo /E:ETHSM_VCAST_HT tools script run ETHSM_VCAST_HT.tst >> commands.tmp
echo /E:ETHSM_VCAST_HT execute batch >> commands.tmp
echo /E:ETHSM_VCAST_HT reports custom management ETHSM_VCAST_HT_management_report.html >> commands.tmp
