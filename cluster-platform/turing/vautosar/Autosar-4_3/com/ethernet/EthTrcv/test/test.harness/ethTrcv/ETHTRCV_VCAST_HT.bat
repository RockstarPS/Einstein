...
echo environment build ETHTRCV_VCAST_HT.env >> commands.tmp
echo /E:ETHTRCV_VCAST_HT tools script run ETHTRCV_VCAST_HT.tst >> commands.tmp
echo /E:ETHTRCV_VCAST_HT execute batch >> commands.tmp
echo /E:ETHTRCV_VCAST_HT reports custom management ETHTRCV_VCAST_HT_management_report.html >> commands.tmp
