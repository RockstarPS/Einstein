...
*   @Reentrancy Reentrant
********************************************************************************************************************/
extern FUNC(void, DOIP_CODE) DoIP_SoAdTpTxConfirmation(PduIdType id, Std_ReturnType result);
/*!******************************************************************************************************************
...
*   @Reentrancy Reentrant
********************************************************************************************************************/
extern FUNC(void, DOIP_CODE) DoIP_SoAdTpRxIndication(PduIdType id, Std_ReturnType result);
/*!******************************************************************************************************************
...
*   @Reentrancy Reentrant for different PduIds. Non reentrant for the same PduId.
********************************************************************************************************************/
extern FUNC(void, DOIP_CODE) DoIP_SoAdIfTxConfirmation(PduIdType TxPduId, Std_ReturnType result);
/*!******************************************************************************************************************
...
********************************************************************************************************************/
extern FUNC(void, DOIP_CODE) DoIP_SoConModeChg(SoAd_SoConIdType SoConId, SoAd_SoConModeType Mode);
/*!******************************************************************************************************************
...
*   @Reentrancy Reentrant for different SoConIds. Non reentrant for the same SoConId.
********************************************************************************************************************/
extern FUNC(void, DOIP_CODE) DoIP_LocalIpAddrAssignmentChg(SoAd_SoConIdType SoConId, TcpIp_IpAddrStateType State);
/*!******************************************************************************************************************
