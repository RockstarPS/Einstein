...
echo options TESTABLE_SOURCE_DIR ..\..\..\..\EthIf\include\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR ..\..\..\..\EthSM\include\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR ..\..\..\..\EthTrcv\include\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR ..\..\..\..\EthIf\test\test.harness\stubs\ >> commands.tmp
echo environment build TCPIP_VCAST_HT.env >> commands.tmp
echo /E:TCPIP_VCAST_HT tools script run TCPIP_VCAST_HT.tst >> commands.tmp
echo /E:TCPIP_VCAST_HT execute batch >> commands.tmp
echo /E:TCPIP_VCAST_HT reports custom management TCPIP_VCAST_HT_management_report.html >> commands.tmp
