...
echo options TESTABLE_SOURCE_DIR ..\..\..\..\..\..\ut-stubs\comp-specific\com\services\ComM\ >> commands.tmp
echo environment build COMM_VCAST_HT.env >> commands.tmp
echo /E:COMM_VCAST_HT tools script run COMM_VCAST_HT.tst >> commands.tmp
echo /E:COMM_VCAST_HT execute batch >> commands.tmp
echo /E:COMM_VCAST_HT tools import_coverage COMM_VCAST_HT.cvr >> commands.tmp
echo /E:COMM_VCAST_HT reports custom management COMM_VCAST_HT_management_report.html >> commands.tmp
