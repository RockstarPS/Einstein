...
echo options TESTABLE_SOURCE_DIR ..\..\..\..\..\..\ut-stubs\comp-specific\com\services\Com\ >> commands.tmp
echo environment build COM_VCAST_HT.env >> commands.tmp
echo /E:COM_VCAST_HT tools script run COM_VCAST_HT.tst >> commands.tmp
echo /E:COM_VCAST_HT execute batch >> commands.tmp
echo /E:COM_VCAST_HT tools import_coverage COM_VCAST_HT.cvr >> commands.tmp
echo /E:COM_VCAST_HT reports custom management COM_VCAST_HT_management_report.html >> commands.tmp
