...
echo options TESTABLE_SOURCE_DIR ..\..\..\..\Com\include\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR ..\..\..\..\..\..\ut-stubs\Common\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR ..\..\..\..\..\..\ut-stubs\comp-specific\com\services\ComXf\ >> commands.tmp
echo environment build COMXF_VCAST_HT.env >> commands.tmp
echo /E:COMXF_VCAST_HT tools script run COMXF_VCAST_HT.tst >> commands.tmp
echo /E:COMXF_VCAST_HT execute batch >> commands.tmp
echo /E:COMXF_VCAST_HT reports custom management COMXF_VCAST_HT_management_report.html >> commands.tmp
