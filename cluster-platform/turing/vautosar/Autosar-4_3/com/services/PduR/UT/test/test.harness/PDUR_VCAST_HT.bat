...
echo options TESTABLE_SOURCE_DIR ..\..\..\..\..\..\ut-stubs\comp-specific\com\services\PduR\ >> commands.tmp
echo environment build PDUR_VCAST_HT.env >> commands.tmp
echo /E:PDUR_VCAST_HT tools script run PDUR_VCAST_HT.tst >> commands.tmp
echo /E:PDUR_VCAST_HT execute batch >> commands.tmp
echo /E:PDUR_VCAST_HT reports custom management PDUR_VCAST_HT_management_report.html >> commands.tmp
