...
extern void PduR_LinIfRxIndication(PduIdType RxPduId, const PduInfoType* PduInfoPtr);
...
changing PduInfoPtr. */
extern Std_ReturnType PduR_LinIfTriggerTransmit(PduIdType TxPduId, PduInfoType* PduInfoPtr);
#endif /* PDUR_LINIF_H */
