...
*    @brief This file provides the callback function prototype of the PduR to CanIf module. This header file should   
*    be included only by CanIf module.
*    @defgroup PduRConfiguration
*    @brief This file provides the callback function prototype of the PduR to CanIf module.
********************************************************************************************************************/
#ifndef PDUR_CANIF_H
#define PDUR_CANIF_H
...
*   @Reentrancy Reentrant for different PduIds. Non reentrant for the same PduId.
********************************************************************************************************************/
extern FUNC(void,PDUR_CODE) PduR_CanIfTxConfirmation(PduIdType TxPduId,Std_ReturnType result);
/*!******************************************************************************************************************
...
*   @Reentrancy     Reentrant for different PduIds. Non reentrant for the same PduId.
********************************************************************************************************************/
extern FUNC(Std_ReturnType,PDUR_CODE) PduR_CanIfTriggerTransmit
(
    PduIdType TxPduId,
