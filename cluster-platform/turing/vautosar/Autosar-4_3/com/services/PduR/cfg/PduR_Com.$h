...
*    @brief This file provides the callback function prototype of the PduR to Com module. This header file should   
*    be included only by Com module.
*    @defgroup ComConfiguration
*    @brief This file provides the callback function prototype of the PduR to Com module.
********************************************************************************************************************/
#ifndef PDUR_COM_H
#define PDUR_COM_H
...
********************************************************************************************************************/
extern FUNC(Std_ReturnType,PDUR_CODE) PduR_ComChangeParameter(PduIdType id, TPParameterType parameter, uint16 value);
/*!******************************************************************************************************************
...
*   @Reentrancy Non Reentrant.
********************************************************************************************************************/
extern FUNC(Std_ReturnType,PDUR_CODE) PduR_ComCancelReceive(PduIdType RxPduId);
