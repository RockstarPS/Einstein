...
echo options TESTABLE_SOURCE_DIR ..\..\..\..\..\..\ut-stubs\comp-specific\com\services\Xcp\ >> commands.tmp
echo environment build XCP_VCAST_HT.env >> commands.tmp
echo /E:XCP_VCAST_HT tools script run XCP_VCAST_HT.tst >> commands.tmp
echo /E:XCP_VCAST_HT execute batch >> commands.tmp
echo /E:XCP_VCAST_HT tools import_coverage XCP_VCAST_HT.cvr >> commands.tmp
echo /E:XCP_VCAST_HT reports custom management XCP_VCAST_HT_management_report.html >> commands.tmp
