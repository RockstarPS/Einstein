...
********************************************************************************************************************/
extern void IpduM_RxIndication(PduIdType RxPduId, const PduInfoType* PduInfoPtr);
extern void IpduM_TxConfirmation(PduIdType TxPduId, Std_ReturnType Result);
extern Std_ReturnType IpduM_TriggerTransmit(PduIdType TxPduId, PduInfoType* PduInfoPtr);
#endif/* IPDUM_CBK_H */
