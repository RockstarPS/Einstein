...
echo options TESTABLE_SOURCE_DIR ..\..\..\..\..\..\ut-stubs\comp-specific\com\services\IpduM\ >> commands.tmp
echo environment build IPDUM_VCAST_HT.env >> commands.tmp
echo /E:IPDUM_VCAST_HT tools script run IPDUM_VCAST_HT.tst >> commands.tmp
echo /E:IPDUM_VCAST_HT execute batch >> commands.tmp
echo /E:IPDUM_VCAST_HT reports custom management IPDUM_VCAST_HT_management_report.html >> commands.tmp
