...
echo environment build NM_VCAST_HT.env >> commands.tmp
echo /E:NM_VCAST_HT tools script run NM_VCAST_HT.tst >> commands.tmp
echo /E:NM_VCAST_HT execute batch >> commands.tmp
echo /E:NM_VCAST_HT reports custom management NM_VCAST_HT_management_report.html >> commands.tmp
