...
echo environment build CANIF_VCAST_HT.env >> commands.tmp
echo /E:CANIF_VCAST_HT tools script run CANIF_VCAST_HT.tst >> commands.tmp
echo /E:CANIF_VCAST_HT execute batch >> commands.tmp
echo /E:CANIF_VCAST_HT reports custom management CANIF_VCAST_HT_management_report.html >> commands.tmp
