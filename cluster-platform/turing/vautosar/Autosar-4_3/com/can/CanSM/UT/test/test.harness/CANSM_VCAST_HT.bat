...
echo environment build CANSM_VCAST_HT.env >> commands.tmp
echo /E:CANSM_VCAST_HT tools script run CANSM_VCAST_HT.tst >> commands.tmp
echo /E:CANSM_VCAST_HT execute batch >> commands.tmp
echo /E:CANSM_VCAST_HT reports custom management CANSM_VCAST_HT_management_report.html >> commands.tmp
