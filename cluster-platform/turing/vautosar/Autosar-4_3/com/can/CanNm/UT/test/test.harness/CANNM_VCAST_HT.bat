...
echo environment build CANNM_VCAST_HT.env >> commands.tmp
echo /E:CANNM_VCAST_HT tools script run CANNM_VCAST_HT.tst >> commands.tmp
echo /E:CANNM_VCAST_HT execute batch >> commands.tmp
echo /E:CANNM_VCAST_HT reports custom management CANNM_VCAST_HT_management_report.html >> commands.tmp
