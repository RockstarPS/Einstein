...
echo environment build CANTRCV_VCAST_HT.env >> commands.tmp
echo /E:CANTRCV_VCAST_HT tools script run CANTRCV_VCAST_HT.tst >> commands.tmp
echo /E:CANTRCV_VCAST_HT execute batch >> commands.tmp
echo /E:CANTRCV_VCAST_HT reports custom management CANTRCV_VCAST_HT_management_report.html >> commands.tmp
