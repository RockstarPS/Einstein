...
echo options TESTABLE_SOURCE_DIR ..\..\..\CanIf\include\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR ..\..\..\CanNm\include\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR ..\..\..\CanSM\include\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR ..\..\include\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR ..\..\src\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR ..\..\..\CanTrcv\include\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR ..\..\..\stubs\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR ..\..\..\..\turing.bsw.services.test\ComM\include\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR ..\..\..\..\turing.bsw.services.test\Com\include\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR ..\..\..\..\turing.bsw.services.test\IpduM\include\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR ..\..\..\..\turing.bsw.services.test\Nm\include\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR ..\..\..\..\turing.bsw.services.test\PduR\include\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR ..\..\..\..\turing.bsw.services.test\Xcp\include\ >> commands.tmp
echo environment build CANTP_VCAST_HT.env >> commands.tmp
echo /E:CANTP_VCAST_HT tools script run CANTP_VCAST_HT.tst >> commands.tmp
echo /E:CANTP_VCAST_HT execute batch >> commands.tmp
echo /E:CANTP_VCAST_HT reports custom management CANTP_VCAST_HT_management_report.html >> commands.tmp
