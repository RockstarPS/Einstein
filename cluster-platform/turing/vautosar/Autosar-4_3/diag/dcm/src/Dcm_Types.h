...
#define DCM_SW_MAJOR_VERSION             2U
...
#define DCM_ROE_STARTED         (0x05U)
#define DCM_ROE_CLEARED         (0x06U)

#define DCM_ROE_ONDTCSTATUSCHANGE                         (0x01U)
