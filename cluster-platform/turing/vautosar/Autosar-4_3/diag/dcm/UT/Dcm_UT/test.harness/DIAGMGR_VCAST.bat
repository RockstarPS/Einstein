...
echo options TESTABLE_SOURCE_DIR ..\..\..\..\..\ut-stubs\comp-specific\diag\dcm\ >> commands.tmp
echo environment build DIAGMGR_VCAST.env >> commands.tmp
echo /E:DIAGMGR_VCAST  tools update mcdc >> commands.tmp
echo /E:DIAGMGR_VCAST tools script run DIAGMGR_VCAST.tst >> commands.tmp
echo /E:DIAGMGR_VCAST execute batch >> commands.tmp
echo /E:DIAGMGR_VCAST tools import_coverage DIAGMGR_VCAST.cvr >> commands.tmp
echo /E:DIAGMGR_VCAST reports custom management DIAGMGR_VCAST_management_report.html >> commands.tmp
