...
echo options TESTABLE_SOURCE_DIR ..\..\..\..\..\ut-stubs\comp-specific\diag\dem\ >> commands.tmp
echo environment build VC_DEM2.env >> commands.tmp
echo /E:VC_DEM2 tools script run VC_DEM2.tst >> commands.tmp
echo /E:VC_DEM2 execute batch >> commands.tmp
echo /E:VC_DEM2 tools import_coverage VC_DEM2.cvr >> commands.tmp
echo /E:VC_DEM2 reports custom management VC_DEM2_management_report.html >> commands.tmp
