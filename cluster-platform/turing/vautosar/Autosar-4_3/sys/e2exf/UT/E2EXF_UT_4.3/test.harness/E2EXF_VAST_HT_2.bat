...
echo options TESTABLE_SOURCE_DIR C:\Users\sbandla\OneDrive - Visteon\Desktop\WORKS\UT\test.harness 2\test.harness\Src\can-develop\CanTrcv\src\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR C:\Users\sbandla\OneDrive - Visteon\Desktop\WORKS\UT\test.harness 2\test.harness\Src\can-develop\CanTrcv\include\ >> commands.tmp
echo environment build E2EXF_VAST_HT_2.env >> commands.tmp
echo /E:E2EXF_VAST_HT_2 tools script run E2EXF_VAST_HT_2.tst >> commands.tmp
echo /E:E2EXF_VAST_HT_2 execute batch >> commands.tmp
echo /E:E2EXF_VAST_HT_2 reports custom management E2EXF_VAST_HT_2_management_report.html >> commands.tmp
