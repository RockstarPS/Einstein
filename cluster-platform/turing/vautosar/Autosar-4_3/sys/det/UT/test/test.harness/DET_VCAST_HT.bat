...
echo options TESTABLE_SOURCE_DIR ..\..\..\..\..\ut-stubs\comp-specific\sys\det\ >> commands.tmp
echo environment build DET_VCAST_HT.env >> commands.tmp
echo /E:DET_VCAST_HT tools script run DET_VCAST_HT.tst >> commands.tmp
echo /E:DET_VCAST_HT execute batch >> commands.tmp
echo /E:DET_VCAST_HT reports custom management DET_VCAST_HT_management_report.html >> commands.tmp
