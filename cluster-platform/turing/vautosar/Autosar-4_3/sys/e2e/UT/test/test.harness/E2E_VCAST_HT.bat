...
echo options TESTABLE_SOURCE_DIR ..\..\..\..\..\ut-stubs\comp-specific\sys\e2e\ >> commands.tmp
echo environment build E2E_VCAST_HT.env >> commands.tmp
echo /E:E2E_VCAST_HT tools script run E2E_VCAST_HT.tst >> commands.tmp
echo /E:E2E_VCAST_HT execute batch >> commands.tmp
echo /E:E2E_VCAST_HT tools import_coverage E2E_VCAST_HT.cvr >> commands.tmp
echo /E:E2E_VCAST_HT reports custom management E2E_VCAST_HT_management_report.html >> commands.tmp
