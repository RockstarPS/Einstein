...
extern FUNC(void, WDGIF_CODE_SEC_START) WdgIf_GetVersionInfo(Std_VersionInfoType* VersionInfo);
#endif
extern FUNC(void, WDGIF_CODE_SEC_START) WdgIf_SetTriggerCondition(uint8 DeviceIndex, uint16 Timeout);

extern FUNC(Std_ReturnType, WDGIF_CODE_SEC_START) WdgIf_SetMode(uint8 DeviceIndex, WdgIf_ModeType WdgMode);
