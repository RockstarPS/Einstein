...
echo options TESTABLE_SOURCE_DIR ..\..\..\src\WdgIf\src\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR ..\..\..\src\WdgM\src\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR ..\..\..\..\..\ut-stubs\Common\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR ..\..\..\..\..\ut-stubs\comp-specific\sys\wdgm\ >> commands.tmp
echo environment build WDGM_VCAST_HT.env >> commands.tmp
echo /E:WDGM_VCAST_HT tools script run WDGM_VCAST_HT.tst >> commands.tmp
echo /E:WDGM_VCAST_HT execute batch >> commands.tmp
echo /E:WDGM_VCAST_HT tools import_coverage WDGM_VCAST_HT.cvr >> commands.tmp
echo /E:WDGM_VCAST_HT reports custom management WDGM_VCAST_HT_management_report.html >> commands.tmp
