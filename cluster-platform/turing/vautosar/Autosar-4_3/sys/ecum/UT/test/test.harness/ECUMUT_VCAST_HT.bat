...
echo options TESTABLE_SOURCE_DIR ..\..\..\..\..\ut-stubs\comp-specific\sys\ecum\ >> commands.tmp
echo environment build ECUMUT_VCAST_HT.env >> commands.tmp
echo /E:ECUMUT_VCAST_HT tools script run ECUMUT_VCAST_HT.tst >> commands.tmp
echo /E:ECUMUT_VCAST_HT execute batch >> commands.tmp
echo /E:ECUMUT_VCAST_HT reports custom management ECUMUT_VCAST_HT_management_report.html >> commands.tmp
