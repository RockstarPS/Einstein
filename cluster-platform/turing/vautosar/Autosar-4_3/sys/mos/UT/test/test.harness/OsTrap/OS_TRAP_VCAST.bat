...
echo options C_DEFINE_LIST const=  OS_PRIVILEGE_USER_ENABLE >> commands.tmp
...
echo environment build OS_TRAP_VCAST.env >> commands.tmp
echo /E:OS_TRAP_VCAST tools script run OS_TRAP_VCAST.tst >> commands.tmp
echo /E:OS_TRAP_VCAST execute batch >> commands.tmp
echo /E:OS_TRAP_VCAST tools import_coverage OS_TRAP_VCAST.cvr >> commands.tmp
echo /E:OS_TRAP_VCAST reports custom management OS_TRAP_VCAST_management_report.html >> commands.tmp
