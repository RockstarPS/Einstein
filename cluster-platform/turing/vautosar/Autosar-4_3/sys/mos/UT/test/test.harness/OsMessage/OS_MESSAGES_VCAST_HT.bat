...
echo environment build OS_MESSAGES_VCAST_HT.env >> commands.tmp
echo /E:OS_MESSAGES_VCAST_HT tools script run OS_MESSAGES_VCAST_HT.tst >> commands.tmp
echo /E:OS_MESSAGES_VCAST_HT execute batch >> commands.tmp
echo /E:OS_MESSAGES_VCAST_HT reports custom management OS_MESSAGES_VCAST_HT_management_report.html >> commands.tmp
