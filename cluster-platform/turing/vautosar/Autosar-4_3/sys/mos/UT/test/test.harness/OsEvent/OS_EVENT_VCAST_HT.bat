...
echo options TESTABLE_SOURCE_DIR ..\..\..\..\src\includes\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR ..\..\..\..\..\..\ut-stubs\Common\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR ..\..\..\..\..\..\ut-stubs\comp-specific\sys\mos\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR ..\..\..\..\..\..\ut-stubs\comp-specific\sys\mos\Amd\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR ..\..\..\..\..\..\ut-stubs\comp-specific\sys\mos\Os\cpu\arm\cortex7\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR ..\..\..\..\..\..\ut-stubs\comp-specific\sys\mos\bsw-gen\bsw\amd\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR ..\..\..\..\..\..\ut-stubs\comp-specific\sys\mos\bsw-gen\bsw\os\ToolUpdateConfig\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR ..\..\..\..\..\..\ut-stubs\comp-specific\sys\mos\Os\cpu\arm\cortex7_main\ >> commands.tmp
echo environment build OS_EVENT_VCAST_HT.env >> commands.tmp
echo /E:OS_EVENT_VCAST_HT tools script run OS_EVENT_VCAST_HT.tst >> commands.tmp
echo /E:OS_EVENT_VCAST_HT execute batch >> commands.tmp
echo /E:OS_EVENT_VCAST_HT tools import_coverage OS_EVENT_VCAST_HT.cvr >> commands.tmp
echo /E:OS_EVENT_VCAST_HT reports custom management OS_EVENT_VCAST_HT_management_report.html >> commands.tmp
