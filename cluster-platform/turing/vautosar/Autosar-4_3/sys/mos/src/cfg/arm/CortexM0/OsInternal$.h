...
#include "intvect.h"
#ifdef __MSPM0G3519__
#include "mspm0g351x.h"
#endif
...
#define osdIntCfgMaxSystemPriority          0x10UL
...
#define osdUsedSystemTimer                  osdReloadTimer_Ch0//need to edit
...
#define OS_INT_NVIC_SHPR1_REG                   ( * ( ( volatile osuint32 * ) 0xe000e01C ) )
#define OS_INT_NVIC_SHPR2_REG                   ( * ( ( volatile osuint32 * ) 0xe000ed1C ) )
#define OS_INT_NVIC_SHPR3_REG                   ( * ( ( volatile osuint32 * ) 0xe000ed20 ) )

#define osdIntCfgNvicSHPRI1                     0UL
#define osdIntCfgNvicSHPRI2                     0UL
#define osdIntCfgNvicSHPRI3                     (osdIntCfgKernelPriority << 16UL)
...
typedef struct
{
    ...
    osuint32 RESERVED1;
    volatile osuint32 SHP[2];            /*!< Offset: 0x01C (R/W)  System Handlers Priority Registers. [0] is RESERVED   */
    volatile const osuint32 SHCSR;		
...
typedef struct
{
    volatile  osuint32 ISER[1];      /*!< Offset: 0x000 (R/W)  Interrupt Set Enable Register           */
       osuint32 RESERVED0[31];
    volatile  osuint32 ICER[1];      /*!< Offset: 0x080 (R/W)  Interrupt Clear Enable Register          */
       osuint32 RSERVED1[31];
    volatile  osuint32 ISPR[1];      /*!< Offset: 0x100 (R/W)  Interrupt Set Pending Register           */
       osuint32 RESERVED2[31];
    volatile  osuint32 ICPR[1];      /*!< Offset: 0x180 (R/W)  Interrupt Clear Pending Register         */
       osuint32 RESERVED3[31];
       osuint32 RESERVED4[64];
    volatile  osuint32 IP[8];        /*!< Offset: 0x300 (R/W)  Interrupt Priority Register              */
...
/* IUNIT */
#define osIRQ_BASE              0xE000E000UL 

/*! NVIC interrupt controller base address. */
# define OS_HAL_INTC_NVIC_BASE  (0xE000E100UL)
/**********************************************************************************************************************
...
# define OS_HAL_INTC_NVIC_ISER(x)    (*(volatile uint32*) (OS_HAL_INTC_NVIC_BASE + 0x000UL + ((x) * 4UL)))              /* PRQA S 3453 */ /* MD_MSR_19.7 */

/*! Interrupt Clear-Enable Registers (ICER). */
# define OS_HAL_INTC_NVIC_ICER(x)    (*(volatile uint32*) (OS_HAL_INTC_NVIC_BASE + 0x080UL + ((x) * 4UL)))              /* PRQA S 3453 */ /* MD_MSR_19.7 */

/*! Interrupt Set-Pending Registers (ISPR). */
# define OS_HAL_INTC_NVIC_ISPR(x)    (*(volatile uint32*) (OS_HAL_INTC_NVIC_BASE + 0x100UL + ((x) * 4UL)))              /* PRQA S 3453 */ /* MD_MSR_19.7 */

/*! Interrupt Clear-Pending Registers (ICPR). */
# define OS_HAL_INTC_NVIC_ICPR(x)    (*(volatile uint32*) (OS_HAL_INTC_NVIC_BASE + 0x180UL + ((x) * 4UL)))              /* PRQA S 3453 */ /* MD_MSR_19.7 */
...
# define OS_HAL_INTC_NVIC_IPR(x)     (*(volatile uint8*) (OS_HAL_INTC_NVIC_BASE + 0x300UL + (x)))                       /* PRQA S 3453 */ /* MD_MSR_19.7 */
...
#ifndef NVIC
#define NVIC                ((OS_NVIC_Type      *)     NVIC_BASE     )
#endif
#ifndef SCB
#define SCB                 ((OS_SCB_Type       *)     SCB_BASE      ) 
#endif
...
//#define osdReloadValue 0x4152UL
