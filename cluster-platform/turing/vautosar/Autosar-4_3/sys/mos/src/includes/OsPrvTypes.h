...
typedef struct
{
    ...
    osuint32            StackRegnSizeAndEnable;
}OsObjConfigType;
...
typedef OsTaskParamType* OsTaskParamRefType;
...
typedef struct
{
    ...
    osuint8             TasksType;
    osuint8             TasksID;
    OsTaskParamRefType  TaskParamRef;
}OsTaskConfigType;

typedef OsTaskConfigType* OsTaskConfigRefType;
...
typedef CounterParamType* CounterParamRefType;
...
typedef struct
{
    ...
    osfloat32           OsSecondsPerTick;
    OsAppConfigRefType  OsCounterAccessingApplication;
    CounterParamRefType         OsCounterParam;
}CounterConfigType;

typedef CounterConfigType* CounterConfigRefType;
...
typedef struct
{
	...
	osuint8		AlarmAutostartType;
}OsAlarmParamType;

typedef OsAlarmParamType* OsAlarmParamRefType;

typedef struct
{
    OsAppConfigRefType OsAlarmAccessingApplication;
    CounterConfigRefType OsAlarmCounterRef;
    OsTaskConfigRefType OsAlarmActivateTaskRef;
    OsAlarmParamRefType OsAlarmParamRef;
    void (*OsAlarmCallback)(void);
    CounterConfigRefType OsCounterInc;
    TaskType OsAlarmTask;
    osuint8 OsAlarmAction;
    EventMaskType OsAlarmEvent;
}AlarmConfigType;

typedef AlarmConfigType* AlarmConfigRefType;
...
typedef OsResConfigType * OsResConfigRefType;

typedef struct
{
    OsIsrCategory OsIsrCat;
    osuint16 IsrNesting;
    osuint16 IsrEnableSource;
    osuint16 IsrMapping;
    IRQSourceType       IrqNum;
    osuint16 Stacksize;
    OsResConfigRefType ResourceRef;
    IRQPrioLevelType    PrioLevel;
    osVoidFunctionType  ServiceRoutine;
    OsObjConfigRefType  pObjRef;
}OsIsrConfigType; 

typedef OsIsrConfigType*    OsIsrConfigRefType;
...
typedef struct
{
    ...
    TickType                    NextTimestamp;
    osuint32                    CurrentExpiryPoint;
}OsSchTblParamType;

typedef OsSchTblParamType* OsSchTblParamRefType;

typedef enum
{
    SCHEDULETABLE_ABSOLUTE,
    SCHEDULETABLE_RELATIVE,
    SCHEDULETABLE_SYNCHRON
}OsSchTblAutostartType;

typedef struct
{
    OsSchTblAutostartType AutoStartType;
    TickType AbsRelTickValue;
    osuint8 OsAppMode;
}OsSchTblAutoStartConfigType;

typedef OsSchTblAutoStartConfigType* OsSchTblAutoStartConfigRefType;

typedef struct
{
    EventMaskType EventMask;
    OsTaskConfigRefType EventTaskRef;
}OsSchTblEventSetConfigType;

typedef OsSchTblEventSetConfigType* OsSchTblEventSetConfigRefType;

typedef struct
{
    OsTaskConfigRefType ActivateTaskRef;
}OsSchTblTaskActivateConfigType;

typedef OsSchTblTaskActivateConfigType* OsSchTblTaskActivateConfigRefType;

typedef struct
{
    TickType MaxLengthenTick;
    TickType MaxShortenTick;
}OsSchTblAdjExpPointConfigType;

typedef OsSchTblAdjExpPointConfigType* OsSchTblAdjExpPointConfigRefType;

typedef struct
{
    TickType ExpPointOffset;
    OsSchTblEventSetConfigRefType EventSetListRef;
    osuint8 NoOfEventSet;
    OsSchTblTaskActivateConfigRefType TaskActivateListRef;
    osuint8 NoOfTaskActivate;
    OsSchTblAdjExpPointConfigRefType AdjExpPointRef;
}OsSchTblExpPointConfigType;

typedef OsSchTblExpPointConfigType* OsSchTblExpPointConfigRefType;

typedef enum
{
    SCHEDULETABLE_SYNC_NONE,
...
typedef struct
{
    OsScheduleTblSyncStrategy SchTblSyncType;
    osuint32 SchTblExplicitPrecision;
}OsSchTblSyncConfigType;

typedef OsSchTblSyncConfigType* OsSchTblSyncConfigRefType;

typedef struct
{
    osuint32 SchedTblDuration;
    osuint8  OsSchedTblRepeating;
    CounterConfigRefType CounterRef;
    OsAppConfigRefType  AccessAppRef;
    osuint8 NoOfAccessingApp;
    OsAppConfigRefType  OwnAppRef;
    OsSchTblAutoStartConfigRefType AutoStartRef;
    OsSchTblExpPointConfigRefType ExpiryPointListRef;
    osuint8 NoOfExpiryPoint;
    OsSchTblSyncConfigRefType SyncConfigRef;
    OsSchTblParamRefType SchTblParam;
}OsScheduleTableConfigType;

typedef OsScheduleTableConfigType* OsScheduleTableConfigRefType;

typedef union
{
    StatusType* Status;
    AccessType* Access;
    ObjectAccessType* ObjAccess;
    ApplicationType* AppId;
}OsTrapArgUnion;
...
typedef union
{
    ...
    ResourceType ResId;
    EventMaskType eventmask;
    EventMaskRefType MaskRef;
    StatusType ErrStatus;
    ISRType ISRId;
    MemoryStartAddressType MemStartAddr;
    MemorySizeType MemSize;
    ApplicationType AppID;
    ObjectTypeType ObjType;
    ObjectIdType ObjID;
    ScheduleTableType ScheduleTblId1;
    ScheduleTableType ScheduleTblId2;
    CounterType CounterId;
    RestartType RestartOpt;
    boolean ClrPending;
    TrustedFunctionIndexType TrustedFuncId;
    TrustedFunctionParameterRefType TrustedFuncParamRef;
}OsTrapParamType;

typedef struct
{
    OsTrapArgUnion RetVal;
    OsTrapParamType Arg1;
    OsTrapParamType Arg2;
    OsTrapParamType Arg3;
}OsTrapArgType;

typedef struct
{
    OsTrapFuncType TrapFunc;
}OsTrapTableType;
