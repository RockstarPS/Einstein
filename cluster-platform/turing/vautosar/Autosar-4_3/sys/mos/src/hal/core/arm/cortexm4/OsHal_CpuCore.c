...
{
    OS_INT_CPUSS_CM4_SYSTEM_INT_CTL(IrqSrc) |= OS_INT_INTC_SYSTEM_INT_CL_ENABLED_BIT;
}
...
static void OsHalPrv_EnableFaultregisters(void)
{
    CM4_SCS_SHCSR |= BUS_MEM_USAGE_FAULT_ENABLE; /*MISRA RULE 11.4 VIOLATION: This is the reason why the MISRA rule could not be followed in this special case*/
}
