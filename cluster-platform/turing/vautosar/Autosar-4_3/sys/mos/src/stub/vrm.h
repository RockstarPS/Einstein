/* Kernbauer Version: 2.15 Konfiguration: ArmCortexR Erzeugungsgangnummer: 34 Zweig: 1 */
...
/* source VRM check               */
#define osdVrmMajRelNumRef 6
#define osdVrmMinRelNumRef 0
#define osdVrmPatchRelNumRef 0

/* generator VRM check            */
#define osdVrmGenMajRelNumRef 6
