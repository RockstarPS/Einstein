...
echo options TESTABLE_SOURCE_DIR ..\..\..\..\..\ut-stubs\comp-specific\sys\crc\ >> commands.tmp
echo environment build CRCLIB_VCAST_HT.env >> commands.tmp
echo /E:CRCLIB_VCAST_HT tools script run CRCLIB_VCAST_HT.tst >> commands.tmp
echo /E:CRCLIB_VCAST_HT execute batch >> commands.tmp
echo /E:CRCLIB_VCAST_HT reports custom management CRCLIB_VCAST_HT_management_report.html >> commands.tmp
