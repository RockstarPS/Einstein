...
/** \brief Type definitions for FLASH configuration.
 **
 ** This type contains the structures for FLASH configuration.
 */
typedef struct
{
...
typedef struct
{
  ...
  CONSTP2VAR( volatile Mcu_FlashRegType,  AUTOMATIC, REGSPACE )  FlashRegBaseAddr[2];
...
typedef struct
{
  ...
  P2CONST( Mcu_FlashConfigDataType,          MCU_CONST, MCU_APPL_CONST )  FlashConfigPtr;
  P2CONST( uint32,                           MCU_CONST, MCU_APPL_CONST )  FastClockCtlRegValPtr;
...
/** \brief Data structure for main core power configuration.
 **
 ** This data shows main core power configuration.
 */
typedef struct
{
  uint32  PwrDelayCtlRegVal;
  uint8   PwrMode;
  uint8   PwrCtlRegIdx;
}
Mcu_MainCorePwrConfigType;
...
typedef struct
{
  ...
  P2CONST( Mcu_MainCorePwrConfigType, MCU_CONST, MCU_APPL_CONST )   MainCorePwrConfigPtr;
  uint32                                                            ScrRegVal;
  uint32                                                            LpmRdyToCnt;
  uint32                                                            RamWbToCnt;
...
typedef struct
{
  ...
  Mcu_CpuStatusType  MainCoreStatus[4];
