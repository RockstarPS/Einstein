...
/* Generator Internal Version                                         11.06.02 (Cfg5.16.x compatible, Release AR4-19), Revision: 92975, Variant: Vag (Vector) */
...
#define DEM_CFG_DATA_AGINGCTR                                              STD_ON       /* Autodetected - STD_ON: any /Dem/DemGeneral/DemDataClass/DemDataElementInternalData == DEM_AGINGCTR exists, STD_OFF: else */ 
...
#define DEM_CFG_SUPPORT_CYCLE_POWER                                        STD_ON       /* Autodetected - STD_ON: cycle type is referenced by any *CycleRef or the /Dem/DemGeneral/DemRestartCycleOnInitRef parameter, STD_OFF: cycle type is not referenced. The '*CycleRef' params are (here 92 refs): /Dem/DemConfigSet/DemEventParameter/DemEventClass/DemAgingCycleRef, ~/DemOperationCycleRef, ~/DemIndicatorAttribute/DemIndicatorFailureCycleRef and ~/DemIndicatorAttribute/DemIndicatorHealingCycleRef. */ 
...
#endif
#ifndef DEM_PROCESSOR_IMX8QUADXPLUS
#define DEM_PROCESSOR_IMX8QUADXPLUS
#endif
...
#endif  /* DEM_CFG_H */
/**********************************************************************************************************************
  END OF FILE: Dem_Cfg.h     [Vag (Vector), VARIANT-PRE-COMPILE, 11.06.02.92975]
**********************************************************************************************************************/
