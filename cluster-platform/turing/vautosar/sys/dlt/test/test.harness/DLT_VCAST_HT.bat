...
echo options VCAST_REPOSITORY C:\\Users\\ssawaria\\Projects\\HyundaiAI3\\DLT\\DLT_UT\\test.harness >> commands.tmp
...
echo options TESTABLE_SOURCE_DIR .\DLT_LEVEL1_REVISED\src\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR .\DLT_LEVEL1_REVISED\test.harness_Dlt\ >> commands.tmp
echo environment build DLT_VCAST_HT.env >> commands.tmp
echo /E:DLT_VCAST_HT tools script run DLT_VCAST_HT.tst >> commands.tmp
echo /E:DLT_VCAST_HT execute batch >> commands.tmp
echo /E:DLT_VCAST_HT reports custom management DLT_VCAST_HT_management_report.html >> commands.tmp
