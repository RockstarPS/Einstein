...
@{
*/
#define COMPILER_VENDOR_ID_CFG_H                      43
/*
 * @violates @ref Compiler_Cfg_REF_1 This is required as per autosar Requirement
 * @violates @ref Compiler_Cfg_REF_2 Violates MISRA 2004 Rule 1.4, Identifier clash
 */
#define COMPILER_AR_RELEASE_MAJOR_VERSION_CFG_H       4
/*
 * @violates @ref Compiler_Cfg_REF_1 This is required as per autosar Requirement
 * @violates @ref Compiler_Cfg_REF_2 Violates MISRA 2004 Rule 1.4, Identifier clash
 */
#define COMPILER_AR_RELEASE_MINOR_VERSION_CFG_H       2
/*
 * @violates @ref Compiler_Cfg_REF_1 This is required as per autosar Requirement
 * @violates @ref Compiler_Cfg_REF_2 Violates MISRA 2004 Rule 1.4, Identifier clash
 */
#define COMPILER_AR_RELEASE_REVISION_VERSION_CFG_H    2
/*
 * @violates @ref Compiler_Cfg_REF_1 This is required as per autosar Requirement, 
 */
#define COMPILER_SW_MAJOR_VERSION_CFG_H               3
/*
 * @violates @ref Compiler_Cfg_REF_1 This is required as per autosar Requirement, 
 */
#define COMPILER_SW_MINOR_VERSION_CFG_H               0
/*
 * @violates @ref Compiler_Cfg_REF_1 This is required as per autosar Requirement, 
 */
#define COMPILER_SW_PATCH_VERSION_CFG_H               0
/*==================================================================================================
*                                           CONSTANTS
==================================================================================================*/
...
// iulivero start: FIXME to be removed from 3-rd party ode
/**********************************************************************************************************************
 *  OS START
 *********************************************************************************************************************/
...
#define CHANGE_SECTION(sec, name) PRAGMA( ghs section sec = name )
#define BSS_BURAM_SECTION   ".Retention_RAM_Group0"
#define BSS_DEFAULT_SECTION   default


#define VAR_BURAM(VARIABLE, TYPE)            \
CHANGE_SECTION(bss, BSS_BURAM_SECTION)       \
TYPE VARIABLE;                               \
CHANGE_SECTION(bss, BSS_DEFAULT_SECTION)


#define VAR_BURAM_ARRAY(VARIABLE, TYPE, SIZE)      \
CHANGE_SECTION(bss, BSS_BURAM_SECTION)             \
TYPE VARIABLE[SIZE];                               \
CHANGE_SECTION(bss, BSS_DEFAULT_SECTION)
 ...
 *********************************************************************************************************************/
 	...
 	extern void DetforAssert( const boolean fl_Condition );
    #define ASSERT(x) DetforAssert(x)
#else
 #define ASSERT(x)
#endif
