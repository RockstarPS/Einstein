...
echo environment build ECUAPPM_VCAST_HT.env >> commands.tmp
echo /E:ECUAPPM_VCAST_HT tools script run ECUAPPM_VCAST_HT.tst >> commands.tmp
echo /E:ECUAPPM_VCAST_HT execute batch >> commands.tmp
echo /E:ECUAPPM_VCAST_HT reports custom management ECUAPPM_VCAST_HT_management_report.html >> commands.tmp
