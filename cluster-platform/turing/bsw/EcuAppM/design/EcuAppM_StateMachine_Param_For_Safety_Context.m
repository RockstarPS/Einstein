...
ECUAPPM_MIN_GROUP_ACTIVE_TIME.Value =uint16(0);
...
GroupCurrentActivity.Dimensions = 5; 
...
EcuAppM_GroupConfigData.Value = struct('wakeupSourceMask',{0xFF 0xFF 0xFF 0xFF 0xFF},'deactivationType',{0 0 0 0 0},'safetyLevel',{SafetyLevelType.eSafetyLevel_QM SafetyLevelType.eSafetyLevel_QM SafetyLevelType.eSafetyLevel_QM SafetyLevelType.eSafetyLevel_ASILA SafetyLevelType.eSafetyLevel_QM},'failSafeTimeout',{20 20 20 20 20},'attributes',{0 0 0 1 0});
...
EcuAppM_WakeupSourcesData.Value = struct('wakeupMask',{1 2 4 8 16 32}, 'validationTime',{20 20 20 20 20 20},'wakeupReaction',{0 0 0 0 0 0});
