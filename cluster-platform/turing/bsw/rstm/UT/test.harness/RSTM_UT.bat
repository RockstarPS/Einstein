...
echo environment build RSTM_UT.env >> commands.tmp
echo /E:RSTM_UT tools script run RSTM_UT.tst >> commands.tmp
echo /E:RSTM_UT execute batch >> commands.tmp
echo /E:RSTM_UT tools import_coverage RSTM_UT.cvr >> commands.tmp
echo /E:RSTM_UT reports custom management Rstm_management_report.html >> commands.tmp
