...
#define DLT_HEADERUSEECUID                          STD_OFF
#define DLT_HEADERUSESESSIONID                      STD_OFF
#define DLT_HEADERUSETIMESTAMP                      STD_ON
#define DLT_USEEXTHEADERINNONVERBMODE               STD_ON
#define DLT_USEVERBOSEMODE                          STD_OFF
...
#define DLT_NUM_LOGCHANNELASSIGNMENT                (1U)
...
#define DLT_GENERAL_GPTCHANNELREF_CONFIG            STD_ON
#define DLT_GENERAL_GPTCHANNELREF                   (0U)          //Add GptChannelID
...
#define DLT_ECUID_VALUE                             (0x12345678U)
#define DLT_ISBIGENDIAN                             (1U)
#define DLT_MAX_HEADER_BUFF_SIZE                    (25U)
...
typedef struct
{
    ...
    uint8 DltLogChannelId[4U];                      // Log channel ID 
