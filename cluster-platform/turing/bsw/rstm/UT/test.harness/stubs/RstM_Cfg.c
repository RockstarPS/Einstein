...
const RstM_FaultConfigType  RstM_FaultConfig[RSTM_MAX_NUM_FAULTS] = 
{
  ...
  {FLTM_E_PMIC_ABIST_FAIL, PMIC_RESET},
...
{
  /* Session Id, loglevel, argCount,  options, appId, contextId*/
  0U, DLT_LOG_FATAL, 1U, DLT_ISMSGVERBOSEMODE_BIT, {(uint8)'R',(uint8)'S',(uint8)'T',(uint8)'M'}, {(uint8)'R',(uint8)'S',(uint8)'T',(uint8)'M'}
};
