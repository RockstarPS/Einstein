...
* @details IMX8 System Memory Map
*/
#define DMA0_BASEADDR                           ((uint32)0x591F0000UL)

/**
* @brief Direct Memory Access Controller (DMA1)
* @details IMX8 System Memory Map
*/
#define DMA1_BASEADDR                           ((uint32)0x599F0000UL)

/**
* @brief Direct Memory Access Controller (DMA2)
* @details IMX8 System Memory Map
*/
#define DMA2_BASEADDR                           ((uint32)0x5A1F0000UL)

/**
* @brief Direct Memory Access Controller (DMA3)
* @details IMX8 System Memory Map
*/
#define DMA3_BASEADDR                           ((uint32)0x5A9F0000UL)
/**
...
/**
@brief  Ethernet Controller  (ENET_1)
@details IMX8 System Memory Map
*/
