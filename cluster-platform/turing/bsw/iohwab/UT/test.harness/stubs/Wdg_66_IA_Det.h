 ...
 *  e -- error code
 */
/* PRQA S 3453 2 *//* This macro is intended to enable or disable DET error report. */
 ...
 *  e -- error code
 */
/* PRQA S 3453 1 *//* This macro is intended to enable or disable DET error report. */
#define WDG_66_IA_DET_REPORTERROR(a,e)
 ...
 **
 ** This function is used inside the wdg module to report an error to the error handler and optionally to the DET.
 **
