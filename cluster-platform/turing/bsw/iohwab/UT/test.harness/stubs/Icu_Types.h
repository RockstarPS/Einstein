...
*     Autosar ConfVariant :
*     SWVersion           : 4.0.0
*     BuildVersion        : IMX8_MCAL_4_0_0_RTM_ASR_REL_4_2_REV_0002_20210812
*
...
#define ICU_TYPES_SW_MAJOR_VERSION                4
...
/* Check if Icu_Types header and Icu_Cfg header file are of the same vendor */
#if (ICU_TYPES_VENDOR_ID != ICU_VENDOR_ID_CFG)
    #error "Icu_Types.h and Icu_Cfg.h have different vendor IDs"
#endif
    /* Check if Icu_Types header file and Icu_Cfg header file are of the same Autosar version */

#if ((ICU_TYPES_AR_RELEASE_MAJOR_VERSION != ICU_AR_RELEASE_MAJOR_VERSION_CFG) || \
     (ICU_TYPES_AR_RELEASE_MINOR_VERSION != ICU_AR_RELEASE_MINOR_VERSION_CFG) || \
     (ICU_TYPES_AR_RELEASE_REVISION_VERSION != ICU_AR_RELEASE_REVISION_VERSION_CFG))
    #error "AutoSar Version Numbers of Icu_Types.h and Icu_Cfg.h are different"
#endif
/* Check if Icu_Types header file and Icu_Cfg header file are of the same software version */
#if ((ICU_TYPES_SW_MAJOR_VERSION != ICU_SW_MAJOR_VERSION_CFG) || \
     (ICU_TYPES_SW_MINOR_VERSION != ICU_SW_MINOR_VERSION_CFG) || \
     (ICU_TYPES_SW_PATCH_VERSION != ICU_SW_PATCH_VERSION_CFG))
