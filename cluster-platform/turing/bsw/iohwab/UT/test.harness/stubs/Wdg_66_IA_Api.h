 ...
 **
 ** This API is used to switch the watchdog driver between the following
 ...
 **
 ** \return E_OK: Switching has been successfully completed.
 **         E_NOT_OK: Switching has been failed.
 */
 ...
 **
 ** This API is used to set the permission to trigger the watchdog hardware for the next 'timeout' milliseconds.
 ** It has to be called again by some upper layer function, usually the watchdog manager, before the permission period expires.
 **
 ** \param [in] Channel   A GPT channel to be started.
 */
extern FUNC( void, WDG_CODE)
