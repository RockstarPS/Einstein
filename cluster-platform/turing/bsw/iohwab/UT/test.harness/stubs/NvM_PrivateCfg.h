...
#define NvM_DemReportErrorReqFailed()        Dem_ReportErrorStatus(DemConf_DemEventParameter_NVM_E_REQ_FAILED,DEM_EVENT_STATUS_FAILED) 
#define NvM_DemReportErrorIntegrityFailed()  Dem_ReportErrorStatus(DemConf_DemEventParameter_NVM_E_INTEGRITY_FAILED,DEM_EVENT_STATUS_FAILED) 
#define NvM_DemReportErrorLossOfRedundancy() Dem_ReportErrorStatus(DemConf_DemEventParameter_NVM_E_LOSS_OF_REDUNDANCY,DEM_EVENT_STATUS_FAILED) 
#define NvM_DemReportErrorQueueOverflow()    Dem_ReportErrorStatus(DemConf_DemEventParameter_NVM_E_QUEUE_OVERFLOW,DEM_EVENT_STATUS_FAILED) 
#define NvM_DemReportErrorWriteProtected()   Dem_ReportErrorStatus(DemConf_DemEventParameter_NVM_E_WRITE_PROTECTED,DEM_EVENT_STATUS_FAILED) 
...
#define NVM_USE_BLOCK_ID_CHECK STD_ON 
