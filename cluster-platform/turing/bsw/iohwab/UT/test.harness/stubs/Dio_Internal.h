 ...
 ** \param[in]  Dio_DriverConfig  This structure contains all post-build
...
extern FUNC(Dio_LevelType,DIO_CODE) Dio_ReadChannel_Internal
    (
        ...
        P2CONST(Dio_ConfigType, AUTOMATIC, DIO_CONST) Dio_DriverConfig
    );
...
/** \brief Dio_GetVersionInfo_Internal
 **
 ** This function get the version information of this module.
 **
 ...
 ** \retval      none
 ** */
extern FUNC(void, DIO_CODE) Dio_GetVersionInfo_Internal(
