...
#include "Std_Types.h"
/*
* @violates @ref Pwm_H_REF_1 precautions to prevent the contents of a header file being included twice
*/
...
/** @violates @ref Pwm_H_REF_3 MISRA 2004 Rule 1.4, The compiler/linker shall be checked to
...
* @implements       Pwm_ErrorIds_define Non-AUTOSAR
*/
#define PWM_E_SAMPLE_FIFO_FULL               (0x3EU)
/**
...
/**
* @brief            API service ID of Pwm_SetPhaseShift_NoUpdate function
* @details          Parameters used when raising an error/exception
*/
...
/*===============================================================================================*/
#ifdef PWM_SET_PHASE_SHIFT_NO_UPDATE_API
