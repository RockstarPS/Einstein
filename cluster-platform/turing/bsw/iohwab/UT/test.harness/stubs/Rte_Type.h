...
#  define Rte_TypeDef_THwData  //stub
typedef uint32 THwData;

# define Rte_TypeDef_IoHwAb_PulseOutDataType //stub
...
#  define Rte_TypeDef_SGaugeInfo_u32dyn3
typedef SGaugeInfo_u32dyn SGaugeInfo_u32dyn3[3];
...
extern CONST(SDLTMessageReadAck, RTE_CONST) Rte_DltExtDLTMessageReadAcktDataValue0; /* PRQA S 0850 */ /* MD_MSR_19.8 */

extern CONST(SDLTMessageReadAck, RTE_CONST) Rte_UclProxyCddDLTMessageReadAcktDataValue0; /* PRQA S 0850 */ /* MD_MSR_19.8 */
...
extern VAR(uint8, RTE_VAR_NOINIT) Rte_Com_SG_ABS_oABS_oCAN00_6681ad27_Rx[7]; /* PRQA S 0850, 0759 */ /* MD_MSR_19.8, MD_MSR_18.4 */
