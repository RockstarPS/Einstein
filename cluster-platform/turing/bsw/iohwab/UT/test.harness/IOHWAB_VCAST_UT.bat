...
echo environment build IOHWAB_VCAST_UT.env >> commands.tmp
echo /E:IOHWAB_VCAST_UT tools script run IOHWAB_VCAST_UT.tst >> commands.tmp
echo /E:IOHWAB_VCAST_UT execute batch >> commands.tmp
echo /E:IOHWAB_VCAST_UT tools import_coverage IOHWAB_VCAST_UT.cvr >> commands.tmp
echo /E:IOHWAB_VCAST_UT reports custom management IoHwAb_TestCaseManagementReport.html >> commands.tmp
