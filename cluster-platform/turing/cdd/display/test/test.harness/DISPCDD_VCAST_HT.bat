...
echo options TESTABLE_SOURCE_DIR ..\..\src\src\Traveo2\ >> commands.tmp
echo environment build DISPCDD_VCAST_HT.env >> commands.tmp
echo /E:DISPCDD_VCAST_HT tools script run DISPCDD_VCAST_HT.tst >> commands.tmp
echo /E:DISPCDD_VCAST_HT execute batch >> commands.tmp
echo /E:DISPCDD_VCAST_HT tools import_coverage DISPCDD_VCAST_HT.cvr >> commands.tmp
echo /E:DISPCDD_VCAST_HT reports custom management DISPCDD_VCAST_HT_management_report.html >> commands.tmp
