...
#define CAN_30_SI_CODE                                   /* CAN modules code qualifier               */ /* PRQA S 0883 */ /* Appears only while testing */
#define CAN_30_SI_STATIC_CODE                            /* CAN local code qualifier                 */
#define CAN_30_SI_CONST                                  /* constant memory                          */
#define CAN_30_SI_CONST_PBCFG                            /* postbuild generated constant/flash       */
#define CAN_30_SI_VAR_NOINIT                             /* none initialized variables               */
#define CAN_30_SI_VAR_INIT                               /* initialized variables                    */
#define CAN_30_SI_VAR_PBCFG                              /* postbuild generated variables/dynamic RAM (CFG5 only) */
#define CAN_30_SI_INT_CTRL                               /* access to Interrupt controller registers */
#define CAN_30_SI_REG_CANCELL                            /* CAN cell register qualifier              */
#define CAN_30_SI_RX_TX_DATA        CAN_REG_CANCELL      /* pointer width >= CAN_REG_CANCELL  / CAN rx/tx data / RAM or SFR    (rx data pointer for Indication and PreCopy functions to higher layers / tx data pointers / sdu  from application)   */
#define CAN_30_SI_APPL_CODE                              /* Application code qualifier               */
#define CAN_30_SI_APPL_CONST                             /* Application constant memory              */
#define CAN_30_SI_APPL_VAR                               /* Application variables                    */
...
#define ETHSWT_30_SJA1105_CODE
#define ETHSWT_30_SJA1105_CODE_FAST
#define ETHSWT_30_SJA1105_CODE_ISR

#define ETHSWT_30_SJA1105_CONST
#define ETHSWT_30_SJA1105_CONST_FAST

#define ETHSWT_30_SJA1105_VAR_INIT
#define ETHSWT_30_SJA1105_VAR_NOINIT
#define ETHSWT_30_SJA1105_VAR_ZERO_INIT
#define ETHSWT_30_SJA1105_VAR_INIT_FAST
#define ETHSWT_30_SJA1105_VAR_NOINIT_FAST
#define ETHSWT_30_SJA1105_VAR_ZERO_INIT_FAST

#define ETHSWT_30_SJA1105_VAR_INIT_NOCACHE
#define ETHSWT_30_SJA1105_VAR_NOINIT_NOCACHE
#define ETHSWT_30_SJA1105_VAR_ZERO_INIT_NOCACHE

#define ETHSWT_30_SJA1105_APPL_DATA
#define ETHSWT_30_SJA1105_APPL_VAR
#define ETHSWT_30_SJA1105_APPL_CONST
...
/* NOTE: Use the next keyword for the PBCFG-root-struct only in case of a ASR3.x till ASR4.0.1 implementation.
   In case of a ASR4.0.3 (CFG5) implementation use for the PBCFG-root-struct the keyword ETH_PBCFG as well and remove the following keyword from this template. */
#define ETH_PBCFG_ROOT

#define ETH_VAR_PBCFG /* ESCAN00065502 */

#define ETH_VAR_INIT
#define ETH_VAR_NOINIT
#define ETH_VAR_ZERO_INIT
#define ETH_VAR_INIT_FAST
#define ETH_VAR_NOINIT_FAST
#define ETH_VAR_ZERO_INIT_FAST

#define ETH_VAR_INIT_NOCACHE
#define ETH_VAR_NOINIT_NOCACHE
#define ETH_VAR_ZERO_INIT_NOCACHE
...
#define WDG_30_RH850F1X_CODE
#define WDG_30_RH850F1X_CONST
#define WDG_30_RH850F1X_VAR
#define WDG_30_RH850F1X_VAR_INIT
#define WDG_30_RH850F1X_VAR_NOINIT
#define WDG_30_RH850F1X_APPL_DATA
#define WDG_30_RH850F1X_PBCFG
