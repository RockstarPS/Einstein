...
* @brief Maximum Number of digital input variants
*/
#define IOHWAB_DIN_UNKNOWN_VARIANT              3U

/**
* @brief Number of digital inputs configured
*/
#define IOHWAB_NUM_DIN_INPUT            		11U

#define eIOPinInId_DI_LDO_FPK_1V2_PG  0U
#define eIOPinInId_DI_LDO_FPK_1V5_PG  1U
#define eIOPinInId_DI_FPK_BKL_FAULT   2U
#define eIOPinInId_DI_FPK_TFT_CONN_CHECK  3U
#define eIOPinInId_DI_REPEATER_FAULT  4U
#define eIOPinInId_DI_SOC_AUDIO_AMP_FLT 5U
#define eIOPinInId_DI_SOC_FPDLINK3_LOCK 6U
#define eIOPinInId_DI_RTC_INT  7U
#define eIOPinInId_DI_SOC_FPDLINK3_PASS  8U
#define eIOPinInId_DI_FPK_TFT_FB  9U
#define eIOPinInId_DI_FPK_BKL_CONN_CHECK 10U
...
*/
//typedef uint8 IoHwAb_DInGroupIdType;
