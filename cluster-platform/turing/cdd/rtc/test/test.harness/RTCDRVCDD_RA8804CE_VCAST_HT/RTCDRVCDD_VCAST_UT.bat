...
echo options TESTABLE_SOURCE_DIR C:\VCAST\Environments\RtcCdd_UT\includes\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR C:\VCAST\Environments\RtcCdd_UT\src\ >> commands.tmp
echo environment build RTCDRVCDD_VCAST_UT.env >> commands.tmp
echo /E:RTCDRVCDD_VCAST_UT tools script run RTCDRVCDD_VCAST_UT.tst >> commands.tmp
echo /E:RTCDRVCDD_VCAST_UT execute batch >> commands.tmp
echo /E:RTCDRVCDD_VCAST_UT tools import_coverage RTCDRVCDD_VCAST_UT.cvr >> commands.tmp
echo /E:RTCDRVCDD_VCAST_UT reports custom management RTCDRVCDD_VCAST_UT_management_report.html >> commands.tmp
