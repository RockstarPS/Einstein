 ...
 * @violates @ref Compiler_Cfg_REF_1 This is required as per autosar Requirement, 
 */
#define COMPILER_SW_MAJOR_VERSION_CFG_H               4
/*
 * @violates @ref Compiler_Cfg_REF_1 This is required as per autosar Requirement, 
 */
...
#define ETH_43_EQOS_CODE
#define ETH_43_EQOS_CONST
#define ETH_43_EQOS_APPL_DATA
#define ETH_43_EQOS_APPL_CONST
#define ETH_43_EQOS_APPL_CODE
#define ETH_43_EQOS_CALLOUT_CODE
#define ETH_43_EQOS_VAR_NOINIT
#define ETH_43_EQOS_VAR_POWER_ON_INIT
#define ETH_43_EQOS_VAR_FAST
#define ETH_43_EQOS_VAR
/**@}*/
