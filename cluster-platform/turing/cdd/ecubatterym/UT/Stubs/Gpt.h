...
/**
* @brief Gpt channel prescaler data type
*
*
*/
...
* @implements Gpt_ChannelConfigType_structure
*/
typedef struct
{
...
typedef struct
{
    ...
    CONST(Gpt_IpConfigType, GPT_CONST) IpConfig;
    /**< @brief Hardware to logic channel map table*/
    CONST(Gpt_ChannelType, GPT_CONST) (*Gpt_aHw2LogicChannelMap)[];
} Gpt_ConfigType;
