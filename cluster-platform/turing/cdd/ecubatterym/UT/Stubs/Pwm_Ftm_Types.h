...
/* @violates @ref Pwm_Ftm_Types_H_REF_2 Identifier exceeds 31 chars. */
#define PWM_FTM_TYPES_SW_MAJOR_VERSION                4
/* @violates @ref Pwm_Ftm_Types_H_REF_2 Identifier exceeds 31 chars. */
#define PWM_FTM_TYPES_SW_MINOR_VERSION                0
/* @violates @ref Pwm_Ftm_Types_H_REF_2 Identifier exceeds 31 chars. */
#define PWM_FTM_TYPES_SW_PATCH_VERSION                0
/**@}*/
...
*             Setting this option will allow only output A and B for a selected Ftm sub-module
*/
typedef enum
{
...
typedef struct
{
    ...
    CONST(Pwm_AlignmentType, PWM_CONST)   eAlignment;
