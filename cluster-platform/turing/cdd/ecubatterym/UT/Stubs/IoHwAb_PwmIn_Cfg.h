...
*/
#define IOHWAB_PWMIN_ENABLE			STD_OFF
/*****************************************************************************
...
#define IOHWAB_NUM_OF_PERIOD_SIGNALS   0

/// Macro defines number of PWM duty inputs
#define IOHWAB_NUM_OF_DUTY_SIGNALS   0

#define eIOPeriodInIdSafe_SP_PULSE_IN_PWMIN	   0
#define eIODutyInIdSafe_SP_PULSE_IN_PWMIN      0
