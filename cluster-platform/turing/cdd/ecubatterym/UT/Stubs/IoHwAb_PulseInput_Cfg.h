...
*/
#define IOHWAB_PULSEINPUT_MAINFUNCTION_PERIODICITY  ((uint16)5)

//Period Related Configurations
#define PULSE_INPUT_CHECK_VALID_PERIOD       STD_ON
#define PULSE_INPUT_CHECK_HYST_FOR_PERIOD    STD_OFF
...
*/
#define IOHWAB_PULSEINPUT_ENTER_CRITICAL_SECTION()             //((void)Os_DisableInterruptSource(OsIsr_Fan_FDBK1))
#define IOHWAB_PULSEINPUT_EXIT_CRITICAL_SECTION()              //((void)Os_EnableInterruptSource(OsIsr_Fan_FDBK1, FALSE))
...
#define IoHwAb_PulseInputSignalIdType   IoHwAb_PulseInputSignalIdType
/*TODO:Needs to be removed when single safe component is used */
#define IoHwAb_ErrorType  IoHwAb_ErrorType
