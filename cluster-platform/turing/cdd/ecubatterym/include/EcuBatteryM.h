...
extern FUNC(void, ECUBATTERYM_CODE) EcuBatteryM_ProcessDelayTime(uint8 channel);
extern FUNC(void, ECUBATTERYM_CODE) EcuBatteryM_SetMonitoringState(uint8 channel,uint8 state);
...
extern FUNC(Std_ReturnType, ECUBATTERYM_CODE) EcuBatteryM_GetChannelRawStatus(VAR(uint8, AUTOMATIC) channel, 
	                                                                      P2VAR(uint8, AUTOMATIC, ECUBATTERYM_APPL_DATA) status
                                                                         );
