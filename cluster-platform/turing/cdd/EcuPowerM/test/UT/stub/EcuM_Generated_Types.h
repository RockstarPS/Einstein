...
#define EcuMConf_EcuMWakeupSource_CAN_f26020e5                 (6UL) 
#define EcuMConf_EcuMWakeupSource_ECUM_WKSOURCE_DEBUGGER       (7UL) 
#define EcuMConf_EcuMWakeupSource_CMFB_MCAN_CHANNEL_f26020e5   (8UL) 
#define EcuMConf_EcuMWakeupSource_ECUM_WKSOURCE_RTC            (9UL) 
...
#define ECUM_WKSOURCE_CAN_f26020e5               (EcuM_WakeupSourceType)(64UL) 
#define ECUM_WKSOURCE_DEBUGGER                   (EcuM_WakeupSourceType)(128UL) 
#define ECUM_WKSOURCE_CMFB_MCAN_CHANNEL_f26020e5 (EcuM_WakeupSourceType)(256UL) 
#define ECUM_WKSOURCE_RTC                        (EcuM_WakeupSourceType)(512UL) 
