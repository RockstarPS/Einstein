...
echo options C_DEFINE_LIST UTEST CHECKER VCAST ALTIA_INTERFACE QT_INTERFACE __interrupt= const= >> commands.tmp
...
echo options TESTABLE_SOURCE_DIR ..\stub\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR ..\..\..\lib_src\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR ..\..\..\include\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR ..\..\..\lib_include\ >> commands.tmp
echo environment build ECUPOWERM_VCAST_HT.env >> commands.tmp
echo /E:ECUPOWERM_VCAST_HT tools script run ECUPOWERM_VCAST_HT.tst >> commands.tmp
echo /E:ECUPOWERM_VCAST_HT execute batch >> commands.tmp
echo /E:ECUPOWERM_VCAST_HT reports custom management ECUPOWERM_VCAST_HT_management_report.html >> commands.tmp
