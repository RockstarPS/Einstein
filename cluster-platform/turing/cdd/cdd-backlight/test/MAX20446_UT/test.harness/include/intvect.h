...
#define osdNumberOfConfiguredIRQs           15U
#define osdNumberOfFIQs                     32
#define osdNumberOfConfiguredFIQs           0
#define osdNumberOfCat2ISRs                 15U
...
void Can_ISR_A(void);
void MCL_DMA0_CH_COMPLETE_ISR(void);
void I2c_LPi2c_Isr_LPI2C_6(void);
void PWM_PWM_CH_2_ISR(void);
void GPT_4_ISR(void);
void GPT_5_ISR(void);
void GPT_6_ISR(void);
void ICU_GPIO_1_ISR(void);
