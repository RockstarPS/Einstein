...
#if (defined DIO_E_PARAM_INVALID_CHANNEL_ID)
...
#define DIO_E_PARAM_INVALID_PORT_ID 20U
 ...
 /* to prevent double declaration */
#if (defined DIO_E_PARAM_INVALID_GROUP )
...
#if (defined DIO_API_INIT ) /* to prevent double declaration */
#error DIO_API_INIT  already defined
#endif /* if (defined DIO_API_INIT ) */

/** \brief Definition of the service Id of the Init service */
#define DIO_API_INIT 0x10U
...
typedef struct
{
    ...
    uint32 mask;     /** Bit mask of the channel group */
...
typedef struct
{
    ...
    P2CONST(Dio_PortConfigType,DIO_CONST,DIO_APPL_CONST) portConfig;
