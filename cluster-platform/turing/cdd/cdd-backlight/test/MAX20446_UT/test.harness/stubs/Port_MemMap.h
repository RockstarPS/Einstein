...
/**************************************** PORT *******************************/
    ...
    */
        ...
        #error "Port_MemMap.h, no valid matching start-stop section defined."
        #endif
    #endif
    /**
    * @file Port_MemMap.h
...
/**************************************** PORT *******************************/
    ...
    */
    #ifndef MEMMAP_MATCH_ERROR
        #define MEMMAP_MATCH_ERROR
        #pragma arm section code=".acport_code_rom", rodata="", rwdata="", zidata=""
    #else
        #ifndef PORT_STOP_SEC_CODE_AC
        #error "Port_MemMap.h, no valid matching start-stop section defined."
        #endif
