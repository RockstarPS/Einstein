...
*/
#define IOHWAB_PULSEOUT_DIO_CHANNEL   					DioConf_DioChannel_DIO_SPEEDOUT_PULSE_MCU_OUT
/**
...
*/
#define IOHWAB_PULSEOUT_GPT_TIMER 						GptConf_GptChannelConfiguration_PulseOut_Timer
