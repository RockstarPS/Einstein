...
echo options TESTABLE_SOURCE_DIR ..\..\..\src\lib_src\MAX20446 >> commands.tmp
echo options TESTABLE_SOURCE_DIR ..\..\..\src\lib_include\MAX20446 >> commands.tmp
echo options TESTABLE_SOURCE_DIR ..\..\..\src\include >> commands.tmp
echo options TESTABLE_SOURCE_DIR .\include >> commands.tmp
echo options TESTABLE_SOURCE_DIR .\stubs >> commands.tmp
echo environment build BACKLIGHTCDD_MAX20446_VCAST_HT.env >> commands.tmp
echo /E:BACKLIGHTCDD_MAX20446_VCAST_HT tools script run BACKLIGHTCDD_MAX20446_VCAST_HT.tst >> commands.tmp
echo /E:BACKLIGHTCDD_MAX20446_VCAST_HT execute batch >> commands.tmp
echo /E:BACKLIGHTCDD_MAX20446_VCAST_HT tools import_coverage BACKLIGHTCDD_MAX20446_VCAST_HT.cvr >> commands.tmp
echo /E:BACKLIGHTCDD_MAX20446_VCAST_HT reports custom management BACKLIGHTCDD_MAX20446_VCAST_HT_management_report.html >> commands.tmp
