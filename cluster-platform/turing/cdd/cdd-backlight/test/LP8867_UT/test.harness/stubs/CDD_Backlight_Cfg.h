...
#define DOUT_BACKLIGHT_EN    eIOPinOutId_DO_FPK_BKL_EN
#define DIN_BACKLIGHT_FLT    eIOPinInId_DI_FPK_BKL_FAULT
#define DOUT_BACKLIGHT_DMN   eIO_PWM_DO_FPK_BKL_DIMMING
...
#define CBACKLIGHTCDD_OPERATINGMODE() EcuBatteryM_GetChannelStatus(1u,1u)
