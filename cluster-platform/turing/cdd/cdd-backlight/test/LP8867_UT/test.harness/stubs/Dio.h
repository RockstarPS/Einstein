...
#if !DIO_AR_VERSION_CHECK(DIO_GEN_AR_RELEASE_MAJOR_VERSION,DIO_GEN_AR_RELEASE_MINOR_VERSION ,DIO_GEN_AR_RELEASE_REVISION_VERSION)
...
/** \brief  Dio_Init
 **
 ** Initialization of the Dio module.
 ** This function initialize the Dio module.
 **
 ** \pre \p ConfigPtr is not equal to zero.
 **
 ...
 ** */
extern FUNC(void,DIO_CODE) 
  Dio_Init ( P2CONST(Dio_ConfigType, AUTOMATIC, DIO_CONST) ConfigPtr);
 ...
 ** This function flips (change from 1 to 0 or from 0 to 1) the level of a channel
 ** and returns the level of the channel after flip.
 **
 ** \pre \p ChannelId is valid (only checked in development mode).
 **
 ...
 ** This function return the version of the Dio driver in a Std_VersionInfoType structure.
 **
