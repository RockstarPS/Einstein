...
/**
* @violates @ref PORT_H_REF_1 The compiler/linker shall be checked to ensure that 31 character
...
=================================================================================================*/
extern P2CONST(Port_ConfigType, PORT_VAR, PORT_APPL_CONST) Port_pConfig;
