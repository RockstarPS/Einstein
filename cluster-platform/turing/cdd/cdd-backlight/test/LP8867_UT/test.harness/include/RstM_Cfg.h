...
#define RSTM_LAST_REST_HISTORY_NUM                DLTEXT_TOTAL_NUM_OF_RESET_HISTORY
 ...
 */
#define RSTM_MAX_NUM_FAULTS         60U
#define RSTM_NUMBER_OF_DLT_LOGINFO  2U
...
extern const RstM_Dlt_MessageLogInfoType  RstM_Dlt_MessageLogInfo[RSTM_NUMBER_OF_DLT_LOGINFO];
