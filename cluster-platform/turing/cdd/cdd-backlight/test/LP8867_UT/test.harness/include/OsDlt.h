...
#define OsDlt_OsGetAppParam                 0U  //todo: assign value for this


#define OsDlt_osSetRelAlarm                 0x3CU
#define OsDlt_osCancelAlarm                 0x3DU
#define OsDlt_osGetAlarm                    0x3EU
#define OsDlt_osShutdownOS                  0x3FU
