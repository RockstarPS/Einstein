...
extern CONST(SFastGaugeInfo, RTE_CONST) Rte_FastGaugeAdapterFastGaugeInfoDataValue0; /* PRQA S 0850 */ /* MD_MSR_19.8 */

extern CONST(SFastGaugeInfo, RTE_CONST) Rte_UclProxyCddFastGaugeInfoDataValue0; /* PRQA S 0850 */ /* MD_MSR_19.8 */
...
extern CONST(SSlowGaugeInfo, RTE_CONST) Rte_SlowGaugeAdapterSlowGaugeInfoDataValue0; /* PRQA S 0850 */ /* MD_MSR_19.8 */

extern CONST(SSlowGaugeInfo, RTE_CONST) Rte_UclProxyCddSlowGaugeInfoDataValue0; /* PRQA S 0850 */ /* MD_MSR_19.8 */
...
extern CONST(SUpdateLongServiceReq, RTE_CONST) Rte_CUpdateCddUpdateLongServiceReqDataValue0; /* PRQA S 0850 */ /* MD_MSR_19.8 */

extern CONST(SUpdateLongServiceReq, RTE_CONST) Rte_UclProxyCddUpdateLongServiceReqDataValue0; /* PRQA S 0850 */ /* MD_MSR_19.8 */

extern CONST(SUpdateShortServiceReq, RTE_CONST) Rte_CUpdateCddUpdateShortServiceReqDataValue0; /* PRQA S 0850 */ /* MD_MSR_19.8 */

extern CONST(SUpdateShortServiceReq, RTE_CONST) Rte_UclProxyCddUpdateShortServiceReqDataValue0; /* PRQA S 0850 */ /* MD_MSR_19.8 */

extern CONST(SUpdateShortServiceResp, RTE_CONST) Rte_CUpdateCddUpdateShortServiceRespDataValue0; /* PRQA S 0850 */ /* MD_MSR_19.8 */

extern CONST(SUpdateShortServiceResp, RTE_CONST) Rte_UclProxyCddUpdateShortServiceRespDataValue0; /* PRQA S 0850 */ /* MD_MSR_19.8 */
...
extern VAR(SUpdateLongServiceReq, RTE_VAR_INIT) Rte_CUpdateCdd_pp_SR_UpdateLongServiceRequest_UpdateLongServiceReqData; /* PRQA S 0850, 3408, 1504 */ /* MD_MSR_19.8, MD_Rte_3408, MD_MSR_8.10 */
extern VAR(SUpdateShortServiceReq, RTE_VAR_INIT) Rte_CUpdateCdd_pp_SR_UpdateShortServiceRequest_UpdateShortServiceReqData; /* PRQA S 0850, 3408, 1504 */ /* MD_MSR_19.8, MD_Rte_3408, MD_MSR_8.10 */
...
extern VAR(UInt8, RTE_VAR_INIT) Rte_MemAbstractMdl_pp_SR_JobStatus_JobStatus_BsReten_VisDlt_Element; /* PRQA S 0850, 3408, 1504 */ /* MD_MSR_19.8, MD_Rte_3408, MD_MSR_8.10 */
...
extern VAR(UInt8, RTE_VAR_INIT) Rte_MemAbstractStub_BsConst_Derating_Backlight_Disable_1_QM_Value; /* PRQA S 0850, 3408, 1504 */ /* MD_MSR_19.8, MD_Rte_3408, MD_MSR_8.10 */
...
extern VAR(SSlowGaugeInfo, RTE_VAR_INIT) Rte_SlowGaugeAdapter_pp_SlowGaugeInfo_SlowGaugeInfoData; /* PRQA S 0850, 3408, 1504 */ /* MD_MSR_19.8, MD_Rte_3408, MD_MSR_8.10 */
...
extern VAR(SUpdateShortServiceResp, RTE_VAR_INIT) Rte_UclProxyCdd_pSR_UpdateShortServiceResp_UpdateShortServiceRespData; /* PRQA S 0850, 3408, 1504 */ /* MD_MSR_19.8, MD_Rte_3408, MD_MSR_8.10 */
...
extern VAR(Rte_QRamInfoType, RTE_VAR_NOINIT) Rte_QRamInfo[9]; /* PRQA S 0850 */ /* MD_MSR_19.8 */
...
extern CONST(Rte_QRomInfoType, RTE_CONST) Rte_QRomInfo[9];
...
typedef struct
{
  Rte_BitType Rte_TxAck_CComAbsMdl_pp_SR_TxBattery_Voltage_Battery_Voltage : 2;
  Rte_BitType Rte_TxAck_CComAbsMdl_pp_SR_TxDebug1_Byte0_Debug1_Byte0 : 2;
  Rte_BitType Rte_TxAck_CComAbsMdl_pp_SR_TxDebug2_Byte0_Debug2_Byte0 : 2;
  Rte_BitType Rte_TxAck_CComAbsMdl_pp_SR_TxDebug3_Byte0_Debug3_Byte0 : 2;
  Rte_BitType Rte_TxAck_CComAbsMdl_pp_SR_TxDebug4_Byte0_Debug4_Byte0 : 2;
  Rte_BitType Rte_TxAck_CComAbsMdl_pp_SR_TxDebug5_Byte0_Debug5_Byte0 : 2;
  Rte_BitType Rte_TxAck_CComAbsMdl_pp_SR_TxFV_Tx_FV_Tx : 2;
  Rte_BitType Rte_TxAck_CComAbsMdl_pp_SR_TxIllumination_PWM_Illumination_PWM : 2;
  Rte_BitType Rte_TxAck_CComAbsMdl_pp_SR_TxOdometer_Odometer : 2;
  Rte_BitType Rte_TxAck_CComAbsMdl_pp_SR_TxSecureTxByte0_SecureTxByte0 : 2;
  Rte_BitType Rte_TxAck_CComAbsMdl_pp_SR_TxVehicleSpeedIC_VehicleSpeedIC : 2;
