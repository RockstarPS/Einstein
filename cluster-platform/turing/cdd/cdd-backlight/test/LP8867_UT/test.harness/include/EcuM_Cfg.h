...
#define ECUM_OS_RESOURCE                        RES_SCHEDULER          
#define ECUM_DEFAULT_SHUTDOWN_TARGET            ECUM_STATE_SLEEP 
#define ECUM_DEFAULT_STATE                      ECUM_STATE_OFF
#define ECUM_DEFAULT_RESET_MODE_REF             ECUM_CFG_WKSOURCE_POWER
...
#define ECUM_MAX_NUM_WAKEUP_SOURCE                             (9U) //total count (std + user)
