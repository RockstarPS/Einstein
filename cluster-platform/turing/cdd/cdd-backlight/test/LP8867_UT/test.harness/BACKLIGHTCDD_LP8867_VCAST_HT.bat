...
echo options TESTABLE_SOURCE_DIR ..\..\..\src\lib_src\LP8867 >> commands.tmp
echo options TESTABLE_SOURCE_DIR ..\..\..\src\lib_include\LP8867 >> commands.tmp
...
echo environment build BACKLIGHTCDD_LP8867_VCAST_HT.env >> commands.tmp
echo /E:BACKLIGHTCDD_LP8867_VCAST_HT tools script run BACKLIGHTCDD_LP8867_VCAST_HT.tst >> commands.tmp
echo /E:BACKLIGHTCDD_LP8867_VCAST_HT execute batch >> commands.tmp
echo /E:BACKLIGHTCDD_LP8867_VCAST_HT tools import_coverage BACKLIGHTCDD_LP8867_VCAST_HT.cvr >> commands.tmp
echo /E:BACKLIGHTCDD_LP8867_VCAST_HT reports custom management BACKLIGHTCDD_LP8867_VCAST_HT_management_report.html >> commands.tmp
