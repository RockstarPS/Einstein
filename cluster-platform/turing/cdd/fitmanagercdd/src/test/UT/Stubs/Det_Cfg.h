...
*                            Include files                                   *
******************************************************************************/
#define Fls_ModuleId  92U
#define Fls_TimeoutErrorId   9U
#define Fls_VerifyEraseFailed 0x07U
...
#define DET_REPORT_ERROR_CALLOUT(a,b,c,d) if(FALSE == ((a == Fls_ModuleId) && ((d == Fls_TimeoutErrorId) || (d == Fls_VerifyEraseFailed)))) \
                                            { \
                                                SRV_Reset_Det_ReportError_Callout(a, b, c, d); \
                                            } \
                                          while(0); \

#else
#define DET_REPORT_ERROR_CALLOUT(a,b,c,d)    //asm(__nop)
#endif
