 ...
 *********************************************************************************************************************/
#  define RTE_START_SEC_CCDD_BSWFIT_APPL_CODE
#  include "MemMap.h" /* PRQA S 5087 */ /* MD_MSR_19.1 */
FUNC(Std_ReturnType, RTE_CCDD_BSWFIT_APPL_CODE) CDD_BswFit_FaultInjectionHandler(UInt8 StartStopData, UInt8 TestListID, P2VAR(UInt8, AUTOMATIC, RTE_CCDD_BSWFIT_APPL_VAR) Data); /* PRQA S 0850 */ /* MD_MSR_19.8 */
#  define RTE_STOP_SEC_CCDD_BSWFIT_APPL_CODE
#  include "MemMap.h" /* PRQA S 5087 */ /* MD_MSR_19.1 */

#  define Rte_Call_rpCS_FitHandler_rpCS_FitHandler_CCDD_BswFit_FaultInjectionHandler CDD_BswFit_FaultInjectionHandler
#  define RTE_START_SEC_CCDD_MCUFIT_APPL_CODE
#  include "MemMap.h" /* PRQA S 5087 */ /* MD_MSR_19.1 */
FUNC(Std_ReturnType, RTE_CCDD_MCUFIT_APPL_CODE) CDD_McuFit_FaultInjectionHandler(UInt8 StartStopData, UInt8 TestListID, P2VAR(UInt8, AUTOMATIC, RTE_CCDD_MCUFIT_APPL_VAR) Data); /* PRQA S 0850 */ /* MD_MSR_19.8 */
#  define RTE_STOP_SEC_CCDD_MCUFIT_APPL_CODE
#  include "MemMap.h" /* PRQA S 5087 */ /* MD_MSR_19.1 */

#  define Rte_Call_rpCS_FitHandler_rpCS_FitHandler_CCDD_McuFit_FaultInjectionHandler CDD_McuFit_FaultInjectionHandler
