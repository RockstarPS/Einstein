...
echo options C_DEFINE_LIST UTEST CHECKER _FS_FAULT_INJECTION_TEST_ENABLE_ VCAST ALTIA_INTERFACE QT_INTERFACE __interrupt= const= func= >> commands.tmp
...
echo options TESTABLE_SOURCE_DIR ..\..\..\..\..\..\..\turing\cdd\fitmanagercdd\src\src\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR ..\..\..\..\..\..\..\turing\cdd\fitmanagercdd\src\include\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR ..\..\..\..\..\..\..\turing\cdd\fitmanagercdd\src\test\UT\Stubs\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR ..\..\..\lib_include\ >> commands.tmp
echo environment build FITMANAGERCDD_VCAST_HT.env >> commands.tmp
echo /E:FITMANAGERCDD_VCAST_HT tools script run FITMANAGERCDD_VCAST_HT.tst >> commands.tmp
echo /E:FITMANAGERCDD_VCAST_HT execute batch >> commands.tmp
echo /E:FITMANAGERCDD_VCAST_HT reports custom management ..\..\..\..\..\fitmanagercdd\src\test\UT\reports\FITMANAGERCDD_VCAST_HT_management_report.html >> commands.tmp
