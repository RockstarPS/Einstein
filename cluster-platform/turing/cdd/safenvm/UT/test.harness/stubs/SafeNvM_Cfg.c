...
{
  { /* Safe Block 0*/
    .NvM_BlockId_Original = NvMConf_NvMBlockDescriptor_NvBlockSwComponentTypeNVBlockDescriptor_BsConst_Illumination,
    .NvM_BlockId_Copy1 = NvMConf_NvMBlockDescriptor_NvBlockSwComponentTypeNVBlockDescriptor_BsConst_Illumination_Copy1,
    .NvM_BlockId_Copy2 = NvMConf_NvMBlockDescriptor_NvBlockSwComponentTypeNVBlockDescriptor_BsConst_Illumination_Copy2,
    .NvM_BlockSize = 52U,
    .DefaultRomPtr = (uint8*)&Rte_NvBlockSwComponentType_NVBlockDescriptor_BsConst_Illumination_ROM_NVBlockDescriptor_BsConst_Illumination,
...
void SafeNvM_AsilRam_CopyTo_RteSafeRam(void)
{
  ...
  Rte_Write_BsConst_BsConst_Illumination_ReservedByte_Value(pAsilRamCopy->BsConst_BsConst_Illumination_ReservedByte);
  Rte_Write_BsConst_Compensation_Line_Shift_b_Value(pAsilRamCopy->BsConst_Compensation_Line_Shift_b);
  Rte_Write_BsConst_Compensation_Line_Slope_m_Value(pAsilRamCopy->BsConst_Compensation_Line_Slope_m);
  Rte_Write_BsConst_Derating_Backlight_Disable_Value(pAsilRamCopy->BsConst_Derating_Backlight_Disable);
  Rte_Write_BsConst_Display_Illum_Max_Level_Safe_Value(pAsilRamCopy->BsConst_Display_Illum_Max_Level);
  Rte_Write_BsConst_Lookup_Curve_HotSpot_Coef_X_Value(pAsilRamCopy->BsConst_Lookup_Curve_HotSpot_Coef_X);
  Rte_Write_BsConst_Lookup_Curve_HotSpot_Coef_Y_Value(pAsilRamCopy->BsConst_Lookup_Curve_HotSpot_Coef_Y);
  Rte_Write_BsConst_PCB_Temperature_Sensor_Conv_Value(pAsilRamCopy->BsConst_PCB_Temperature_Sensor_Conv);
  Rte_Write_BsConst_PWM_boost_bypass_duty_Value(pAsilRamCopy->BsConst_PWM_boost_bypass_duty);
  Rte_Write_BsConst_Temp_Threshold_Hysteresis_Derating_Value(pAsilRamCopy->BsConst_Temp_Threshold_Hysteresis_Derating);
  Rte_Write_BsConst_Temperature_Sensor_Conv_Value(pAsilRamCopy->BsConst_Temperature_Sensor_Conv);

  SafeNvM_AsilData_Status = 1;
}
...
{
  NV_Data_BsConst_Illumination * pAsilRamCopy = NvMSafe_Blockconfig[0].AsilCopyPtr;
  if(SafeNvM_AsilData_Status == 0)
  {
      Rte_Read_BsConst_Compensation_Line_Shift_b_Value(&pAsilRamCopy->BsConst_Compensation_Line_Shift_b);
      Rte_Read_BsConst_Compensation_Line_Slope_m_Value(&pAsilRamCopy->BsConst_Compensation_Line_Slope_m);
      Rte_Read_BsConst_Derating_Backlight_Disable_Value(&pAsilRamCopy->BsConst_Derating_Backlight_Disable);
      Rte_Read_BsConst_Display_Illum_Max_Level_Safe_Value(&pAsilRamCopy->BsConst_Display_Illum_Max_Level);
      Rte_Read_BsConst_Lookup_Curve_HotSpot_Coef_X_Value(&pAsilRamCopy->BsConst_Lookup_Curve_HotSpot_Coef_X);
      Rte_Read_BsConst_Lookup_Curve_HotSpot_Coef_Y_Value(&pAsilRamCopy->BsConst_Lookup_Curve_HotSpot_Coef_Y);
      Rte_Read_BsConst_PCB_Temperature_Sensor_Conv_Value(&pAsilRamCopy->BsConst_PCB_Temperature_Sensor_Conv);
      Rte_Read_BsConst_PWM_boost_bypass_duty_Value(&pAsilRamCopy->BsConst_PWM_boost_bypass_duty);
      Rte_Read_BsConst_Temp_Threshold_Hysteresis_Derating_Value(&pAsilRamCopy->BsConst_Temp_Threshold_Hysteresis_Derating);
      Rte_Read_BsConst_Temperature_Sensor_Conv_Value(&pAsilRamCopy->BsConst_Temperature_Sensor_Conv);
      SafeNvM_SetWriteBlockReq(0);
  }
  else
  {
    SafeNvM_AsilData_Status = 0;
  }
}

void EcumExt_SafeNvM_TriggerDataCompare(void)
{
  OsTrustedCall_SafeNvM_TriggerDataCompare();
}

void MemAbstractMdl_Safe_NotifyJobEnd_BsConst_Illumination( uint8 ServiceId, NvM_RequestResultType JobResult)
{
  OsTrustedCall_SafeNvM_NvM_WriteCallback_Original(0, ServiceId, JobResult);
}

void MemAbstractMdl_Safe_NotifyJobEnd_BsConst_Illumination_Copy1( uint8 ServiceId, NvM_RequestResultType JobResult)
{
  OsTrustedCall_SafeNvM_NvM_WriteCallback_Copy1(0, ServiceId, JobResult);
}

void MemAbstractMdl_Safe_NotifyJobEnd_BsConst_Illumination_Copy2(uint8 ServiceId, NvM_RequestResultType JobResult)
{
