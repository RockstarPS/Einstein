 ...
 *       License:  CBD1800851
 *
 *   Description:  Application types header file for SW-C <SafeNvM>
 *********************************************************************************************************************/

/* double include prevention */
#ifndef _RTE_SAFENVM_TYPE_H
# define _RTE_SAFENVM_TYPE_H
