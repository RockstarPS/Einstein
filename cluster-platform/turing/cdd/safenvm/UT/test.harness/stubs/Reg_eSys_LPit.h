...
#define REG_ESYS_LPIT_SW_MAJOR_VERSION                4
#define REG_ESYS_LPIT_SW_MINOR_VERSION                0
#define REG_ESYS_LPIT_SW_PATCH_VERSION                0
...
#define LPIT_TCTRL_CHAIN_MASK_U32                             ((uint32)(BIT1))
...
#define LPIT_MCR_SW_RST_MASK_U32                            ((uint32)(BIT1))       
#define LPIT_MCR_DOZE_EN_MASK_U32                           ((uint32)(BIT2))
#define LPIT_MCR_DBG_EN_SHIFT                               ((uint32) 3UL)
