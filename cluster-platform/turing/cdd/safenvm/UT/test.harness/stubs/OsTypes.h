...
typedef TaskType                    OsTaskType;
typedef osuint32                    ScheduleTableType;
typedef void *                      OsTrapParameterRefType;
typedef osuint16                    OsTrapFuncIndexType;
...
typedef void                        (*OsTrapFuncType)(OsTrapParameterRefType FnParam);
...
#define osdCtxMax                         0x1001 /*MISRA RULE 2.5 VIOLATION: This is the reason why the MISRA rule could not be followed in this special case*/
