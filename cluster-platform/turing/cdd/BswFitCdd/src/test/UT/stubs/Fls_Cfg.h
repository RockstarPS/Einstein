...
#define FLS_GEN_SW_MINOR_VERSION            18U
#define FLS_GEN_SW_PATCH_VERSION            0U
 ...
 ** OFF API not supported
  */
#define FLS_SET_CYCLE_MODE_API   STD_ON
 ...
 ** OFF eCT Flash safety mechanism is not provided
  */
#define FLS_USE_SAFETY_MECHANISM   STD_ON



/** This parameter defines the existence and the name of a callout function that is
 ** called each time flash embedded (program or erase) operation finished.
 ** The function has to have the following parameter: (Info: uint8)
*/
#define FLS_WORK_EMBEDDED_NOTIFICATION  WorkEmbeddedNotification
