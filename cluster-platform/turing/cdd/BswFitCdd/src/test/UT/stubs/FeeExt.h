...
#define FEE_LARGE_SECTOR_SIZE   2048UL
/**********************************************************************************************************************
 ...
 * @return    Std_ReturnType
 */
extern Std_ReturnType FeeExt_Write (uint32 TargetAddress, const uint8* SourceAddressPtr, uint32 Length);
extern Std_ReturnType FeeExt_Write_1 (uint32 TargetAddress, const uint8* SourceAddressPtr, uint32 Length);
/**
...
/**
 * This method provides the Fls Blank Check functionality through FeeExt module with timeout condition
 * @param     uint32 SourceAddress, uint32 Length
 * @return    Std_ReturnType
 */
extern Std_ReturnType FeeExt_BlankCheck (uint32 SourceAddress, uint32 Length);
