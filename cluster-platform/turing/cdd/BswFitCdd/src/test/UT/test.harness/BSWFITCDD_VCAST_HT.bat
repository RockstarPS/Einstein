call BSWFITCDD_VCAST_HT_Clean.bat
...
echo options C_DEFINE_LIST UTEST CHECKER _FS_FAULT_INJECTION_TEST_ENABLE_ VCAST ALTIA_INTERFACE QT_INTERFACE __interrupt= const= function=>> commands.tmp
...
echo options VCAST_CUSTOM_REPORT_FORMAT TEXT >> commands.tmp
...
echo environment build BSWFITCDD_VCAST_HT.env >> commands.tmp
echo /E:BSWFITCDD_VCAST_HT tools script run BSWFITCDD_VCAST_HT.tst >> commands.tmp
echo /E:BSWFITCDD_VCAST_HT execute batch >> commands.tmp
echo /E:BSWFITCDD_VCAST_HT tools import_coverage BSWFITCDD_VCAST_HT.cvr >> commands.tmp
echo /E:BSWFITCDD_VCAST_HT reports custom management ..\..\..\..\..\BswFitCdd\src\test\UT\reports\BSWFITCDD_VCAST_HT_management_report.html >> commands.tmp
