...
*   @implements     CompilerDefinition_h_Artifact
*   @version 2.0.0
*
...
*   SW Version           : 2.0.0
*   Build Version        : IMX8_MCAL_2_0_0_RTM_ASR_REL_4_2_REV_0002_20190131
*
...
==================================================================================================*/
  ...
  /*
    ...
    * macros, objects and functions shall not be reused.
    */
  #define _COSMIC_C_IMX8_
#endif
#if (defined(__GNUC__) && !defined(__DCC__))
         /**
        * @brief Symbol required to be defined when GCC and Linaro ARM compiler is used.
        */
        /*
        * @violates @ref CompilerDefinition_h_REF_2 The names of standard library
        * macros, objects and functions shall not be reused.
