...
#define DetConf_DetModule_DetServicePort (4096UL) 


/*! Service port defines */
#define DetConf_DetServicePort 4096U 
...
#define DET_DUMMY_STATEMENT(v) (void)(v) /* PRQA S 3453 */ /* MD_MSR_19.7 */  /* /MICROSAR/EcuC/EcucGeneral/DummyStatementKind */
#endif
...
#endif
#ifndef DET_PROCESSOR_S6J332EJB
#define DET_PROCESSOR_S6J332EJB
#endif
...
FUNC(Std_ReturnType, DET_CODE) Appl_DetEntryCallout( uint16 ModuleId, uint8 InstanceId, uint8 ApiId, uint8 ErrorId );
