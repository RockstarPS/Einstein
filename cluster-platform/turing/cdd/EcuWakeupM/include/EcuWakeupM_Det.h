...
//
//---------------------------------------------------------------------------------------------------------------------
#ifndef __ECUWAKEUPM_DET_H__
#define __ECUWAKEUPM_DET_H__
...
#if (ECUWAKEUPM_DEV_ERROR_DETECT == STD_ON)
#include <Det.h>
#endif /* #if ECUWAKEUPM_DEV_ERROR_DETECT == STD_ON */
 ...
 **
 ** */
extern FUNC(void, ECUWAKEUPM_CODE) EcuWakeupM_ReportError
(
