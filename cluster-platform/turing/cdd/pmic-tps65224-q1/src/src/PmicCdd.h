...
**                    PmicCdd_Reset_Reason_Not_Ready - Initialization is not complete;
**                                                     caller shall retry later
**
** Critical Section :  yes
**
**==========================================================================*/
...
**
**==========================================================================*/
extern Std_ReturnType PmicCdd_GetResetCount(uint8* PmicReset_Count);
...
** Visibility       :   Public
**
** Description      :  This function is used to reset the MCU
**
** Invocation       :  Application
**
** Inputs           :   void
...
**
**==========================================================================*/
extern Std_ReturnType PmicCdd_EnableSpreadSpectrum(void);
...
**
**==========================================================================*/
extern Std_ReturnType PmicCdd_DisableSpreadSpectrum(void);
...
**
**==========================================================================*/
extern Std_ReturnType PmicCdd_SetSpreadSpectrum_Depth(PmicCdd_SpreadSpectrum_ModulationDepType SS_Depth);
#endif
