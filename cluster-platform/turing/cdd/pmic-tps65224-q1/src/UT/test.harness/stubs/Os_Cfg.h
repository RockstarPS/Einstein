...
#define OS_CFG_MPU_STACK_REGION_NUM     11U

#define OS_CFG_OSSTACK_REGION_INDEX     0U
...
# define Rte_Ev_Cyclic2_OsTask_MemSer_0_10ms     ((EventMaskType)1uLL)
# define Rte_Ev_Cyclic_MemSer_10msLP_0_10ms     ((EventMaskType)2uLL)
...
# define Rte_Ev_Cyclic_OsTask_DispFun_0_5ms     ((EventMaskType)2uLL)
...
# define Rte_Ev_Run_DmnMgr_DmnMgr_MonitorDmnExtendShutdownTime     ((EventMaskType)8uLL)
# define Rte_Ev_Run_DmnMgr_DmnMgr_MonitorDmnHealthDumpData     ((EventMaskType)16uLL)
# define Rte_Ev_Run_DmnMgr_DmnMgr_MonitorDmnHealthDumpHdrInfo     ((EventMaskType)32uLL)
# define Rte_Ev_Run_DmnMgr_DmnMgr_MonitorDmnHealthFatalError     ((EventMaskType)64uLL)
# define Rte_Ev_Run_DmnMgr_DmnMgr_MonitorDmnHeartBeat     ((EventMaskType)128uLL)
# define Rte_Ev_Run_DmnMgr_DmnMgr_MonitorDmnKeepSystemAwake     ((EventMaskType)256uLL)
# define Rte_Ev_Run_DmnMgr_DmnMgr_MonitorDmnPowerSystemState     ((EventMaskType)512uLL)
# define Rte_Ev_Run_Ea_Ea_MainFunction     ((EventMaskType)1024uLL)
# define Rte_Ev_Run_GdtCdd_CGdtCdd_Impl_MainFunction     ((EventMaskType)1uLL)
# define Rte_Ev_Run_NvBlockSwComponentType_NvBlockSwComponentTypeRunnable     ((EventMaskType)2048uLL)
# define Rte_Ev_Run_NvMExt_NvMExt_SpeedupRunnable     ((EventMaskType)1uLL)
# define Rte_Ev_Run_SafeBsw_OsTask_SafeBsw_WdgM_CheckPoint_20ms     ((EventMaskType)2uLL)
# define Rte_Ev_Run_UclProxyCdd_CUclProxyCdd_Impl_MainFunction     ((EventMaskType)4096uLL)
# define Rte_Ev_Run_UclProxyCdd_OnDre_DisplaySetPower     ((EventMaskType)8192uLL)
# define Rte_Ev_Run_UclProxyCdd_OnDre_HealthDumpGetData     ((EventMaskType)16384uLL)
# define Rte_Ev_Run_UclProxyCdd_OnDre_HealthDumpGetHdr     ((EventMaskType)32768uLL)
# define Rte_Ev_Run_UclProxyCdd_OnDre_PowerSystemStateReqChange     ((EventMaskType)65536uLL)
