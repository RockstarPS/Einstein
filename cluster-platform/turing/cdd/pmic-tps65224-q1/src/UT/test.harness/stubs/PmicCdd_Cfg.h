...
/* Enable or disable the Wdg funtionality */
#define PMICCDD_ENABLE_WDG STD_ON
/* Enable or disable the Esm funtionality */
...
/* Enablinng macro to rewrit the Bucks and Ldos */
...
#define PMICCDD_TI_NVM_REV                         0x03U
