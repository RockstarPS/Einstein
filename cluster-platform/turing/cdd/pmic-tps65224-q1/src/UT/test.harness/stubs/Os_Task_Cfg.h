...
File Name        :  Os_Task_Cfg.h
Module Short Name:  Os_Task_Cfg.h
VOBName          :  
Author           :  
...
#define OsNumberOfTasks              26U

/*****************************************************************************
*                        Task Ids                                            *
*****************************************************************************/
#define OsTask_IpcUclEv                  ((TaskType)0)
#define osTaskID_OsTask_IpcUclEv                  ((TaskType)0)

#define OsTask_Diagnostics                  ((TaskType)1)
#define osTaskID_OsTask_Diagnostics                  ((TaskType)1)

#define OsTask_LSH_16ms                  ((TaskType)2)
#define osTaskID_OsTask_LSH_16ms                  ((TaskType)2)

#define InitTask                  ((TaskType)3)
#define osTaskID_InitTask                  ((TaskType)3)

#define OsTask_AppFun                  ((TaskType)4)
#define osTaskID_OsTask_AppFun                  ((TaskType)4)

#define OsTask_AudioFun                  ((TaskType)5)
#define osTaskID_OsTask_AudioFun                  ((TaskType)5)

#define OsTask_Can0DataRxEv                  ((TaskType)6)
#define osTaskID_OsTask_Can0DataRxEv                  ((TaskType)6)

#define OsTask_Can1DataRxEv                  ((TaskType)7)
#define osTaskID_OsTask_Can1DataRxEv                  ((TaskType)7)

#define OsTask_CANFun                  ((TaskType)8)
#define osTaskID_OsTask_CANFun                  ((TaskType)8)

#define OsTask_DispFun                  ((TaskType)9)
#define osTaskID_OsTask_DispFun                  ((TaskType)9)

#define OsTask_EthFun                  ((TaskType)10)
#define osTaskID_OsTask_EthFun                  ((TaskType)10)

#define OsTask_FotaEv                  ((TaskType)11)
#define osTaskID_OsTask_FotaEv                  ((TaskType)11)

#define OsTask_FotaFun                  ((TaskType)12)
#define osTaskID_OsTask_FotaFun                  ((TaskType)12)

#define OsTask_GaugeFun                  ((TaskType)13)
#define osTaskID_OsTask_GaugeFun                  ((TaskType)13)

#define OsTask_IdleTask                  ((TaskType)14)
#define osTaskID_OsTask_IdleTask                  ((TaskType)14)

#define OsTask_IndFun                  ((TaskType)15)
#define osTaskID_OsTask_IndFun                  ((TaskType)15)

#define OsTask_LinFun                  ((TaskType)16)
#define osTaskID_OsTask_LinFun                  ((TaskType)16)

#define OsTask_Mcal                  ((TaskType)17)
#define osTaskID_OsTask_Mcal                  ((TaskType)17)

#define OsTask_MemSer                  ((TaskType)18)
#define osTaskID_OsTask_MemSer                  ((TaskType)18)

#define OsTask_ModeMgt                  ((TaskType)19)
#define osTaskID_OsTask_ModeMgt                  ((TaskType)19)

#define OsTask_NvmSpeedup                  ((TaskType)20)
#define osTaskID_OsTask_NvmSpeedup                  ((TaskType)20)

#define OsTask_SafeApp                  ((TaskType)21)
#define osTaskID_OsTask_SafeApp                  ((TaskType)21)

#define OsTask_SafeBsw                  ((TaskType)22)
#define osTaskID_OsTask_SafeBsw                  ((TaskType)22)

#define OsTask_TripFun                  ((TaskType)23)
#define osTaskID_OsTask_TripFun                  ((TaskType)23)

#define OsTask_WarnFun                  ((TaskType)24)
#define osTaskID_OsTask_WarnFun                  ((TaskType)24)

#define OsTask_WdgMngt                  ((TaskType)25)
#define osTaskID_OsTask_WdgMngt                  ((TaskType)25)
...
/* Object Names */
/* Task Object Names */
#define Object_OsTask_IpcUclEv            ((ObjectIdType)0)
#define Object_OsTask_Diagnostics            ((ObjectIdType)1)
#define Object_OsTask_LSH_16ms            ((ObjectIdType)2)
#define Object_InitTask            ((ObjectIdType)3)
#define Object_OsTask_AppFun            ((ObjectIdType)4)
#define Object_OsTask_AudioFun            ((ObjectIdType)5)
#define Object_OsTask_Can0DataRxEv            ((ObjectIdType)6)
#define Object_OsTask_Can1DataRxEv            ((ObjectIdType)7)
#define Object_OsTask_CANFun            ((ObjectIdType)8)
#define Object_OsTask_DispFun            ((ObjectIdType)9)
#define Object_OsTask_EthFun            ((ObjectIdType)10)
#define Object_OsTask_FotaEv            ((ObjectIdType)11)
#define Object_OsTask_FotaFun            ((ObjectIdType)12)
#define Object_OsTask_GaugeFun            ((ObjectIdType)13)
#define Object_OsTask_IdleTask            ((ObjectIdType)14)
#define Object_OsTask_IndFun            ((ObjectIdType)15)
#define Object_OsTask_LinFun            ((ObjectIdType)16)
#define Object_OsTask_Mcal            ((ObjectIdType)17)
#define Object_OsTask_MemSer            ((ObjectIdType)18)
#define Object_OsTask_ModeMgt            ((ObjectIdType)19)
#define Object_OsTask_NvmSpeedup            ((ObjectIdType)20)
#define Object_OsTask_SafeApp            ((ObjectIdType)21)
#define Object_OsTask_SafeBsw            ((ObjectIdType)22)
#define Object_OsTask_TripFun            ((ObjectIdType)23)
#define Object_OsTask_WarnFun            ((ObjectIdType)24)
#define Object_OsTask_WdgMngt            ((ObjectIdType)25)


/* Isr Object Names */
#define Object_McuOsGptIsr            ((ObjectIdType)26)
#define Object_McuCan0RxTxIsr            ((ObjectIdType)27)
#define Object_McuCan1RxTxIsr            ((ObjectIdType)28)
#define Object_McuCddIpcMbxFromA53SS_0_0Isr            ((ObjectIdType)29)
...
#define Object_McuEsmIsr            ((ObjectIdType)36)
...
#define Object_ObjectIdMax        ((ObjectIdType)46)


/* Object Ids */
#define Os_Object_Id_0          Object_OsTask_IpcUclEv
#define Os_Object_Id_1          Object_OsTask_Diagnostics
#define Os_Object_Id_2          Object_OsTask_LSH_16ms
#define Os_Object_Id_3          Object_InitTask
#define Os_Object_Id_4          Object_OsTask_AppFun
#define Os_Object_Id_5          Object_OsTask_AudioFun
#define Os_Object_Id_6          Object_OsTask_Can0DataRxEv
#define Os_Object_Id_7          Object_OsTask_Can1DataRxEv
#define Os_Object_Id_8          Object_OsTask_CANFun
#define Os_Object_Id_9          Object_OsTask_DispFun
#define Os_Object_Id_10          Object_OsTask_EthFun
#define Os_Object_Id_11          Object_OsTask_FotaEv
#define Os_Object_Id_12          Object_OsTask_FotaFun
#define Os_Object_Id_13          Object_OsTask_GaugeFun
#define Os_Object_Id_14          Object_OsTask_IdleTask
#define Os_Object_Id_15          Object_OsTask_IndFun
#define Os_Object_Id_16          Object_OsTask_LinFun
#define Os_Object_Id_17          Object_OsTask_Mcal
#define Os_Object_Id_18          Object_OsTask_MemSer
#define Os_Object_Id_19          Object_OsTask_ModeMgt
#define Os_Object_Id_20          Object_OsTask_NvmSpeedup
#define Os_Object_Id_21          Object_OsTask_SafeApp
#define Os_Object_Id_22          Object_OsTask_SafeBsw
#define Os_Object_Id_23          Object_OsTask_TripFun
#define Os_Object_Id_24          Object_OsTask_WarnFun
#define Os_Object_Id_25          Object_OsTask_WdgMngt
#define Os_Object_Id_26          Object_McuOsGptIsr
#define Os_Object_Id_27          Object_McuCan0RxTxIsr
#define Os_Object_Id_28          Object_McuCan1RxTxIsr
#define Os_Object_Id_29          Object_McuCddIpcMbxFromA53SS_0_0Isr
...
#define Os_Object_Id_36          Object_McuEsmIsr
...
#define osPrioTask_OsTask_LSH_16ms                        24
...
#define osStackSizeTask_OsTask_AppFun                   sizeof(OsStack_OsTask_AppFunDyn)
...
#define osStackSizeTask_OsTask_AudioFun                   sizeof(OsStack_OsTask_AudioFunDyn)
...
#define osTypeTask_OsTask_CANFun                        TASK_BASIC
...
#define osStackSizeTask_OsTask_EthFun                   sizeof(OsStack_OsTask_EthFunDyn)
...
#define osCategoryTask_OsTask_FotaFun                    TASK_PREEMPTIVE
...
#define osStackSizeTask_OsTask_GaugeFun                   sizeof(OsStack_OsTask_GaugeFunDyn)
...
#define osPrioTask_OsTask_IdleTask                        25
...
#define osStackSizeTask_OsTask_IndFun                   sizeof(OsStack_OsTask_IndFunDyn)
...
#define osStackSizeTask_OsTask_LinFun                   sizeof(OsStack_OsTask_LinFunDyn)
...
#define osStackSizeTask_OsTask_Mcal                   sizeof(OsStack_OsTask_McalDyn)
...
#define osTypeTask_OsTask_ModeMgt                        TASK_BASIC
...
#define osStackSizeTask_OsTask_SafeApp                   sizeof(OsStack_OsTask_SafeAppDyn)
...
#define osStackSizeTask_OsTask_TripFun                   sizeof(OsStack_OsTask_TripFunDyn)
...
#define osStackSizeTask_OsTask_WarnFun                   sizeof(OsStack_OsTask_WarnFunDyn)
