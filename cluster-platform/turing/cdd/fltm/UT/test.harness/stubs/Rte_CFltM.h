...
#  define RTE_START_SEC_RSTM_APPL_CODE
#  include "MemMap.h" /* PRQA S 5087 */ /* MD_MSR_19.1 */
FUNC(Std_ReturnType, RTE_RSTM_APPL_CODE) RstM_ClearResetHistory(void); /* PRQA S 0850 */ /* MD_MSR_19.8 */
#  define RTE_STOP_SEC_RSTM_APPL_CODE
#  include "MemMap.h" /* PRQA S 5087 */ /* MD_MSR_19.1 */

#  define Rte_Call_rp_CS_RstM_ClearResetHistory_RstM_ClearResetHistory RstM_ClearResetHistory
#  define RTE_START_SEC_RSTM_APPL_CODE
#  include "MemMap.h" /* PRQA S 5087 */ /* MD_MSR_19.1 */
FUNC(Std_ReturnType, RTE_RSTM_APPL_CODE) RstM_GetLastResetReason(P2VAR(eFltM_FaultIdType, AUTOMATIC, RTE_RSTM_APPL_VAR) pFaultId); /* PRQA S 0850 */ /* MD_MSR_19.8 */
#  define RTE_STOP_SEC_RSTM_APPL_CODE
#  include "MemMap.h" /* PRQA S 5087 */ /* MD_MSR_19.1 */
...
#  define RTE_START_SEC_RSTM_APPL_CODE
#  include "MemMap.h" /* PRQA S 5087 */ /* MD_MSR_19.1 */
FUNC(Std_ReturnType, RTE_RSTM_APPL_CODE) RstM_GetResetCount(eFltM_FaultIdType FaultId, P2VAR(UInt8, AUTOMATIC, RTE_RSTM_APPL_VAR) count); /* PRQA S 0850 */ /* MD_MSR_19.8 */
#  define RTE_STOP_SEC_RSTM_APPL_CODE
#  include "MemMap.h" /* PRQA S 5087 */ /* MD_MSR_19.1 */
...
#  define RTE_START_SEC_RSTM_APPL_CODE
#  include "MemMap.h" /* PRQA S 5087 */ /* MD_MSR_19.1 */
FUNC(Std_ReturnType, RTE_RSTM_APPL_CODE) RstM_GetResetHistory(P2VAR(UInt8, AUTOMATIC, RTE_RSTM_APPL_VAR) ResetHistory); /* PRQA S 0850 */ /* MD_MSR_19.8 */
#  define RTE_STOP_SEC_RSTM_APPL_CODE
#  include "MemMap.h" /* PRQA S 5087 */ /* MD_MSR_19.1 */
...
#  define RTE_START_SEC_RSTM_APPL_CODE
#  include "MemMap.h" /* PRQA S 5087 */ /* MD_MSR_19.1 */
FUNC(Std_ReturnType, RTE_RSTM_APPL_CODE) RstM_RequestSwReset(eFltM_FaultIdType FaultId, P2VAR(UInt8, AUTOMATIC, RTE_RSTM_APPL_VAR) LogData, UInt16 LogLength); /* PRQA S 0850 */ /* MD_MSR_19.8 */
#  define RTE_STOP_SEC_RSTM_APPL_CODE
#  include "MemMap.h" /* PRQA S 5087 */ /* MD_MSR_19.1 */
