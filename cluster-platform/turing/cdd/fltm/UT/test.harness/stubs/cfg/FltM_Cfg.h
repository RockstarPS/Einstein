 ...
 */
#ifndef FLTM_RESET_STORM_HW_TEST_ENABLE
#define FLTM_RESET_STORM_HW_TEST_ENABLE STD_ON
#endif

#ifndef FLTM_RESET_STORM_HW_TEST_MODE
#define FLTM_RESET_STORM_HW_TEST_MODE 2U
#endif

#ifndef FLTM_RESET_STORM_HW_TEST_MODE_NONE
#define FLTM_RESET_STORM_HW_TEST_MODE_NONE 0U
#endif

#ifndef FLTM_RESET_STORM_HW_TEST_MODE_SAME_FAULT
#define FLTM_RESET_STORM_HW_TEST_MODE_SAME_FAULT 1U
#endif

#ifndef FLTM_RESET_STORM_HW_TEST_MODE_GLOBAL_STORM
#define FLTM_RESET_STORM_HW_TEST_MODE_GLOBAL_STORM 2U
#endif

#if ((FLTM_RESET_STORM_HW_TEST_ENABLE != STD_OFF) && (FLTM_RESET_STORM_HW_TEST_ENABLE != STD_ON))
#error "FLTM_RESET_STORM_HW_TEST_ENABLE must be STD_OFF or STD_ON"
#endif

#if ((FLTM_RESET_STORM_HW_TEST_MODE != FLTM_RESET_STORM_HW_TEST_MODE_NONE) && \
     (FLTM_RESET_STORM_HW_TEST_MODE != FLTM_RESET_STORM_HW_TEST_MODE_SAME_FAULT) && \
     (FLTM_RESET_STORM_HW_TEST_MODE != FLTM_RESET_STORM_HW_TEST_MODE_GLOBAL_STORM))
#error "FLTM_RESET_STORM_HW_TEST_MODE must be NONE, SAME_FAULT, or GLOBAL_STORM"
#endif

#if ((FLTM_RESET_STORM_HW_TEST_ENABLE == STD_ON) && (FLTM_RESET_STORM_HW_TEST_MODE == FLTM_RESET_STORM_HW_TEST_MODE_NONE))
#error "FLTM reset-storm HW test mode NONE is invalid when test support is STD_ON"
#endif

#if ((FLTM_RESET_STORM_HW_TEST_ENABLE == STD_OFF) && (FLTM_RESET_STORM_HW_TEST_MODE != FLTM_RESET_STORM_HW_TEST_MODE_NONE))
#error "FLTM reset-storm HW test mode must be NONE when test support is STD_OFF"
#endif

#if (FLTM_RESET_STORM_HW_TEST_ENABLE == STD_ON)
#define FLTM_MAX_NUM_FAULTS         89U
...
#define FLTM_DEM_CFG_GLOBAL_RESET_STORM_RESERVED            (86U)
...
#define FLTM_HW_TEST_FAULT_A                                (0xF9E9U)
#define FLTM_HW_TEST_FAULT_B                                (0xF9EAU)
#endif
...
typedef Std_ReturnType (*FltM_GlobalResetStormActionType)(FltM_FaultIdType TriggerFaultId,
                                                          uint8 StormCount);
...
typedef struct
{
  boolean GlobalResetStormDetectionEnable;              /**< Enables global reset-storm detection */
  uint8 GlobalResetStormThreshold;                      /**< Reset-history threshold for storm action */
  FltM_GlobalResetStormActionType GlobalResetStormAction; /**< Optional action called at threshold */
} FltM_GlobalResetStormConfigType;
...
extern const FltM_GlobalResetStormConfigType FltM_GlobalResetStormConfig;
