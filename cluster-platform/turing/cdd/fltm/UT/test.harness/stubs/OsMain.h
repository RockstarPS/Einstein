...
#define OsSetContext(x)             (OsCtrlParam.CurrentContext = x) /*MISRA RULE 2.5 VIOLATION: This is the reason why the MISRA rule could not be followed in this special case*/
