...
echo options TESTABLE_SOURCE_DIR ..\..\src\fltm_soc\ti\src\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR ..\test.harness\stubs\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR ..\test.harness\stubs\cfg\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR ..\test.harness\stubs\sdl\ >> commands.tmp
echo environment build UT_FLTM.env >> commands.tmp
echo /E:UT_FLTM tools script run UT_FLTM.tst >> commands.tmp
echo /E:UT_FLTM execute batch >> commands.tmp
echo /E:UT_FLTM tools import_coverage UT_FLTM.cvr >> commands.tmp
echo /E:UT_FLTM reports custom management UT_FLTM_management_report.html >> commands.tmp
