...
# Configuration for FltM sheet
FLTM_CONFIG = {
    "sheet_name": "FltM",
    "templates": [
        ("FltM_Cfg.h.j2", "FltM_Cfg.h"),
        ("FltM_Cfg.c.j2", "FltM_Cfg.c")
    ]
}
...
def process_fltm_sheet(env: Environment, xl: pd.ExcelFile, sheet_name: str, templates: List[Tuple[str, str]]) -> bool:
    """Process FltM sheet with blank row separator and two headers."""
    try:
