...
#define FLTM_PPU_ENABLE                                         STD_ON
#define FLTM_OCOCLKDET_ENABLE                                   STD_ON
#define FLTM_FLSINTEGRITY_ENABLE                                STD_ON
#define FLTM_POK_TEST_ENABLE                                    STD_ON


#define FLTM_DCC_READBACK_PERIODICITY                           80  /* 800 ms */
#define FLTM_ECC_READBACK_PERIODICITY                           50  /* 500 ms */
#define FLTM_PPU_READBACK_PERIODICITY                           80  /* 800 ms */
...
#if (FLTM_FLSINTEGRITY_ENABLE == STD_ON)
extern const FltM_FlsIntegrityConfigType FltM_FlsIntegrityConfig[FLS_INTEGRITY_TOTAL_TEXT_REGIONS];
#endif
/*****************************************************************************
*                               Functions                                    *
******************************************************************************/

extern void FltM_Soc_WkupCallBackFunc(SDL_ESM_Inst esmInstType, SDL_ESM_IntType esmIntType,
                                    uint32_t grpChannel, uint32_t index, uint32_t intSrc, void *arg);

extern void FltM_Soc_MainCallBackFunc(SDL_ESM_Inst esmInstType, SDL_ESM_IntType esmIntType,
                                    uint32_t grpChannel, uint32_t index, uint32_t intSrc, void *arg);
...
extern void FltM_ReportError(uint8 DomainId, uint8 ErrorId);
