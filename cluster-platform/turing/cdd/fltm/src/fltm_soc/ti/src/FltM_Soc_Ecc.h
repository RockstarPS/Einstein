...
** Invocation       :   Application
**
** Inputs           :   esmInst     - ESM instance
**                      esmIntrType - ESM interrupt type
**                      grpChannel  - ESM group channel
**                      index       - ESM interrupt index
...
**
**==========================================================================*/
extern int32_t FltM_ECC_CallBackFunc(SDL_ESM_Inst esmInst, SDL_ESM_IntType esmIntrType,
