...
echo options TESTABLE_SOURCE_DIR ..\testharness\stubs\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR ..\..\src\src\ >> commands.tmp
echo environment build ICUDRV_VCAST_UT.env >> commands.tmp
echo /E:ICUDRV_VCAST_UT tools script run ICUDRV_VCAST_UT.tst >> commands.tmp
echo /E:ICUDRV_VCAST_UT execute batch >> commands.tmp
echo /E:ICUDRV_VCAST_UT tools import_coverage ICUDRV_VCAST_UT.cvr >> commands.tmp
echo /E:ICUDRV_VCAST_UT reports custom management IcuDrv_mangament_report.html >> commands.tmp
