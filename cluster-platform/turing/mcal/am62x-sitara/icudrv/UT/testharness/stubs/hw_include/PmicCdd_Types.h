...
#define PMICCDD_INIT                  ((uint8)0x01U)
#define PMICCDD_I2C_CB                ((uint8)0x02U)
#define PMICCDD_MAIN_FUNCTION         ((uint8)0x02U)

/* Det Error Definition */
#define PMICCDD_ERROR_I2C_PUSH_SEQUENCE_FAILED          ((uint8)0x01U)
#define PMICCDD_ERROR_I2C_POP_SEQUENCE_FAILED           ((uint8)0x02U)
#define PMICCDD_ERROR_I2C_ASYN_TRANSMIT_FAILED          ((uint8)0x03U)
#define PMICCDD_ERROR_I2C_CB_SEQUENCE_FAILED            ((uint8)0x04U)
...
#define GPIO1_CONF_REG                               ((uint8)0x31U)
#define GPIO2_CONF_REG                               ((uint8)0x32U)
#define GPIO3_CONF_REG                               ((uint8)0x33U)
#define GPIO4_CONF_REG                               ((uint8)0x34U)
#define GPIO5_CONF_REG                               ((uint8)0x35U)
#define GPIO6_CONF_REG                               ((uint8)0x36U)
#define POWER_ON_CONFIG_REG                          ((uint8)0x3CU)
...
#define MASK_ESM_REG                                 ((uint8)0x59U)
#define INT_TOP_REG                                  ((uint8)0x5AU)
#define INT_BUCK_REG                                 ((uint8)0x5BU)
#define INT_LDO_VMON_REG                             ((uint8)0x5FU)
#define INT_GPIO_REG                                 ((uint8)0x63U)
#define INT_STARTUP_REG                              ((uint8)0x65U)
#define INT_MISC_REG                                 ((uint8)0x66U)
#define INT_MODERATE_ERR_REG                         ((uint8)0x67U)
#define INT_SEVERE_ERR_REG                           ((uint8)0x68U)
#define INT_FSM_ERR_REG                              ((uint8)0x69U)
#define INT_ESM_REG                                  ((uint8)0x6CU)
...
#define CONFIG_2_REG                                 ((uint8)0x7EU)
...
#define REGISTER_LOCK_REG                            ((uint8)0xA1U)
...
#define ADC_CTRL_REG                                 ((uint8)0xACU)
#define ADC_RESULT_REG_1                             ((uint8)0xADU)
#define ADC_RESULT_REG_2                             ((uint8)0xAEU)
...
#define WD_MODE_REG                             ((uint8)0x06U)
#define WD_QA_CFG_REG                           ((uint8)0x07U)
#define WD_ERR_STATUS_REG                       ((uint8)0x08U)
#define WD_THR_CFG_REG                          ((uint8)0x09U)
#define WD_FAIL_CNT_REG                         ((uint8)0x0AU)
...
typedef union {
    struct {
        uint8_t nint_endrv_pu_sel : 1;    // NINT_ENDRV_PU_SEL
        uint8_t nint_endrv_sel : 1;       // NINT_ENDRV_SEL
        uint8_t reserved1 : 3;            // RESERVED
        uint8_t en_pb_degl : 1;           // EN_PB_DEGL
        uint8_t en_pb_vsense_config : 2;  // EN_PB_VSENSE_CONFIG
    } bits;
    uint8_t value;
...
typedef union {
    struct {
        uint8_t gpio1_dir : 1;      // GPIO1_DIR
        uint8_t gpio1_od : 1;       // GPIO1_OD
        uint8_t gpio1_pu_sel : 1;   // GPIO1_PU_SEL
        uint8_t gpio1_pu_pd_en : 1; // GPIO1_PU_PD_EN
        uint8_t gpio1_deglitch_en : 1; // GPIO1_DEGLITCH_EN
        uint8_t gpio1_sel : 2;      // GPIO1_SEL
    } bits;
    uint8_t value;
} PmicCdd_Gpio1_Reg_t;
...
typedef union {
    struct {
        uint8_t gpio2_dir : 1;      // GPIO2_DIR
        uint8_t gpio2_od : 1;       // GPIO2_OD
        uint8_t gpio2_pu_sel : 1;   // GPIO2_PU_SEL
        uint8_t gpio2_pu_pd_en : 1; // GPIO2_PU_PD_EN
        uint8_t gpio2_deglitch_en : 1; // GPIO2_DEGLITCH_EN
        uint8_t gpio2_sel : 2;      // GPIO2_SEL
    } bits;
    uint8_t value;
} PmicCdd_Gpio2_Reg_t;
...
typedef union {
    struct {
        uint8_t gpio3_dir : 1;      // GPIO3_DIR
        uint8_t gpio3_od : 1;       // GPIO3_OD
        uint8_t gpio3_pu_sel : 1;   // GPIO3_PU_SEL
        uint8_t gpio3_pu_pd_en : 1; // GPIO3_PU_PD_EN
        uint8_t gpio3_deglitch_en : 1; // GPIO3_DEGLITCH_EN
        uint8_t gpio3_sel : 2;      // GPIO3_SEL
    } bits;
    uint8_t value;
} PmicCdd_Gpio3_Reg_t;
...
typedef union {
    struct {
        uint8_t gpio4_dir : 1;      // GPIO4_DIR
        uint8_t gpio4_od : 1;       // GPIO4_OD
        uint8_t gpio4_pu_sel : 1;   // GPIO4_PU_SEL
        uint8_t gpio4_pu_pd_en : 1; // GPIO4_PU_PD_EN
        uint8_t gpio4_deglitch_en : 1; // GPIO4_DEGLITCH_EN
        uint8_t gpio4_sel : 2;      // GPIO4_SEL
    } bits;
    uint8_t value;
} PmicCdd_Gpio4_Reg_t;
...
typedef union {
    struct {
        uint8_t gpio5_dir : 1;      // GPIO5_DIR
        uint8_t gpio5_od : 1;       // GPIO5_OD
        uint8_t gpio5_pu_sel : 1;   // GPIO5_PU_SEL
        uint8_t gpio5_pu_pd_en : 1; // GPIO5_PU_PD_EN
        uint8_t gpio5_deglitch_en : 1; // GPIO5_DEGLITCH_EN
        uint8_t gpio5_sel : 2;      // GPIO5_SEL
    } bits;
    uint8_t value;
} PmicCdd_Gpio5_Reg_t;
...
typedef union {
    struct {
        uint8_t gpio6_dir : 1;      // GPIO6_DIR
        uint8_t gpio6_od : 1;       // GPIO6_OD
        uint8_t gpio6_pu_sel : 1;   // GPIO6_PU_SEL
        uint8_t gpio6_pu_pd_en : 1; // GPIO6_PU_PD_EN
        uint8_t gpio6_deglitch_en : 1; // GPIO6_DEGLITCH_EN
        uint8_t gpio6_sel : 3;      // GPIO6_SEL
    } bits;
    uint8_t value;
} PmicCdd_Gpio6_Reg_t;
...
typedef union {
    struct {
        uint8_t wd_longwin : 8;  // WD_LONGWIN
    } bits;
    uint8_t value;
...
typedef union {
    struct {
        uint8_t wd_return_longwin : 1;    // WD_RETURN_LONGWIN
        uint8_t wd_mode_select : 1;       // WD_MODE_SELECT
        uint8_t wd_pwrhold : 1;           // WD_PWRHOLD
        uint8_t reserved2 : 3;            // RESERVED
        uint8_t wd_endrv_sel : 1;         // WD_ENDRV_SEL
        uint8_t wd_cnt_sel : 1;           // WD_CNT_SEL
    } bits;
    uint8_t value;
} PmicCdd_WdModeReg_t;
...
typedef union {
    struct {
        uint8_t wd_longwin_timeout_int : 1;  // WD_LONGWIN_TIMEOUT_INT
        uint8_t wd_timeout : 1;              // WD_TIMEOUT
        uint8_t wd_trig_early : 1;           // WD_TRIG_EARLY
        uint8_t wd_answ_early : 1;           // WD_ANSW_EARLY
        uint8_t wd_seq_err : 1;              // WD_SEQ_ERR
        uint8_t wd_answ_err : 1;             // WD_ANSW_ERR
        uint8_t wd_fail_int : 1;             // WD_FAIL_INT
        uint8_t wd_rst_int : 1;              // WD_RST_INT
    } bits;
    uint8_t value;
...
typedef union {
    struct {
        uint8_t wd_rst_th : 3;    // WD_RST_TH
        uint8_t wd_fail_th : 3;   // WD_FAIL_TH
        uint8_t wd_en : 1;        // WD_EN
        uint8_t wd_rst_en : 1;    // WD_RST_EN
    } bits;
    uint8_t value;
...
typedef union {
    struct {
        uint8_t wd_fail_cnt : 4;  // WD_FAIL_CNT
        uint8_t reserved3 : 1;    // RESERVED
        uint8_t wd_first_ok : 1;  // WD_FIRST_OK
        uint8_t wd_bad_event : 1; // WD_BAD_EVENT
    } bits;
    uint8_t value;
...
typedef union {
    struct {
        uint8_t adc_start : 1;                // ADC_START
        uint8_t adc_cont_conv : 1;            // ADC_CONT_CONV
        uint8_t adc_thermal_sel : 1;          // ADC_THERMAL_SEL
        uint8_t adc_rdiv_en : 1;              // ADC_RDIV_EN
        uint8_t reserved38 : 3;               // RESERVED
        uint8_t adc_status : 1;               // ADC_STATUS
    } bits;
    uint8_t value;
...
typedef union {
    struct {
        uint8_t adc_result_11_4 : 8;          // ADC_RESULT_11_4
    } bits;
    uint8_t value;
...
typedef union {
    struct {
        uint8_t reserved39 : 4;               // RESERVED
        uint8_t adc_result_3_0 : 4;           // ADC_RESULT_3_0
    } bits;
    uint8_t value;
...
typedef union {
    struct {
        uint8_t buck1_uvov_mask : 1;       // BUCK1_UVOV_MASK
        uint8_t buck2_uvov_mask : 1;       // BUCK2_UVOV_MASK
        uint8_t buck3_uvov_mask : 1;       // BUCK3_UVOV_MASK
        uint8_t buck4_uvov_mask : 1;       // BUCK4_UVOV_MASK
    } bits;
    uint8_t value;
...
typedef union {
    struct {
        uint8_t ldo1_uvov_mask : 1;        // LDO1_UVOV_MASK
        uint8_t ldo2_uvov_mask : 1;        // LDO2_UVOV_MASK
        uint8_t ldo3_uvov_mask : 1;        // LDO3_UVOV_MASK
        uint8_t reserved17 : 1;            // RESERVED
        uint8_t vcca_uvov_mask : 1;        // VCCA_UVOV_MASK 
        uint8_t vmon1_uvov_mask : 1;       // VMON1_UVOV_MASK
        uint8_t vmon2_uvov_mask : 1;       // VMON2_UVOV_MASK 
    } bits;
    uint8_t value;
...
typedef union {
    struct {
        uint8_t gpio1_fall_mask : 1;       // GPIO1_FALL_MASK
        uint8_t gpio2_fall_mask : 1;       // GPIO2_FALL_MASK
        uint8_t gpio3_fall_mask : 1;       // GPIO3_FALL_MASK
        uint8_t gpio4_fall_mask : 1;       // GPIO4_FALL_MASK
        uint8_t gpio5_fall_mask : 1;       // GPIO5_FALL_MASK
        uint8_t gpio6_fall_mask : 1;       // GPIO6_FALL_MASK
    } bits;
    uint8_t value;
...
typedef union {
    struct {
        uint8_t gpio1_rise_mask : 1;       // GPIO1_RISE_MASK
        uint8_t gpio2_rise_mask : 1;       // GPIO2_RISE_MASK
        uint8_t gpio3_rise_mask : 1;       // GPIO3_RISE_MASK
        uint8_t gpio4_rise_mask : 1;       // GPIO4_RISE_MASK
        uint8_t gpio5_rise_mask : 1;       // GPIO5_RISE_MAKS
        uint8_t gpio6_rise_mask : 1;       // GPIO6_RISE_MASK
    } bits;
    uint8_t value;
...
typedef union {
    struct {
        uint8_t vsense_mask : 1;           // VSENSE_MASK
        uint8_t enable_mask : 1;           // ENABLE_MASK
        uint8_t pb_short_mask : 1;         // PB_SHORT_MASK
        uint8_t reserved18 : 1;            // RESERVED
        uint8_t fsd_mask : 1;              // FSD_MASK
        uint8_t soft_reboot_mask : 1;      // SOFT_REBOOT_MASK
    } bits;
    uint8_t value;
...
typedef union {
    struct {
        uint8_t bist_pass_mask : 1;        // BIST_PASS_MASK
        uint8_t ext_clk_mask : 1;          // EXT_CLK_MASK
        uint8_t reg_unlock_mask : 1;       // REG_UNLOCK_MASK
        uint8_t twarn_mask : 1;            // TWARN_MASK
        uint8_t pb_long_mask : 1;          // PB_LONG_MASK
        uint8_t pb_fall_mask : 1;          // PB_FALL_MASK
        uint8_t pb_rise_mask : 1;          // PB_RISE_MASK
        uint8_t adc_conv_ready_mask : 1;   // ADC_CONV_READY_MASK
    } bits;
} PmicCdd_MaskMisc_Reg_t;                  // 0x53U

typedef union {
    struct {
        uint8_t reserved19 : 1;            // RESERVED
        uint8_t bist_fail_mask : 1;        // BIST_FAIL_MASK
        uint8_t reg_crc_err_mask : 1;      // REG_CRC_ERR_MASK        
    } bits;
    uint8_t value;
...
typedef union {
    struct {
        uint8_t imm_shutdown_mask : 1;     // IMM_SHUTDOWN_MASK
        uint8_t ord_shutdown_mask : 1;     // ORD_SHUTDOWN_MASK
        uint8_t mcu_pwr_err_mask : 1;      // MCU_PWR_ERR_MASK
        uint8_t soc_pwr_err_mask : 1;      // SOC_PWR_ERR_MASK
        uint8_t comm_err_mask : 1;         // COMM_ERR_MASK
        uint8_t i2c2_err_mask : 1;         // I2C2_ERR_MASK
    } bits;
    uint8_t value;
...
typedef union {
    struct {
        uint8_t reserved20 : 3;            // RESERVED
        uint8_t esm_mcu_pin_mask : 1;      // ESM_MCU_PIN_MASK
        uint8_t esm_mcu_fail_mask : 1;     // ESM_MCU_FAIL_MASK
        uint8_t esm_mcu_rst_mask : 1;      // ESM_MCU_RST_MASK
    } bits;
    uint8_t value;
...
typedef union {
    struct {
        uint8_t buck_int : 1;              // BUCK_INT
        uint8_t ldo_vmon_int : 1;          // LDO_VMON_INT
        uint8_t gpio_int : 1;              // GPIO_INT
        uint8_t startup_int : 1;           // STRATUP_INT
        uint8_t misc_int : 1;              // MISC_INT
        uint8_t moderate_err_int : 1;      // MODERATE_ERR_INT
        uint8_t severe_err_int : 1;        // SEVERE_ERR_INT
        uint8_t fsm_err_int : 1;           // FSM_ERR_INT
    } bits;
    uint8_t value;
...
typedef union {
    struct {
        uint8_t buck1_uvov_int : 1;        // BUCK1_UVOV_INT
        uint8_t buck2_uvov_int : 1;        // BUCK2_UVOV_INT
        uint8_t buck3_uvov_int : 1;        // BUCK3_UVOV_INT
        uint8_t buck4_uvov_int : 1;        // BUCK4_UVOV_INT
    } bits;
    uint8_t value;
...
typedef union {
    struct {
        uint8_t ldo1_uvov_int : 1;         // LDO1_UVOV_INT
        uint8_t ldo2_uvov_int : 1;         // LDO2_UVOV_INT
        uint8_t ldo3_uvov_int : 1;         // LDO3_UVOV_INT
        uint8_t reserved21 : 1;            // RESERVED
        uint8_t vcca_uvov_int : 1;         // VCCA_UVOV_INT
        uint8_t vmon1_uvov_int : 1;        // VMON1_UVOV_INT
        uint8_t vmon2_uvov_int : 1;        // VMON2_UVOV_INT
    } bits;
    uint8_t value;
...
typedef union {
    struct {
        uint8_t gpio1_int : 1;             // GPIO1_INT
        uint8_t gpio2_int : 1;             // GPIO2_INT
        uint8_t gpio3_int : 1;             // GPIO3_INT
        uint8_t gpio4_int : 1;             // GPIO4_INT
        uint8_t gpio5_int : 1;             // GPIO5_INT
        uint8_t gpio6_int : 1;             // GPIO6_INT
    } bits;
    uint8_t value;
...
typedef union {
    struct {
        uint8_t vsense_int : 1;            // VSENSE_INT
        uint8_t enable_int : 1;            // ENABLE_INT
        uint8_t pb_short_int : 1;          // PB_SHORT_INT
        uint8_t reserved22 : 1;            // RESERVED
        uint8_t fsd_int : 1;               // FSD_INT
        uint8_t soft_reboot_int : 1;       // SOFT_REBOOT_INT
    } bits;
    uint8_t value;
...
typedef union {
    struct {
        uint8_t bist_pass_int : 1;         // BIST_PASS_INT
        uint8_t ext_clk_int : 1;           // EXT_CLK_INT
        uint8_t reg_unlock_int : 1;        // REG_UNLOCK_INT
        uint8_t twarn_int : 1;             // TWARN_INT
        uint8_t pb_long_int : 1;           // PB_LONG_INT
        uint8_t pb_fall_int : 1;           // PB_FALL_INT
        uint8_t pb_rise_int : 1;           // PB_RISE_INT
        uint8_t adc_conv_ready_int : 1;    // ADC_CONV_READY_INT
    } bits;
    uint8_t value;
...
typedef union {
    struct {
        uint8_t tsd_ord_int : 1;           // TSD_ORD_INT
        uint8_t bist_fail_int : 1;         // BIST_FAIL_INT
        uint8_t reg_crc_err_int : 1;       // REG_CRC_ERR_INT
        uint8_t recov_cnt_int : 1;         // RECOV_CNT_INT
    } bits;
    uint8_t value;
...
typedef union {
    struct {
        uint8_t tsd_imm_int : 1;           // TSD_IMM_INT
        uint8_t vcca_ovp_int : 1;          // VCCA_OVP_INT
        uint8_t pfsm_err_int : 1;          // PFSM_ERR_INT
        uint8_t bg_xmon_int : 1;           // BG_XMON_INT
    } bits;
    uint8_t value;
...
typedef union {
    struct {
        uint8_t imm_shutdown_int : 1;      // IMM_SHUTDOWN_INT
        uint8_t ord_shutdown_int : 1;      // ORD_SHUTDOWN_INT
        uint8_t mcu_pwr_err_int : 1;       // MCU_PWR_ERR_INT
        uint8_t soc_pwr_err_int : 1;       // SOC_PWR_ERR_INT
        uint8_t comm_err_int : 1;          // COMM_ERR_INT
        uint8_t i2c2_err_int : 1;          // I2C2_ERR_INT
        uint8_t esm_int : 1;               // ESM_INT
        uint8_t wd_int : 1;                // WD_INT
    } bits;
    uint8_t value;
...
typedef union {
    struct {
        uint8_t reserved23 : 1;            // RESERVED
        uint8_t esm_mcu_pin_int : 1;       // ESM_MCU_PIN_INT
        uint8_t esm_mcu_fail_int : 1;      // ESM_MCU_FAIL_INT
        uint8_t esm_mcu_rst_int : 1;       // ESM_MCU_RST_INT
    } bits;
    uint8_t value;                         
...
typedef union {
    struct {
        uint8_t esm_mcu_start : 1;           // ESM_MCU_START
    } bits;
    uint8_t value;
...
typedef union {
    struct {
        uint8_t esm_mcu_delay1 : 8;          // ESM_MCU_DELAY1
    } bits;
    uint8_t value;
...
typedef union {
    struct {
        uint8_t esm_mcu_delay2 : 8;          // ESM_MCU_DELAY2
    } bits;
    uint8_t value;
...
typedef union {
    struct {
        uint8_t esm_mcu_err_cnt_th : 4;      // ESM_MCU_ERR_CNT_TH
        uint8_t reserved36 : 1;              // RESERVED
        uint8_t esm_mcu_endrv : 1;           // ESM_MCU_ENDRV
        uint8_t esm_mcu_en : 1;              // ESM_MCU_ENDRV
        uint8_t esm_mcu_mode : 1;            // ESM_MCU_MODE
    } bits;
    uint8_t value;
...
typedef union {
    struct {
        uint8_t esm_mcu_hmax : 8;            // ESM_MCU_HMAX
    } bits;
    uint8_t value;
...
typedef union {
    struct {
        uint8_t esm_mcu_hmin : 8;            // ESM_MCU_HMIN
    } bits;
    uint8_t value;
...
typedef union {
    struct {
        uint8_t esm_mcu_lmax : 8;            // ESM_MCU_LMAX
    } bits;
    uint8_t vaule;
...
typedef union {
    struct {
        uint8_t esm_mcu_lmin : 8;            // ESM_MCU_LMIN
    } bits;
    uint8_t value;
...
typedef union {
    struct {
        uint8_t esm_mcu_err_cnt : 5;         // ESM_MCU_ERR_CNT
    } bits;
    uint8_t value;
...
/*  Macro for Window 1 and 2 Timing to load into the register
tWINDOW1_MIN = (WD_WIN1[6:0] + 1) � 0.55 � 0.95 ms,
WINDOW2_MIN = (WD_WIN2[6:0] + 1) � 0.55 � 0.95 ms.
*/
typedef enum {
...
typedef enum {
    ...
    PMIC_INT_REG_CRC_ERR = 0x80000000,
