...
#if (defined NMOSEK_CODE) /* to prevent double definition */
#error NMOSEK_CODE already defined
#endif /* if (defined NMOSEK_CODE) */
...
#if (defined NMOSEK_CONST) /* to prevent double definition */
#error NMOSEK_CONST already defined
#endif /* if (defined NMOSEK_CONST) */
...
#if (defined NMOSEK_APPL_DATA) /* to prevent double definition */
#error NMOSEK_APPL_DATA already defined
#endif /* if (defined NMOSEK_APPL_DATA) */

/** \brief definition of the application data pointer class
 **
 ** To be used for references on application data (expected to
 ** be in RAM or ROM) passed via API. */
#define NMOSEK_APPL_DATA

#if (defined NMOSEK_APPL_CONST) /* to prevent double definition */
#error NMOSEK_APPL_CONST already defined
#endif /* if (defined NMOSEK_APPL_CONST) */
...
#if (defined NMOSEK_APPL_CODE) /* to prevent double definition */
#error NMOSEK_APPL_CODE already defined
#endif /* if (defined NMOSEK_APPL_CODE) */
...
#if (defined NMOSEK_CALLOUT_CODE) /* to prevent double definition */
#error NMOSEK_CALLOUT_CODE already defined
#endif /* if (defined NMOSEK_CALLOUT_CODE) */

/** \briefdefinition of the application function variable memory class*/
#define NMOSEK_CALLOUT_CODE

#if (defined NMOSEK_VAR_NOINIT) /* to prevent double definition */
#error NMOSEK_VAR_NOINIT already defined
#endif /* if (defined NMOSEK_VAR_NOINIT) */

/** \brief definition of the noinit variable memory class
 **
 ** To be used for all global or static variables that are
 ** never initialized. */
#define NMOSEK_VAR_NOINIT

#if (defined NMOSEK_VAR_POWER_ON_INIT) /* to prevent double definition */
#error NMOSEK_VAR_POWER_ON_INIT already defined
#endif /* if (defined NMOSEK_VAR_POWER_ON_INIT) */

/** \brief definition of a power on init variable memory class
 **
 ** To be used for all global or static variables that are initialized
 ** only after power on reset. */
#define NMOSEK_VAR_POWER_ON_INIT

#if (defined NMOSEK_VAR_FAST) /* to prevent double definition */
#error NMOSEK_VAR_FAST already defined
#endif /* if (defined NMOSEK_VAR_FAST) */
 ...
 ** - frequently used
 ** - high number of accesses in source code */
#define NMOSEK_VAR_FAST

#if (defined NMOSEK_VAR) /* to prevent double definition */
#error NMOSEK_VAR already defined
#endif /* if (defined NMOSEK_VAR) */
