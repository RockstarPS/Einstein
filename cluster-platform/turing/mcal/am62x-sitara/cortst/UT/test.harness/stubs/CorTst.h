...
/* Service ID defined */
#define CORTST_API_INIT					((uint8)0x0U)
#define CORTST_API_DEINIT				((uint8)0x1U)
#define CORTST_API_ABORT				((uint8)0x2U)
...
#define CORTST_API_GET_STATE			((uint8)0x3U)
#define CORTST_API_GET_CURRENT_STATUS	((uint8)0x4U)
#define CORTST_API_GET_SIGNATURE		((uint8)0x5U)
#define CORTST_API_GET_FGND_SIGNATURE	((uint8)0x6U)
#define CORTST_API_START				((uint8)0x7U)
#define CORTST_API_GET_VERSION_INFO		((uint8)0x8U)
#define CORTST_API_MAINFUNCTION			((uint8)0x0bU)
...
typedef enum
{
    CORTST_ABORT = 0x0, CORTST_INIT, CORTST_UNINIT, CORTST_RUNNING_BGND,
} CorTst_StateType;
