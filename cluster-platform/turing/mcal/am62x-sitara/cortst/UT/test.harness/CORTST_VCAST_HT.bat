...
echo options TESTABLE_SOURCE_DIR C:\VCAST\Environments\turing.mcal.cortst.tst\src\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR C:\VCAST\Environments\turing.mcal.cortst.tst\include\ >> commands.tmp
echo environment build CORTST_VCAST_HT.env >> commands.tmp
echo /E:CORTST_VCAST_HT tools script run CORTST_VCAST_HT.tst >> commands.tmp
echo /E:CORTST_VCAST_HT execute batch >> commands.tmp
echo /E:CORTST_VCAST_HT tools import_coverage CORTST_VCAST_HT.cvr >> commands.tmp
echo /E:CORTST_VCAST_HT reports custom management CORTST_VCAST_HT_management_report.html >> commands.tmp
