...
******************************************************************************/
#define I2C_REG_BYTES_COUNT             (4u)
#define I2C_REG_HALFWORDS_COUNT         (2u)
#define I2C_RESERVED_GAP_1              (2u)
#define I2C_RESERVED_GAP_2              (3u)
#define I2C_RESERVED_GAP_3              (20u)
#define I2C_RESERVED_GAP_4              (1u)
...
typedef union 
{
    ...
    uint8                 au8Byte[I2C_REG_BYTES_COUNT];
    uint16                au16Halfword[I2C_REG_HALFWORDS_COUNT];
...
{
    uint32           u32Register;
    I2c_IE_field    IE_field;
    uint8            au8Byte[I2C_REG_BYTES_COUNT];
    uint16           au16Halfword[I2C_REG_HALFWORDS_COUNT];
}I2c_IE_reg;  /* offset = 84h */
...
{
    uint32             u32Register;
    I2c_STAT_field    STAT_field;
    uint8              au8Byte[I2C_REG_BYTES_COUNT];
    uint16             au16Halfword[I2C_REG_HALFWORDS_COUNT];
}I2c_STAT_reg; /* offset = 88h */
typedef struct 
{
    uint32            u1RDONE:1;
    uint32            :15;
...
typedef struct 
{
    ...
    uint32                         u32Reserved[I2C_RESERVED_GAP_1];
    I2c_Sysc_reg                   SYSC_reg;    /* 10h */
    uint32                         u32Reserved1[I2C_RESERVED_GAP_2];
    ...
    uint32                         u32Reserved2[I2C_RESERVED_GAP_3];
    I2c_IE_reg                     IE_reg;  /* 84h */
    I2c_STAT_reg                   STAT_reg; /* 88h */
    I2c_SYSS_reg                   SYSS_reg; /* 90h */
    I2c_BUF_reg                    BUF_reg; /* 94h */
    I2c_CNT_reg                    CNT_reg; /* 98h */
    I2c_DATA_reg                   DATA_reg; /* 9Ch */
    uint32                         u32Reserved3[I2C_RESERVED_GAP_4];
...
// Det Error
#define I2C_SYNC_TRANSMIT     0U
#define I2C_MASTER_INTERRUPT  1U
