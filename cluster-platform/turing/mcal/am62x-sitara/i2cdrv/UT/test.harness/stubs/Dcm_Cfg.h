...
#define DcmDslDiagRespMaxNumRespPend            0xFF
...
#define DcmNumOfRIDSupported                    (uint8)11
#define DcmNumOfDIDSupported                    (uint16)27
...
#define DcmDspNumOfDidOpInfo                     43U
#define DcmDsdNumOfStateRef                      22U
#define DcmDspNumOfDidSignalInfo                 1U
#define DcmDspNumOfRidSignalInfo                 20U
...
extern Std_ReturnType DcmExt_42DiagProcess(Dcm_OpStatusType OpStatus,  Dcm_MsgContextType *pMsgContext, Dcm_NegativeResponseCodeType *NegRes);
...
// extern FUNC(Std_ReturnType, CDD_FitManager_CODE) CDD_FitManager_RouteFITDID(uint8 *Data, uint8 OpStatus, uint8 *pNrc);
#endif

extern Std_ReturnType DcmExt_FITDID_DiagAction(Dcm_OpStatusType OpStatus, uint8 *Data , uint8 *pNrc, uint8 eOperation);
extern Std_ReturnType DcmExt_NVMWRITEDID_DiagAction(Dcm_OpStatusType OpStatus, uint8 *Data , uint8 *pNrc, uint8 eOperation);
extern Std_ReturnType DcmExt_ResetHistory_DiagAction(Dcm_OpStatusType OpStatus, uint8 *Data , uint8 *pNrc, uint8 eOperation);
