...
#define NO_OF_PINMUX_ENTRIES              3U
/* hw units */
...
extern void Ads7142Cdd_I2cEndNotification(uint8 sequence, uint8 busstate, uint8 sequencestate);

extern void BacklightCdd_I2cEndNotification(uint8 sequence, uint8 busstate, uint8 sequencestate);
