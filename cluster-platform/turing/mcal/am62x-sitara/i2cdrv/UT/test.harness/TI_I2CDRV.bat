...
echo environment build TI_I2CDRV.env >> commands.tmp
echo /E:TI_I2CDRV tools script run TI_I2CDRV.tst >> commands.tmp
echo /E:TI_I2CDRV execute batch >> commands.tmp
echo /E:TI_I2CDRV tools import_coverage TI_I2CDRV.cvr >> commands.tmp
echo /E:TI_I2CDRV reports custom management I2cDrv_management_report.html >> commands.tmp
