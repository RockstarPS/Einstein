...
extern SRV_Reset_Det_ReportError_Callout(uint16 ModuleId, uint8 InstanceId, uint8 ApiId, uint8 ErrorId);

#define DET_REPORT_ERROR_CALLOUT(a,b,c,d)    while(1); \
									  SRV_Reset_Det_ReportError_Callout(a, b, c, d); \

#else
#define DET_REPORT_ERROR_CALLOUT(a,b,c,d)  while(1); //asm(__nop)
#endif
