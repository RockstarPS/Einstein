...
echo environment build RAMTST_UT.env >> commands.tmp
echo /E:RAMTST_UT  tools update mcdc >> commands.tmp
echo /E:RAMTST_UT tools script run RAMTST_UT.tst >> commands.tmp
echo /E:RAMTST_UT execute batch >> commands.tmp
echo /E:RAMTST_UT tools import_coverage RAMTST_UT.cvr >> commands.tmp
echo /E:RAMTST_UT reports custom management Ramtst_management_report.html >> commands.tmp
