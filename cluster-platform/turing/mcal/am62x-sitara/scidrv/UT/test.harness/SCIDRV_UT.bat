...
echo environment build SCIDRV_UT.env >> commands.tmp
echo /E:SCIDRV_UT tools script run SCIDRV_UT.tst >> commands.tmp
echo /E:SCIDRV_UT execute batch >> commands.tmp
echo /E:SCIDRV_UT tools import_coverage SCIDRV_UT.cvr >> commands.tmp
echo /E:SCIDRV_UT reports custom management SciDrv_TestCase_Management_Report.html >> commands.tmp
