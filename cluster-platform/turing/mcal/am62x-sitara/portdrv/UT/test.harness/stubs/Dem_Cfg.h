...
#define Dem_Cfg_Mem_Total_Primary_Entry 	5U
...
#define DemMaxNumberFreezeFrameRecords    0x01
...
typedef enum
{
    ...
    DEM_EXTENDED_DATA_OCCCNTR = 0x2,
    DEM_EXTENDED_DATA_AGINGCNTR = 0x4,
    DEM_EXTENDED_DATA_CYCLES_SINCE_LAST_FAILED = 0x8,
    DEM_EXTENDED_DATA_CYCLES_SINCE_FIRST_FAILED = 0x10,
    DEM_EXTENDED_DATA_CYCLES_SINCE_FIRST_FAILED_EVENT = 0x20,
    DEM_EXTENDED_DATA_CYCLES_SINCE_FIRST_CONFIRMED_EVENT = 0x40,
    DEM_EXTENDED_DATA_RECENT_FAILED_EVENT = 0x80,
    RECENT_CONFIRMED_EVENT = 0x100,
    DEM_EXTENDED_DATA_OPERATION_CYCLES_COUNTER = 0x200,
    DEM_EXTENDED_DATA_FDC = 0x400
