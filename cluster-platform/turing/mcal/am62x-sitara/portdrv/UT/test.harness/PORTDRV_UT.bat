...
echo environment build PORTDRV_UT.env >> commands.tmp
echo /E:PORTDRV_UT tools script run PORTDRV_UT.tst >> commands.tmp
echo /E:PORTDRV_UT execute batch >> commands.tmp
echo /E:PORTDRV_UT reports custom management PORTDRV_MANAGEMENTREPORT.html >> commands.tmp
