...
echo environment build NETWORK_MANAGER_UT.env >> commands.tmp
echo /E:NETWORK_MANAGER_UT tools script run NETWORK_MANAGER_UT.tst >> commands.tmp
echo /E:NETWORK_MANAGER_UT execute batch >> commands.tmp
echo /E:NETWORK_MANAGER_UT reports custom management NETWORK_MANAGER_UT_management_report.html >> commands.tmp
