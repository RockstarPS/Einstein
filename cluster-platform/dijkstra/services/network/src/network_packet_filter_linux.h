...
///
/// @brief  CNetworkPacketFilterLinux Class. This class implements the pf(packet filter) control.
...
///
//---------------------------------------------------------------------------------------------------------------------
#ifndef NETWORK_PACKET_FILTER_LINUX_H
#define NETWORK_PACKET_FILTER_LINUX_H
...
class CNetworkPacketFilterLinux : public CNetworkPacketFilterIf
{
public:
    ///
    ...
    ///
    virtual void setFilterConfiguration(const std::string &configFilePath);
...
private:
    ...
    /// @brief
    ///
    std::string mConfigfilePath = "/tmp/iprules.txt";
    ...
    ///                    terminated
    ///
    static bool invokeIpTables(const char * pName, char *const *const arglist);
};
...
#endif  //NETWORK_PACKET_FILTER_LINUX_H
