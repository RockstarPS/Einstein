...
echo options C_DEFINE_LIST VCAST_NO_PTR_TO_UNCON_ARRAY_SUPPORT DISPLAY_GAMMA_RGB >> commands.tmp
...
echo environment build DISPLAY_MGR_UT.env >> commands.tmp
echo /E:DISPLAY_MGR_UT tools script run DISPLAY_MGR_UT.tst >> commands.tmp
echo /E:DISPLAY_MGR_UT execute batch >> commands.tmp
echo /E:DISPLAY_MGR_UT reports custom full DISPLAY_MGR_UT_full_report.html >> commands.tmp
