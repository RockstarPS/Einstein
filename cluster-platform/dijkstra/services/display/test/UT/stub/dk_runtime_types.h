...
// Date: Wed Aug 03 13:53:04 IST 2022
// User: SSUBRA21
// System: GIP
// Configuration: Platform
// Project: NISSAN_J32V_IC
// Message Catalogue version : 1.0.34
//
//---------------------------------------------------------------------------------------------------------------------
...
#define EFileModeOfOperation_AddFile        ((EFileModeOfOperation_t)1)
#define EFileModeOfOperation_DeleteFile        ((EFileModeOfOperation_t)2)
#define EFileModeOfOperation_ReplaceFile        ((EFileModeOfOperation_t)3)
#define EFileModeOfOperation_ReadFile        ((EFileModeOfOperation_t)4)
#define EFileModeOfOperation_ReadDir        ((EFileModeOfOperation_t)5)
#define EFileModeOfOperation_Last        ((EFileModeOfOperation_t)6)
