...
echo options TESTABLE_SOURCE_DIR ..\..\..\src\system_state\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR ..\stub\ >> commands.tmp
echo environment build SYSTEM_STATE_UT.env >> commands.tmp
echo /E:SYSTEM_STATE_UT tools script run SYSTEM_STATE_UT.tst >> commands.tmp
echo /E:SYSTEM_STATE_UT execute batch >> commands.tmp
echo /E:SYSTEM_STATE_UT reports custom full SYSTEM_STATE_UT_full_report.html >> commands.tmp
"%VECTORCAST_DIR%\CLICAST"  /L:CPLUSPLUS tools execute commands.tmp true
