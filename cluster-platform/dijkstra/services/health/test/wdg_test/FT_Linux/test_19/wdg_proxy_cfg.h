...
#define PROCESS_MONITOR_LIST_SIZE       (5U)

#define PROCESS_MONITOR_LIST    \
    /*Process Name            Service Name                   Watchdog Enabled*/     \
    {"test_01",               "test_19_1.service",             false},              \
    {"test_02",               "test_19_2.service",             true},               \
    {"test_04",               "test_19_3.service",             false},              \
    {"test_05",               "test_19_4.service",             true},               \
    {"test_18",               "test_19_5.service",             false}
