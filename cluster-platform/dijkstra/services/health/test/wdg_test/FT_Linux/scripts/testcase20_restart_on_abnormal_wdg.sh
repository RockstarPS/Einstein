...
# Configuration
SERVICE_TO_KILL="test_12.service"
SERVICE_TO_MONITOR="wdg_proxy_test_12.service"
LOG_FILTER="wdg"

echo "------------------------------------------------------------------"
echo "----- Test Case 20 - Restart type: on-abnormal -------------------"
...
# Function to send signal (simulate watchdog trigger if app supports it)
send_signal() {
    local TEST_NAME=$1
    local SIGNAL=$2
    local DESC=$3
