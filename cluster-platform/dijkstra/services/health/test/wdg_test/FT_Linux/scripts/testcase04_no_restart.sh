...
echo "------------------------------------------------------------------"
echo "----- Test Case 4 - Restart type: no restart ---------------------"
echo "  Cause of termination:"
echo "        Unclean termination due to signal"
echo ""
...
# 3. Trigger unclean termination using signal
echo "......................................................."
echo "Test: process receives signal 37 and exits with code 255"
echo "......................................................."
PID_01=$(systemctl show --property MainPID --value "$SERVICE_TO_KILL")

if [ "$PID_01" -ne 0 ]; then
    echo "[!] Sending signal 37 to $SERVICE_TO_KILL (PID: $PID_01)..."
    kill -37 "$PID_01"
else
