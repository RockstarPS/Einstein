...
# Configuration
SERVICE_TO_KILL="test_18_3.service"
SERVICE_TO_MONITOR="wdg_proxy_test_18.service"
LOG_FILTER="wdg_proxy"

echo "------------------------------------------------------------------"
echo "-----   Testcase 32 - Multiprocess Monitoring  -------------------"
echo "  Configuration:"
echo "        (1) Restart action  : Always"
echo "        (2) Watchdog        : Disabled"
echo "  Expected Behaviour:"
echo "        - Process shall be restarted"
echo "        - Fatal error notification expected : No"
echo "        - Process restart expected          : Yes"
echo "------------------------------------------------------------------"
