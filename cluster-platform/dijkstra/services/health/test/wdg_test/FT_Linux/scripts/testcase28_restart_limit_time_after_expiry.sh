...
echo "------------------------------------------------------------------"
echo "----- Test Case 28 - Restart type: always with limit (after interval expiry) -----"
...
echo "        The process shall be restarted beyond the limit configured in StartLimitBurst,"
echo "        if it does not crash continuously within the time defined by StartLimitInterval."
echo ""
...
# 5. Wait for interval expiry
echo "-----------------------------------------------"
echo "    Waiting for 5 minutes (StartLimitInterval)..."
echo "-----------------------------------------------"
sleep 300

# 6. Third kill (after interval)
echo "......................................................."
