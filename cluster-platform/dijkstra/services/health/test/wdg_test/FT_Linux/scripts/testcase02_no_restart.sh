...
echo "------------------------------------------------------------------"
echo "----- Test Case 2 - Restart type: no restart ---------------------"
echo "  Cause of termination:"
echo "        One of the clean signals: SIGHUP, SIGINT, SIGTERM, or SIGPIPE"
echo ""
...
# 3. Trigger termination using SIGHUP
echo "......................................................."
echo "       Test with clean signal exit (SIGHUP)"
echo "......................................................."
PID_01=$(systemctl show --property MainPID --value "$SERVICE_TO_KILL")

if [ "$PID_01" -ne 0 ]; then
    echo "[!] Sending signal 1 (SIGHUP) to $SERVICE_TO_KILL (PID: $PID_01)..."
    kill -1 "$PID_01"
else
