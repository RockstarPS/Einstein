...
echo options C_DEFINE_LIST WDG_PROXY_HEALTH_EVENT __linux__ >> commands.tmp
...
echo environment build WDG_PROXY_LINUX_UT.env >> commands.tmp
echo /E:WDG_PROXY_LINUX_UT tools script run WDG_PROXY_LINUX_UT.tst >> commands.tmp
echo /E:WDG_PROXY_LINUX_UT execute batch >> commands.tmp
echo /E:WDG_PROXY_LINUX_UT reports custom full WDG_PROXY_LINUX_UT_full_report.html >> commands.tmp
