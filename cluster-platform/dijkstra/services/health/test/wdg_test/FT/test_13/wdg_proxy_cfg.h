...
#define PROCESS_MONITOR_LIST_SIZE       (2U)

#define PROCESS_MONITOR_LIST    \
    /*Entity Name    HB Enabled    HB Low Miss Action   HB High Miss Action      Death Action        Restart Count*/ \
	{"test_13",       TRUE,        WP_ACTION_FATAL,     WP_ACTION_FATAL,      WP_ACTION_RESTART,        5},			 \
	{"test_13_1",     FALSE,       WP_ACTION_RESTART,   WP_ACTION_RESTART,    WP_ACTION_FATAL,          5}
