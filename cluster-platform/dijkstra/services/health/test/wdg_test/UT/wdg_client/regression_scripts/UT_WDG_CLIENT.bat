...
echo options C_DEFINE_LIST __QNX__ >> commands.tmp
...
echo environment build UT_WDG_CLIENT.env >> commands.tmp
echo /E:UT_WDG_CLIENT tools script run UT_WDG_CLIENT.tst >> commands.tmp
echo /E:UT_WDG_CLIENT execute batch >> commands.tmp
echo /E:UT_WDG_CLIENT reports custom full UT_WDG_CLIENT_full_report.html >> commands.tmp
