...
/* The following macro can be deleted once this file version has propagated
 * to all startup branches and conditional comp checks in that source have
 * been removed (2018/07/30).
 */
#define QTIME_HAS_TIMER_LOAD_HI
...
struct callout_entry {
	...
	union {
		...
		_SCPP32(_Uint64t, timer_value_64, (struct syspage_entry *, struct qtime_entry *));
	};
	union {
	...
	union {
		...
		_SCPP64(_Uint64t, timer_value_64, (struct syspage_entry *, struct qtime_entry *));
	};
	union {
	...
	union {
		_SCPP32(_Uint32t, custom, (struct syspage_entry *, _Uint32t, _Uint32t *));
		_SCPP64(_Uint64t, custom, (struct syspage_entry *, _Uint32t, _Uint64t *));
	};
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.1.0/trunk/services/system/public/sys/syspage.h $ $Rev: 932582 $")
#endif
