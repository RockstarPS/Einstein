...
// #define KEYCODE_HELP                                            (KEYCODE_CONSUMER_KEYS + 0xF2)
// #define KEYCODE_WIRELESS_RADIO_BUTTON                           (KEYCODE_CONSUMER_KEYS + 0xF3)
// #define KEYCODE_WIRELESS_RADIO_LED                              (KEYCODE_CONSUMER_KEYS + 0xF4)
// #define KEYCODE_WIRELESS_RADIO_SLIDER_SWITCH                    (KEYCODE_CONSUMER_KEYS + 0xF5)
// #define KEYCODE_DISPLAY_BRIGHTNESS_INCREMENT                    (KEYCODE_CONSUMER_KEYS + 0xF6)
// #define KEYCODE_DISPLAY_BRIGHTNESS_DECREMENT                    (KEYCODE_CONSUMER_KEYS + 0xF7)
// #define KEYCODE_DISPLAY_BRIGHTNESS                              (KEYCODE_CONSUMER_KEYS + 0xF8)
// #define KEYCODE_DISPLAY_BRIGHTNESS_TOGGLE                       (KEYCODE_CONSUMER_KEYS + 0xF9)
// #define KEYCODE_DISPLAY_SET_BRIGHTNESS_TO_MINIMUM               (KEYCODE_CONSUMER_KEYS + 0xFA)
// #define KEYCODE_DISPLAY_SET_BRIGHTNESS_TO_MAXIMUM               (KEYCODE_CONSUMER_KEYS + 0xFB)
// #define KEYCODE_DISPLAY_BRIGHTNESS_SET_AUTO_BRIGHTNESS          (KEYCODE_CONSUMER_KEYS + 0xFC)
...
// __SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.1.0/trunk/hardware/devi/public/sys/keycodes.h $ $Rev: 828697 $")
// #endif
