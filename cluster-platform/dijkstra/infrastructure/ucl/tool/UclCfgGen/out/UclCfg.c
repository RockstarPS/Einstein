...
///
/// Generated on 2019/06/26 12:11:13 by DMURUGE2
///---------------------------------------------------------------------------------------------------------------------
...
#define UCLALHWCBK_NUM_INSTANCES     (1u)
...
extern SUclALPhySpiASRCfg UclALPhyCfg_0;
...
static SUclALPhySpiASRInst UclALPhyInst_0 = {
	.pCfg = &UclALPhyCfg_0,
	.numIUclALPhyCbk = 1,
...
static Ucl_ReturnType UclALPhyInst_0_UclDLInst_0_IUclALPhy_Initialize(void) {return UclALPhySpiASR_Impl_IUclALPhy_Initialize(&UclALPhyInst_0, (0)); }
static Ucl_ReturnType UclALPhyInst_0_UclDLInst_0_IUclALPhy_Read(uint8 *pData, uint16 *pSize) { return UclALPhySpiASR_Impl_IUclALPhy_Read(&UclALPhyInst_0, (0), pData, pSize); }
static Ucl_ReturnType UclALPhyInst_0_UclDLInst_0_IUclALPhy_Shutdown(void) {return UclALPhySpiASR_Impl_IUclALPhy_Shutdown(&UclALPhyInst_0, (0)); }
static Ucl_ReturnType UclALPhyInst_0_UclDLInst_0_IUclALPhy_Write(uint8 *pData, uint16 size) { return UclALPhySpiASR_Impl_IUclALPhy_Write(&UclALPhyInst_0, (0), pData, size); }
...
static void UclDLInst_0_UclALPhyInst_0_IUclALPhyCbk_FatalError(uint8 status) { UclDL_Impl_IUclALPhyCbk_FatalError(&UclDLInst_0, (0), status); }
...
static void UclALPhyInst_0_DummyHw_IUclALHwCbk_TransmitComplete(void) {UclALPhySpiASR_Impl_IUclALHwCbk_TransmitComplete(&UclALPhyInst_0, (0)); }
static void UclALPhyInst_0_DummyHw_IUclALHwCbk_ReceiveComplete(void) {UclALPhySpiASR_Impl_IUclALHwCbk_ReceiveComplete(&UclALPhyInst_0, (0)); }
static void UclALPhyInst_0_DummyHw_IUclALHwCbk_GpioChanged(uint32 gpioNum) { UclALPhySpiASR_Impl_IUclALHwCbk_GpioChanged(&UclALPhyInst_0, (0), gpioNum); }

static const IUclALHwCbk UclALPhyInst_0_DummyHw_IUclALHwCbk = {
	&UclALPhyInst_0_DummyHw_IUclALHwCbk_TransmitComplete,
	&UclALPhyInst_0_DummyHw_IUclALHwCbk_ReceiveComplete,
	&UclALPhyInst_0_DummyHw_IUclALHwCbk_GpioChanged,
};
...
const IUclALHwCbk *UclALHwCbkObjs[1] = {
	&UclALPhyInst_0_DummyHw_IUclALHwCbk,
};
...
void UclALPhyCbk_FatalError(uint8 instId, uint8 status) { 
