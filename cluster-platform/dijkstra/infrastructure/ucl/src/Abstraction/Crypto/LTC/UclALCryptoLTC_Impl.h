...
/// @file
/// @ingroup UclALCrypto
/// UCL Crypto Abstraction Layer Implementation for LibTomCrypt library.
/// APIs in this file are not to called directly by the users
///
///---------------------------------------------------------------------------------------------------------------------
#ifndef UCLALCRYPTOLTC_IMPL_H
#define UCLALCRYPTOLTC_IMPL_H

#include "UclALCrypto_Types.h"
#include "tomcrypt.h"

typedef struct SUclALCryptoLTCInst_t SUclALCryptoLTCInst;

///
/// @brief Key structure declaration for SUclALCryptoLTC_Impl.
///
...
///
/// @brief Configuration data for SUclALCryptoLTC_Impl.
///
/// The SUclALCryptoLTCCfg structure defines the constant configuration data for SUclALCryptoLTC_Impl class.
///
typedef struct SUclALCryptoLTCCfg_t
{
...
///
/// @brief Private instance data for SUclALCryptoLTC_Impl. \n
/// @ingroup UclALCrypto
///
/// The SUclALCryptoLTCInst structure defines the private instance data for SUclALCryptoLTC_Impl class.
///
struct SUclALCryptoLTCInst_t
{
    const SUclALCryptoLTCCfg *pCfg; ///< Configuration for the SUclALCryptoLTC_Impl instance
    prng_state LTCprng_state;       ///< LTC PRNG State Variable
    omac_state LTCOmacState;        ///< LTC Omac State Variable
    symmetric_CBC LTCCbc;           ///< LTC CBC State Variable
