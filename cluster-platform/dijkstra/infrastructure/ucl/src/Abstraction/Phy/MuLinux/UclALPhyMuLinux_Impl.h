...
///
///---------------------------------------------------------------------------------------------------------------------
#ifndef UCLALPHY_MuLinuxIMPL
#define UCLALPHY_MuLinuxIMPL
...
///
/// @brief Configuration Structure for UclALPhyMuLinux_Impl
/// @ingroup UclALPhy
///
/// The SUclALPhyMuLinuxCfg structure defines the configuration
/// data for UclALPhyMuLinux class.
///
typedef struct
{
...
/// @ingroup UclALPhy
///
/// The SUclALPhyMuLinuxInst structure defines the instance
/// data for UclALPhyMuLinux class.
///
typedef struct
{
    const SUclALPhyMuLinuxCfg *pCfg; ///< Configuration for the UclALPhyMuLinux instance
...
} SUclALPhyMuLinuxInst;

///
/// @brief Function to Initialize the UclALPhyMuLinux class.
///
...
///
/// @brief Function to Shutdown the UclALPhyMuLinux class.
///
/// @param pInst  Instance Pointer.
/// @param InstId Instance ID of the caller
///
...
///
/// @brief Function to send data to the UclALPhyMuLinux class.
///
/// @param pInst  Instance Pointer.
/// @param InstId Instance ID of the caller
...
///
/// @brief Function to read data from the UclALPhyMuLinux class.
///
/// @param pInst  Instance Pointer.
/// @param InstId Instance ID of the caller
/// @param pData Pointer to the data buffer
