...
/// @ingroup UclALPhy
///
/// The SUclALPhyMuFreeRtosSlaveCfg structure defines the configuration
...
} SUclALPhyMuFreeRtosSlaveCfg;

///
/// @brief Configuration Structure for UclALPhyMuQnx_Impl
/// @ingroup UclALPhy
///
/// The SUclALPhyMuFreeRtosSlaveInst structure defines the instance
/// data for UclALPhyMuQnx class.
///
typedef struct
{
