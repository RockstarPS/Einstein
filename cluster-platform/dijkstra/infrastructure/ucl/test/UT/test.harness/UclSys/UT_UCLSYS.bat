...
echo options TESTABLE_SOURCE_DIR ..\..\..\..\src\System\UclSys\ >> commands.tmp
...
echo environment build UT_UCLSYS.env >> commands.tmp
echo /E:UT_UCLSYS tools script run UT_UCLSYS.tst >> commands.tmp
echo /E:UT_UCLSYS execute batch >> commands.tmp
echo /E:UT_UCLSYS reports custom full UT_UCLSYS_full_report.html >> commands.tmp
