...
echo environment build HT_UCLDL_IMPL.env >> commands.tmp
echo /E:HT_UCLDL_IMPL tools script run HT_UCLDL_IMPL.tst >> commands.tmp
echo /E:HT_UCLDL_IMPL execute batch >> commands.tmp
echo /E:HT_UCLDL_IMPL tools import_coverage HT_UCLDL_IMPL.cvr >> commands.tmp
echo /E:HT_UCLDL_IMPL reports custom full HT_UCLDL_IMPL_full_report.html >> commands.tmp
