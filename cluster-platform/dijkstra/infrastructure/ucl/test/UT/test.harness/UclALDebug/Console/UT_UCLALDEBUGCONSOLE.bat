...
echo options TESTABLE_SOURCE_DIR ..\..\..\..\..\src\Abstraction\Debug\Console\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR ..\..\..\..\..\src\Common\ >> commands.tmp
echo environment build UT_UCLALDEBUGCONSOLE.env >> commands.tmp
echo /E:UT_UCLALDEBUGCONSOLE tools script run UT_UCLALDEBUGCONSOLE.tst >> commands.tmp
echo /E:UT_UCLALDEBUGCONSOLE execute batch >> commands.tmp
echo /E:UT_UCLALDEBUGCONSOLE reports custom full UT_UCLALDEBUGCONSOLE_full_report.html >> commands.tmp
