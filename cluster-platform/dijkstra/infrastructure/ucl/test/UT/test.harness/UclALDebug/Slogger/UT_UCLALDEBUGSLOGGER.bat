...
echo options TESTABLE_SOURCE_DIR ..\..\..\..\..\src\Abstraction\Debug\Slogger\ >> commands.tmp
...
echo options TESTABLE_SOURCE_DIR ..\..\..\..\..\test\UT\test.harness\UclALDebug\Slogger\headers\ >> commands.tmp
echo environment build UT_UCLALDEBUGSLOGGER.env >> commands.tmp
echo /E:UT_UCLALDEBUGSLOGGER tools script run UT_UCLALDEBUGSLOGGER.tst >> commands.tmp
echo /E:UT_UCLALDEBUGSLOGGER execute batch >> commands.tmp
echo /E:UT_UCLALDEBUGSLOGGER reports custom full UT_UCLALDEBUGSLOGGER_full_report.html >> commands.tmp
