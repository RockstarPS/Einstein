...
echo options TESTABLE_SOURCE_DIR ..\..\..\..\..\src\Abstraction\Debug\SYSLOG\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR ..\..\..\..\..\src\Common\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR .\headers\ >> commands.tmp
echo environment build UT_SYSLOG.env >> commands.tmp
echo /E:UT_SYSLOG tools script run UT_SYSLOG.tst >> commands.tmp
echo /E:UT_SYSLOG execute batch >> commands.tmp
echo /E:UT_SYSLOG reports custom full UT_SYSLOG_full_report.html >> commands.tmp
