...
echo options TESTABLE_SOURCE_DIR ..\..\..\..\..\src\Abstraction\Debug\DLT\ >> commands.tmp
...
echo environment build UT_UCLALDEBUGDLT.env >> commands.tmp
echo /E:UT_UCLALDEBUGDLT tools script run UT_UCLALDEBUGDLT.tst >> commands.tmp
echo /E:UT_UCLALDEBUGDLT execute batch >> commands.tmp
echo /E:UT_UCLALDEBUGDLT reports custom full UT_UCLALDEBUGDLT_full_report.html >> commands.tmp
