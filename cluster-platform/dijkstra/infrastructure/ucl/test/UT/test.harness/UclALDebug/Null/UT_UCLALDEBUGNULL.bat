...
echo options TESTABLE_SOURCE_DIR ..\..\..\..\..\src\Abstraction\Debug\Null\ >> commands.tmp
...
echo environment build UT_UCLALDEBUGNULL.env >> commands.tmp
echo /E:UT_UCLALDEBUGNULL tools script run UT_UCLALDEBUGNULL.tst >> commands.tmp
echo /E:UT_UCLALDEBUGNULL execute batch >> commands.tmp
echo /E:UT_UCLALDEBUGNULL reports custom full UT_UCLALDEBUGNULL_full_report.html >> commands.tmp
