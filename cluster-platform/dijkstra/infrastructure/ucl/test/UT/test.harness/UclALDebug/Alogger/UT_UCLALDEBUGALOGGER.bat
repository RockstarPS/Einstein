...
echo options TESTABLE_SOURCE_DIR ..\..\..\..\..\src\Abstraction\Debug\Alogger\ >> commands.tmp
...
echo options TESTABLE_SOURCE_DIR ..\..\..\..\..\test\UT\test.harness\UclALDebug\Alogger\headers\ >> commands.tmp
echo environment build UT_UCLALDEBUGALOGGER.env >> commands.tmp
echo /E:UT_UCLALDEBUGALOGGER tools script run UT_UCLALDEBUGALOGGER.tst >> commands.tmp
echo /E:UT_UCLALDEBUGALOGGER execute batch >> commands.tmp
echo /E:UT_UCLALDEBUGALOGGER reports custom full UT_UCLALDEBUGALOGGER_full_report.html >> commands.tmp
