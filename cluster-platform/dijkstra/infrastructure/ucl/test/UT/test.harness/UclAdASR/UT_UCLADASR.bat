...
echo options TESTABLE_SOURCE_DIR ..\..\..\..\test\UT\test.harness\UclAdASR\headers\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR ..\..\..\..\src\Adapters\ASR\ >> commands.tmp
echo environment build UT_UCLADASR.env >> commands.tmp
echo /E:UT_UCLADASR tools script run UT_UCLADASR.tst >> commands.tmp
echo /E:UT_UCLADASR execute batch >> commands.tmp
echo /E:UT_UCLADASR reports custom full UT_UCLADASR_full_report.html >> commands.tmp
