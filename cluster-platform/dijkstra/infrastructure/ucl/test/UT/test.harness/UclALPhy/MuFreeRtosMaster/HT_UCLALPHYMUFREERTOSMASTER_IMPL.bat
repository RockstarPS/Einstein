...
echo options VCAST_CLASS_INST_SHARING TRUE >> commands.tmp
...
echo options VCAST_TYPEOF_OPERATOR FALSE >> commands.tmp
echo options WHITEBOX YES >> commands.tmp
echo clear_default_source_dirs  >> commands.tmp
echo options TESTABLE_SOURCE_DIR ..\..\..\..\..\src\Abstraction\Phy\MuFreeRtosMaster\ >> commands.tmp
...
echo environment build HT_UCLALPHYMUFREERTOSMASTER_IMPL.env >> commands.tmp\ >> commands.tmp
echo /E:HT_UCLALPHYMUFREERTOSMASTER_IMPL tools script run HT_UCLALPHYMUFREERTOSMASTER_IMPL.tst >> commands.tmp
echo /E:HT_UCLALPHYMUFREERTOSMASTER_IMPL execute batch >> commands.tmp
echo /E:HT_UCLALPHYMUFREERTOSMASTER_IMPL reports custom full HT_UCLALPHYMUFREERTOSMASTER_IMPL_full_report.html >> commands.tmp
