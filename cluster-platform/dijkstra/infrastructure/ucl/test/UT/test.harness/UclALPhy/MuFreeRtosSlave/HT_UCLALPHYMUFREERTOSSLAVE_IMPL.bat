...
echo options TESTABLE_SOURCE_DIR ..\..\..\..\..\src\Abstraction\Phy\MuFreeRtosSlave\ >> commands.tmp
echo environment build HT_UCLALPHYMUFREERTOSSLAVE_IMPL.env >> commands.tmp
echo /E:HT_UCLALPHYMUFREERTOSSLAVE_IMPL tools script run HT_UCLALPHYMUFREERTOSSLAVE_IMPL.tst >> commands.tmp
echo /E:HT_UCLALPHYMUFREERTOSSLAVE_IMPL execute batch >> commands.tmp
echo /E:HT_UCLALPHYMUFREERTOSSLAVE_IMPL reports custom full HT_UCLALPHYMUFREERTOSSLAVE_IMPL_full_report.html >> commands.tmp
