...
#endif
#ifndef inde16
#define inde16(__port)             (ENDIAN_DE16(in16((__port))))
#endif
#ifndef inde32
#define inde32(__port)             (ENDIAN_DE32(in32((__port))))
#endif
#ifndef outle16
...
#endif
#ifndef outde16
#define outde16(__port, __val)     (out16((__port), ENDIAN_DE16((__val))))
#endif
#ifndef outde32
#define outde32(__port, __val)     (out32((__port), ENDIAN_DE32((__val))))
#endif
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/lib/c/public/hw/inout.h $ $Rev: 780356 $")
#endif
