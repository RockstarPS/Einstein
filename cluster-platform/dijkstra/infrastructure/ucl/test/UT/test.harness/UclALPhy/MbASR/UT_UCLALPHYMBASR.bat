...
echo options TESTABLE_SOURCE_DIR ..\..\..\..\..\src\DataLayer\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR ..\..\..\..\..\src\Abstraction\Phy\MailboxASR\ >> commands.tmp
echo environment build UT_UCLALPHYMBASR.env >> commands.tmp
echo /E:UT_UCLALPHYMBASR tools script run UT_UCLALPHYMBASR.tst >> commands.tmp
echo /E:UT_UCLALPHYMBASR execute batch >> commands.tmp
echo /E:UT_UCLALPHYMBASR reports custom full UT_UCLALPHYMBASR_full_report.html >> commands.tmp
