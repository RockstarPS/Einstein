/**
*   @file           Compiler.h
*   @implements     Compiler_h_Artifact
*   @version 1.0.1
*
...
*   SW Version           : 1.0.1
*   Build Version        : IMX8_MCAL_1_0_1_RTM_ASR_REL_4_2_REV_0002_20180917
*
...
#endif /* #ifdef _GREENHILLS_C_IMX8QXP_ */

/**************************************** Wind River Diab *****************************************/
#ifdef _DIABDATA_C_IMX8QXP_
    /* Prototypes for intrinsic functions */
    /**
...
#endif /* #ifdef _DIABDATA_C_IMX8QXP_ */

/*************************************** CodeWarrior **********************************************/
#ifdef _CODEWARRIOR_C_IMX8QXP_
    /* Prototypes for intrinsic functions */
    /**
    * @brief The compiler abstraction shall provide the INLINE define for abstraction of the keyword
    *        inline.
 ...
 #endif /* #ifdef _CODEWARRIOR_C_IMX8QXP_ */

/*************************************** Cosmic ***************************************************/
#ifdef _COSMIC_C_IMX8QXP_
    /* Prototypes for intrinsic functions */
    /**
    * @brief The compiler abstraction shall provide the INLINE define for abstraction of the keyword
    *        inline.
...
#endif /* #ifdef _COSMIC_C_IMX8QXP_ */
/*************************************** HighTec **********************************************/
#ifdef _HITECH_C_IMX8QXP_
    /* Prototypes for intrinsic functions */
    /**
    * @brief The compiler abstraction shall provide the INLINE define for abstraction of the keyword
    *        inline.
...
#endif /* #ifdef _HITECH_C_IMX8QXP_ */

/**************************************** Gcc *********************************************/
#ifdef _GCC_C_IMX8QXP_
    /* Prototypes for intrinsic functions */
    /**
    * @brief The compiler abstraction shall provide the INLINE define for abstraction of the keyword
    *        inline.
...
#endif /* #ifdef _GCC_C_IMX8QXP_ */
/**************************************** DS5 *************************************************/
#ifdef _ARM_DS5_C_IMX8QXP_
    /* Prototypes for intrinsic functions */
    /**
    * @brief The compiler abstraction shall provide the INLINE define for abstraction of the keyword
    *        inline.
  ...
  /*
    ...
    */        
    #define INTERRUPT_FUNC
#endif /* #ifdef _ARM_DS5_C_IMX8QXP_ */

/**************************************** IAR *************************************************/
#ifdef _IAR_C_IMX8QXP_
    /* Prototypes for intrinsic functions */
    /**
    * @brief The compiler abstraction shall provide the INLINE define for abstraction of the keyword
    *        inline.
