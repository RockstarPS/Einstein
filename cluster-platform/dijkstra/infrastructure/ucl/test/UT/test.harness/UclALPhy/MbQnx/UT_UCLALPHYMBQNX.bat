...
echo options TESTABLE_SOURCE_DIR ..\..\..\..\..\src\Abstraction\Phy\MailboxQnx\ >> commands.tmp
...
echo environment build UT_UCLALPHYMBQNX.env >> commands.tmp
echo /E:UT_UCLALPHYMBQNX tools script run UT_UCLALPHYMBQNX.tst >> commands.tmp
echo /E:UT_UCLALPHYMBQNX execute batch >> commands.tmp
echo /E:UT_UCLALPHYMBQNX reports custom full UT_UCLALPHYMBQNX_full_report.html >> commands.tmp
