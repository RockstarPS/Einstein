...
echo options TESTABLE_SOURCE_DIR ..\..\..\..\..\src\Abstraction\Phy\MuLinux\ >> commands.tmp
echo environment build HT_UCLALPHYMULINUX_IMPL.env >> commands.tmp
echo /E:HT_UCLALPHYMULINUX_IMPL tools script run HT_UCLALPHYMULINUX_IMPL.tst >> commands.tmp
echo /E:HT_UCLALPHYMULINUX_IMPL execute batch >> commands.tmp
echo /E:HT_UCLALPHYMULINUX_IMPL reports custom full HT_UCLALPHYMULINUX_IMPL_full_report.html >> commands.tmp
