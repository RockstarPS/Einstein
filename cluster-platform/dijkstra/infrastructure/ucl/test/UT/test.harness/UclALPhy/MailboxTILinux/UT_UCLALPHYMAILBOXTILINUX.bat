...
echo options TESTABLE_SOURCE_DIR ..\..\..\..\..\src\Abstraction\Phy\MailboxTILinux\ >> commands.tmp
...
echo options TESTABLE_SOURCE_DIR .\header\ >> commands.tmp
echo environment build UT_UCLALPHYMAILBOXTILINUX.env >> commands.tmp
echo /E:UT_UCLALPHYMAILBOXTILINUX tools script run UT_UCLALPHYMAILBOXTILINUX.tst >> commands.tmp
echo /E:UT_UCLALPHYMAILBOXTILINUX execute batch >> commands.tmp
echo /E:UT_UCLALPHYMAILBOXTILINUX reports custom full UT_UCLALPHYMAILBOXTILINUX_full_report.html >> commands.tmp
