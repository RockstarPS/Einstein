...
echo options TESTABLE_SOURCE_DIR ..\..\..\..\..\src\Abstraction\Phy\MuQnx\ >> commands.tmp
...
echo options TESTABLE_SOURCE_DIR ..\..\..\..\..\test\UT\test.harness\UclALPhy\MuQNX\headers\ >> commands.tmp
echo environment build HT_UCLALPHYMUQNX_IMPL.env >> commands.tmp
echo /E:HT_UCLALPHYMUQNX_IMPL tools script run HT_UCLALPHYMUQNX_IMPL.tst >> commands.tmp
echo /E:HT_UCLALPHYMUQNX_IMPL execute batch >> commands.tmp
echo /E:HT_UCLALPHYMUQNX_IMPL reports custom full HT_UCLALPHYMUQNX_IMPL_full_report.html >> commands.tmp
