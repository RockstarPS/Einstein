...
echo options TESTABLE_SOURCE_DIR ..\..\..\..\..\src\Abstraction\Phy\SerialPOSIX\ >> commands.tmp
...
echo environment build HT_UCLALPHYSERIALPOSIX_IMPL.env >> commands.tmp
echo /E:HT_UCLALPHYSERIALPOSIX_IMPL tools script run HT_UCLALPHYSERIALPOSIX_IMPL.tst >> commands.tmp
echo /E:HT_UCLALPHYSERIALPOSIX_IMPL execute batch >> commands.tmp
echo /E:HT_UCLALPHYSERIALPOSIX_IMPL reports custom full HT_UCLALPHYSERIALPOSIX_IMPL_full_report.html >> commands.tmp
