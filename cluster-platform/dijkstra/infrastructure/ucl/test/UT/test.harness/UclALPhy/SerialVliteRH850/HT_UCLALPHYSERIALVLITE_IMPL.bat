...
echo options TESTABLE_SOURCE_DIR ..\..\..\..\..\src\Abstraction\Phy\SerialVliteRH850\ >> commands.tmp
...
echo environment build HT_UCLALPHYSERIALVLITE_IMPL.env >> commands.tmp
echo /E:HT_UCLALPHYSERIALVLITE_IMPL tools script run HT_UCLALPHYSERIALVLITE_IMPL.tst >> commands.tmp
echo /E:HT_UCLALPHYSERIALVLITE_IMPL execute batch >> commands.tmp
echo /E:HT_UCLALPHYSERIALVLITE_IMPL reports custom full HT_UCLALPHYSERIALVLITE_IMPL_full_report.html >> commands.tmp
