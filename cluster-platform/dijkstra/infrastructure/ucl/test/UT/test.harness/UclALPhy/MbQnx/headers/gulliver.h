...
#define ENDIAN_RET16(__x)		(_Uint16t)__builtin_bswap16(__x)
#else
#define ENDIAN_RET16(__x)		(_Uint16t)((((__x) >> 8) & 0xff) | \
											(((__x) & 0xff) << 8))
#endif
...
#elif defined(__GNUC__) && (__GNUC__ >= 5)
#define ENDIAN_RET32(__x)		(_Uint32t)__builtin_bswap32(__x)
#else
#define ENDIAN_RET32(__x)		(_Uint32t)((((__x) >> 24) & 0xff) | \
											(((__x) >> 8) & 0xff00) | \
											(((__x) & 0xff00) << 8) | \
											(((__x) & 0xff) << 24))
#endif
...
#elif defined(__GNUC__) && (__GNUC__ >= 5)
#define ENDIAN_RET64(__x)		(_Uint64t)__builtin_bswap64(__x)
#else
#define ENDIAN_RET64(__x)		(_Uint64t)((((__x) >> 56) & 0xffull) | \
											(((__x) >> 40) & 0xff00ull) | \
											(((__x) >> 24) & 0xff0000ull) | \
											(((__x) >>  8) & 0xff000000ull) | \
											(((__x) & 0xff000000ull) <<  8) | \
...
#else
#define ENDIAN_SWAP16(__x)		(*(_Uint16t *)(__x) = (_Uint16t)ENDIAN_RET16(*(_Uint16t *)(__x)))
#endif
...
#define ENDIAN_LE16(__x)		((_Uint16t)(__x))
#define ENDIAN_LE32(__x)		((_Uint32t)(__x))
#define ENDIAN_LE64(__x)		((_Uint64t)(__x))
#define ENDIAN_BE16(__x)		((_Uint16t)(ENDIAN_RET16(__x)))
#define ENDIAN_BE32(__x)		((_Uint32t)(ENDIAN_RET32(__x)))
#define ENDIAN_BE64(__x)		((_Uint64t)(ENDIAN_RET64(__x)))
...
#define ENDIAN_LE16(__x)		((_Uint16t)(ENDIAN_RET16(__x)))
#define ENDIAN_LE32(__x)		((_Uint32t)(ENDIAN_RET32(__x)))
#define ENDIAN_LE64(__x)		((_Uint64t)(ENDIAN_RET64(__x)))
#define ENDIAN_BE16(__x)		((_Uint16t)(__x))
#define ENDIAN_BE32(__x)		((_Uint32t)(__x))
#define ENDIAN_BE64(__x)		((_Uint64t)(__x))
...
#ifndef __CPU_UNALIGNED_RET32
#define UNALIGNED_RET32(__p)	((unsigned)(((_Uint8t volatile *)(__p))[0] << 24) | \
...
#define ENDIAN_DE16(__x)		ENDIAN_RET16(__x)
#define ENDIAN_DE32(__x)		ENDIAN_RET32(__x)
#define ENDIAN_DE64(__x)		ENDIAN_RET64(__x)
#else
#define ENDIAN_DE16(__x)		(__x)
#define ENDIAN_DE32(__x)		(__x)
#define ENDIAN_DE64(__x)		(__x)
#endif
...
struct _debug_thread_info64;
struct _debug_channel;
struct _debug_irq64;
struct _debug_timer64;
...
extern void __swap_siginfo_sized(struct _siginfo * __sinfo, int __64bit);
extern void __swap_siginfo(struct _siginfo * __sinfo);
extern void __swap_timerinfo_sized(struct _timer_info * __tinfo, int __64bit);
extern void __swap_timerinfo(struct _timer_info * __tinfo);
extern int  __swap_stat(int __format, void * __statp);


void __swap_procfs_info(struct _debug_process_info * __info);
void __swap_procfs_mapinfo(struct _procfs_map_info * __minfo);
void __swap_procfs_status_sized(struct _debug_thread_info64 * __status, int __64bit);
void __swap_procfs_status(struct _debug_thread_info64 * __status);
void __swap_procfs_channel(struct _debug_channel * __chan);
void __swap_procfs_irq_sized(struct _debug_irq64 * __irq, int __64bit);
void __swap_procfs_irq(struct _debug_irq64 * __irq);
void __swap_procfs_timer_sized(struct _debug_timer64 * __timer, int __64bit);
void __swap_procfs_timer(struct _debug_timer64 * __timer);
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.1.0/trunk/lib/c/public/gulliver.h $ $Rev: 853312 $")
#endif
