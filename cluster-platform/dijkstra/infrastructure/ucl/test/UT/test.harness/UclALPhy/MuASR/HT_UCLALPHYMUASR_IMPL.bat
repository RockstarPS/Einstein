...
echo options TESTABLE_SOURCE_DIR ..\..\..\..\..\src\Abstraction\Phy\MuASR\ >> commands.tmp
...
echo environment build HT_UCLALPHYMUASR_IMPL.env >> commands.tmp
echo /E:HT_UCLALPHYMUASR_IMPL tools script run HT_UCLALPHYMUASR_IMPL.tst >> commands.tmp
echo /E:HT_UCLALPHYMUASR_IMPL execute batch >> commands.tmp
echo /E:HT_UCLALPHYMUASR_IMPL reports custom full HT_UCLALPHYMUASR_IMPL_full_report.html >> commands.tmp
