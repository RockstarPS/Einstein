...
echo options TESTABLE_SOURCE_DIR ..\..\..\..\..\src\Abstraction\Phy\SerialASR\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR ..\..\..\..\..\src\DataLayer\UclDL\ >> commands.tmp
...
echo environment build HT_UCLALPHYSERIALASR_IMPL.env >> commands.tmp
echo /E:HT_UCLALPHYSERIALASR_IMPL tools script run HT_UCLALPHYSERIALASR_IMPL.tst >> commands.tmp
echo /E:HT_UCLALPHYSERIALASR_IMPL execute batch >> commands.tmp
echo /E:HT_UCLALPHYSERIALASR_IMPL reports custom full HT_UCLALPHYSERIALASR_IMPL_full_report.html >> commands.tmp
