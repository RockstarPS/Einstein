...
echo options TESTABLE_SOURCE_DIR ..\..\..\..\src\InterfaceLayer\UclILSched\ >> commands.tmp
...
echo options TESTABLE_SOURCE_DIR ..\..\..\..\src\InterfaceLayer\UclILRouter\ >> commands.tmp
...
echo environment build HT_UCLILSCHED_IMPL.env >> commands.tmp
echo /E:HT_UCLILSCHED_IMPL tools script run HT_UCLILSCHED_IMPL.tst >> commands.tmp
echo /E:HT_UCLILSCHED_IMPL execute batch >> commands.tmp
echo /E:HT_UCLILSCHED_IMPL tools import_coverage HT_UCLILSCHED_IMPL.cvr >> commands.tmp
echo /E:HT_UCLILSCHED_IMPL reports custom full HT_UCLILSCHED_IMPL_full_report.html >> commands.tmp
