...
echo options TESTABLE_SOURCE_DIR ..\..\..\..\src\Adapters\SOMEIP\ >> commands.tmp
...
echo environment build UT_UCL_ADAPTOR_SOMEIP.env >> commands.tmp
echo /E:UT_UCL_ADAPTOR_SOMEIP tools script run UT_UCL_ADAPTOR_SOMEIP.tst >> commands.tmp
echo /E:UT_UCL_ADAPTOR_SOMEIP execute batch >> commands.tmp
echo /E:UT_UCL_ADAPTOR_SOMEIP tools import_coverage UT_UCL_ADAPTOR_SOMEIP.cvr >> commands.tmp
echo /E:UT_UCL_ADAPTOR_SOMEIP reports custom full UT_UCL_ADAPTOR_SOMEIP_full_report.html >> commands.tmp
