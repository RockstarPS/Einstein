...
echo options TESTABLE_SOURCE_DIR C:\Users\ssrini28\Documents\ucl_dijkstra\ucl\test\UT\test.harness\Common\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR C:\Users\ssrini28\Documents\ucl_dijkstra\ucl\src\Common\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR C:\Users\ssrini28\Documents\ucl_dijkstra\ucl\src\Abstraction\Common\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR C:\Users\ssrini28\Documents\ucl_dijkstra\ucl\src\Abstraction\Os\Vlite\ >> commands.tmp
echo environment build UCLALOSVLITE_UT.env >> commands.tmp
echo /E:UCLALOSVLITE_UT tools script run UCLALOSVLITE_UT.tst >> commands.tmp
echo /E:UCLALOSVLITE_UT execute batch >> commands.tmp
echo /E:UCLALOSVLITE_UT tools import_coverage UCLALOSVLITE_UT.cvr >> commands.tmp
echo /E:UCLALOSVLITE_UT reports custom full UCLALOSVLITE_UT_full_report.html >> commands.tmp
