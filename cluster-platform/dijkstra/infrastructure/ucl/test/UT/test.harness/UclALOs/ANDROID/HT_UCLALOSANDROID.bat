...
echo options TESTABLE_SOURCE_DIR ..\..\..\..\..\src\Abstraction\Os\Android\ >> commands.tmp
...
echo environment build HT_UCLALOSANDROID.env >> commands.tmp
echo /E:HT_UCLALOSANDROID tools script run HT_UCLALOSANDROID.tst >> commands.tmp
echo /E:HT_UCLALOSANDROID execute batch >> commands.tmp
echo /E:HT_UCLALOSANDROID tools import_coverage HT_UCLALOSANDROID.cvr >> commands.tmp
echo /E:HT_UCLALOSANDROID reports custom full HT_UCLALOSANDROID_full_report.html >> commands.tmp
