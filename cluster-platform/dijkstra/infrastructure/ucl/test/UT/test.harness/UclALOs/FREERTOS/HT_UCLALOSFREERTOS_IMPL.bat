...
echo environment build HT_UCLALOSFREERTOS_IMPL.env >> commands.tmp
echo /E:HT_UCLALOSFREERTOS_IMPL tools script run HT_UCLALOSFREERTOS_IMPL.tst >> commands.tmp
echo /E:HT_UCLALOSFREERTOS_IMPL execute batch >> commands.tmp
echo /E:HT_UCLALOSFREERTOS_IMPL reports custom full HT_UCLALOSFREERTOS_IMPL_full_report.html >> commands.tmp
