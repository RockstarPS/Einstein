...
echo options TESTABLE_SOURCE_DIR ..\..\..\..\..\src\Abstraction\Os\ASR\ >> commands.tmp
...
echo environment build HT_UCLALOSASR_IMPL.env >> commands.tmp
echo /E:HT_UCLALOSASR_IMPL tools script run HT_UCLALOSASR_IMPL.tst >> commands.tmp
echo /E:HT_UCLALOSASR_IMPL execute batch >> commands.tmp
echo /E:HT_UCLALOSASR_IMPL reports custom full HT_UCLALOSASR_IMPL_full_report.html >> commands.tmp
