...
echo options TESTABLE_SOURCE_DIR ..\..\..\..\..\src\Abstraction\Os\POSIX\ >> commands.tmp
...
echo environment build HT_UCLALOSPOSIX_IMPL.env >> commands.tmp
echo /E:HT_UCLALOSPOSIX_IMPL tools script run HT_UCLALOSPOSIX_IMPL.tst >> commands.tmp
echo /E:HT_UCLALOSPOSIX_IMPL execute batch >> commands.tmp
echo /E:HT_UCLALOSPOSIX_IMPL tools import_coverage HT_UCLALOSPOSIX_IMPL.cvr >> commands.tmp
echo /E:HT_UCLALOSPOSIX_IMPL reports custom full HT_UCLALOSPOSIX_IMPL_full_report.html >> commands.tmp
