...
echo options TESTABLE_SOURCE_DIR ..\..\..\..\src\System\UclSysDL\ >> commands.tmp
...
echo environment build UT_UCLSYSDL.env >> commands.tmp
echo /E:UT_UCLSYSDL tools script run UT_UCLSYSDL.tst >> commands.tmp
echo /E:UT_UCLSYSDL execute batch >> commands.tmp
echo /E:UT_UCLSYSDL reports custom full UT_UCLSYSDL_full_report.html >> commands.tmp
