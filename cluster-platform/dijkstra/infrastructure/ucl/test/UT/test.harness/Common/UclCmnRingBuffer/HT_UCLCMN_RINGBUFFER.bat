...
echo environment build HT_UCLCMN_RINGBUFFER.env >> commands.tmp
echo /E:HT_UCLCMN_RINGBUFFER tools script run HT_UCLCMN_RINGBUFFER.tst >> commands.tmp
echo /E:HT_UCLCMN_RINGBUFFER execute batch >> commands.tmp
echo /E:HT_UCLCMN_RINGBUFFER reports custom full HT_UCLCMN_RINGBUFFER_full_report.html >> commands.tmp
