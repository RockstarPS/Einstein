...
echo environment build HT_UCLVMFMSGQUEUE.env >> commands.tmp
echo /E:HT_UCLVMFMSGQUEUE tools script run HT_UCLVMFMSGQUEUE.tst >> commands.tmp
echo /E:HT_UCLVMFMSGQUEUE execute batch >> commands.tmp
echo /E:HT_UCLVMFMSGQUEUE reports custom full HT_UCLVMFMSGQUEUE_full_report.html >> commands.tmp
