...
echo environment build HT_UCLCMN_UCLCRC.env >> commands.tmp
echo /E:HT_UCLCMN_UCLCRC tools script run HT_UCLCMN_UCLCRC.tst >> commands.tmp
echo /E:HT_UCLCMN_UCLCRC execute batch >> commands.tmp
echo /E:HT_UCLCMN_UCLCRC reports custom full HT_UCLCMN_UCLCRC_full_report.html >> commands.tmp
