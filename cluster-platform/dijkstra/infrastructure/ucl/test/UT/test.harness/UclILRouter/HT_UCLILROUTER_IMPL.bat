...
echo environment build HT_UCLILROUTER_IMPL.env >> commands.tmp
echo /E:HT_UCLILROUTER_IMPL tools script run HT_UCLILROUTER_IMPL.tst >> commands.tmp
echo /E:HT_UCLILROUTER_IMPL execute batch >> commands.tmp
echo /E:HT_UCLILROUTER_IMPL reports custom full HT_UCLILROUTER_IMPL_full_report.html >> commands.tmp
