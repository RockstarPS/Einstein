...
#define MAX_DEBUG_MSG_SIZE  400
    ...
    /*******************************************************************************/
    #define NW_VMF_DEBUG_PRINT(_aspect_, _level_, args...)     (void)fprintf (ERROR_CHANNEL, args); (void)fprintf(ERROR_CHANNEL, "\n")
    /*******************************************************************************/
#else
    /*******************************************************************************/
    /*! \def NW_VMF_DEBUG_PRINT
    ...
    /*******************************************************************************/
    #define NW_VMF_DEBUG_PRINT(_aspect_, _level_,args...)    
    /*******************************************************************************/
#endif
...
/*******************************************************************************/
#define NW_VMF_DEBUG_INFO(args...)            (void)fprintf (ERROR_CHANNEL, args); (void)fprintf(ERROR_CHANNEL, "\n");
/*******************************************************************************/
...
/*******************************************************************************/
 #define NW_VMF_DEBUG_ERROR(args...)          (void)fprintf(ERROR_CHANNEL, args); (void)fprintf(ERROR_CHANNEL, "\n");
/*******************************************************************************/
...
/*******************************************************************************/
/*! \def SYSLOG_PRIO_WARNING

    Syslog priority for debug output. \n\n */
/*******************************************************************************/
#define SYSLOG_PRIO_WARNING     (LOG_USER | LOG_WARNING)


/*******************************************************************************/
/*! \def SYSLOG_PRIO_ERROR

    Syslog priority for error output. \n\n */
/*******************************************************************************/
#define SYSLOG_PRIO_ERROR       (LOG_USER | LOG_ERR)


/*******************************************************************************/
/*! \def _NW_VMF_DEBUG_SYSLOG_ERROR

    Debug error via syslog. \n\n
    NOTE: DO NOT USE it's private! */
/*******************************************************************************/
#define _NW_VMF_DEBUG_SYSLOG_ERROR(args...)                                     \
                            {                                                   \
                                char ch_tmp[MAX_DEBUG_MSG_SIZE+1];              \
                                snprintf (ch_tmp, MAX_DEBUG_MSG_SIZE,args);     \
                                nw_vmf_debug_syslog(SYSLOG_PRIO_ERROR, ch_tmp); \
                                delay(10);                                      \
                            }


/*******************************************************************************/
/*! \def _NW_VMF_DEBUG_SYSLOG_INFO

    Debug output via syslog. \n\n
    NOTE: DO NOT USE it's private! */
/*******************************************************************************/
#define _NW_VMF_DEBUG_SYSLOG_INFO(args...)                                        \
                            {                                                     \
                                char ch_tmp[MAX_DEBUG_MSG_SIZE+1];                \
                                snprintf (ch_tmp, MAX_DEBUG_MSG_SIZE,args);       \
                                nw_vmf_debug_syslog(SYSLOG_PRIO_WARNING, ch_tmp); \
                            }


/* function prototypes */
bool        nw_vmf_debug_syslog     (unsigned int uPri,char *pstrMsg);
void        nw_con_HexDump          (char * name,unsigned8 *buffer,int len);
unsigned32  nw_tardis_get_ms_time   (void);
