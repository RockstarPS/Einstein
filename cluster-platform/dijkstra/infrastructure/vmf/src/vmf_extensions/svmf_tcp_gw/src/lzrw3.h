...
#define _LZRW3_H
/*
 * $Source: /home/u1/kartik/CVSROOT/irs/linux.irs/drivers/char/ftape/compressor/lzrw3.h,v $
 * $Revision: 1.1.1.1 $
...
/******************************************************************************/
      ...
      #ifdef __MINGW32__
      #include "os_types.h"
      typedef unsigned8   __u8;
      typedef unsigned16  __u16;
      typedef unsigned32  __u32;
      typedef signed8     __s8;
      typedef signed16    __s16;
      typedef signed32    __s32;						
	  typedef bool        BOOL;

      #define TRUE  true
      #define FALSE false
      
      #define UBYTE unsigned8	       	/* Unsigned byte                       	*/
      #define UWORD unsigned16       	/* Unsigned word (2 bytes)             	*/
      #define ULONG unsigned32      	/* Unsigned word (4 bytes)             	*/
      #define LONG  signed32      		/* Unsigned word (4 bytes)             	*/
