...
*  remote vmf config                    *
******************************************************************************/
#ifndef __REM_VMF_CLIENT_CFG_H
#define __REM_VMF_CLIENT_CFG_H

#define VMF_RPC_MAX_SERVER_CONNECTIONS (20)
#define VMF_RPC_SERVER_PORT	(5432)
#define VMF_RPC_SERVER_IP	"192.168.1.11"
