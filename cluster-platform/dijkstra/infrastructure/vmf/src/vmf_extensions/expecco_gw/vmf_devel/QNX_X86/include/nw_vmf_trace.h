...
/* trace macros */
    ...
    #define VMF_TRACE_SET_SEVERITY(a,b)         		vmf_trace_set_severity(a,b)
        ...
        #define VMF_TRACE_PRINTF(a,b,c,d,e,args...) 
...
DLL_EXPORT  vmf_ret_t   vmf_trace_register    (unsigned8 *trid,const char *trid_name);
...
DLL_EXPORT  vmf_ret_t   vmf_trace_printf      (unsigned8 trid,unsigned8 severity,const char *task,const char *scope,const char *__format, ... );
