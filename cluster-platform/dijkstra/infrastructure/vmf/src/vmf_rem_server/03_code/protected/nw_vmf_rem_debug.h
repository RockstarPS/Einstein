...
#ifdef VMF_TRACE
#define VMF_REM_SERVER_TRACE_PRINT(trid, severity, task, scope, msg)        (void)VMF_TRACE_PRINT(trid, severity, task, scope, msg)
#define VMF_REM_SERVER_TRACE_PRINTF(trid, severity, task, scope, msg,...)   (void)VMF_TRACE_PRINTF(trid, severity, task, scope, msg,##__VA_ARGS__)
#else
#define VMF_REM_SERVER_TRACE_PRINT(trid, severity, task, scope, msg)        
#define VMF_REM_SERVER_TRACE_PRINTF(trid, severity, task, scope, msg,...)   
#endif
    ...
    #define NW_VMF_DEBUG_ERROR              NW_REM_VMF_DEBUG_ERROR
        ...
        #define NW_REM_VMF_DEBUG_INFO2(args...)     printf("vmf_remote: info2: ");printf(args);printf("\n");fflush(ERROR_CHANNEL);
    #else
        #define NW_REM_VMF_DEBUG_ERROR(args...)     // printf("vmf_remote: error: ");printf(args);printf("\n");fflush(ERROR_CHANNEL);
        #define NW_REM_VMF_DEBUG_PRINTF(args...)    // printf("vmf_remote: info:  ");printf(args);printf("\n");fflush(ERROR_CHANNEL);
        #define NW_REM_VMF_DEBUG_INFO(args...)      // printf("vmf_remote: info:  ");printf(args);printf("\n");fflush(ERROR_CHANNEL);
        #define NW_REM_VMF_DEBUG_INFO2(args...)     // printf("vmf_remote: info:  ");printf(args);printf("\n");fflush(ERROR_CHANNEL);
    #endif
