...
VMF_REM_SERVER_PUBLIC_INC		= -I$(VMF_REM_SERVER_DIR)/03_code/public
VMF_REM_SERVER_PROTECTED_INC	= -I$(VMF_REM_SERVER_DIR)/03_code/protected
VMF_REM_CLIENT_PROTECTED_INC	= -I$(VMF_REM_CLIENT_DIR)/03_code/protected
...
$(VMF_REM_SERVER_OBJS): $(VMF_REM_SERVER_DIR)/03_code/build/vmf_rem_server.mk

#--------------------------------------------------------------
#						VMF remote server Rules
#--------------------------------------------------------------

$(VMF_REM_SERVER_OBJ_DIR)/%.o: $(VMF_REM_SERVER_DIR)/03_code/src/%.c
	$(ECHO_COMPILING)
