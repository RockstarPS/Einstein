...
NW_CONFIG_SHM_OBJS = $(NW_CONFIG_OBJ_DIR)/shm_area.o

nw_config_clean:
	$(RM) $(NW_CONFIG_OBJ_DIR) $(NW_CONFIG_OBJS) $(NW_CONFIG_SHM_OBJS)

nw_config: nw_config_obj_dir $(NW_CONFIG_OBJS) $(NW_CONFIG_SHM_OBJS)
...
$(NW_CONFIG_SHM_OBJS): $(NETWORK_CONFIG_DIR)/03_code/build/nw_os_config.mk
...
$(NW_CONFIG_OBJ_DIR)/%.o: $(NETWORK_CONFIG_DIR)/03_code/src/%.c
	$(ECHO_COMPILING)
	$(QCC_COMPILER) -fPIC $(NETWORK_PUBLIC_INC) $(CCINC) $(OTF_ENABLE) $(GCOV) -Wp,-MD,$(@:.o=.p) -o $@ $<
	$(FIXDEP)
	$(ECHO_QACING)
