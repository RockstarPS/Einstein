...
extern void          nw_vmf_routing_db_clear();
extern vmf_ret_t     nw_vmf_routing_db_event_register(vmf_handle_t, unsigned8 GroupID);
extern void          nw_vmf_routing_db_event_deregister(vmf_handle_t, unsigned8 GroupID);
...
extern vmf_ret_t     nw_vmf_routing_db_get_handle_list(vmf_msg_t*, vmf_handle_t** start_of_list_p);
