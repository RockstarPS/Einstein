...
extern vmf_routing_db_t*              __vmf_routing_db();
...
extern vmf_routing_db_memory_pool_t* __vmf_routing_db_memory_pool();
extern bool                          __vmf_routing_db_memory_pool_is_full();
