...
/* from nw_os_config_linux/public/nw_config.h */
...
enum SVMF_CTRL_MSG_T
{
    ...
    VMF_CTRL_REGISTER_SPY       = 12,                  /* register_spy */
...
#define VMF_MSG_LEN(pl_len)					    (sizeof(VMF_VAR_MSG_TYP(pl_len)))
...
/* v2.3  vmf mi message transfer format  */
#pragma pack(push,4)
typedef struct
{
...
#define NW_VMF_MSG_EVENT(msg)               NW_VMF_BASIC_MSG_GROUP(msg)
#define NW_VMF_MSG_GROUP(msg)               NW_VMF_BASIC_MSG_EVENT(msg)
...
vmf_ret_t nw_vmf_disconnect			(vmf_cid_t vmf_client_id); 			/*!< client id */

vmf_ret_t 
nw_vmf_de_register_msg_group		(vmf_cid_t vmf_client_id, 			/**<INPUT connection_id*/
                                     unsigned16 groups_num,          	/**<INPUT number of groups in List*/
