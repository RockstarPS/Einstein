...
#define MAX_DEBUG_MSG_SIZE  400
    ...
    /*******************************************************************************/
    #define NW_VMF_DEBUG_PRINT(_aspect_, _level_, args...)     fprintf (ERROR_CHANNEL, args); fprintf(ERROR_CHANNEL, "\n")
    /*******************************************************************************/
#else
    /*******************************************************************************/
    /*! \def NW_VMF_DEBUG_PRINT
...
/*******************************************************************************/
#define NW_VMF_DEBUG_INFO(args...)            fprintf (ERROR_CHANNEL, args); fprintf(ERROR_CHANNEL, "\n");
/*******************************************************************************/
...
/*******************************************************************************/
 #define NW_VMF_DEBUG_ERROR(args...)          fprintf(ERROR_CHANNEL, args); fprintf(ERROR_CHANNEL, "\n");
/*******************************************************************************/
