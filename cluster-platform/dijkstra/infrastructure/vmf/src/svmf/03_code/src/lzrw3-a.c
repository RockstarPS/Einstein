...
/*
 * $Source: /home/u1/kartik/CVSROOT/irs/linux.irs/drivers/char/ftape/compressor/lzrw3.c,v $
 * $Revision: 1.1.1.1 $
 * $Date: 2001/09/27 00:53:28 $
 *
...
static void compress_compress  (UBYTE *,UBYTE *,ULONG,UBYTE *, LONG *);
static void compress_decompress(UBYTE *,UBYTE *,LONG,UBYTE *, LONG *);
...
void lzrw3_compress(UWORD action,UBYTE *wrk_mem,UBYTE *src_adr,
					LONG src_len,UBYTE *dst_adr,void *p_dst_len)
#else
void lzrw3_compress(action, wrk_mem, src_adr, src_len, dst_adr, p_dst_len)
...
static void compress_compress (p_wrk_mem,p_src_first,src_len,p_dst_first,p_dst_len)
 ...
 *p_dst_len= -1; /* return a negative number to indicate uncompressed data */
#endif
}

/******************************************************************************/

static void compress_decompress
...
/*                               End of LZRW3.C                               */
/******************************************************************************/
#endif /*#if ( VS_MICRO_CORE_M4 == VS_MICRO_CORE )*/
