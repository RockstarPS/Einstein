...
vmf_ret_t
nw_vmf_routing_db_get_handle_list(vmf_msg_t* msg, vmf_handle_t** response_p)
{
    static vmf_handle_t   reply_on_broadcast[1] = { VMF_HANDLE_BROADCAST };
    vmf_msg_t*            basic_msg = 0x0;
    ...
    if( msg->group == VMF_BROADCAST_GROUP ) {
        ...
        *response_p = reply_on_broadcast;
        ...
        return((vmf_ret_t)__vmf_routing_db_event_get_handle_list(basic_msg, response_p));
    }
}
