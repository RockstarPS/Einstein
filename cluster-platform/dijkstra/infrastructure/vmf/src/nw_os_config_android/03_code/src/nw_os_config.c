...
void * nw_os_malloc(size_t size)
{
    ...
    /* malloc returns aligned mem or NULL in case of error */
 ...
 *
 *   Parameters:    object_name -- name of the shared memory
 *                  mode        -- access rights
 *                  len         -- size of the sharem memory in bytes
 *
...
/* jmerkle  23.09.2013 14:02:19 */
/* jmerkle  No shared memory in Android - use a "normal" file instead... */
/* jmerkle      fd = shm_open(object_name,O_CREAT | O_RDWR, mode); */
