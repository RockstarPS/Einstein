...
NW_CONFIG_PUBLIC_INC        += -I$(NETWORK_CONFIG_DIR)/pthread_w32/include

NW_CONFIG_OBJS = $(NW_CONFIG_OBJ_DIR)/nw_os_config.o $(NW_CONFIG_OBJ_DIR)/getopt.o
...
$(NW_CONFIG_OBJ_DIR)/%.o: $(NETWORK_CONFIG_DIR)/03_code/src/%.c
	$(ECHO_COMPILING)
	$(QCC_COMPILER) $(SO_FPIC) $(NETWORK_PUBLIC_INC) $(CCINC) $(OTF_ENABLE) -Wp,-MD,$(@:.o=.p) -o $@ $<
	$(FIXDEP)
	$(ECHO_QACING)
