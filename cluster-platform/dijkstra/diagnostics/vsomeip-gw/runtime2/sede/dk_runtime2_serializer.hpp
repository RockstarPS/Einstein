...
public:
  ...
  bool serialize(const bool value) { return serialize((uint8_t &)value); }
  bool serialize(const int8_t value) { return serialize((uint8_t &)value); }
  bool serialize(const int16_t value) { return serialize((uint16_t &)value); }
  bool serialize(const int32_t value, bool omitLastByte = false) { return serialize((uint32_t &)value, omitLastByte); }
  bool serialize(const int64_t value) { return serialize((uint64_t &)value); }
