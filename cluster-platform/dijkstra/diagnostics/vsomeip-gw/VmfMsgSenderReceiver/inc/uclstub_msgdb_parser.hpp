...
//=============================================================================
// @file        uclstub_msgdb_parser.hpp
// @ingroup     visteon_cdc
// @brief       implementation of MessageDbParser class.
// @author      Krishnaswamy Durai (kdurai@visteon.com)


#ifndef VMF_MSG_SENDER_RECEIVER_MESSAGEDB_PARSER
#define VMF_MSG_SENDER_RECEIVER_MESSAGEDB_PARSER
...
#endif  //VMF_MSG_SENDER_RECEIVER_MESSAGEDB_PARSER
