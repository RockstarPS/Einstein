...
//=============================================================================
// @file        uclstub_helper.hpp
// @ingroup     visteon_cdc
// @brief       implementation of MsgSenderReceiverHelper class.
// @author      Krishnaswamy Durai (kdurai@visteon.com)


#ifndef VMF_MSG_SENDER_RECEIVER_MSG_SENDER_RECEIVER_HELPER
#define VMF_MSG_SENDER_RECEIVER_MSG_SENDER_RECEIVER_HELPER
...
public:
	/**
	* \brief method return version of vmf_msg_sender_receiver
	* \param none
...
#endif  //VMF_MSG_SENDER_RECEIVER_MSG_SENDER_RECEIVER_HELPER
