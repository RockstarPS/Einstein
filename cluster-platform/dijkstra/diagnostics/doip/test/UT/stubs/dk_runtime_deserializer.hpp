...
class Deserializer
{
    public:
        ...
        {
            return deserialize ( ( uint8_t & ) value );
        }
        bool deserialize ( int16_t &value )
        {
            return deserialize ( ( uint16_t & ) value );
        }
        bool deserialize ( int32_t &value, bool omitLastByte = false )
        {
            return deserialize ( ( uint32_t & ) value, omitLastByte );
        }
