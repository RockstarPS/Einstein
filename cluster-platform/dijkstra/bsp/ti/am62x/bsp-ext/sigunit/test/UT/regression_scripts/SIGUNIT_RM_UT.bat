...
echo options C_DEFINE_LIST VC_UNIT_TEST >> commands.tmp
...
echo options EVENT_LIMIT 100 >> commands.tmp
...
echo options TESTABLE_SOURCE_DIR ..\..\..\src\ti-am62p\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR ..\..\..\src\public\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR ..\..\..\src\resmgr\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR ..\..\..\test\UT\test.harness\stubs\include\ >> commands.tmp
echo environment build SIGUNIT_RM_UT.env >> commands.tmp
echo /E:SIGUNIT_RM_UT tools script run SIGUNIT_RM_UT.tst >> commands.tmp
echo /E:SIGUNIT_RM_UT execute batch >> commands.tmp
echo /E:SIGUNIT_RM_UT reports custom management SIGUNIT_RM_UT_management_report.html >> commands.tmp
