...
#define    DISENG_SIG_LOCKUNLOCK 0x00 		/*Register to change the protection status of this address block. (sig*_LockUnlock)*/
...
#define    DISENG_SIG_STATUS 0x13C 			/*Module status. (sig*_Status)*/
