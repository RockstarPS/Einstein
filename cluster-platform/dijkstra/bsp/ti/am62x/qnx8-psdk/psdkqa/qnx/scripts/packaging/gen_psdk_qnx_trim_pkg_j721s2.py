...
# ti-processor-sdk-rtos-j721s2-xx_xx_xx_xx-linux-x64-installer.run            #
#                                                                             #
#                                                                             #
# To see Usage:                                                               #
#   python3  gen_psdk_qnx_trim_pkg_j721s2.py -h                               #
#                                                                             #
# Sample command used in TI PSDK QNX Build environment                        #
#   python3  gen_psdk_qnx_trim_pkg_j721s2.py                                  #
#       -r ${PSDK_RTOS_PATH}/psdkqa/pdk/packages/ti                           #
#       -d umda sciclient enet ipc                                            #
#       -o psdk_qnx_pkg_j721s2                                                #
#                                                                             #
# Expected output:                                                            #
#      Directory 'psdk_qnx_pkg_j721s2' is created containing libraries,       #
...
def CopyPsdkqaQnxLibsAndBinaries(rootDir, outDir, verbose):
     files = ["/qnx/resmgr/udma_qnx_rsmgr/resmgr/aarch64/o.le/tiudma-mgr",
             ...
             "/qnx/devnp/cpsw2g-main/aarch64/dll.le/devnp-cpsw2g-main.so",
