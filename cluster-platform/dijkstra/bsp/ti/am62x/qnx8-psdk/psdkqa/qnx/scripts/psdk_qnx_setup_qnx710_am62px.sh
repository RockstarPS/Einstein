...
# PSDK QNX addon package installation for QNX SDP 710.
#
...
# was downloaded to
#
#    ${QNX_BSP_PATH}/BSP_ti-am62px-evm_br-710_be-710_SVNxxxxxx_JBNyy.zip
#
###############################################################################
...
QNX_BSP_NAME=BSP_ti-am62p-sk-evm-iosock_br-710_be-710_SVN990446_JBN7.zip
QNX_BSP_PATH=${QNX_BASE}/bsp
QNX_BSP_VERSION=710_SVN990446_JBN7
