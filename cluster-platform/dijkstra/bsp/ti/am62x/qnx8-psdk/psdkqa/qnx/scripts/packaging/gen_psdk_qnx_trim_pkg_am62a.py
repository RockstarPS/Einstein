...
#                                                                             #
# To see Usage:                                                               #
#   python3  gen_psdk_qnx_trim_pkg_am62a.py -h                                #
#                                                                             #
# Sample command used in TI PSDK QNX Build environment                        #
#   python3  gen_psdk_qnx_trim_pkg_am62a.py                                   #
#       -r ${PSDK_PATH}/psdkqa/pdk/packages/ti                                #
#       -d umda sciclient enet ipc                                            #
#       -o psdk_qnx_pkg_am62a                                                 #
#                                                                             #
# Expected output:                                                            #
#      Directory 'psdk_qnx_pkg_am62a' is created containing libraries,        #
...
def CopyPrebuiltDtbs(rootDir, outDir, verbose):
    src_dtb_folder = rootDir + "/../../../qnx/internal_docs/scripts/trim_package/dtbs/am62a/*.dt*"
...
def CopyPsdkqaQnxLibsAndBinaries(rootDir, outDir, verbose):
     files = ["/qnx/resmgr/udma_qnx_rsmgr/resmgr/aarch64/o.le/tiudma-mgr",
             ...
             "/qnx/pdk_libs/csirxlld/aarch64/so.le/libti-csirxlld.so",
             "/qnx/pdk_libs/csirxlld/aarch64/so.le/libti-csirxlldS.a",
             "/qnx/pdk_libs/fvid2lld/aarch64/so.le/libti-fvid2lld.so",
             "/qnx/pdk_libs/fvid2lld/aarch64/so.le/libti-fvid2lldS.a",
