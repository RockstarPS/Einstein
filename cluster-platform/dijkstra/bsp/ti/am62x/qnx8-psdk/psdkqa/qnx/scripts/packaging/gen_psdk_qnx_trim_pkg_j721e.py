...
# requiring full download, installation and build of the TI PSDK RTOS and     #
# PSDK QNX releases.                                                          #
#                                                                             #
...
#                                                                             #
# To see Usage:                                                               #
#   python3  gen_psdk_qnx_trim_pkg_j721e.py -h                                #
#                                                                             #
# Sample command used in TI PSDK QNX Build environment                        #
#   python3  gen_psdk_trim_qnx_pkg_j721e.py                                   #
#       -r ${PSDK_RTOS_PATH}/psdkqa/pdk/packages/ti                           #
#       -d umda sciclient enet ipc                                            #
#       -o psdk_qnx_pkg_j721e                                                 #
#                                                                             #
# Expected output:                                                            #
#      Directory 'psdk_qnx_pkg_j721e' is created containing libraries,        #
...
def CopyPsdkqaQnxLibsAndBinaries(rootDir, outDir, verbose):
     files = ["/qnx/resmgr/udma_qnx_rsmgr/resmgr/aarch64/o.le/tiudma-mgr",
             ...
             "/qnx/devnp/cpsw2g/aarch64/dll.le/devnp-cpsw2g.so",
             "/qnx/devnp/cpsw9g/aarch64/dll.le/devnp-cpsw9g.so",
             "/qnx/devnp/remote_device/aarch64/a.le/libti-remote-device-client.a",
             "/qnx/devnp/ethremotecfg/aarch64/a.le/libti-remoteswitchcfg-client.a",
             ...
             "/qnx/pdk_libs/enetlld/aarch64/so.le/libti-enetlld.so",
             "/qnx/pdk_libs/enetlld/aarch64/so.le/libti-enetlldS.a",
...
# def CopyRemoteCoreImages

def CopyRemoteCoreImages(rootDir, outDir, verbose):
     images = ["/vision_apps/out/J7/R5F/FREERTOS/release/vx_app_rtos_qnx_mcu2_0.out",
               "/vision_apps/out/J7/R5F/FREERTOS/release/vx_app_rtos_qnx_mcu2_1.out",
               #"/vision_apps/out/J7/R5F/FREERTOS/release/vx_app_irtos_qnx_mcu3_0.out",
               #"/vision_apps/out/J7/R5F/FREERTOS/release/vx_app_rtos_qnx_mcu3_1.out",
               "/vision_apps/out/J7/C66/SYSBIOS/release/vx_app_rtos_qnx_c6x_1.out",
               "/vision_apps/out/J7/C66/SYSBIOS/release/vx_app_rtos_qnx_c6x_2.out",
               "/vision_apps/out/J7/C71/SYSBIOS/release/vx_app_rtos_qnx_c7x_1.out"]
     for image in images:
        dst_filename = ""
        dst_filename = outDir + image
        if not os.path.exists(dst_filename):
            os.makedirs(dst_filename)
        src_filename = rootDir + "/../../../.." + image
        if verbose:
            print("Copying binaries from:", src_filename, "to:", dst_filename)
        shutil.copy(src_filename, dst_filename)
...
if __name__ == '__main__':
    ...
    # Vision Apps remote core binaries
    #if args.out_dir:
    #    CopyRemoteCoreImages(args.root_dir, args.out_dir, args.verbose)
