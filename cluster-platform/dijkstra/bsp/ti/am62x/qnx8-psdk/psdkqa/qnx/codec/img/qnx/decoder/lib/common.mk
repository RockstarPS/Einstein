...
define PINFO
PINFO DESCRIPTION=J7 video decoder lib
...
EXTRA_SRCVPATH+=$(PSDK_QNX_PATH)/qnx/codec/img/driver/decoder \
                $(PSDK_QNX_PATH)/qnx/codec/img/driver/common \
                $(PSDK_QNX_PATH)/qnx/codec/img/osal/src/qnx \
                $(PSDK_QNX_PATH)/qnx/codec/img/timmlib/decoder

CCFLAGS=-DOSAL_QNX -DSOC_J721E -DQNX_OS -DHAS_HEVC -DERROR_CONCEALMENT
#for debug purpose
