...
# ti-processor-sdk-rtos-j784s4-xx_xx_xx_xx-linux-x64-installer.run            #
#                                                                             #
#                                                                             #
# To see Usage:                                                               #
#   python3  gen_psdk_qnx_trim_pkg_j784s4.py -h                               #
#                                                                             #
# Sample command used in TI PSDK QNX Build environment                        #
#   python3  gen_psdk_qnx_trim_pkg_j784s4.py                                  #
#       -r ${PSDK_RTOS_PATH}/psdkqa/pdk/packages/ti                           #
#       -d umda sciclient enet ipc                                            #
#       -o psdk_qnx_pkg_j784s4                                                #
#                                                                             #
# Expected output:                                                            #
#      Directory 'psdk_qnx_pkg_j784s4' is created containing libraries,       #
