###############################################################################
#                                                                             #
# This script shows a sample usage of gen_psdk_qnx_trim_pkg_j7200.py script.  #
#                                                                             #
...
# PSDK QNX releases.                                                          #
#                                                                             #
# See gen_psdk_qnx_trim_pkg_j7200.py for further information                  #
#                                                                             #
...
then
  ...
  python3  gen_psdk_qnx_trim_pkg_j7200.py -r ${PSDK_RTOS_PATH}/psdkqa/pdk/packages/ti -d udma sciclient sciclient_hs enet ipc -o psdk_qnx_trim_pkg_j7200
  tar -czf psdk_qnx_trim_pkg_j7200.tar.gz psdk_qnx_trim_pkg_j7200
  echo "Trim package psdk_qnx_trim_pkg_j7200.tar.gz generated!"
fi
