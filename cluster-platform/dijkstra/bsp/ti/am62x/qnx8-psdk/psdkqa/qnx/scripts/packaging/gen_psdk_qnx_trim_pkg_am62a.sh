###############################################################################
#                                                                             #
# This script shows a sample usage of gen_psdk_qnx_trim_pkg_am62a.py script.  #
#                                                                             #
...
#                                                                             #
# See gen_psdk_qnx_trim_pkg_am62a.py for further information                  #
#                                                                             #
...
then
  ...
  python3  gen_psdk_qnx_trim_pkg_am62a.py -r ${PSDK_PATH}/psdkqa/pdk/packages/ti -d udma sciclient sciclient_hs enet ipc -o psdk_qnx_trim_pkg_am62a
  tar -czf psdk_qnx_trim_pkg_am62a.tar.gz psdk_qnx_trim_pkg_am62a
  echo "Trim package psdk_qnx_trim_pkg_am62a.tar.gz generated!"
fi
