...
# ti-processor-sdk-rtos-j7200-xx_xx_xx_xx-linux-x64-installer.run             #
#                                                                             #
#                                                                             #
# To see Usage:                                                               #
#   python3  gen_psdk_qnx_trim_pkg_j7200.py -h                                #
#                                                                             #
# Sample command used in TI PSDK QNX Build environment                        #
#   python3  gen_psdk_qnx_trim_pkg_j7200.py                                   #
#       -r ${PSDK_RTOS_PATH}/psdkqa/pdk/packages/ti                           #
#       -d umda sciclient enet ipc                                            #
#       -o psdk_qnx_pkg_j7200                                                 #
#                                                                             #
# Expected output:                                                            #
#      Directory 'psdk_qnx_pkg_j7200' is created containing libraries,        #
...
def CopyPsdkqaQnxLibsAndBinaries(rootDir, outDir, verbose):
     files = ["/qnx/resmgr/udma_qnx_rsmgr/resmgr/aarch64/o.le/tiudma-mgr",
             ...
             "/qnx/devnp/cpsw5g/aarch64/dll.le/devnp-cpsw5g.so",
...
def CopyRemoteCoreImages(rootDir, outDir, verbose):
     images = ["/ethfw_firmware/j7200-main-r5f0_0-fw",
               "/ethfw_firmware/j7200-main-r5f0_1-fw"]
     for image in images:
        dst_filename = ""
