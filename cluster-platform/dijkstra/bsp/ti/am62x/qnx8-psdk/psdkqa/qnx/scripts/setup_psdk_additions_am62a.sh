...
#apply patch for mcu-plus-sdk
cp $PSDK_RTOS_PATH/psdkqa/qnx/scripts/misc/mcu_plus_sdk_qnx_sbl_am62a.patch $MCU_PLUS_PATH
cp $PSDK_RTOS_PATH/psdkqa/qnx/scripts/misc/mcu_plus_sdk_qnx_ipc_am62a.patch $MCU_PLUS_PATH
cd $MCU_PLUS_PATH; patch -p1 < mcu_plus_sdk_qnx_sbl_am62a.patch; patch -p1 < mcu_plus_sdk_qnx_ipc_am62a.patch; cd -
