...
# was downloaded to
#
#    ${QNX_BSP_PATH}/BSP_ti-am62a-sk-evm_br-hw-rel_be-800_SVN998577_JBN7.zip
#
###############################################################################
...
QNX_BSP_NAME=BSP_ti-am62a-sk-evm_br-hw-rel_be-800_SVN998577_JBN7.zip
QNX_BSP_PATH=${QNX_BASE}/bsp
QNX_BSP_VERSION=800_SVN998577_JBN7
...
setup_qnx_bsp_in_psdkqa()
{
  ...
  if [ $QNX_BSP_VERSION="800_SVN998577_JBN7" ]
      then
