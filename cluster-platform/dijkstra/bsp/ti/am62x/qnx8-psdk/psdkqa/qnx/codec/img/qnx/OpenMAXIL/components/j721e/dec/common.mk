...
EXTRA_INCVPATH+=$(PSDK_QNX_PATH)/qnx/codec/img/qnx/OpenMAXIL/khronos/openmaxil \
                ...
                $(PSDK_QNX_PATH)/qnx/codec/img/qnx/decoder/cli
...
define PINFO
PINFO DESCRIPTION=OMX IL j721e decoder component
...
ifeq ($(PSDK_QNX_USE_DSO),1)
  ...
  LIBS+= vxd_dec-cli$(BUILD_PROFILE_QNX_SUFFIX)S
  LIBPREF_vxd_dec-cli$(BUILD_PROFILE_QNX_SUFFIX) = -Bstatic
