...
# was downloaded to
#
#    ${QNX_BSP_PATH}/BSP_ti-am62x-evm_br-710_be-710_SVNxxxxxx_JBNyy.zip
#
###############################################################################
...
QNX_BSP_NAME=BSP_ti-am62a-sk-evm-iosock_br-710_be-710_SVN977709_JBN6.zip
QNX_BSP_PATH=${QNX_BASE}/bsp
QNX_BSP_VERSION=710_SVN977709_JBN6
