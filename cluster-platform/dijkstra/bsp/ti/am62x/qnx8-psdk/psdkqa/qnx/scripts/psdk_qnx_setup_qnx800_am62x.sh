...
# was downloaded to
#
#    ${QNX_BSP_PATH}/BSP_ti-am62x-sk-evm_br-hw-rel_be-800_SVN998642_JBN4.zip
#
###############################################################################
...
QNX_BSP_NAME=BSP_ti-am62x-sk-evm_br-hw-rel_be-800_SVN998642_JBN4.zip
QNX_BSP_PATH=${QNX_BASE}/bsp
QNX_BSP_VERSION=800_SVN998642_JBN4
