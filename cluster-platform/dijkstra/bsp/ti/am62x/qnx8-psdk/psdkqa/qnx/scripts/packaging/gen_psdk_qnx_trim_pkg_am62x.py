...
#                                                                             #
# To see Usage:                                                               #
#   python3  gen_psdk_qnx_trim_pkg_am62x.py -h                                #
#                                                                             #
# Sample command used in TI PSDK QNX Build environment                        #
#   python3  gen_psdk_qnx_trim_pkg_am62x.py                                   #
#       -r ${PSDK_PATH}/psdkqa/pdk/packages/ti                                #
#       -d umda sciclient enet ipc                                            #
#       -o psdk_qnx_pkg_am62x                                                 #
#                                                                             #
# Expected output:                                                            #
#      Directory 'psdk_qnx_pkg_am62x' is created containing libraries,        #
...
def CopyPrebuiltDtbs(rootDir, outDir, verbose):
    src_dtb_folder = rootDir + "/../../../qnx/internal_docs/scripts/trim_package/dtbs/am62x/*.dt*"
