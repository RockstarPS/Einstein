...
echo options VCAST_DEPENDENCY_CACHE_DIR C:\\VCAST\\Environments >> commands.tmp
...
echo options TESTABLE_SOURCE_DIR ..\..\..\test\UT\stubs\include\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR ..\..\..\src\ti-am62p\ >> commands.tmp
echo environment build UTP_DIO_RM.env >> commands.tmp
echo /E:UTP_DIO_RM tools script run UTP_DIO_RM.tst >> commands.tmp
echo /E:UTP_DIO_RM execute batch >> commands.tmp
echo /E:UTP_DIO_RM reports custom management UTP_DIO_RM_management_report.html >> commands.tmp
