/*
 * Copyright (c) 2020-2024 BlackBerry Limited.
 *
...
{
    static uint64_t am62xx_aarch64_tlb[TLB_SIZE] __attribute__ ((aligned(64 * 1024)));
    ...
    aarch64_setup_tlb(board_tlb, am62xx_aarch64_tlb);
    aarch64_enable_mmu((uint64_t)am62xx_aarch64_tlb);
}
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/hardware/branches/release/hardware/startup/boards/ti-am62xx/board_sysctl.c $ $Rev: 994120 $")
#endif
