...
{
	struct startup_intrinfo gic_v3_intr_lpi =
     {
     .vector_base     = 8192,
	...
	struct startup_intrinfo gic_v3_intr_lpi_msi =
     {
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/hardware/branches/release/hardware/startup/boards/ti-am62xx/am62p/init_intrinfo.c $ $Rev: 994120 $")
#endif
