...
#define LINFLEXD_LINSR			0x8
	#define LINFLEXD_LINSR_LINS_MSK	        (0xF<<12)
	#define LINFLEXD_LINSR_LINS_INIT	(1 << 12)       /*LINFlexD is in Initialization mode */
...
#define LINFLEXD_LINESR			0xC
	...
	#define LINFLEXD_LINESR_MSK		0xFF81
...
#ifdef __ASM__
__SRCVERSION "$URL: http://svn.ott.qnx.com/product/hardware/branches/release/hardware/devc/public/hw/linflexd.h $ $Rev: 983072 $"
#else
__SRCVERSION( "$URL: http://svn.ott.qnx.com/product/hardware/branches/release/hardware/devc/public/hw/linflexd.h $ $Rev: 983072 $" )
#endif
#endif
