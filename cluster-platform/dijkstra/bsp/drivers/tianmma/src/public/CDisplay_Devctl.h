...
#define DISPLAY_EPOWER_LIMITED_USE      ((display_EPower_t) 2)
#define DISPLAY_EPOWER_SUSPEND          ((display_EPower_t) 3)
typedef struct
{
    uint8_t power_U8;
...
#define GAMMA_RGB_VALUE_READ     __DIOF(_DCMD_MISC, CMD_CODE + 3, display_gamma_rgb_type_ts)
#define GAMMA_RGB_VALUE_WRITE    __DIOT(_DCMD_MISC, CMD_CODE + 4, display_gamma_rgb_type_ts)
