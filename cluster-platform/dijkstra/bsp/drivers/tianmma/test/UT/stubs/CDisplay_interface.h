...
typedef struct
{
    ...
    int32_t ( *Set_Gamma_RGB_Devctl ) ( int32_t  p_gamma_red_S32, int32_t  p_gamma_green_S32, int32_t  p_gamma_blue_S32 );
    int32_t ( *Get_Gamma_RGB_Devctl ) ( int32_t *p_gamma_red_S32, int32_t *p_gamma_green_S32, int32_t *p_gamma_blue_S32 );
} ts_display_funcs;

int32_t Set_Gamma_RGB_Devctl_FuncPtr ( int32_t p_gamma_red_S32, int32_t p_gamma_green_S32, int32_t p_gamma_blue_S32 );
int32_t Get_Gamma_RGB_Devctl_FuncPtr ( int32_t *p_gamma_red_S32, int32_t *p_gamma_green_S32, int32_t *p_gamma_blue_S32 );
