...
typedef struct {
    uint32_t            speed_mode; /* supported speeds: I2C_SPEED_* */
    uint32_t            addr_mode;  /* supported address fmts: I2C_ADDRFMT_* */
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/lib/i2c/public/hw/i2c.h $ $Rev: 816939 $")
#endif
