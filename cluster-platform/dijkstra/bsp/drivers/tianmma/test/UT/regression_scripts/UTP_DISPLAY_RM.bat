...
echo environment build UTP_DISPLAY_RM.env >> commands.tmp
echo /E:UTP_DISPLAY_RM tools script run UTP_DISPLAY_RM.tst >> commands.tmp
echo /E:UTP_DISPLAY_RM execute batch >> commands.tmp
echo /E:UTP_DISPLAY_RM tools import_coverage UTP_DISPLAY_RM.cvr >> commands.tmp
echo /E:UTP_DISPLAY_RM reports custom management UTP_DISPLAY_RM_management_report.html >> commands.tmp
