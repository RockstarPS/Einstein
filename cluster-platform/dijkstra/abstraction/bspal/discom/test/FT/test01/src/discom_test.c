...
char image_path[PATH_MAX] = "/tmp/sample.png";
...
//                                EvWindow.lowerright_y_U16, EvWindow.alpha_U8, EvWindow.action_U8, EvWindow.ref_crc.red_U32, EvWindow.ref_crc.green_U32, EvWindow.ref_crc.blue_U32);
    ...
    uif_rect[0] = EvWindow.upperleft_x_U16;
    uif_rect[1] = EvWindow.upperleft_y_U16;
    uif_rect[2] = EvWindow.lowerright_x_U16;
    uif_rect[3] = EvWindow.lowerright_y_U16;
...
//    screen_wait_vsync(screen_disp);
    ...
    fprintf(stdout, "Expect CRC of ROI: 0x%08x\n", crc32.expect);
    fprintf(stdout, "CRC of ROI: 0x%08x\n", p_win_crc_sts.crc.rgb_crc_U32);
