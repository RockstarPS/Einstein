...
extern int32_t qcom_misr_init(void);
extern int32_t qcom_misr_set_roi_crc(uint32_t roi_index, ts_SSigUnitWinCfg_t *g_roi_crc_set);
extern int32_t qcom_misr_get_roi_crc(uint32_t  roi_index);
extern int32_t qcom_misr_terminate(void);
extern int32_t qcom_misr_commit(void);
extern int32_t qcom_misr_stop(uint32_t roi_index);
