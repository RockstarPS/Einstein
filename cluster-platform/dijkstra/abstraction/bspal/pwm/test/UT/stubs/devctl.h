...
extern int devctlv(int fd, int dcmd, int sparts, int rparts, const iovec *sv, const iovec *rv, int *dev_info_ptr);
...
#define get_device_command(_cmd)			((unsigned)(_cmd)&DEVDIR_CMD_MASK)
#define get_device_size(_cmd)				(((unsigned)(_cmd) & ~DEVDIR_TOFROM) >> 16)
#define get_device_direction(_cmd)			((unsigned)(_cmd)&DEVDIR_TOFROM)
#define set_device_direction(_cmd, _dir)	((unsigned)(_cmd)|(_dir))
...
#define __DIO_RAW(__class, __cmd, __size, __dir) (int)(((__size)<<16) + ((__class)<<8) + (__cmd) + (__dir))
#define __DIOF(class, cmd, data)	(int)(cmd)
#define __DIOT(class, cmd, data)	(int)(cmd)
#define __DIOTF(class, cmd, data)	(int)(cmd)

#define __DION(class, cmd)			(int)(((class)<<8) + (cmd) + _POSIX_DEVDIR_NONE)
