...
echo options TESTABLE_SOURCE_DIR ..\..\..\lib\src\qnx\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR ..\..\..\lib\public\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR ..\..\..\test\UT\stubs\ >> commands.tmp
echo environment build UTP_BSPAL_PWM.env >> commands.tmp
echo /E:UTP_BSPAL_PWM tools script run UTP_BSPAL_PWM.tst >> commands.tmp
echo /E:UTP_BSPAL_PWM execute batch >> commands.tmp
echo /E:UTP_BSPAL_PWM reports custom management UTP_BSPAL_PWM_management_report.html >> commands.tmp
