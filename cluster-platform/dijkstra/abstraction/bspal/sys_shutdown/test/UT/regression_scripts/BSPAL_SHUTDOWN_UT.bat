...
echo options TESTABLE_SOURCE_DIR ..\..\..\lib\src\imx8\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR ..\stubs\ >> commands.tmp
echo environment build BSPAL_SHUTDOWN_UT.env >> commands.tmp
echo /E:BSPAL_SHUTDOWN_UT tools script run BSPAL_SHUTDOWN_UT.tst >> commands.tmp
echo /E:BSPAL_SHUTDOWN_UT execute batch >> commands.tmp
echo /E:BSPAL_SHUTDOWN_UT reports custom management BSPAL_SHUTDOWN_UT_management_report.html >> commands.tmp
