...
echo environment build UTP_BSPAL_DISPLAY.env >> commands.tmp
echo /E:UTP_BSPAL_DISPLAY tools script run UTP_BSPAL_DISPLAY.tst >> commands.tmp
echo /E:UTP_BSPAL_DISPLAY execute batch >> commands.tmp
echo /E:UTP_BSPAL_DISPLAY reports custom management UTP_BSPAL_DISPLAY_management_report.html >> commands.tmp
