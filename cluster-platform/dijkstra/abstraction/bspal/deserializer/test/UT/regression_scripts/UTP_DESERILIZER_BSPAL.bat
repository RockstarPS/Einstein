...
echo environment build UTP_DESERILIZER_BSPAL.env >> commands.tmp
echo /E:UTP_DESERILIZER_BSPAL tools script run UTP_DESERILIZER_BSPAL.tst >> commands.tmp
echo /E:UTP_DESERILIZER_BSPAL execute batch >> commands.tmp
echo /E:UTP_DESERILIZER_BSPAL reports custom management UTP_DESERILIZER_BSPAL_management_report.html >> commands.tmp
