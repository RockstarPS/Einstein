...
echo environment build OSALOSTIMER.env >> commands.tmp
echo /E:OSALOSTIMER tools script run OSALOSTIMER.tst >> commands.tmp
echo /E:OSALOSTIMER execute batch >> commands.tmp
echo /E:OSALOSTIMER reports custom management OSALOSTIMER_management_report.html >> commands.tmp
