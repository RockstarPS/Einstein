...
echo environment build OSALTIMER.env >> commands.tmp
echo /E:OSALTIMER tools script run OSALTIMER.tst >> commands.tmp
echo /E:OSALTIMER execute batch >> commands.tmp
echo /E:OSALTIMER tools import_coverage OSALTIMER.cvr >> commands.tmp
echo /E:OSALTIMER reports custom management OSALTIMER_management_report.html >> commands.tmp
