...
echo environment build OSALCLOCK_UTP.env >> commands.tmp
echo /E:OSALCLOCK_UTP tools script run OSALCLOCK_UTP.tst >> commands.tmp
echo /E:OSALCLOCK_UTP execute batch >> commands.tmp
echo /E:OSALCLOCK_UTP reports custom management OSALCLOCK_UTP_management_report.html >> commands.tmp
