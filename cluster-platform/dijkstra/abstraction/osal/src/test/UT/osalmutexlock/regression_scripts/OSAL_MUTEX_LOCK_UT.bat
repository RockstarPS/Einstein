...
echo environment build OSAL_MUTEX_LOCK_UT.env >> commands.tmp
echo /E:OSAL_MUTEX_LOCK_UT tools script run OSAL_MUTEX_LOCK_UT.tst >> commands.tmp
echo /E:OSAL_MUTEX_LOCK_UT execute batch >> commands.tmp
echo /E:OSAL_MUTEX_LOCK_UT reports custom management OSAL_MUTEX_LOCK_UT_management_report.html >> commands.tmp
