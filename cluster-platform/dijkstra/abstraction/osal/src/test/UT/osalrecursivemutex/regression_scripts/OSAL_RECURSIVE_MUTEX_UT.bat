...
echo environment build OSAL_RECURSIVE_MUTEX_UT.env >> commands.tmp
echo /E:OSAL_RECURSIVE_MUTEX_UT tools script run OSAL_RECURSIVE_MUTEX_UT.tst >> commands.tmp
echo /E:OSAL_RECURSIVE_MUTEX_UT execute batch >> commands.tmp
echo /E:OSAL_RECURSIVE_MUTEX_UT reports custom management OSAL_RECURSIVE_MUTEX_UT_management_report.html >> commands.tmp
