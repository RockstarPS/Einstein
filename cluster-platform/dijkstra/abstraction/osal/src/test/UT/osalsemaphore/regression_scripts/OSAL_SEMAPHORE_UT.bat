...
echo environment build OSAL_SEMAPHORE_UT.env >> commands.tmp
echo /E:OSAL_SEMAPHORE_UT tools script run OSAL_SEMAPHORE_UT.tst >> commands.tmp
echo /E:OSAL_SEMAPHORE_UT execute batch >> commands.tmp
echo /E:OSAL_SEMAPHORE_UT reports custom management OSAL_SEMAPHORE_UT_management_report.html >> commands.tmp
