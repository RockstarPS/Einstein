...
echo environment build OSAL_SHAREDMEMORY_UT.env >> commands.tmp
echo /E:OSAL_SHAREDMEMORY_UT tools script run OSAL_SHAREDMEMORY_UT.tst >> commands.tmp
echo /E:OSAL_SHAREDMEMORY_UT execute batch >> commands.tmp
echo /E:OSAL_SHAREDMEMORY_UT reports custom management OSAL_SHAREDMEMORY_UT_management_report.html >> commands.tmp
