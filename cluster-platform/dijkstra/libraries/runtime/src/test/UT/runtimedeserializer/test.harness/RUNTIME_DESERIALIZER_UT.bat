...
echo options TESTABLE_SOURCE_DIR ..\..\..\..\runtime\serdes\ >> commands.tmp
echo environment build RUNTIME_DESERIALIZER_UT.env >> commands.tmp
echo /E:RUNTIME_DESERIALIZER_UT tools script run RUNTIME_DESERIALIZER_UT.tst >> commands.tmp
echo /E:RUNTIME_DESERIALIZER_UT execute batch >> commands.tmp
echo /E:RUNTIME_DESERIALIZER_UT tools import_coverage RUNTIME_DESERIALIZER_UT.cvr >> commands.tmp
echo /E:RUNTIME_DESERIALIZER_UT reports custom full RUNTIME_DESERIALIZER_UT_full_report.html >> commands.tmp
