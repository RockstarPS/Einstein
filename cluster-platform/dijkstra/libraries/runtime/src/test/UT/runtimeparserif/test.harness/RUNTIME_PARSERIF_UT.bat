...
echo environment build RUNTIME_PARSERIF_UT.env >> commands.tmp
echo /E:RUNTIME_PARSERIF_UT tools script run RUNTIME_PARSERIF_UT.tst >> commands.tmp
echo /E:RUNTIME_PARSERIF_UT execute batch >> commands.tmp
echo /E:RUNTIME_PARSERIF_UT reports custom full RUNTIME_PARSERIF_UT_full_report.html >> commands.tmp
