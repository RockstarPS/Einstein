...
echo options C_DEFINE_LIST DK_VMF_ENABLED VCAST_NO_PTR_TO_UNCON_ARRAY_SUPPORT >> commands.tmp
...
echo environment build RUNTIME_COMPONENT_UT.env >> commands.tmp
echo /E:RUNTIME_COMPONENT_UT tools script run RUNTIME_COMPONENT_UT.tst >> commands.tmp
echo /E:RUNTIME_COMPONENT_UT execute batch >> commands.tmp
echo /E:RUNTIME_COMPONENT_UT reports custom full RUNTIME_COMPONENT_UT_full_report.html >> commands.tmp
