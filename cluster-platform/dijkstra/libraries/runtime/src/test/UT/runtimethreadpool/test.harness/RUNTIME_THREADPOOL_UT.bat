...
echo environment build RUNTIME_THREADPOOL_UT.env >> commands.tmp
echo /E:RUNTIME_THREADPOOL_UT tools script run RUNTIME_THREADPOOL_UT.tst >> commands.tmp
echo /E:RUNTIME_THREADPOOL_UT execute batch >> commands.tmp
echo /E:RUNTIME_THREADPOOL_UT reports custom full RUNTIME_THREADPOOL_UT_full_report.html >> commands.tmp
