...
echo environment build RUNTIME_CONTAINER_UT.env >> commands.tmp
echo /E:RUNTIME_CONTAINER_UT tools script run RUNTIME_CONTAINER_UT.tst >> commands.tmp
echo /E:RUNTIME_CONTAINER_UT execute batch >> commands.tmp
echo /E:RUNTIME_CONTAINER_UT reports custom full RUNTIME_CONTAINER_UT_full_report.html >> commands.tmp
