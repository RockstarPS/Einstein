...
echo environment build RUNTIME_MSGCMN_UT.env >> commands.tmp
echo /E:RUNTIME_MSGCMN_UT tools script run RUNTIME_MSGCMN_UT.tst >> commands.tmp
echo /E:RUNTIME_MSGCMN_UT execute batch >> commands.tmp
echo /E:RUNTIME_MSGCMN_UT reports custom full RUNTIME_MSGCMN_UT_full_report.html >> commands.tmp
