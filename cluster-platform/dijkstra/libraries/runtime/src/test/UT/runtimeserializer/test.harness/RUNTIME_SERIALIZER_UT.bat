...
echo environment build RUNTIME_SERIALIZER_UT.env >> commands.tmp
echo /E:RUNTIME_SERIALIZER_UT tools script run RUNTIME_SERIALIZER_UT.tst >> commands.tmp
echo /E:RUNTIME_SERIALIZER_UT execute batch >> commands.tmp
echo /E:RUNTIME_SERIALIZER_UT tools import_coverage RUNTIME_SERIALIZER_UT.cvr >> commands.tmp
echo /E:RUNTIME_SERIALIZER_UT reports customs full RUNTIME_SERIALIZER_UT_full_report.html >> commands.tmp
