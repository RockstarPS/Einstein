...
echo environment build RUNTIME_WDGIF_UT.env >> commands.tmp
echo /E:RUNTIME_WDGIF_UT tools script run RUNTIME_WDGIF_UT.tst >> commands.tmp
echo /E:RUNTIME_WDGIF_UT execute batch >> commands.tmp
echo /E:RUNTIME_WDGIF_UT reports custom full RUNTIME_WDGIF_UT_full_report.html >> commands.tmp
