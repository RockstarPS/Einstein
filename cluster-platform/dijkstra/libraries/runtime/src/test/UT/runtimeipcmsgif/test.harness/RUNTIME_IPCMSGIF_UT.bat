...
echo options C_DEFINE_LIST VCAST_NO_PTR_TO_UNCON_ARRAY_SUPPORT DK_VMF_ENABLED >> commands.tmp
...
echo options TESTABLE_SOURCE_DIR ..\..\..\..\runtime\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR ..\stubs\ >> commands.tmp
echo environment build RUNTIME_IPCMSGIF_UT.env >> commands.tmp
echo /E:RUNTIME_IPCMSGIF_UT tools script run RUNTIME_IPCMSGIF_UT.tst >> commands.tmp
echo /E:RUNTIME_IPCMSGIF_UT execute batch >> commands.tmp
echo /E:RUNTIME_IPCMSGIF_UT tools import_coverage RUNTIME_IPCMSGIF_UT.cvr >> commands.tmp
echo /E:RUNTIME_IPCMSGIF_UT reports custom full RUNTIME_IPCMSGIF_UT_full_report.html >> commands.tmp
