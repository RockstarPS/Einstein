...
echo environment build RUNTIME_APPLICATION_UT.env >> commands.tmp
echo /E:RUNTIME_APPLICATION_UT tools script run RUNTIME_APPLICATION_UT.tst >> commands.tmp
echo /E:RUNTIME_APPLICATION_UT execute batch >> commands.tmp
echo /E:RUNTIME_APPLICATION_UT tools import_coverage RUNTIME_APPLICATION_UT.cvr >> commands.tmp
echo /E:RUNTIME_APPLICATION_UT reports custom full RUNTIME_APPLICATION_UT_full_report.html >> commands.tmp
