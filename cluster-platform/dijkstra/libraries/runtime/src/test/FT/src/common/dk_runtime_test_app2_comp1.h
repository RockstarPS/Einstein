...
//
//---------------------------------------------------------------------------------------------------------------------
#ifndef DK_RUNTIME_TEST_APP2_COMP1_H
#define DK_RUNTIME_TEST_APP2_COMP1_H
...
#define DK_RTE_Send_DkMsgTestApp2Transmit(x) gApp.sendDkMsgTestApp2Transmit((x));

#ifdef __cplusplus
} // runtime
} // dk
#endif
#endif //DK_RUNTIME_TEST_APP2_COMP1_H
