...
//
//---------------------------------------------------------------------------------------------------------------------
#ifndef DK_RUNTIME_TEST_APP1_COMP2_H
#define DK_RUNTIME_TEST_APP1_COMP2_H
...
#define DK_RTE_Send_DkMsgTestApp2Receive(x) gApp.sendDkMsgTestApp2Receive((x));

#ifdef __cplusplus
} // runtime
} // dk
#endif
#endif //DK_RUNTIME_TEST_APP1_COMP2_H
