...
#include "test_app2_thread_ids.h"

using namespace dk::runtime;

class testApp2 : public dk::runtime::core::Application
{
public:
    template <typename T1 = dk::runtime::core::Container *, typename... T2>
    testApp2(const char *pAppName, T1 c, T2... cList) : Application(pAppName)
    {
    ...
    //Send APIs
    void sendDkMsgTestApp2Transmit(DkMsgTestMsg_t & msg);
};

extern testApp2 gApp;
#endif //TEST_APP2_H
