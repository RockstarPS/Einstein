...
/*
 * TA_OTP_KEYWRITING_CMD_KEYREV_KEYCNT - Command to get the keycnt and keyrev
 * param[0].a (value/output) keycnt value
 * param[1].a (value/output) keyrev value
 * param[2] unused
 * param[3] unused
 */
#define TA_OTP_KEYWRITING_CMD_KEYREV_KEYCNT  2
