#ifndef out_arm_plat_k3_core_include_generated_asm_defines_h
#define out_arm_plat_k3_core_include_generated_asm_defines_h
...
#define __CORE_MMU_BASE_TABLE_OFFSET	256	/* CORE_MMU_BASE_TABLE_OFFSET"	*/
#endif
