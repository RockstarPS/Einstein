#ifndef _out_arm_plat_k3_include_generated_conf_h_
#define _out_arm_plat_k3_include_generated_conf_h_
...
#define PLATFORM_FLAVOR am62px
#define PLATFORM_FLAVOR_am62px 1
