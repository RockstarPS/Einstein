...
echo options TESTABLE_SOURCE_DIR ..\..\..\logger\ >> commands.tmp
echo environment build LOGGER_UT.env >> commands.tmp
echo /E:LOGGER_UT tools script run LOGGER_UT.tst >> commands.tmp
echo /E:LOGGER_UT execute batch >> commands.tmp
echo /E:LOGGER_UT reports custom full LOGGER_UT_management_report.html >> commands.tmp
