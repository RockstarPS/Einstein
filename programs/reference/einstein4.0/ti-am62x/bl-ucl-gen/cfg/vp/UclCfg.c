...
///
/// Generated on 2022/03/18 05:56:37 by IRAJENDR
///---------------------------------------------------------------------------------------------------------------------
///---------------------------------------------------------------------------------------------------------------------
/// Include files
///---------------------------------------------------------------------------------------------------------------------
...
#define UCLDLCBK_NUM_INSTANCES     (1u)
...
///---------------------------------------------------------------------------------------------------------------------
extern SUclALDebugNullCfg UclALDebugCfg_0;
extern SUclALOsASRCfg UclALOsCfg_0;
extern SUclALPhyMailboxASRCfg UclALPhyCfg_0;
extern SUclDLCfg UclDLCfg_0;
extern SUclSysDLCfg UclSysCfg_0;
...
static uint8 UclSysInst_0_IUclDL[1] = {0};

static SUclSysDLInst UclSysInst_0 = {
	.pCfg = &UclSysCfg_0,
	.numIUclALDebug = 1,
    ...
    .numIUclDL = 1,
	.pIUclDL = &UclSysInst_0_IUclDL[0],
};

static SUclALOsASRInst UclALOsInst_0 = {
	.pCfg = &UclALOsCfg_0,
};

static SUclALDebugNullInst UclALDebugInst_0 = {
	.pCfg = &UclALDebugCfg_0,
};

static uint8 UclDLInst_0_IUclALPhy[1] = {0};
static uint8 UclDLInst_0_IUclDLCbk[1] = {0};
...
static SUclALPhyMailboxASRInst UclALPhyInst_0 = {
	.pCfg = &UclALPhyCfg_0,
	.numIUclALPhyCbk = 1,
...
/// Instance Links
///---------------------------------------------------------------------------------------------------------------------
static Ucl_ReturnType UclSysInst_0_DummyMain_IUclSys_Initialize(void) {return UclSysDL_Impl_IUclSys_Initialize(&UclSysInst_0, (0)); }
static Ucl_ReturnType UclSysInst_0_DummyMain_IUclSys_Send(uint8 dlInst, SUclDLMsg *pMsg) { return UclSysDL_Impl_IUclSys_Send(&UclSysInst_0, (0), dlInst, pMsg); }
static Ucl_ReturnType UclSysInst_0_DummyMain_IUclSys_Shutdown(void) {return UclSysDL_Impl_IUclSys_Shutdown(&UclSysInst_0, (0)); }
static void UclSysInst_0_DummyMain_IUclSys_Task(void) {UclSysDL_Impl_IUclSys_Task(&UclSysInst_0, (0)); }
...
static Ucl_ReturnType UclALOsInst_0_UclSysInst_0_IUclALOs_DisableAllInterrupts(void) {return UclALOsASR_Impl_IUclALOs_DisableAllInterrupts(&UclALOsInst_0, (0)); }
static Ucl_ReturnType UclALOsInst_0_UclSysInst_0_IUclALOs_EnableAllInterrupts(void) {return UclALOsASR_Impl_IUclALOs_EnableAllInterrupts(&UclALOsInst_0, (0)); }
static uint64 UclALOsInst_0_UclSysInst_0_IUclALOs_GetSystemTimeMs(void) {return UclALOsASR_Impl_IUclALOs_GetSystemTimeMs(&UclALOsInst_0, (0)); }
static uint32 UclALOsInst_0_UclSysInst_0_IUclALOs_GetSystemTimeResolutionMs(void) {return UclALOsASR_Impl_IUclALOs_GetSystemTimeResolutionMs(&UclALOsInst_0, (0)); }
static Ucl_ReturnType UclALOsInst_0_UclSysInst_0_IUclALOs_Initialize(void) {return UclALOsASR_Impl_IUclALOs_Initialize(&UclALOsInst_0, (0)); }
static Ucl_ReturnType UclALOsInst_0_UclSysInst_0_IUclALOs_Memcpy(void *pDest, void *pSrc, uint32 size) { return UclALOsASR_Impl_IUclALOs_Memcpy(&UclALOsInst_0, (0), pDest, pSrc, size); }
static Ucl_ReturnType UclALOsInst_0_UclSysInst_0_IUclALOs_Memset(void *pBuffer, uint8 val, uint32 size) { return UclALOsASR_Impl_IUclALOs_Memset(&UclALOsInst_0, (0), pBuffer, val, size); }
static Ucl_ReturnType UclALOsInst_0_UclSysInst_0_IUclALOs_MutexCreate(uint32 *pMutexId) { return UclALOsASR_Impl_IUclALOs_MutexCreate(&UclALOsInst_0, (0), pMutexId); }
static Ucl_ReturnType UclALOsInst_0_UclSysInst_0_IUclALOs_MutexDestroy(uint32 mutexId) { return UclALOsASR_Impl_IUclALOs_MutexDestroy(&UclALOsInst_0, (0), mutexId); }
static Ucl_ReturnType UclALOsInst_0_UclSysInst_0_IUclALOs_MutexLock(uint32 mutexId) { return UclALOsASR_Impl_IUclALOs_MutexLock(&UclALOsInst_0, (0), mutexId); }
static Ucl_ReturnType UclALOsInst_0_UclSysInst_0_IUclALOs_MutexUnlock(uint32 mutexId) { return UclALOsASR_Impl_IUclALOs_MutexUnlock(&UclALOsInst_0, (0), mutexId); }
static Ucl_ReturnType UclALOsInst_0_UclSysInst_0_IUclALOs_SemCreate(uint32 *pSemId, uint8 value) { return UclALOsASR_Impl_IUclALOs_SemCreate(&UclALOsInst_0, (0), pSemId, value); }
static Ucl_ReturnType UclALOsInst_0_UclSysInst_0_IUclALOs_SemDestroy(uint32 semId) { return UclALOsASR_Impl_IUclALOs_SemDestroy(&UclALOsInst_0, (0), semId); }
static Ucl_ReturnType UclALOsInst_0_UclSysInst_0_IUclALOs_SemPost(uint32 semId) { return UclALOsASR_Impl_IUclALOs_SemPost(&UclALOsInst_0, (0), semId); }
static Ucl_ReturnType UclALOsInst_0_UclSysInst_0_IUclALOs_SemWait(uint32 semId) { return UclALOsASR_Impl_IUclALOs_SemWait(&UclALOsInst_0, (0), semId); }
static Ucl_ReturnType UclALOsInst_0_UclSysInst_0_IUclALOs_Shutdown(void) {return UclALOsASR_Impl_IUclALOs_Shutdown(&UclALOsInst_0, (0)); }
static Ucl_ReturnType UclALOsInst_0_UclSysInst_0_IUclALOs_TaskCreate(uint32 *pThreadId, TUclOsTaskEntryFunc pFunc, void *pInst) { return UclALOsASR_Impl_IUclALOs_TaskCreate(&UclALOsInst_0, (0), pThreadId, pFunc, pInst); }
static Ucl_ReturnType UclALOsInst_0_UclSysInst_0_IUclALOs_TaskDestroy(uint32 threadId) { return UclALOsASR_Impl_IUclALOs_TaskDestroy(&UclALOsInst_0, (0), threadId); }
static void UclALOsInst_0_UclSysInst_0_IUclALOs_Tick(void) {UclALOsASR_Impl_IUclALOs_Tick(&UclALOsInst_0, (0)); }
static Ucl_ReturnType UclALOsInst_0_UclSysInst_0_IUclALOs_TimerCreate(uint32 *pTimerId, TUclOsTaskEntryFunc pFunc, void *pData, EUclOsTimerType timerType) { return UclALOsASR_Impl_IUclALOs_TimerCreate(&UclALOsInst_0, (0), pTimerId, pFunc, pData, timerType); }
static Ucl_ReturnType UclALOsInst_0_UclSysInst_0_IUclALOs_TimerDestroy(uint32 timerId) { return UclALOsASR_Impl_IUclALOs_TimerDestroy(&UclALOsInst_0, (0), timerId); }
static Ucl_ReturnType UclALOsInst_0_UclSysInst_0_IUclALOs_TimerStart(uint32 timerId, uint32 timeout) { return UclALOsASR_Impl_IUclALOs_TimerStart(&UclALOsInst_0, (0), timerId, timeout); }
static Ucl_ReturnType UclALOsInst_0_UclSysInst_0_IUclALOs_TimerStop(uint32 timerId) { return UclALOsASR_Impl_IUclALOs_TimerStop(&UclALOsInst_0, (0), timerId); }
static Ucl_ReturnType UclALOsInst_0_UclSysInst_0_IUclALOs_Memcmp(void *pDest, void *pSrc, uint32 size) { return UclALOsASR_Impl_IUclALOs_Memcmp(&UclALOsInst_0, (0), pDest, pSrc, size); }
static Ucl_ReturnType UclALOsInst_0_UclSysInst_0_IUclALOs_MutexTryLock(uint32 mutexId) { return UclALOsASR_Impl_IUclALOs_MutexTryLock(&UclALOsInst_0, (0), mutexId); }
...
static Ucl_ReturnType UclDLInst_0_UclSysInst_0_IUclDL_Initialize(void) {return UclDL_Impl_IUclDL_Initialize(&UclDLInst_0, (0)); }
static Ucl_ReturnType UclDLInst_0_UclSysInst_0_IUclDL_Send(SUclDLMsg *pMsg) { return UclDL_Impl_IUclDL_Send(&UclDLInst_0, (0), pMsg); }
static Ucl_ReturnType UclDLInst_0_UclSysInst_0_IUclDL_Shutdown(void) {return UclDL_Impl_IUclDL_Shutdown(&UclDLInst_0, (0)); }
static Ucl_ReturnType UclDLInst_0_UclSysInst_0_IUclDL_GetStats(SUclDLStats *pDLStats) { return UclDL_Impl_IUclDL_GetStats(&UclDLInst_0, (0), pDLStats); }
static const IUclDL UclDLInst_0_UclSysInst_0_IUclDL = {
	&UclDLInst_0_UclSysInst_0_IUclDL_Initialize,
	&UclDLInst_0_UclSysInst_0_IUclDL_Send,
	&UclDLInst_0_UclSysInst_0_IUclDL_Shutdown,
	&UclDLInst_0_UclSysInst_0_IUclDL_GetStats,
};
static void UclSysInst_0_UclDLInst_0_IUclDLCbk_FatalError(EUclDLError status) { UclSysDL_Impl_IUclDLCbk_FatalError(&UclSysInst_0, (0), status); }
static void UclSysInst_0_UclDLInst_0_IUclDLCbk_LinkStatusChanged(EUclDLLinkStatus status) { UclSysDL_Impl_IUclDLCbk_LinkStatusChanged(&UclSysInst_0, (0), status); }
static void UclSysInst_0_UclDLInst_0_IUclDLCbk_MsgReceived(EUclDLRxStatus status, SUclDLMsg *pMsg) { UclSysDL_Impl_IUclDLCbk_MsgReceived(&UclSysInst_0, (0), status, pMsg); }
static void UclSysInst_0_UclDLInst_0_IUclDLCbk_MsgTransmitStatus(uint16 msgId, EUclDLAckStatus status) { UclSysDL_Impl_IUclDLCbk_MsgTransmitStatus(&UclSysInst_0, (0), msgId, status); }
static const IUclDLCbk UclSysInst_0_UclDLInst_0_IUclDLCbk = {
	&UclSysInst_0_UclDLInst_0_IUclDLCbk_FatalError,
	&UclSysInst_0_UclDLInst_0_IUclDLCbk_LinkStatusChanged,
	&UclSysInst_0_UclDLInst_0_IUclDLCbk_MsgReceived,
	&UclSysInst_0_UclDLInst_0_IUclDLCbk_MsgTransmitStatus,
};
static void UclALDebugInst_0_UclSysInst_0_IUclALDebug_Initialize(void) {UclALDebugNull_Impl_IUclALDebug_Initialize(&UclALDebugInst_0, (0)); }
static void UclALDebugInst_0_UclSysInst_0_IUclALDebug_Log(EUclALDebugLevel level, char8 *pTag, char8 *pMsg) { UclALDebugNull_Impl_IUclALDebug_Log(&UclALDebugInst_0, (0), level, pTag, pMsg); }
static void UclALDebugInst_0_UclSysInst_0_IUclALDebug_SetLevel(EUclALDebugLevel level) { UclALDebugNull_Impl_IUclALDebug_SetLevel(&UclALDebugInst_0, (0), level); }
static void UclALDebugInst_0_UclSysInst_0_IUclALDebug_Shutdown(void) {UclALDebugNull_Impl_IUclALDebug_Shutdown(&UclALDebugInst_0, (0)); }
...
static Ucl_ReturnType UclALPhyInst_0_UclDLInst_0_IUclALPhy_Initialize(void) {return UclALPhyMailboxASR_Impl_IUclALPhy_Initialize(&UclALPhyInst_0, (0)); }
static Ucl_ReturnType UclALPhyInst_0_UclDLInst_0_IUclALPhy_Read(uint8 *pData, uint16 *pSize) { return UclALPhyMailboxASR_Impl_IUclALPhy_Read(&UclALPhyInst_0, (0), pData, pSize); }
static Ucl_ReturnType UclALPhyInst_0_UclDLInst_0_IUclALPhy_Shutdown(void) {return UclALPhyMailboxASR_Impl_IUclALPhy_Shutdown(&UclALPhyInst_0, (0)); }
static Ucl_ReturnType UclALPhyInst_0_UclDLInst_0_IUclALPhy_Write(uint8 *pData, uint16 size) { return UclALPhyMailboxASR_Impl_IUclALPhy_Write(&UclALPhyInst_0, (0), pData, size); }
...
const IUclDL *UclDLObjs[1] = {
	&UclDLInst_0_UclSysInst_0_IUclDL,
};

const IUclDLCbk *UclDLCbkObjs[1] = {
	&UclSysInst_0_UclDLInst_0_IUclDLCbk,
};
