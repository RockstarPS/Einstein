...
def GenerateReport():
    ...
    file_path = os.path.join(dir_path, '/media/sofia13/Data/workspace/workspace/Daily/MIC_Next_29130/BMW_MY26_MIC_NEXT_IC_EP29130_DAILY/programs/bmw/my2026/ic-mic/vp-build/Misc_script/daily/RAM_ROM_scripts/scripts/results/Vip_RAM_Report.html')
    #print(file_path)
    ...
    with open(file_path, 'w') as myFile:
        ...
        myFile.write('<tr bgcolor="#FDF5E6" ><td>VIP_RAM_metrics_BMW.py</td><td align="center">%.2f</td>' %memSize);
...
dir_path = os.path.dirname(sys.path[0])
file_path = os.path.join(dir_path, '/media/sofia13/Data/workspace/workspace/Daily/MIC_Next_29130/BMW_MY26_MIC_NEXT_IC_EP29130_DAILY/programs/bmw/my2026/ic-mic/vp-build/Misc_script/daily/RAM_ROM_scripts/scripts/results/vip_RAM.csv')
#print(file_path)
