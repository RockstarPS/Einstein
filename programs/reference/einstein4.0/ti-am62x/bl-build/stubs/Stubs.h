...
extern void Icu_EnableNotification(void);
extern void Icu_DisableNotification(void);
...
extern FUNC(Std_ReturnType, ECUAPPM_CODE)  Rte_Call_rp_CmpLibCmd_rp_CmpLibCmd_CPmicCdd_Impl_OnCommand(uint8 cmdP);
...
extern FUNC(Std_ReturnType, ECUAPPM_CODE)  Rte_Call_rp_CmpLibCmd_rp_CmpLibCmd_CRstMgr_Impl_OnCommand(uint8 cmdP);
...
extern FUNC(Std_ReturnType, ECUAPPM_CODE)  Rte_Call_rp_CmpLibCmd_rp_CmpLibCmd_CMemAbstractMdl_Impl_OnCommand(uint8 cmdP);
...
extern FUNC(Std_ReturnType, ECUAPPM_CODE)  Rte_Call_rp_CmpLibCmd_rp_CmpLibCmd_CGdtCdd_Impl_OnCommand(uint8 cmdP);
