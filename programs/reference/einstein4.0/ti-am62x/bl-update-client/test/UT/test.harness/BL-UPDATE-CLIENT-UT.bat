...
echo environment build BL-UPDATE-CLIENT-UT.env >> commands.tmp
echo /E:BL-UPDATE-CLIENT-UT tools script run BL-UPDATE-CLIENT-UT.tst >> commands.tmp
echo /E:BL-UPDATE-CLIENT-UT execute batch >> commands.tmp
echo /E:BL-UPDATE-CLIENT-UT reports custom management BL-UPDATE-CLIENT-UT_management_report.html >> commands.tmp
