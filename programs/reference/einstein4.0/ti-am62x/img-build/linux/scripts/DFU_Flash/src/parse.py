...
dfu_commands = {
    FLASH_MEDIA.NOR  : 'sf probe 0 0; dfu 0 sf 0:0',
...
reset_commands = {
    FLASH_MEDIA.USB  : 'mw 0x43000030 0x53 0x1;reset;',
...
def get_command(dfu_conf, reset, create):
    alt = []
    ...
    if media is FLASH_MEDIA.NAND:
        ...
        flash_command = f'mmc dev 0 0;run set_emmc_partitions;mmc part;setenv dfu_alt_info "{";".join(alt)}"'
    else:
