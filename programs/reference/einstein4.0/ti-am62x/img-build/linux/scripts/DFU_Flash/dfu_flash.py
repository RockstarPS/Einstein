...
def main():
    ...
    # Argument to create partitions before flashing the board 
    args_parser.add_argument("-C",
                             "--create",
                             action="store_true",
                             help="Create eMMC partition before flashing if partitions or not created",)
    ...
    # Get the DFU command
    command = get_command(dfu_flash_conf, cli_args["reset"], cli_args["create"])
