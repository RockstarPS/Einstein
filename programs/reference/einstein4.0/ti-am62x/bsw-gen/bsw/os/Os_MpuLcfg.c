...
*    Auto generated code in vAUTOSAR TOOL by SGOPAL1 at 2026-03-31 13:17:24.403558500
********************************************************************************************************************/
...
const OsIntMpuConfigType OsMpu_QMSystem[OsNumberOfMPURegions_OsMpu_QMSystem] = {
...
const OsMPUAccessGroupConfigType OsMPUAccessGroupConfig[OsMaxAccessGroupIds] = {
	...
	{
	/*Region Count					= */ OsNumberOfMPURegions_OsMpu_QMSystem,
	/*OsIntMpuConfigTypeRef			= */ (OsIntMpuConfigType*)&OsMpu_QMSystem
	}
};
