...
*    @brief This files contains the memory map for the PduR module.The file should be included in MemMap.h file.
...
/* Local scope */
#ifdef PDUR_START_SEC_VAR_INIT_LOCAL_UNSPECIFIED
/* Enter here a #pragma command for opening the specified section eg #pragma ghs section bss = ".bswdata" */
# undef PDUR_START_SEC_VAR_INIT_LOCAL_UNSPECIFIED
/* Remove this common define if specific section is configured  */
# define START_SEC_VAR_INIT_UNSPECIFIED
#endif

#ifdef PDUR_STOP_SEC_VAR_INIT_LOCAL_UNSPECIFIED
/* Enter here a #pragma command for closing the specified section , eg #pragma ghs section bss = default*/
# undef PDUR_STOP_SEC_VAR_INIT_LOCAL_UNSPECIFIED
/* Remove this common define if specific section is configured  */
# define STOP_SEC_VAR
#endif

#ifdef PDUR_START_SEC_VAR_INIT_LOCAL_8
/* Enter here a #pragma command for opening the specified section eg #pragma ghs section bss = ".bswdata" */
# undef PDUR_START_SEC_VAR_INIT_LOCAL_8
/* Remove this common define if specific section is configured  */
# define START_SEC_VAR_INIT_8
#endif

#ifdef PDUR_STOP_SEC_VAR_INIT_LOCAL_8
/* Enter here a #pragma command for closing the specified section , eg #pragma ghs section bss = default*/
# undef PDUR_STOP_SEC_VAR_INIT_LOCAL_8
/* Remove this common define if specific section is configured  */
# define STOP_SEC_VAR
#endif
...
#ifdef PDUR_START_SEC_CALLOUT_CODE
/* Enter here a #pragma command for opening the specified section eg #pragma ghs section text = ".bswcode" */
...
#ifdef PDUR_STOP_SEC_CALLOUT_CODE
/* Enter here a #pragma command for closing the specified section , eg #pragma ghs section text = default*/
...
#ifdef PDUR_START_SEC_APPL_CODE
/* Enter here a #pragma command for opening the specified section eg #pragma ghs section text = ".bswcode" */
