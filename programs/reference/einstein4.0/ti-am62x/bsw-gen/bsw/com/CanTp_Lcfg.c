...
{
    CANTP_PDU_DIAG_RESP_USDT,   /* DIAG_RESP_USDT */
    CANTP_PDU_DIAG_RESP_UUDT    /* DIAG_RESP_UUDT */
};
...
{
    CANTP_PDU_DIAG_REQ_PHYSICAL,    /* DIAG_REQ_PHYSICAL */
    CANTP_PDU_DIAG_REQ_FUNCTIONAL, /* DIAG_REQ_FUNCTIONAL */
};
...
{
    {  200U,  200U,  180U,  FALSE,  CANTP_STANDARD,  CANTP_ON,  CANTP_CANFD_PHYSICAL,  CANTP_CHANNEL_CANTPCHANNEL0,  64U,  PDUR_SRC_DIAG_RESP_USDT,  CANIF_PDU_DIAG_RESP_USDT,  CANTP_RXNSDU_DIAG_REQ_PHYSICAL }, /* 0 DIAG_RESP_USDT */
    {  200U,  200U,  180U,  FALSE,  CANTP_STANDARD,  CANTP_ON,  CANTP_CANFD_PHYSICAL,  CANTP_CHANNEL_CANTPCHANNEL0,  64U,  PDUR_SRC_DIAG_RESP_UUDT,  CANIF_PDU_DIAG_RESP_UUDT,  CANTP_RXNSDU_DIAG_REQ_PHYSICAL }, /* 1 DIAG_RESP_UUDT */
};
...
{
    {  20U,  100U,  200U,  0U,  0U,  0U,  CANTP_STANDARD,  CANTP_ON,  CANTP_CANFD_PHYSICAL,  CANTP_CHANNEL_CANTPCHANNEL0,  PDUR_SRC_DIAG_REQ_PHYSICAL,  CANTP_TXNSU_DIAG_RESP_USDT,  CANIF_PDU_DIAG_RESP_USDT, TRUE}, /* 0 DIAG_REQ_PHYSICAL */
    {  20U,  100U,  200U,  0U,  0U,  0U,  CANTP_STANDARD,  CANTP_ON,  CANTP_CANFD_FUNCTIONAL,  CANTP_CHANNEL_CANTPCHANNEL1,  PDUR_SRC_DIAG_REQ_FUNCTIONAL,  CANTP_TXNSU_DIAG_RESP_USDT,  CANIF_PDU_DIAG_RESP_USDT, TRUE}, /* 1 DIAG_REQ_FUNCTIONAL */
};
