...
#define CANIF_NUM_OF_MAILBOX 16U
...
#define CANIF_NUM_OF_TX_FIFO_ELEMENTS 5U
...
#define CANIF_PDU_CLUSTER_TX_NORMAL_COM_HS 0U
#define CANIF_PDU_CLUSTER_TX_NORMAL_COM_MS 1U
#define CANIF_PDU_CLUSTER_TX_NORMAL_COM_LS 2U
#define CANIF_PDU_CLUSTER_TX_REDUCED_COM 3U
#define CANIF_PDU_CLUSTER_SECURE_TX 4U
#define CANIF_PDU_IC_NMPDU 5U
#define CANIF_PDU_DEBUG_FRAME_1 6U
#define CANIF_PDU_DEBUG_FRAME_2 7U
#define CANIF_PDU_DEBUG_FRAME_3 8U
#define CANIF_PDU_DEBUG_FRAME_4 9U
#define CANIF_PDU_DEBUG_FRAME_5 10U
#define CANIF_PDU_DIAG_RESP_USDT 11U
#define CANIF_PDU_DIAG_RESP_UUDT 12U
#define CANIF_PDU_CAN1_Tx 13U

/*! @brief Defines the number of transmit PDU supported */
#define CANIF_NUM_OF_TX_PDU 13U
...
#define CANIF_PDU_VEHICLE_CONTROL 0U
#define CANIF_PDU_ILLUM_CONTROL 1U
#define CANIF_PDU_ABS 2U
#define CANIF_PDU_NM_COORD_NMPDU 3U
#define CANIF_PDU_DIAG_REQ_PHYSICAL 4U
#define CANIF_PDU_DIAG_REQ_FUNCTIONAL 5U
/*! @brief Defines the number of receive PDU supported */
#define CANIF_NUM_OF_RX_PDU                             6U
...
typedef struct
{
    ...
    P2VAR(uint8, AUTOMATIC, CANIF_APPL_DATA)
    CanIfRxPduBuffer;
...
typedef struct
{
    ...
    P2CONST(CanIf_RxHashTableType, AUTOMATIC, CANIF_APPL_CONST)
    pRxRxHashTableRef;
...
extern void CanIf_EnterCriticalSection(void);
extern void CanIf_ExitCriticalSection(void);
