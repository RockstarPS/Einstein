...
/* Stub function delaration for UlTxTimeoutExceptionFunctPtr */
static void Nm_TxTimeoutExceptionStub(void);
#endif
...
/* Stub function definition for UlTxTimeoutExceptionFunctPtr */
#if (NM_PASSIVE_MODE_ENABLED == STD_OFF)
static void Nm_TxTimeoutExceptionStub(void)
{
    /*Do Nothing*/
