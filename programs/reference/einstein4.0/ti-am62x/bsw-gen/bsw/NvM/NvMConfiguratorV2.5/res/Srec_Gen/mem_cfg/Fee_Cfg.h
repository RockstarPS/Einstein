...
#define FEE_USE_BLANKCHECK                       STD_OFF
...
#define FLS_BLANKCHECK(x,y)                      FeeExt_BlankCheck(x,y)
#define FEE_BLANKCHECK_LENGTH                    4
#endif

#define FEE_NUM_BLOCKS          213
#define FEE_NUM_PARTITIONS      7
#define FEE_MAX_LENGTH          534
#define FEE_SECTOR_HEADER_SIZE  8
#define FEE_SECTOR_FOOTER_SIZE  8
#define FEE_HEADER_SIZE         8
#define FEE_NUM_OF_SECTORS      14
