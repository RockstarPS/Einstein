...
{
    {  /* Full element 0 of array */
        {  /* Nested struct: ChannelConfig */
			{
                PwmConf_PwmChannel_PwmChannel_1,  /* Mcal PWM channel id */
                0,                                /* DUTY Resolution Id */
                0                                 /* PERIOD Resolution Id */
			}
        },                                    /* End of nested struct */
        FALSE,                                /* PWM update only on edge? */
        eIO_DOUT_DO_PWM_DIMMING               /* PWM Output Signal Id */
