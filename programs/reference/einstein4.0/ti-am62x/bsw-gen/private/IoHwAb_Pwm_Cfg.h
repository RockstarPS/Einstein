...
*/
#define IOHWAB_PWM_ENABLE     (STD_ON)
/*****************************************************************************
...
#define IOHWAB_NUM_OF_PWM_OUTPUT   1u

#define IOHWAB_MAX_DUTY_VAL             0x8000u
#define IOHWAB_MAX_PERIOD_VAL           0xFFFFu
...
#define IOHWAB_PWM_PERIOD_MASK                     0xFFFFu /*Macro to define the maximum allowable value for PWM period */
...
typedef struct
{
  ...
  boolean PwmDutyPeriodUpdateOnEdgeNotification;
