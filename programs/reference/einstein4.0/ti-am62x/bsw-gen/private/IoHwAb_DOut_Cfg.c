...
const IoHwAb_DOutCfgType IoHwAb_DOutCfg[IOHWAB_NUM_DOUT_OUTPUT] =
{
    ...
    /* TELL TALES from LEDDRV */
    {
        {
            /* LEFT_ESC_SERVICE_LED */
            {
                LEFT_ESC_SERVICE_LED,                                 /* LED Driver channel id*/
                STD_LOW,                                        /* Init value of output signal*/
                IOHWAB_SOURCE_DOUT_LEDDRV,                        /* Source ID of the output pin*/
                IOHWAB_DOUT_ACTIVE_HIGH,                        /* Active level of the output pin*/
            }
        },
        eIO_DOUT_LEFT_ESC_SERVICE_LED
    },
    {
        {
            /* LEFT_TIRE_PRESSURE_LED */
            {
                LEFT_TIRE_PRESSURE_LED,                                 /* LED Driver channel id*/
                STD_LOW,                                        /* Init value of output signal*/
                IOHWAB_SOURCE_DOUT_LEDDRV,                        /* Source ID of the output pin*/
                IOHWAB_DOUT_ACTIVE_HIGH,                        /* Active level of the output pin*/
            }
        },
        eIO_DOUT_LEFT_TIRE_PRESSURE_LED
    },
	{
        {
            /* LEFT_EU_BRAKE_LED */
            {
                LEFT_EU_BRAKE_LED,                                 /* LED Driver channel id*/
                STD_LOW,                                        /* Init value of output signal*/
                IOHWAB_SOURCE_DOUT_LEDDRV,                        /* Source ID of the output pin*/
                IOHWAB_DOUT_ACTIVE_HIGH,                        /* Active level of the output pin*/
            }
        },
        eIO_DOUT_LEFT_EU_BRAKE_LED
    },
	{
        {
            /* LEFT_DRV_AIR_BAG_LED */
            {
                LEFT_DRV_AIR_BAG_LED,                                 /* LED Driver channel id*/
                STD_LOW,                                        /* Init value of output signal*/
                IOHWAB_SOURCE_DOUT_LEDDRV,                        /* Source ID of the output pin*/
                IOHWAB_DOUT_ACTIVE_HIGH,                       /* Active level of the output pin*/
            }
        },
        eIO_DOUT_LEFT_DRV_AIR_BAG_LED
    },
	{
        {
            /* LEFT_SEATBELT_LED */
            {
                LEFT_SEATBELT_LED,                                 /* LED Driver channel id*/
                STD_LOW,                                        /* Init value of output signal*/
                IOHWAB_SOURCE_DOUT_LEDDRV,                        /* Source ID of the output pin*/
                IOHWAB_DOUT_ACTIVE_HIGH,                        /* Active level of the output pin*/
            }
        },
        eIO_DOUT_LEFT_SEATBELT_LED
    },
	{
        {
            /* LEFT_US_BRAKE_LED */
            {
                LEFT_US_BRAKE_LED,                                 /* LED Driver channel id*/
                STD_LOW,                                        /* Init value of output signal*/
                IOHWAB_SOURCE_DOUT_LEDDRV,                        /* Source ID of the output pin*/
                IOHWAB_DOUT_ACTIVE_HIGH,                       /* Active level of the output pin*/
            }
        },
        eIO_DOUT_LEFT_US_BRAKE_LED
    },
	{
        {
            /* LEFT_ANTILOCK_BRAKE_LED */
            {
                LEFT_ANTILOCK_BRAKE_LED,                                 /* LED Driver channel id*/
                STD_LOW,                                        /* Init value of output signal*/
                IOHWAB_SOURCE_DOUT_LEDDRV,                        /* Source ID of the output pin*/
                IOHWAB_DOUT_ACTIVE_HIGH,                      /* Active level of the output pin*/
            }
        },
        eIO_DOUT_LEFT_ANTILOCK_BRAKE_LED
    },
	{
        {
            /* RIGHT_ESC_OFF_LED */
            {
                RIGHT_ESC_OFF_LED,                                 /* LED Driver channel id*/
                STD_LOW,                                        /* Init value of output signal*/
                IOHWAB_SOURCE_DOUT_LEDDRV,                        /* Source ID of the output pin*/
                IOHWAB_DOUT_ACTIVE_HIGH,                       /* Active level of the output pin*/
            }
        },
        eIO_DOUT_RIGHT_ESC_OFF_LED
    },
	{
        {
            /* RIGHT_ESC_SERVICE_LED */
            {
                RIGHT_ESC_SERVICE_LED,                                 /* LED Driver channel id*/
                STD_LOW,                                        /* Init value of output signal*/
                IOHWAB_SOURCE_DOUT_LEDDRV,                        /* Source ID of the output pin*/
                IOHWAB_DOUT_ACTIVE_HIGH,                       /* Active level of the output pin*/
            }
        },
        eIO_DOUT_RIGHT_ESC_SERVICE_LED
    },
	{
        {
            /* RIGHT_TIRE_PRESSURE_LED */
            {
                RIGHT_TIRE_PRESSURE_LED,                                 /* LED Driver channel id*/
                STD_LOW,                                        /* Init value of output signal*/
                IOHWAB_SOURCE_DOUT_LEDDRV,                        /* Source ID of the output pin*/
                IOHWAB_DOUT_ACTIVE_HIGH,                        /* Active level of the output pin*/
            }
        },
        eIO_DOUT_RIGHT_TIRE_PRESSURE_LED
    },
	{
        {
            /* RIGHT_EU_BRAKE_LED */
            {
                RIGHT_EU_BRAKE_LED,                                 /* LED Driver channel id*/
                STD_LOW,                                        /* Init value of output signal*/
                IOHWAB_SOURCE_DOUT_LEDDRV,                        /* Source ID of the output pin*/
                IOHWAB_DOUT_ACTIVE_HIGH,                        /* Active level of the output pin*/
            }
        },
        eIO_DOUT_RIGHT_EU_BRAKE_LED
    },
    {
        {
            /* Variant 1 */
            {
                Main_GPIO1_Channel_2,                                 /* LED Driver channel id*/
                STD_LOW,                                        /* Init value of output signal*/
                IOHWAB_SOURCE_DOUT_MCAL,                        /* Source ID of the output pin*/
                IOHWAB_DOUT_ACTIVE_HIGH,                        /* Active level of the output pin*/
            }
        },
        eIO_DOUT_DO_1V2_EN
	...
	{
        {
            /* Variant 1 */
            {
                MCU_GPIO0_B01_Ch12,                                 /* Mcal dio channel id*/
                STD_LOW,                                        /* Init value of output signal*/
                IOHWAB_SOURCE_DOUT_MCAL,                        /* Source ID of the output pin*/
                IOHWAB_DOUT_ACTIVE_HIGH,                        /* Active level of the output pin*/
            }
        },
        eIO_DOUT_DO_LIN_NSLP
    },
    {
        {
            /* Variant 1 */
...
void IoHwAb_Dio_WriteChannel(Dio_ChannelType ChannelId, Dio_LevelType Level, IoHwAb_DOutSourceSignalType SourceSignalId)
{
    ...
    {
        (void)IoExp_WriteChannel(ChannelId, Level);
    }
    else if(SourceSignalId == IOHWAB_SOURCE_DOUT_LEDDRV)
    {
        LedDrv_WriteChannel(ChannelId, Level);
    }
    else
    {
        /* Nothing to do */
