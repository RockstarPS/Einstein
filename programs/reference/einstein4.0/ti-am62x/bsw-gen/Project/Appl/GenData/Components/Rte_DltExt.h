 ...
 * API prototypes
 *********************************************************************************************************************/
FUNC(Std_ReturnType, RTE_CODE) Rte_Read_DltExt_rSR_DLTControlMessageRequest_DLTControlMessageRequestData(P2VAR(SDLTControlMessageRequest, AUTOMATIC, RTE_DLTEXT_APPL_VAR) data); /* PRQA S 0850 */ /* MD_MSR_19.8 */
FUNC(Std_ReturnType, RTE_CODE) Rte_Read_DltExt_rSR_DLTMessageReadAck_DLTMessageReadAckData(P2VAR(SDLTMessageReadAck, AUTOMATIC, RTE_DLTEXT_APPL_VAR) data); /* PRQA S 0850 */ /* MD_MSR_19.8 */
FUNC(Std_ReturnType, RTE_CODE) Rte_Write_DltExt_pSR_DLTControlMessageReponse_DLTControlMessageReponseData(P2CONST(SDLTControlMessageReponse, AUTOMATIC, RTE_DLTEXT_APPL_DATA) data); /* PRQA S 0850 */ /* MD_MSR_19.8 */
FUNC(Std_ReturnType, RTE_CODE) Rte_Write_DltExt_pSR_DLTMessageReadRequest_DLTMessageReadRequestData(P2CONST(SDLTMessageReadRequest, AUTOMATIC, RTE_DLTEXT_APPL_DATA) data); /* PRQA S 0850 */ /* MD_MSR_19.8 */
 ...
 *********************************************************************************************************************/
#  define Rte_Read_rSR_DLTControlMessageRequest_DLTControlMessageRequestData Rte_Read_DltExt_rSR_DLTControlMessageRequest_DLTControlMessageRequestData
 ...
 *********************************************************************************************************************/
#  define Rte_Write_pSR_DLTControlMessageReponse_DLTControlMessageReponseData Rte_Write_DltExt_pSR_DLTControlMessageReponse_DLTControlMessageReponseData
...
#  define RTE_RUNNABLE_DltExt_OnDreDLTMessageReadAckData DltExt_OnDreDLTMessageReadAckData
...
FUNC(void, DltExt_CODE) DltExt_OnDreDLTMessageReadAckData(void); /* PRQA S 0850, 3451 */ /* MD_MSR_19.8, MD_Rte_3451 */
