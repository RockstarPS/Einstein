 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *          File:  Rte_MemAbstract_Stub_Safe_Type.h
 *        Config:  BMW.dpa
 *   ECU-Project:  IC
 *
 ...
 *       License:  CBD1800851
 *
 *   Description:  Application types header file for SW-C <MemAbstract_Stub_Safe>
 *********************************************************************************************************************/

/* double include prevention */
#ifndef _RTE_MEMABSTRACT_STUB_SAFE_TYPE_H
# define _RTE_MEMABSTRACT_STUB_SAFE_TYPE_H
...
#endif /* _RTE_MEMABSTRACT_STUB_SAFE_TYPE_H */
