 ...
 *          File:  Mdl_wAirbag.c
 *        Config:  BMW.dpa
 *     SW-C Type:  Mdl_wAirbag
 *
 *     Generator:  MICROSAR RTE Generator Version 4.19.0
 *                 RTE Core Version 1.19.0
 *       License:  CBD1800851
 *
 *   Description:  C-Code implementation template for SW-C <Mdl_wAirbag>
 *********************************************************************************************************************/
...
#include "Rte_Mdl_wAirbag.h" /* PRQA S 0857 */ /* MD_MSR_1.1_857 */
#include "TSC_Mdl_wAirbag.h"
...
static void Mdl_wAirbag_TestDefines(void);
...
#define Mdl_wAirbag_START_SEC_CODE
#include "Mdl_wAirbag_MemMap.h" /* PRQA S 5087 */ /* MD_MSR_19.1 */

/**********************************************************************************************************************
 *
 * Runnable Entity Name: Mdl_wAirbag_Init
 *
 ...
 * Runnable prototype:
 * ===================
 *   void Mdl_wAirbag_Init(void)
 *
 *********************************************************************************************************************/
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of documentation area >>                  DO NOT CHANGE THIS COMMENT!
 * Symbol: Mdl_wAirbag_Init_doc
 *********************************************************************************************************************/
...
FUNC(void, Mdl_wAirbag_CODE) Mdl_wAirbag_Init(void) /* PRQA S 0850 */ /* MD_MSR_19.8 */
{
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of runnable implementation >>             DO NOT CHANGE THIS COMMENT!
 * Symbol: Mdl_wAirbag_Init
 *********************************************************************************************************************/

  Mdl_wAirbag_TestDefines();
...
/**********************************************************************************************************************
 *
 * Runnable Entity Name: Mdl_wAirbag_Task
 *
 * This runnable can be invoked concurrently (reentrant implementation).
 *
 *---------------------------------------------------------------------------------------------------------------------
 ...
 *   Std_ReturnType Rte_Read_rp_Vehiclestate_WSSCurrentVehicleState(VehicleActiveModes *data)
 *
 * Client/Server Interfaces:
 * =========================
 *   Server Invocation:
 *   ------------------
 *   Std_ReturnType Rte_Call_rpUpdateAirbagWarning_UpdateWarningStatus(WarningId WarningCurId, WarningStatus WarningCurStatus, WarningEvent WarningCurEvent, UInt32 WarningPayload)
 *     Synchronous Server Invocation. Timeout: None
 *   Std_ReturnType Rte_Call_rp_CS_CanAdapterSafeRx_RxCan_GetSignalValue(tSafeRxSignalId SignalId, UInt8 *pSignalValue, tSafeRxSignalStatus *pSignalStatus)
 *     Synchronous Server Invocation. Timeout: None
 *     Returned Application Errors: RTE_E_if_CS_ComAbsRxSafe_E_NOT_OK
 *   Std_ReturnType Rte_Call_rp_CS_CanAdapterSafeRx_RxCan_GetSignalValueU8Arr(tSafeRxSignalId SignalId, UInt8 *pSignalValue, tSafeRxSignalStatus *pSignalStatus, UInt32 *pSignalLength)
 *     Synchronous Server Invocation. Timeout: None
 *     Returned Application Errors: RTE_E_if_CS_ComAbsRxSafe_E_NOT_OK
 *   Std_ReturnType Rte_Call_rp_CS_CanAdapterSafeRx_RxCan_SetSignalInitValue(tSafeRxSignalId SignalId, UInt8 *pSignalValue)
 *     Synchronous Server Invocation. Timeout: None
 *     Returned Application Errors: RTE_E_if_CS_ComAbsRxSafe_E_NOT_OK
 *   Std_ReturnType Rte_Call_rp_CS_CanAdapterSafeRx_RxCan_SetSignalInitValueU8Arr(tSafeRxSignalId SignalId, UInt8 *pSignaValue, UInt32 *pSignalLength)
 *     Synchronous Server Invocation. Timeout: None
 *     Returned Application Errors: RTE_E_if_CS_ComAbsRxSafe_E_NOT_OK
 *   Std_ReturnType Rte_Call_rp_CS_CanAdapterSafeRx_RxCan_SignalClearJustRcvdStatus(tSafeRxSignalId SignalId)
 *     Synchronous Server Invocation. Timeout: None
 *   Std_ReturnType Rte_Call_rp_CS_CanAdapterSafeRx_RxCan_SignalGetJustRcvdStatus(tSafeRxSignalId SignalId, tSafeRxSignalJustRcvdStatus *pJustRcvdStatus)
 *     Synchronous Server Invocation. Timeout: None
 *   Std_ReturnType Rte_Call_rp_CS_CanAdapterSafeRx_RxCan_SignalInvalidProcessingControl(tSafeRxSignalId SignalId, Boolean Status)
 *     Synchronous Server Invocation. Timeout: None
 *   Std_ReturnType Rte_Call_rp_CS_CanAdapterSafeRx_RxCan_SignalMissingProcessingControl(tSafeRxSignalId SignalId, Boolean Status)
 *     Synchronous Server Invocation. Timeout: None
 *   Std_ReturnType Rte_Call_rp_CS_CanAdapterSafeRx_RxCan_SignalNRProcessingControl(tSafeRxSignalId SignalId, Boolean Status)
 *     Synchronous Server Invocation. Timeout: None
 *
 *********************************************************************************************************************/
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of documentation area >>                  DO NOT CHANGE THIS COMMENT!
 * Symbol: Mdl_wAirbag_Task_doc
 *********************************************************************************************************************/
...
FUNC(void, Mdl_wAirbag_CODE) Mdl_wAirbag_Task(void) /* PRQA S 0850 */ /* MD_MSR_19.8 */
{
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of runnable implementation >>             DO NOT CHANGE THIS COMMENT!
 * Symbol: Mdl_wAirbag_Task
 *********************************************************************************************************************/
  ...
  VehicleActiveModes Read_rp_Vehiclestate_WSSCurrentVehicleState;

  UInt8 Call_rp_CS_CanAdapterSafeRx_RxCan_GetSignalValue_pSignalValue = 0U;
  tSafeRxSignalStatus Call_rp_CS_CanAdapterSafeRx_RxCan_GetSignalValue_pSignalStatus = 0U;
  UInt8 Call_rp_CS_CanAdapterSafeRx_RxCan_GetSignalValueU8Arr_pSignalValue = 0U;
  tSafeRxSignalStatus Call_rp_CS_CanAdapterSafeRx_RxCan_GetSignalValueU8Arr_pSignalStatus = 0U;
  UInt32 Call_rp_CS_CanAdapterSafeRx_RxCan_GetSignalValueU8Arr_pSignalLength = 0U;
  UInt8 Call_rp_CS_CanAdapterSafeRx_RxCan_SetSignalInitValue_pSignalValue = 0U;
  UInt8 Call_rp_CS_CanAdapterSafeRx_RxCan_SetSignalInitValueU8Arr_pSignaValue = 0U;
  UInt32 Call_rp_CS_CanAdapterSafeRx_RxCan_SetSignalInitValueU8Arr_pSignalLength = 0U;
  tSafeRxSignalJustRcvdStatus Call_rp_CS_CanAdapterSafeRx_RxCan_SignalGetJustRcvdStatus_pJustRcvdStatus = 0U;

  /*************************************************
  * Direct Function Accesses
  *************************************************/

  fct_status = TSC_Mdl_wAirbag_Rte_Read_rpIgnSubstate_IgnitionSubstate(&Read_rpIgnSubstate_IgnitionSubstate);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_Mdl_wAirbag_Rte_Read_rp_ClusterMode_WSSCurrentClusterMode(&Read_rp_ClusterMode_WSSCurrentClusterMode);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_Mdl_wAirbag_Rte_Read_rp_Vehiclestate_WSSCurrentVehicleState(&Read_rp_Vehiclestate_WSSCurrentVehicleState);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_Mdl_wAirbag_Rte_Call_rpUpdateAirbagWarning_UpdateWarningStatus(0U, 0U, 0U, 0U);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_Mdl_wAirbag_Rte_Call_rp_CS_CanAdapterSafeRx_RxCan_GetSignalValue(0U, &Call_rp_CS_CanAdapterSafeRx_RxCan_GetSignalValue_pSignalValue, &Call_rp_CS_CanAdapterSafeRx_RxCan_GetSignalValue_pSignalStatus);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_Mdl_wAirbag_Rte_Call_rp_CS_CanAdapterSafeRx_RxCan_GetSignalValueU8Arr(0U, &Call_rp_CS_CanAdapterSafeRx_RxCan_GetSignalValueU8Arr_pSignalValue, &Call_rp_CS_CanAdapterSafeRx_RxCan_GetSignalValueU8Arr_pSignalStatus, &Call_rp_CS_CanAdapterSafeRx_RxCan_GetSignalValueU8Arr_pSignalLength);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_Mdl_wAirbag_Rte_Call_rp_CS_CanAdapterSafeRx_RxCan_SetSignalInitValue(0U, &Call_rp_CS_CanAdapterSafeRx_RxCan_SetSignalInitValue_pSignalValue);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_Mdl_wAirbag_Rte_Call_rp_CS_CanAdapterSafeRx_RxCan_SetSignalInitValueU8Arr(0U, &Call_rp_CS_CanAdapterSafeRx_RxCan_SetSignalInitValueU8Arr_pSignaValue, &Call_rp_CS_CanAdapterSafeRx_RxCan_SetSignalInitValueU8Arr_pSignalLength);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_Mdl_wAirbag_Rte_Call_rp_CS_CanAdapterSafeRx_RxCan_SignalClearJustRcvdStatus(0U);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_Mdl_wAirbag_Rte_Call_rp_CS_CanAdapterSafeRx_RxCan_SignalGetJustRcvdStatus(0U, &Call_rp_CS_CanAdapterSafeRx_RxCan_SignalGetJustRcvdStatus_pJustRcvdStatus);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_Mdl_wAirbag_Rte_Call_rp_CS_CanAdapterSafeRx_RxCan_SignalInvalidProcessingControl(0U, FALSE);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_Mdl_wAirbag_Rte_Call_rp_CS_CanAdapterSafeRx_RxCan_SignalMissingProcessingControl(0U, FALSE);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_Mdl_wAirbag_Rte_Call_rp_CS_CanAdapterSafeRx_RxCan_SignalNRProcessingControl(0U, FALSE);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
...
#define Mdl_wAirbag_STOP_SEC_CODE
#include "Mdl_wAirbag_MemMap.h" /* PRQA S 5087 */ /* MD_MSR_19.1 */
