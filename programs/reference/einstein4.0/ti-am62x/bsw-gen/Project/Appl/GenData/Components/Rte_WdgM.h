...
FUNC(void, WdgM_CODE) GraphicsTaskStubRunnable(void); /* PRQA S 0850, 3451 */ /* MD_MSR_19.8, MD_Rte_3451 */
FUNC(void, WdgM_CODE) TxRxIpcMessage(void); /* PRQA S 0850, 3451 */ /* MD_MSR_19.8, MD_Rte_3451 */
