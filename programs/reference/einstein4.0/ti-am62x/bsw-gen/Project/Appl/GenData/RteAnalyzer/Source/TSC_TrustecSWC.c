...
{
  return Rte_Read_RP_RX_SG_ABS_RP_SR_TX_SG_ABS(data, transformerError);
}
...
{
  return Rte_Write_PP_TX_SG_COM_HS_SG_COM_HS(data, transformerError);
}
...
{
  return Rte_Feedback_PP_TX_SG_COM_HS_SG_COM_HS();
}
