 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *          File:  CCDD_EcuBatteryM.c
 *        Config:  BMW.dpa
 *     SW-C Type:  CCDD_EcuBatteryM
 *
 *     Generator:  MICROSAR RTE Generator Version 4.19.0
 *                 RTE Core Version 1.19.0
 *       License:  CBD1800851
 *
 *   Description:  C-Code implementation template for SW-C <CCDD_EcuBatteryM>
 *********************************************************************************************************************/
...
#include "Rte_CCDD_EcuBatteryM.h" /* PRQA S 0857 */ /* MD_MSR_1.1_857 */
#include "TSC_CCDD_EcuBatteryM.h"
...
static void CCDD_EcuBatteryM_TestDefines(void);
...
/**********************************************************************************************************************
 *
 * Runnable Entity Name: CCDD_EcuBatteryM_Impl_MainFunction
 *
 ...
 * Symbol: CCDD_EcuBatteryM_Impl_MainFunction_doc
 *********************************************************************************************************************/
...
FUNC(void, CCDD_EcuBatteryM_CODE) CCDD_EcuBatteryM_Impl_MainFunction(void) /* PRQA S 0850 */ /* MD_MSR_19.8 */
{
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of runnable implementation >>             DO NOT CHANGE THIS COMMENT!
 * Symbol: CCDD_EcuBatteryM_Impl_MainFunction
 *********************************************************************************************************************/
  ...
  *************************************************/
  ...
  fct_status = TSC_CCDD_EcuBatteryM_Rte_Call_rpIoHwAb_ADC_GetAsyncRawAdc(0U, &Call_rpIoHwAb_ADC_GetAsyncRawAdc_AsyncRawAdc, &Call_rpIoHwAb_ADC_GetAsyncRawAdc_ErrorStatus);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CCDD_EcuBatteryM_Rte_Call_rpIoHwAb_ADC_GetProcessedAdc(0U, &Call_rpIoHwAb_ADC_GetProcessedAdc_ProcessedAdc, &Call_rpIoHwAb_ADC_GetProcessedAdc_ErrorStatus);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CCDD_EcuBatteryM_Rte_Call_rpIoHwAb_ADC_GetSyncRawAdc(0U, &Call_rpIoHwAb_ADC_GetSyncRawAdc_SyncRawAdc, &Call_rpIoHwAb_ADC_GetSyncRawAdc_ErrorStatus);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CCDD_EcuBatteryM_Rte_Call_rpIoHwAb_DOut_SetOutputGroup(0, 0U, &Call_rpIoHwAb_DOut_SetOutputGroup_ErrorStatus);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CCDD_EcuBatteryM_Rte_Call_rpIoHwAb_DOut_SetOutputPin(0U, FALSE, &Call_rpIoHwAb_DOut_SetOutputPin_ErrorStatus);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CCDD_EcuBatteryM_Rte_Call_rpIoHwAb_Din_GetAsyncRawInput(0U, &Call_rpIoHwAb_Din_GetAsyncRawInput_AsyncInput, &Call_rpIoHwAb_Din_GetAsyncRawInput_ErrorStatus);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CCDD_EcuBatteryM_Rte_Call_rpIoHwAb_Din_GetInputGroup(0, &Call_rpIoHwAb_Din_GetInputGroup_SyncInput, &Call_rpIoHwAb_Din_GetInputGroup_ErrorStatus);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CCDD_EcuBatteryM_Rte_Call_rpIoHwAb_Din_GetProcessedInput(0U, &Call_rpIoHwAb_Din_GetProcessedInput_InputSignal, &Call_rpIoHwAb_Din_GetProcessedInput_ErrorStatus);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CCDD_EcuBatteryM_Rte_Call_rpIoHwAb_Din_GetSyncRawInput(0U, &Call_rpIoHwAb_Din_GetSyncRawInput_SyncInput, &Call_rpIoHwAb_Din_GetSyncRawInput_ErrorStatus);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CCDD_EcuBatteryM_Rte_Call_rpIoHwAb_PWM_PwmSetDuty(0U, 0U, &Call_rpIoHwAb_PWM_PwmSetDuty_ErrorStatus);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CCDD_EcuBatteryM_Rte_Call_rpIoHwAb_PWM_PwmSetDutyAndPeriod(0U, 0U, 0U, &Call_rpIoHwAb_PWM_PwmSetDutyAndPeriod_ErrorStatus);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CCDD_EcuBatteryM_Rte_Call_rpIoHwAb_PWM_PwmSetIdeal(0U, &Call_rpIoHwAb_PWM_PwmSetIdeal_ErrorStatus);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
...
/**********************************************************************************************************************
 *
 * Runnable Entity Name: CCDD_EcuBatteryM_Impl_OnCommand
 *
 * This runnable can be invoked concurrently (reentrant implementation).
 *
 *---------------------------------------------------------------------------------------------------------------------
 ...
 * Runnable prototype:
 * ===================
 *   Std_ReturnType CCDD_EcuBatteryM_Impl_OnCommand(ECmpCmd cmdP)
 *
 **********************************************************************************************************************
 *
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of documentation area >>                  DO NOT CHANGE THIS COMMENT!
 * Symbol: CCDD_EcuBatteryM_Impl_OnCommand_doc
 *********************************************************************************************************************/
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of runnable implementation >>             DO NOT CHANGE THIS COMMENT!
 * Symbol: CCDD_EcuBatteryM_Impl_OnCommand (returns application error)
 *********************************************************************************************************************/
...
/**********************************************************************************************************************
 *
 * Runnable Entity Name: EcuBatteryM_GetChannelStatus
 *
 * This runnable can be invoked concurrently (reentrant implementation).
 *
 *---------------------------------------------------------------------------------------------------------------------
 *
 * Executed if at least one of the following trigger conditions occurred:
 *   - triggered by server invocation for OperationPrototype <EcuBatteryM_GetChannelStatus> of PortPrototype <ppCS_EcuBatteryOutData>
 *
 **********************************************************************************************************************
 *
 * Runnable prototype:
 * ===================
 *   Std_ReturnType EcuBatteryM_GetChannelStatus(UInt8 Channel, UInt8 *Status)
 *
 **********************************************************************************************************************
 *
 * Available Application Errors:
 * =============================
 *   RTE_E_TI_EcuBatteryMData_E_NOT_OK
 *
 *********************************************************************************************************************/
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of documentation area >>                  DO NOT CHANGE THIS COMMENT!
 * Symbol: EcuBatteryM_GetChannelStatus_doc
 *********************************************************************************************************************/
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of runnable implementation >>             DO NOT CHANGE THIS COMMENT!
 * Symbol: EcuBatteryM_GetChannelStatus (returns application error)
 *********************************************************************************************************************/
...
/**********************************************************************************************************************
 *
 * Runnable Entity Name: EcuBatteryM_GetDIOStatus
 *
 * This runnable can be invoked concurrently (reentrant implementation).
 *
 *---------------------------------------------------------------------------------------------------------------------
 *
 * Executed if at least one of the following trigger conditions occurred:
 *   - triggered by server invocation for OperationPrototype <EcuBatteryM_GetDIOStatus> of PortPrototype <ppCS_EcuBatteryOutData>
 *
 **********************************************************************************************************************
 *
 * Runnable prototype:
 * ===================
 *   Std_ReturnType EcuBatteryM_GetDIOStatus(UInt8 InputId, UInt8 *Status)
 *
 **********************************************************************************************************************
 *
 * Available Application Errors:
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of documentation area >>                  DO NOT CHANGE THIS COMMENT!
 * Symbol: EcuBatteryM_GetDIOStatus_doc
 *********************************************************************************************************************/
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of runnable implementation >>             DO NOT CHANGE THIS COMMENT!
 * Symbol: EcuBatteryM_GetDIOStatus (returns application error)
 *********************************************************************************************************************/
