 ...
 *       License:  CBD1800851
 *
 *   Description:  Application types header file for SW-C <RamTst>
 *********************************************************************************************************************/

/* double include prevention */
#ifndef _RTE_RAMTST_TYPE_H
# define _RTE_RAMTST_TYPE_H
