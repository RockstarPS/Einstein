 ...
 *       License:  CBD1800851
 *
 *   Description:  Application types header file for SW-C <Mdl_Dim>
 *********************************************************************************************************************/

/* double include prevention */
#ifndef _RTE_MDL_DIM_TYPE_H
# define _RTE_MDL_DIM_TYPE_H
