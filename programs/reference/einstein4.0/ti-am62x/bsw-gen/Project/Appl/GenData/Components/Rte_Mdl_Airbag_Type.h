 ...
 *       License:  CBD1800851
 *
 *   Description:  Application types header file for SW-C <Mdl_Airbag>
 *********************************************************************************************************************/

/* double include prevention */
#ifndef _RTE_MDL_AIRBAG_TYPE_H
# define _RTE_MDL_AIRBAG_TYPE_H
