 ...
 *       License:  CBD1800851
 *
 *   Description:  Application header file for SW-C <Ctrl_Dim>
 *********************************************************************************************************************/

/* double include prevention */
#ifndef _RTE_CTRL_DIM_H
# define _RTE_CTRL_DIM_H
...
#  define Rte_InitValue_rpSR_PowerCdd_AVP_HVP0Flag (FALSE)
#  define Rte_InitValue_rpSR_PowerCdd_AVP_HVSD0Flag (FALSE)
#  define Rte_InitValue_rpSR_PowerCdd_AVP_HVSD1Flag (FALSE)
#  define Rte_InitValue_rpSR_PowerCdd_AVP_HVSD2Flag (FALSE)
#  define Rte_InitValue_rpSR_PowerCdd_AVP_HVSD3Flag (FALSE)
#  define Rte_InitValue_rpSR_PowerCdd_AVP_HVSD4Flag (FALSE)
#  define Rte_InitValue_rpSR_PowerCdd_AVP_LVP0Flag (FALSE)
#  define Rte_InitValue_rpSR_PowerCdd_AVP_LVP1Flag (FALSE)
#  define Rte_InitValue_rpSR_PowerCdd_AVP_LVSD0Flag (FALSE)
#  define Rte_InitValue_rpSR_PowerCdd_AVP_LVSD1Flag (FALSE)
#  define Rte_InitValue_rpSR_PowerCdd_AVP_LVSD2Flag (FALSE)
#  define Rte_InitValue_rpSR_PowerCdd_AVP_LVSD3Flag (FALSE)
#  define Rte_InitValue_rpSR_PowerCdd_AVP_LVSD4Flag (FALSE)
#  define Rte_InitValue_rpSR_PowerCdd_AVP_SVPFlag (FALSE)
 ...
 * API prototypes
 *********************************************************************************************************************/
FUNC(Std_ReturnType, RTE_CODE) Rte_Write_Ctrl_Dim_pSR_IlluminationData_IlluminationDataData(P2CONST(SIlluminationData, AUTOMATIC, RTE_CTRL_DIM_APPL_DATA) data); /* PRQA S 0850 */ /* MD_MSR_19.8 */
 ...
 *********************************************************************************************************************/
#  define Rte_Read_rpEtmSts_IllumStatus Rte_Read_Ctrl_Dim_rpEtmSts_IllumStatus
#  define Rte_Read_Ctrl_Dim_rpEtmSts_IllumStatus(data) (*(data) = 0U, ((Std_ReturnType)RTE_E_UNCONNECTED)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rpIgnSubstate_IgnitionSubstate Rte_Read_Ctrl_Dim_rpIgnSubstate_IgnitionSubstate
#  define Rte_Read_Ctrl_Dim_rpIgnSubstate_IgnitionSubstate(data) (*(data) = Rte_Ctrl_WSS_ppIgnSubstate_IgnitionSubstate, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rpIllum_Etm_IllumStatus Rte_Read_Ctrl_Dim_rpIllum_Etm_IllumStatus
#  define Rte_Read_Ctrl_Dim_rpIllum_Etm_IllumStatus(data) (*(data) = 0U, ((Std_ReturnType)RTE_E_UNCONNECTED)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rpSR_PowerCdd_AVP_HVP0Flag Rte_Read_Ctrl_Dim_rpSR_PowerCdd_AVP_HVP0Flag
#  define Rte_Read_Ctrl_Dim_rpSR_PowerCdd_AVP_HVP0Flag(data) (*(data) = FALSE, ((Std_ReturnType)RTE_E_UNCONNECTED)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rpSR_PowerCdd_AVP_HVSD0Flag Rte_Read_Ctrl_Dim_rpSR_PowerCdd_AVP_HVSD0Flag
#  define Rte_Read_Ctrl_Dim_rpSR_PowerCdd_AVP_HVSD0Flag(data) (*(data) = FALSE, ((Std_ReturnType)RTE_E_UNCONNECTED)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rpSR_PowerCdd_AVP_HVSD1Flag Rte_Read_Ctrl_Dim_rpSR_PowerCdd_AVP_HVSD1Flag
#  define Rte_Read_Ctrl_Dim_rpSR_PowerCdd_AVP_HVSD1Flag(data) (*(data) = FALSE, ((Std_ReturnType)RTE_E_UNCONNECTED)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rpSR_PowerCdd_AVP_HVSD2Flag Rte_Read_Ctrl_Dim_rpSR_PowerCdd_AVP_HVSD2Flag
#  define Rte_Read_Ctrl_Dim_rpSR_PowerCdd_AVP_HVSD2Flag(data) (*(data) = FALSE, ((Std_ReturnType)RTE_E_UNCONNECTED)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rpSR_PowerCdd_AVP_HVSD3Flag Rte_Read_Ctrl_Dim_rpSR_PowerCdd_AVP_HVSD3Flag
#  define Rte_Read_Ctrl_Dim_rpSR_PowerCdd_AVP_HVSD3Flag(data) (*(data) = FALSE, ((Std_ReturnType)RTE_E_UNCONNECTED)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rpSR_PowerCdd_AVP_HVSD4Flag Rte_Read_Ctrl_Dim_rpSR_PowerCdd_AVP_HVSD4Flag
#  define Rte_Read_Ctrl_Dim_rpSR_PowerCdd_AVP_HVSD4Flag(data) (*(data) = FALSE, ((Std_ReturnType)RTE_E_UNCONNECTED)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rpSR_PowerCdd_AVP_LVP0Flag Rte_Read_Ctrl_Dim_rpSR_PowerCdd_AVP_LVP0Flag
#  define Rte_Read_Ctrl_Dim_rpSR_PowerCdd_AVP_LVP0Flag(data) (*(data) = FALSE, ((Std_ReturnType)RTE_E_UNCONNECTED)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rpSR_PowerCdd_AVP_LVP1Flag Rte_Read_Ctrl_Dim_rpSR_PowerCdd_AVP_LVP1Flag
#  define Rte_Read_Ctrl_Dim_rpSR_PowerCdd_AVP_LVP1Flag(data) (*(data) = FALSE, ((Std_ReturnType)RTE_E_UNCONNECTED)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rpSR_PowerCdd_AVP_LVSD0Flag Rte_Read_Ctrl_Dim_rpSR_PowerCdd_AVP_LVSD0Flag
#  define Rte_Read_Ctrl_Dim_rpSR_PowerCdd_AVP_LVSD0Flag(data) (*(data) = FALSE, ((Std_ReturnType)RTE_E_UNCONNECTED)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rpSR_PowerCdd_AVP_LVSD1Flag Rte_Read_Ctrl_Dim_rpSR_PowerCdd_AVP_LVSD1Flag
#  define Rte_Read_Ctrl_Dim_rpSR_PowerCdd_AVP_LVSD1Flag(data) (*(data) = FALSE, ((Std_ReturnType)RTE_E_UNCONNECTED)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rpSR_PowerCdd_AVP_LVSD2Flag Rte_Read_Ctrl_Dim_rpSR_PowerCdd_AVP_LVSD2Flag
#  define Rte_Read_Ctrl_Dim_rpSR_PowerCdd_AVP_LVSD2Flag(data) (*(data) = FALSE, ((Std_ReturnType)RTE_E_UNCONNECTED)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rpSR_PowerCdd_AVP_LVSD3Flag Rte_Read_Ctrl_Dim_rpSR_PowerCdd_AVP_LVSD3Flag
#  define Rte_Read_Ctrl_Dim_rpSR_PowerCdd_AVP_LVSD3Flag(data) (*(data) = FALSE, ((Std_ReturnType)RTE_E_UNCONNECTED)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rpSR_PowerCdd_AVP_LVSD4Flag Rte_Read_Ctrl_Dim_rpSR_PowerCdd_AVP_LVSD4Flag
#  define Rte_Read_Ctrl_Dim_rpSR_PowerCdd_AVP_LVSD4Flag(data) (*(data) = FALSE, ((Std_ReturnType)RTE_E_UNCONNECTED)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rpSR_PowerCdd_AVP_SVPFlag Rte_Read_Ctrl_Dim_rpSR_PowerCdd_AVP_SVPFlag
#  define Rte_Read_Ctrl_Dim_rpSR_PowerCdd_AVP_SVPFlag(data) (*(data) = FALSE, ((Std_ReturnType)RTE_E_UNCONNECTED)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rpVehicleAppMode_WSSCurrentVehicleState Rte_Read_Ctrl_Dim_rpVehicleAppMode_WSSCurrentVehicleState
#  define Rte_Read_Ctrl_Dim_rpVehicleAppMode_WSSCurrentVehicleState(data) (*(data) = Rte_Ctrl_WSS_pp_VehicleAppMode_WSSCurrentVehicleState, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_ClusterMode_WSSCurrentClusterMode Rte_Read_Ctrl_Dim_rp_ClusterMode_WSSCurrentClusterMode
#  define Rte_Read_Ctrl_Dim_rp_ClusterMode_WSSCurrentClusterMode(data) (*(data) = Rte_Ctrl_WSS_pp_ClusterMode_WSSCurrentClusterMode, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_Ctrl_DayNight_Mode_Day_Night_mode_Ctrl Rte_Read_Ctrl_Dim_rp_Ctrl_DayNight_Mode_Day_Night_mode_Ctrl
#  define Rte_Read_Ctrl_Dim_rp_Ctrl_DayNight_Mode_Day_Night_mode_Ctrl(data) (*(data) = 0U, ((Std_ReturnType)RTE_E_UNCONNECTED)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_EcoRunSystemState_EcoRunSystem_Flag Rte_Read_Ctrl_Dim_rp_EcoRunSystemState_EcoRunSystem_Flag
#  define Rte_Read_Ctrl_Dim_rp_EcoRunSystemState_EcoRunSystem_Flag(data) (*(data) = 0U, ((Std_ReturnType)RTE_E_UNCONNECTED)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_EtmIllumSts_IllumStatus Rte_Read_Ctrl_Dim_rp_EtmIllumSts_IllumStatus
#  define Rte_Read_Ctrl_Dim_rp_EtmIllumSts_IllumStatus(data) (*(data) = 0U, ((Std_ReturnType)RTE_E_UNCONNECTED)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_IlumStep_IllumStepValue Rte_Read_Ctrl_Dim_rp_IlumStep_IllumStepValue
#  define Rte_Read_Ctrl_Dim_rp_IlumStep_IllumStepValue(data) (*(data) = Rte_Mdl_Dim_pp_IlumStep_IllumStepValue, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_RheostatDayStep_RheostatDayStep Rte_Read_Ctrl_Dim_rp_RheostatDayStep_RheostatDayStep
#  define Rte_Read_Ctrl_Dim_rp_RheostatDayStep_RheostatDayStep(data) (*(data) = Rte_Mdl_Dim_pp_RheostatDayStep_RheostatDayStep, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_RheostatNightStep_RheostatNightStep Rte_Read_Ctrl_Dim_rp_RheostatNightStep_RheostatNightStep
#  define Rte_Read_Ctrl_Dim_rp_RheostatNightStep_RheostatNightStep(data) (*(data) = Rte_Mdl_Dim_pp_RheostatNightStep_RheostatNightStep, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_Rheostat_Change_RheoUpdateVal Rte_Read_Ctrl_Dim_rp_Rheostat_Change_RheoUpdateVal
#  define Rte_Read_Ctrl_Dim_rp_Rheostat_Change_RheoUpdateVal(data) (*(data) = Rte_Mdl_Dim_pp_illum_rheostat_change_RheoUpdateVal, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_TFTDisplayOn_TFTDisplayOn Rte_Read_Ctrl_Dim_rp_TFTDisplayOn_TFTDisplayOn
#  define Rte_Read_Ctrl_Dim_rp_TFTDisplayOn_TFTDisplayOn(data) (*(data) = Rte_Ctrl_WSS_pp_TFTDisplayOn_TFTDisplayOn, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */


/**********************************************************************************************************************
 * Rte_Write_<p>_<d> (explicit S/R communication with isQueued = false)
 *********************************************************************************************************************/
#  define Rte_Write_pSR_IlluminationData_IlluminationDataData Rte_Write_Ctrl_Dim_pSR_IlluminationData_IlluminationDataData
#  define Rte_Write_pp_Ctrl_ILL_Duty_ILL_Duty Rte_Write_Ctrl_Dim_pp_Ctrl_ILL_Duty_ILL_Duty
#  define Rte_Write_Ctrl_Dim_pp_Ctrl_ILL_Duty_ILL_Duty(data) (RTE_E_OK) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Write_pp_Ctrl_RGB_Dimming_RGB_Dimming Rte_Write_Ctrl_Dim_pp_Ctrl_RGB_Dimming_RGB_Dimming
#  define Rte_Write_Ctrl_Dim_pp_Ctrl_RGB_Dimming_RGB_Dimming(data) (RTE_E_OK) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Write_pp_Ctrl_RGB_Starter_Status_Starter_Status Rte_Write_Ctrl_Dim_pp_Ctrl_RGB_Starter_Status_Starter_Status
#  define Rte_Write_Ctrl_Dim_pp_Ctrl_RGB_Starter_Status_Starter_Status(data) (RTE_E_OK) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Write_pp_Ctrl_Ready_to_Sleep_Ready_to_Sleep Rte_Write_Ctrl_Dim_pp_Ctrl_Ready_to_Sleep_Ready_to_Sleep
#  define Rte_Write_Ctrl_Dim_pp_Ctrl_Ready_to_Sleep_Ready_to_Sleep(data) (Rte_Ctrl_Dim_pp_Ctrl_Ready_to_Sleep_Ready_to_Sleep = (data), ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Write_pp_IlumDayNightRequired_IlumDayNightRequired Rte_Write_Ctrl_Dim_pp_IlumDayNightRequired_IlumDayNightRequired
#  define Rte_Write_Ctrl_Dim_pp_IlumDayNightRequired_IlumDayNightRequired(data) (Rte_Ctrl_Dim_pp_IlumDayNightRequired_IlumDayNightRequired = (data), ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Write_pp_IlumDayNightStatus_Day_Night_Status Rte_Write_Ctrl_Dim_pp_IlumDayNightStatus_Day_Night_Status
#  define Rte_Write_Ctrl_Dim_pp_IlumDayNightStatus_Day_Night_Status(data) (Rte_Ctrl_Dim_pp_IlumDayNightStatus_Day_Night_Status = (data), ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Write_pp_PWM_LCD_BL_Dimming_BL_Dimming Rte_Write_Ctrl_Dim_pp_PWM_LCD_BL_Dimming_BL_Dimming
#  define Rte_Write_Ctrl_Dim_pp_PWM_LCD_BL_Dimming_BL_Dimming(data) (RTE_E_OK) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Write_pp_StopPwmUpdate_channel_id Rte_Write_Ctrl_Dim_pp_StopPwmUpdate_channel_id
#  define Rte_Write_Ctrl_Dim_pp_StopPwmUpdate_channel_id(data) (Rte_Ctrl_Dim_pp_StopPwmUpdate_channel_id = (data), ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Write_pp_UCL_IlluminationData_IlluminationDataData Rte_Write_Ctrl_Dim_pp_UCL_IlluminationData_IlluminationDataData
#  define Rte_Write_Ctrl_Dim_pp_UCL_IlluminationData_IlluminationDataData(data) (RTE_E_OK) /* PRQA S 3453 */ /* MD_MSR_19.7 */
...
# ifndef RTE_CORE
#  define RTE_RUNNABLE_Ctrl_Dim_GetPwmCurrentDuty Ctrl_Dim_GetPwmCurrentDuty
#  define RTE_RUNNABLE_Ctrl_Dim_GetPwmDirect Ctrl_Dim_GetPwmDirect
#  define RTE_RUNNABLE_Ctrl_Dim_GetPwmWithTime Ctrl_Dim_GetPwmWithTime
#  define RTE_RUNNABLE_Ctrl_Dim_GetPwmWithTimeExp Ctrl_Dim_GetPwmWithTimeExp
#  define RTE_RUNNABLE_Ctrl_Dim_Init Ctrl_Dim_Init
#  define RTE_RUNNABLE_Ctrl_Dim_PWM_Rate_Status Ctrl_Dim_PWM_Rate_Status
#  define RTE_RUNNABLE_Ctrl_Dim_Task Ctrl_Dim_Task
# endif
...
FUNC(void, Ctrl_Dim_CODE) Ctrl_Dim_Task(void); /* PRQA S 0850, 3451 */ /* MD_MSR_19.8, MD_Rte_3451 */
