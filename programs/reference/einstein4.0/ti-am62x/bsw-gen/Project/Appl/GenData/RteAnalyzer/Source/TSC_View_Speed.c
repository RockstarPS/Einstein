...
{
  return Rte_Write_pp_Display_speed_Value_Digital_Speed_Value(data);
}

Std_ReturnType TSC_View_Speed_Rte_Write_pp_SubDisplaySpeed_Value_SubDispSpeedVal(UInt16 data)
{
  return Rte_Write_pp_SubDisplaySpeed_Value_SubDispSpeedVal(data);
}

Std_ReturnType TSC_View_Speed_Rte_Write_pp_SubSpeedUnit_Value_SubSpeedunit(UInt8 data)
{
  return Rte_Write_pp_SubSpeedUnit_Value_SubSpeedunit(data);
}
