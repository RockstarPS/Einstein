 ...
 *       License:  CBD1800851
 *
 *   Description:  C-Code implementation template for SW-C <CBattMdl>
 *********************************************************************************************************************/
...
#include "Rte_CBattMdl.h" /* PRQA S 0857 */ /* MD_MSR_1.1_857 */
...
static void CBattMdl_TestDefines(void);
...
/**********************************************************************************************************************
 *
 * Runnable Entity Name: CBattMdl_Impl_MainFunction
 *
 ...
 *   Explicit S/R API:
 *   -----------------
 *   Std_ReturnType Rte_Write_ppSR_BattMdl_AVP_HVP0Flag(Boolean data)
 *   Std_ReturnType Rte_Write_ppSR_BattMdl_AVP_HVSD0Flag(Boolean data)
 *   Std_ReturnType Rte_Write_ppSR_BattMdl_AVP_HVSD1Flag(Boolean data)
 *   Std_ReturnType Rte_Write_ppSR_BattMdl_AVP_HVSD2Flag(Boolean data)
 *   Std_ReturnType Rte_Write_ppSR_BattMdl_AVP_HVSD3Flag(Boolean data)
 *   Std_ReturnType Rte_Write_ppSR_BattMdl_AVP_HVSD4Flag(Boolean data)
 *   Std_ReturnType Rte_Write_ppSR_BattMdl_AVP_LVP0Flag(Boolean data)
 *   Std_ReturnType Rte_Write_ppSR_BattMdl_AVP_LVP1Flag(Boolean data)
 *   Std_ReturnType Rte_Write_ppSR_BattMdl_AVP_LVSD0Flag(Boolean data)
 *   Std_ReturnType Rte_Write_ppSR_BattMdl_AVP_LVSD1Flag(Boolean data)
 *   Std_ReturnType Rte_Write_ppSR_BattMdl_AVP_LVSD2Flag(Boolean data)
 *   Std_ReturnType Rte_Write_ppSR_BattMdl_AVP_LVSD3Flag(Boolean data)
 *   Std_ReturnType Rte_Write_ppSR_BattMdl_AVP_LVSD4Flag(Boolean data)
 *   Std_ReturnType Rte_Write_ppSR_BattMdl_AVP_SVPFlag(Boolean data)
 *   Std_ReturnType Rte_Write_ppSR_BattMdl_Voltage_OverVoltageInterruptFlag(Boolean data)
 *
 ...
 * Symbol: CBattMdl_Impl_MainFunction_doc
 *********************************************************************************************************************/
...
FUNC(void, CBattMdl_CODE) CBattMdl_Impl_MainFunction(void) /* PRQA S 0850 */ /* MD_MSR_19.8 */
{
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of runnable implementation >>             DO NOT CHANGE THIS COMMENT!
 * Symbol: CBattMdl_Impl_MainFunction
 *********************************************************************************************************************/
  ...
  *************************************************/
  ...
  fct_status = TSC_CBattMdl_Rte_Write_ppSR_BattMdl_AVP_HVP0Flag(Rte_InitValue_ppSR_BattMdl_AVP_HVP0Flag);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CBattMdl_Rte_Write_ppSR_BattMdl_AVP_HVSD0Flag(Rte_InitValue_ppSR_BattMdl_AVP_HVSD0Flag);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CBattMdl_Rte_Write_ppSR_BattMdl_AVP_HVSD1Flag(Rte_InitValue_ppSR_BattMdl_AVP_HVSD1Flag);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CBattMdl_Rte_Write_ppSR_BattMdl_AVP_HVSD2Flag(Rte_InitValue_ppSR_BattMdl_AVP_HVSD2Flag);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CBattMdl_Rte_Write_ppSR_BattMdl_AVP_HVSD3Flag(Rte_InitValue_ppSR_BattMdl_AVP_HVSD3Flag);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CBattMdl_Rte_Write_ppSR_BattMdl_AVP_HVSD4Flag(Rte_InitValue_ppSR_BattMdl_AVP_HVSD4Flag);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CBattMdl_Rte_Write_ppSR_BattMdl_AVP_LVP0Flag(Rte_InitValue_ppSR_BattMdl_AVP_LVP0Flag);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CBattMdl_Rte_Write_ppSR_BattMdl_AVP_LVP1Flag(Rte_InitValue_ppSR_BattMdl_AVP_LVP1Flag);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CBattMdl_Rte_Write_ppSR_BattMdl_AVP_LVSD0Flag(Rte_InitValue_ppSR_BattMdl_AVP_LVSD0Flag);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CBattMdl_Rte_Write_ppSR_BattMdl_AVP_LVSD1Flag(Rte_InitValue_ppSR_BattMdl_AVP_LVSD1Flag);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CBattMdl_Rte_Write_ppSR_BattMdl_AVP_LVSD2Flag(Rte_InitValue_ppSR_BattMdl_AVP_LVSD2Flag);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CBattMdl_Rte_Write_ppSR_BattMdl_AVP_LVSD3Flag(Rte_InitValue_ppSR_BattMdl_AVP_LVSD3Flag);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CBattMdl_Rte_Write_ppSR_BattMdl_AVP_LVSD4Flag(Rte_InitValue_ppSR_BattMdl_AVP_LVSD4Flag);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CBattMdl_Rte_Write_ppSR_BattMdl_AVP_SVPFlag(Rte_InitValue_ppSR_BattMdl_AVP_SVPFlag);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CBattMdl_Rte_Write_ppSR_BattMdl_Voltage_OverVoltageInterruptFlag(Rte_InitValue_ppSR_BattMdl_Voltage_OverVoltageInterruptFlag);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CBattMdl_Rte_Call_rpIoHwAb_ADC_GetAsyncRawAdc(0U, &Call_rpIoHwAb_ADC_GetAsyncRawAdc_AsyncRawAdc, &Call_rpIoHwAb_ADC_GetAsyncRawAdc_ErrorStatus);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CBattMdl_Rte_Call_rpIoHwAb_ADC_GetProcessedAdc(0U, &Call_rpIoHwAb_ADC_GetProcessedAdc_ProcessedAdc, &Call_rpIoHwAb_ADC_GetProcessedAdc_ErrorStatus);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CBattMdl_Rte_Call_rpIoHwAb_ADC_GetSyncRawAdc(0U, &Call_rpIoHwAb_ADC_GetSyncRawAdc_SyncRawAdc, &Call_rpIoHwAb_ADC_GetSyncRawAdc_ErrorStatus);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CBattMdl_Rte_Call_rpIoHwAb_DOut_SetOutputGroup(0, 0U, &Call_rpIoHwAb_DOut_SetOutputGroup_ErrorStatus);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CBattMdl_Rte_Call_rpIoHwAb_DOut_SetOutputPin(0U, FALSE, &Call_rpIoHwAb_DOut_SetOutputPin_ErrorStatus);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CBattMdl_Rte_Call_rpIoHwAb_Din_GetAsyncRawInput(0U, &Call_rpIoHwAb_Din_GetAsyncRawInput_AsyncInput, &Call_rpIoHwAb_Din_GetAsyncRawInput_ErrorStatus);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CBattMdl_Rte_Call_rpIoHwAb_Din_GetInputGroup(0, &Call_rpIoHwAb_Din_GetInputGroup_SyncInput, &Call_rpIoHwAb_Din_GetInputGroup_ErrorStatus);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CBattMdl_Rte_Call_rpIoHwAb_Din_GetProcessedInput(0U, &Call_rpIoHwAb_Din_GetProcessedInput_InputSignal, &Call_rpIoHwAb_Din_GetProcessedInput_ErrorStatus);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CBattMdl_Rte_Call_rpIoHwAb_Din_GetSyncRawInput(0U, &Call_rpIoHwAb_Din_GetSyncRawInput_SyncInput, &Call_rpIoHwAb_Din_GetSyncRawInput_ErrorStatus);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
...
/**********************************************************************************************************************
 *
 * Runnable Entity Name: CBattMdl_Impl_OnCommand
 *
 * This runnable can be invoked concurrently (reentrant implementation).
 *
 *---------------------------------------------------------------------------------------------------------------------
 *
 * Executed if at least one of the following trigger conditions occurred:
 *   - triggered by server invocation for OperationPrototype <Impl_OnCommand> of PortPrototype <pp_CmpLibCmd_CBattMdl>
 *
 **********************************************************************************************************************
 *
 * Output Interfaces:
 ...
 * Runnable prototype:
 * ===================
 *   Std_ReturnType CBattMdl_Impl_OnCommand(ECmpCmd cmdP)
 *
 **********************************************************************************************************************
 *
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of documentation area >>                  DO NOT CHANGE THIS COMMENT!
 * Symbol: CBattMdl_Impl_OnCommand_doc
 *********************************************************************************************************************/
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of runnable implementation >>             DO NOT CHANGE THIS COMMENT!
 * Symbol: CBattMdl_Impl_OnCommand (returns application error)
 *********************************************************************************************************************/
