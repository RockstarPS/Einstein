 ...
 *       License:  CBD1800851
 *
 *   Description:  C-Code implementation template for SW-C <CFltMExt>
 *********************************************************************************************************************/
...
#include "Rte_CFltMExt.h" /* PRQA S 0857 */ /* MD_MSR_1.1_857 */
#include "TSC_CFltMExt.h"
...
static void CFltMExt_TestDefines(void);
...
/**********************************************************************************************************************
 *
 * Runnable Entity Name: CFltMExt_Impl_OnCommand
 *
 ...
 *   - triggered by server invocation for OperationPrototype <Impl_OnCommand> of PortPrototype <pp_CmpLibCmd_CFltMExt>
 *
 **********************************************************************************************************************
 *
 ...
 *     Synchronous Server Invocation. Timeout: None
 *     Returned Application Errors: RTE_E_TI_EcuBatteryMData_E_NOT_OK
 *   Std_ReturnType Rte_Call_rp_CS_FltM_ReportFault_FltM_ReportFault(eFltM_FaultIdType FaultId, eFltM_FaultStatusType FaultStatus, UInt8 *LogData, UInt16 LogLength)
 *     Synchronous Server Invocation. Timeout: None
 *     Returned Application Errors: RTE_E_TI_FltM_ReportFault_E_NOT_OK
 *
 **********************************************************************************************************************
 *
 * Runnable prototype:
 * ===================
 *   Std_ReturnType CFltMExt_Impl_OnCommand(ECmpCmd cmdP)
 *
 **********************************************************************************************************************
 *
 ...
 * Symbol: CFltMExt_Impl_OnCommand_doc
 *********************************************************************************************************************/
 ...
 * Symbol: CFltMExt_Impl_OnCommand (returns application error)
 *********************************************************************************************************************/
  ...
  UInt8 Call_rp_CS_FltM_ReportFault_FltM_ReportFault_LogData = 0U;

  /*************************************************
  * Direct Function Accesses
  *************************************************/

  fct_status = TSC_CFltMExt_Rte_Call_rp_CS_EcuBatteryOutData_EcuBatteryM_GetChannelStatus(0U, &Call_rp_CS_EcuBatteryOutData_EcuBatteryM_GetChannelStatus_Status);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CFltMExt_Rte_Call_rp_CS_EcuBatteryOutData_EcuBatteryM_GetDIOStatus(0U, &Call_rp_CS_EcuBatteryOutData_EcuBatteryM_GetDIOStatus_Status);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CFltMExt_Rte_Call_rp_CS_FltM_ReportFault_FltM_ReportFault(0U, 0U, &Call_rp_CS_FltM_ReportFault_FltM_ReportFault_LogData, 0U);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
    ...
    case RTE_E_TIMEOUT:
      fct_error = 1;
      break;
    case RTE_E_TI_FltM_ReportFault_E_NOT_OK:
      fct_error = 1;
      break;
  }

  CFltMExt_TestDefines();
...
/**********************************************************************************************************************
 *
 * Runnable Entity Name: CFltMExt_MainFunction
 *
 * This runnable can be invoked concurrently (reentrant implementation).
 *
 *---------------------------------------------------------------------------------------------------------------------
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of documentation area >>                  DO NOT CHANGE THIS COMMENT!
 * Symbol: CFltMExt_MainFunction_doc
 *********************************************************************************************************************/
...
FUNC(void, CFltMExt_CODE) CFltMExt_MainFunction(void) /* PRQA S 0850 */ /* MD_MSR_19.8 */
{
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of runnable implementation >>             DO NOT CHANGE THIS COMMENT!
 * Symbol: CFltMExt_MainFunction
 *********************************************************************************************************************/
