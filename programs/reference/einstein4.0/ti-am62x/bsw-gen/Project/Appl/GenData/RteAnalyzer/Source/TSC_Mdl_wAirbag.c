...
{
  return Rte_Read_rp_Vehiclestate_WSSCurrentVehicleState(data);
}
...
{
  return Rte_Call_rpUpdateAirbagWarning_UpdateWarningStatus(WarningCurId, WarningCurStatus, WarningCurEvent, WarningPayload);
}
...
{
  return Rte_Call_rp_CS_CanAdapterSafeRx_RxCan_GetSignalValue(SignalId, pSignalValue, pSignalStatus);
}
...
{
  return Rte_Call_rp_CS_CanAdapterSafeRx_RxCan_GetSignalValueU8Arr(SignalId, pSignalValue, pSignalStatus, pSignalLength);
}
...
{
  return Rte_Call_rp_CS_CanAdapterSafeRx_RxCan_SetSignalInitValue(SignalId, pSignalValue);
}
...
{
  return Rte_Call_rp_CS_CanAdapterSafeRx_RxCan_SetSignalInitValueU8Arr(SignalId, pSignaValue, pSignalLength);
}
Std_ReturnType TSC_Mdl_wAirbag_Rte_Call_rp_CS_CanAdapterSafeRx_RxCan_SignalClearJustRcvdStatus(tSafeRxSignalId SignalId)
{
  return Rte_Call_rp_CS_CanAdapterSafeRx_RxCan_SignalClearJustRcvdStatus(SignalId);
}
...
{
  return Rte_Call_rp_CS_CanAdapterSafeRx_RxCan_SignalGetJustRcvdStatus(SignalId, pJustRcvdStatus);
}
...
{
  return Rte_Call_rp_CS_CanAdapterSafeRx_RxCan_SignalInvalidProcessingControl(SignalId, Status);
}
...
{
  return Rte_Call_rp_CS_CanAdapterSafeRx_RxCan_SignalMissingProcessingControl(SignalId, Status);
}
...
{
  return Rte_Call_rp_CS_CanAdapterSafeRx_RxCan_SignalNRProcessingControl(SignalId, Status);
}
