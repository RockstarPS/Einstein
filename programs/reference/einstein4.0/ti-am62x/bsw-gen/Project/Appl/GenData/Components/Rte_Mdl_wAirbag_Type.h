 ...
 *       License:  CBD1800851
 *
 *   Description:  Application types header file for SW-C <Mdl_wAirbag>
 *********************************************************************************************************************/

/* double include prevention */
#ifndef _RTE_MDL_WAIRBAG_TYPE_H
# define _RTE_MDL_WAIRBAG_TYPE_H
