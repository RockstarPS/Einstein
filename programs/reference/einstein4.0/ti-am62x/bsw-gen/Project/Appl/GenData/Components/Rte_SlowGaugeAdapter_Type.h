 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *          File:  Rte_SlowGaugeAdapter_Type.h
 *        Config:  BMW.dpa
 *   ECU-Project:  IC
 *
 ...
 *       License:  CBD1800851
 *
 *   Description:  Application types header file for SW-C <SlowGaugeAdapter>
 *********************************************************************************************************************/

/* double include prevention */
#ifndef _RTE_SLOWGAUGEADAPTER_TYPE_H
# define _RTE_SLOWGAUGEADAPTER_TYPE_H
...
#endif /* _RTE_SLOWGAUGEADAPTER_TYPE_H */
