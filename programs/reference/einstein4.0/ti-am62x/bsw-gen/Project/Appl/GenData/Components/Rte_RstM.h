...
FUNC(Std_ReturnType, CRstM_CODE) RstM_GetLastResetReason(P2VAR(eFltM_FaultIdType, AUTOMATIC, RTE_RSTM_APPL_VAR) pFaultId); /* PRQA S 0850 */ /* MD_MSR_19.8 */
FUNC(Std_ReturnType, CRstM_CODE) RstM_GetResetCount(eFltM_FaultIdType FaultId, P2VAR(UInt8, AUTOMATIC, RTE_RSTM_APPL_VAR) count); /* PRQA S 0850 */ /* MD_MSR_19.8 */
FUNC(Std_ReturnType, CRstM_CODE) RstM_GetResetHistory(P2VAR(UInt8, AUTOMATIC, RTE_RSTM_APPL_VAR) ResetHistory); /* PRQA S 0850 */ /* MD_MSR_19.8 */
FUNC(void, CRstM_CODE) CRstM_Impl_MainFunction(void); /* PRQA S 0850, 3451 */ /* MD_MSR_19.8, MD_Rte_3451 */
FUNC(Std_ReturnType, CRstM_CODE) CRstM_Impl_OnCommand(ECmpCmd cmdP); /* PRQA S 0850 */ /* MD_MSR_19.8 */
FUNC(Std_ReturnType, CRstM_CODE) RstM_RequestSwReset(eFltM_FaultIdType FaultId, P2VAR(UInt8, AUTOMATIC, RTE_RSTM_APPL_VAR) LogData, UInt16 LogLength); /* PRQA S 0850 */ /* MD_MSR_19.8 */
