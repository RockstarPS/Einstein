 ...
 *       License:  CBD1800851
 *
 *   Description:  Application types header file for SW-C <DemApp>
 *********************************************************************************************************************/

/* double include prevention */
#ifndef _RTE_DEMAPP_TYPE_H
# define _RTE_DEMAPP_TYPE_H
