...
#  define RTE_RUNNABLE_IoHwAb_OsTask_SafeBsw_Task_10ms IoHwAb_OsTask_SafeBsw_Task_10ms
#  define RTE_RUNNABLE_IoHwAb_OsTask_SafeBsw_WdgM_CheckPoint_10ms IoHwAb_OsTask_SafeBsw_WdgM_CheckPoint_10ms
#  define RTE_RUNNABLE_IoHwAb_OsTask_SafeBsw_WdgM_CheckPoint_20ms IoHwAb_OsTask_SafeBsw_WdgM_CheckPoint_20ms
#  define RTE_RUNNABLE_IoHwAb_OsTask_SafeBsw_WdgM_CheckPoint_30ms IoHwAb_OsTask_SafeBsw_WdgM_CheckPoint_30ms
...
FUNC(void, IoHwAb_CODE) IoHwAb_OsTask_SafeBsw_Task_10ms(void); /* PRQA S 0850, 3451 */ /* MD_MSR_19.8, MD_Rte_3451 */
FUNC(void, IoHwAb_CODE) IoHwAb_OsTask_SafeBsw_WdgM_CheckPoint_10ms(void); /* PRQA S 0850, 3451 */ /* MD_MSR_19.8, MD_Rte_3451 */
FUNC(void, IoHwAb_CODE) IoHwAb_OsTask_SafeBsw_WdgM_CheckPoint_20ms(void); /* PRQA S 0850, 3451 */ /* MD_MSR_19.8, MD_Rte_3451 */
FUNC(void, IoHwAb_CODE) IoHwAb_OsTask_SafeBsw_WdgM_CheckPoint_30ms(void); /* PRQA S 0850, 3451 */ /* MD_MSR_19.8, MD_Rte_3451 */
