 ...
 *       License:  CBD1800851
 *
 *   Description:  Application types header file for SW-C <CorTst>
 *********************************************************************************************************************/

/* double include prevention */
#ifndef _RTE_CORTST_TYPE_H
# define _RTE_CORTST_TYPE_H
