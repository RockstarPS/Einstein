 ...
 *       License:  CBD1800851
 *
 *   Description:  Application types header file for SW-C <CSigCdd>
 *********************************************************************************************************************/

/* double include prevention */
#ifndef _RTE_CSIGCDD_TYPE_H
# define _RTE_CSIGCDD_TYPE_H
