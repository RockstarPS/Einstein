 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *          File:  Rte_Ctrl_Illumination_Type.h
 *        Config:  BMW.dpa
 *   ECU-Project:  IC
 *
 ...
 *       License:  CBD1800851
 *
 *   Description:  Application types header file for SW-C <Ctrl_Illumination>
 *********************************************************************************************************************/

/* double include prevention */
#ifndef _RTE_CTRL_ILLUMINATION_TYPE_H
# define _RTE_CTRL_ILLUMINATION_TYPE_H
...
#endif /* _RTE_CTRL_ILLUMINATION_TYPE_H */
