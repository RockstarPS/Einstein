 ...
 *       License:  CBD1800851
 *
 *   Description:  Application types header file for SW-C <CPmicCdd>
 *********************************************************************************************************************/

/* double include prevention */
#ifndef _RTE_CPMICCDD_TYPE_H
# define _RTE_CPMICCDD_TYPE_H
