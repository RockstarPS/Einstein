 ...
 *       License:  CBD1800851
 *
 *   Description:  Application header file for SW-C <View_Illumination>
 *********************************************************************************************************************/

/* double include prevention */
#ifndef _RTE_VIEW_ILLUMINATION_H
# define _RTE_VIEW_ILLUMINATION_H
...
# include "Rte_View_Illumination_Type.h"
 ...
 * API prototypes
 *********************************************************************************************************************/
FUNC(Std_ReturnType, RTE_CODE) Rte_Read_View_Illumination_rp_IllumCtrl_Op_IllumCtrl_Op_Data(P2VAR(IllumCtrl_Op, AUTOMATIC, RTE_VIEW_ILLUMINATION_APPL_VAR) data); /* PRQA S 0850 */ /* MD_MSR_19.8 */
 ...
 *********************************************************************************************************************/
#  define Rte_Read_rpEtmSts_IllumStatus Rte_Read_View_Illumination_rpEtmSts_IllumStatus
#  define Rte_Read_View_Illumination_rpEtmSts_IllumStatus(data) (*(data) = 0U, ((Std_ReturnType)RTE_E_UNCONNECTED)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rpIgnSubstate_IgnitionSubstate Rte_Read_View_Illumination_rpIgnSubstate_IgnitionSubstate
#  define Rte_Read_View_Illumination_rpIgnSubstate_IgnitionSubstate(data) (*(data) = Rte_Ctrl_WSS_ppIgnSubstate_IgnitionSubstate, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rpIllum_Etm_IllumStatus Rte_Read_View_Illumination_rpIllum_Etm_IllumStatus
#  define Rte_Read_View_Illumination_rpIllum_Etm_IllumStatus(data) (*(data) = 0U, ((Std_ReturnType)RTE_E_UNCONNECTED)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rpVehicleAppMode_WSSCurrentVehicleState Rte_Read_View_Illumination_rpVehicleAppMode_WSSCurrentVehicleState
#  define Rte_Read_View_Illumination_rpVehicleAppMode_WSSCurrentVehicleState(data) (*(data) = Rte_Ctrl_WSS_pp_VehicleAppMode_WSSCurrentVehicleState, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_EcoRunSystemState_EcoRunSystem_Flag Rte_Read_View_Illumination_rp_EcoRunSystemState_EcoRunSystem_Flag
#  define Rte_Read_View_Illumination_rp_EcoRunSystemState_EcoRunSystem_Flag(data) (*(data) = 0U, ((Std_ReturnType)RTE_E_UNCONNECTED)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_EtmIllumSts_IllumStatus Rte_Read_View_Illumination_rp_EtmIllumSts_IllumStatus
#  define Rte_Read_View_Illumination_rp_EtmIllumSts_IllumStatus(data) (*(data) = 0U, ((Std_ReturnType)RTE_E_UNCONNECTED)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_IllumCtrl_Op_IllumCtrl_Op_Data Rte_Read_View_Illumination_rp_IllumCtrl_Op_IllumCtrl_Op_Data
#  define Rte_Read_rp_RheostatDayStep_RheostatDayStep Rte_Read_View_Illumination_rp_RheostatDayStep_RheostatDayStep
#  define Rte_Read_View_Illumination_rp_RheostatDayStep_RheostatDayStep(data) (*(data) = Rte_Mdl_Dim_pp_RheostatDayStep_RheostatDayStep, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_RheostatNightStep_RheostatNightStep Rte_Read_View_Illumination_rp_RheostatNightStep_RheostatNightStep
#  define Rte_Read_View_Illumination_rp_RheostatNightStep_RheostatNightStep(data) (*(data) = Rte_Mdl_Dim_pp_RheostatNightStep_RheostatNightStep, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_Rheostat_Change_RheoUpdateVal Rte_Read_View_Illumination_rp_Rheostat_Change_RheoUpdateVal
#  define Rte_Read_View_Illumination_rp_Rheostat_Change_RheoUpdateVal(data) (*(data) = Rte_Mdl_Dim_pp_illum_rheostat_change_RheoUpdateVal, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_TFTDisplayOn_TFTDisplayOn Rte_Read_View_Illumination_rp_TFTDisplayOn_TFTDisplayOn
#  define Rte_Read_View_Illumination_rp_TFTDisplayOn_TFTDisplayOn(data) (*(data) = Rte_Ctrl_WSS_pp_TFTDisplayOn_TFTDisplayOn, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */


/**********************************************************************************************************************
 * Rte_Write_<p>_<d> (explicit S/R communication with isQueued = false)
 *********************************************************************************************************************/
#  define Rte_Write_pp_UCL_IlluminationData_IlluminationDataData Rte_Write_View_Illumination_pp_UCL_IlluminationData_IlluminationDataData
#  define Rte_Write_View_Illumination_pp_UCL_IlluminationData_IlluminationDataData(data) (RTE_E_OK) /* PRQA S 3453 */ /* MD_MSR_19.7 */
...
# ifndef RTE_CORE
#  define RTE_RUNNABLE_CView_Illumination_Impl_MainFunction CView_Illumination_Impl_MainFunction
#  define RTE_RUNNABLE_CView_Illumination_Impl_OnCommand CView_Illumination_Impl_OnCommand
#  define RTE_RUNNABLE_View_Illumination_Task View_Illumination_Task
# endif

FUNC(void, View_Illumination_CODE) CView_Illumination_Impl_MainFunction(void); /* PRQA S 0850, 3451 */ /* MD_MSR_19.8, MD_Rte_3451 */
FUNC(Std_ReturnType, View_Illumination_CODE) CView_Illumination_Impl_OnCommand(ECmpCmd cmdP); /* PRQA S 0850 */ /* MD_MSR_19.8 */
FUNC(void, View_Illumination_CODE) View_Illumination_Task(void); /* PRQA S 0850, 3451 */ /* MD_MSR_19.8, MD_Rte_3451 */
...
#endif /* _RTE_VIEW_ILLUMINATION_H */
