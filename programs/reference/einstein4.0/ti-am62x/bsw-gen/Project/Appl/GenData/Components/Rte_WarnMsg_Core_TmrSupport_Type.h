 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *          File:  Rte_WarnMsg_Core_TmrSupport_Type.h
 *        Config:  BMW.dpa
 *   ECU-Project:  IC
 *
 ...
 *       License:  CBD1800851
 *
 *   Description:  Application types header file for SW-C <WarnMsg_Core_TmrSupport>
 *********************************************************************************************************************/

/* double include prevention */
#ifndef _RTE_WARNMSG_CORE_TMRSUPPORT_TYPE_H
# define _RTE_WARNMSG_CORE_TMRSUPPORT_TYPE_H
...
#endif /* _RTE_WARNMSG_CORE_TMRSUPPORT_TYPE_H */
