 ...
 *   Explicit S/R API:
 *   -----------------
 *   Std_ReturnType Rte_Write_ppSRPhasedRead_Status_phase1readcompleted_PhasedRead_Status_phase1readcompleted(Boolean data)
 *   Std_ReturnType Rte_Write_ppSRPhasedRead_Status_phase2readcompleted_PhasedRead_Status_phase2readcompleted(Boolean data)
 *   Std_ReturnType Rte_Write_ppSRPhasedRead_Status_phase3readcompleted_PhasedRead_Status_phase3readcompleted(Boolean data)
 ...
 *********************************************************************************************************************/
  ...
  *************************************************/
  ...
  fct_status = TSC_NvMExt_Rte_Write_ppSRPhasedRead_Status_phase1readcompleted_PhasedRead_Status_phase1readcompleted(Rte_InitValue_ppSRPhasedRead_Status_phase1readcompleted_PhasedRead_Status_phase1readcompleted);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_NvMExt_Rte_Write_ppSRPhasedRead_Status_phase2readcompleted_PhasedRead_Status_phase2readcompleted(Rte_InitValue_ppSRPhasedRead_Status_phase2readcompleted_PhasedRead_Status_phase2readcompleted);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_NvMExt_Rte_Write_ppSRPhasedRead_Status_phase3readcompleted_PhasedRead_Status_phase3readcompleted(Rte_InitValue_ppSRPhasedRead_Status_phase3readcompleted_PhasedRead_Status_phase3readcompleted);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
