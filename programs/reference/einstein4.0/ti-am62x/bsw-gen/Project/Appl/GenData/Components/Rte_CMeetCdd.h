 ...
 *       License:  CBD1800851
 *
 *   Description:  Application header file for SW-C <CMeetCdd>
 *********************************************************************************************************************/

/* double include prevention */
#ifndef _RTE_CMEETCDD_H
# define _RTE_CMEETCDD_H
...
#  define Rte_InitValue_pp_SR_SleepReq_SleepReqData (FALSE)
 ...
 * API prototypes
 *********************************************************************************************************************/
FUNC(Std_ReturnType, RTE_CODE) Rte_Receive_CMeetCdd_rSR_DiagResponse_DiagResponseData(P2VAR(SDiagResponse, AUTOMATIC, RTE_CMEETCDD_APPL_VAR) data); /* PRQA S 0850 */ /* MD_MSR_19.8 */
FUNC(Std_ReturnType, RTE_CODE) Rte_Send_CMeetCdd_pSR_DiagDIDRequest_DiagDIDRequestData(P2CONST(SDiagDIDRequest, AUTOMATIC, RTE_CMEETCDD_APPL_DATA) data); /* PRQA S 0850 */ /* MD_MSR_19.8 */
FUNC(Std_ReturnType, RTE_CODE) Rte_Send_CMeetCdd_pSR_DiagIOCtrlRequest_DiagIOCtrlRequestData(P2CONST(SDiagIOCtrlRequest, AUTOMATIC, RTE_CMEETCDD_APPL_DATA) data); /* PRQA S 0850 */ /* MD_MSR_19.8 */
FUNC(Std_ReturnType, RTE_CODE) Rte_Send_CMeetCdd_pSR_DiagRoutineRequest_DiagRoutineRequestData(P2CONST(SDiagRoutineRequest, AUTOMATIC, RTE_CMEETCDD_APPL_DATA) data); /* PRQA S 0850 */ /* MD_MSR_19.8 */
 ...
 *********************************************************************************************************************/
#  define Rte_Receive_rSR_DiagResponse_DiagResponseData Rte_Receive_CMeetCdd_rSR_DiagResponse_DiagResponseData


/**********************************************************************************************************************
 * Rte_Read_<p>_<d> (explicit S/R communication with isQueued = false)
 *********************************************************************************************************************/
#  define Rte_Read_rp_SR_JobStatus_JobStatus_BsConst_Audio_Element Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsConst_Audio_Element
#  define Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsConst_Audio_Element(data) (*(data) = Rte_MemAbstractMdl_pp_SR_JobStatus_JobStatus_BsConst_Audio_Element, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_SR_JobStatus_JobStatus_BsConst_BsConst_Illumination_ReservedByte Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsConst_BsConst_Illumination_ReservedByte
#  define Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsConst_BsConst_Illumination_ReservedByte(data) (*(data) = Rte_MemAbstractMdl_pp_SR_JobStatus_JobStatus_BsConst_BsConst_Illumination_ReservedByte, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_SR_JobStatus_JobStatus_BsConst_BsConst_Illumination_ReservedByte_SafeCopy1 Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsConst_BsConst_Illumination_ReservedByte_SafeCopy1
#  define Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsConst_BsConst_Illumination_ReservedByte_SafeCopy1(data) (*(data) = Rte_MemAbstractMdl_pp_SR_JobStatus_JobStatus_BsConst_BsConst_Illumination_ReservedByte_SafeCopy1, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_SR_JobStatus_JobStatus_BsConst_BsConst_Illumination_ReservedByte_SafeCopy2 Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsConst_BsConst_Illumination_ReservedByte_SafeCopy2
#  define Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsConst_BsConst_Illumination_ReservedByte_SafeCopy2(data) (*(data) = Rte_MemAbstractMdl_pp_SR_JobStatus_JobStatus_BsConst_BsConst_Illumination_ReservedByte_SafeCopy2, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_SR_JobStatus_JobStatus_BsConst_Communication_Element Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsConst_Communication_Element
#  define Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsConst_Communication_Element(data) (*(data) = Rte_MemAbstractMdl_pp_SR_JobStatus_JobStatus_BsConst_Communication_Element, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_SR_JobStatus_JobStatus_BsConst_Compensation_Line_Shift_b Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsConst_Compensation_Line_Shift_b
#  define Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsConst_Compensation_Line_Shift_b(data) (*(data) = Rte_MemAbstractMdl_pp_SR_JobStatus_JobStatus_BsConst_Compensation_Line_Shift_b, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_SR_JobStatus_JobStatus_BsConst_Compensation_Line_Shift_b_SafeCopy1 Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsConst_Compensation_Line_Shift_b_SafeCopy1
#  define Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsConst_Compensation_Line_Shift_b_SafeCopy1(data) (*(data) = Rte_MemAbstractMdl_pp_SR_JobStatus_JobStatus_BsConst_Compensation_Line_Shift_b_SafeCopy1, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_SR_JobStatus_JobStatus_BsConst_Compensation_Line_Shift_b_SafeCopy2 Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsConst_Compensation_Line_Shift_b_SafeCopy2
#  define Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsConst_Compensation_Line_Shift_b_SafeCopy2(data) (*(data) = Rte_MemAbstractMdl_pp_SR_JobStatus_JobStatus_BsConst_Compensation_Line_Shift_b_SafeCopy2, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_SR_JobStatus_JobStatus_BsConst_Compensation_Line_Slope_m Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsConst_Compensation_Line_Slope_m
#  define Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsConst_Compensation_Line_Slope_m(data) (*(data) = Rte_MemAbstractMdl_pp_SR_JobStatus_JobStatus_BsConst_Compensation_Line_Slope_m, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_SR_JobStatus_JobStatus_BsConst_Compensation_Line_Slope_m_SafeCopy1 Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsConst_Compensation_Line_Slope_m_SafeCopy1
#  define Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsConst_Compensation_Line_Slope_m_SafeCopy1(data) (*(data) = Rte_MemAbstractMdl_pp_SR_JobStatus_JobStatus_BsConst_Compensation_Line_Slope_m_SafeCopy1, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_SR_JobStatus_JobStatus_BsConst_Compensation_Line_Slope_m_SafeCopy2 Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsConst_Compensation_Line_Slope_m_SafeCopy2
#  define Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsConst_Compensation_Line_Slope_m_SafeCopy2(data) (*(data) = Rte_MemAbstractMdl_pp_SR_JobStatus_JobStatus_BsConst_Compensation_Line_Slope_m_SafeCopy2, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_SR_JobStatus_JobStatus_BsConst_Derating_Backlight_Disable Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsConst_Derating_Backlight_Disable
#  define Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsConst_Derating_Backlight_Disable(data) (*(data) = Rte_MemAbstractMdl_pp_SR_JobStatus_JobStatus_BsConst_Derating_Backlight_Disable, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_SR_JobStatus_JobStatus_BsConst_Derating_Backlight_Disable_SafeCopy1 Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsConst_Derating_Backlight_Disable_SafeCopy1
#  define Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsConst_Derating_Backlight_Disable_SafeCopy1(data) (*(data) = Rte_MemAbstractMdl_pp_SR_JobStatus_JobStatus_BsConst_Derating_Backlight_Disable_SafeCopy1, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_SR_JobStatus_JobStatus_BsConst_Derating_Backlight_Disable_SafeCopy2 Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsConst_Derating_Backlight_Disable_SafeCopy2
#  define Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsConst_Derating_Backlight_Disable_SafeCopy2(data) (*(data) = Rte_MemAbstractMdl_pp_SR_JobStatus_JobStatus_BsConst_Derating_Backlight_Disable_SafeCopy2, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_SR_JobStatus_JobStatus_BsConst_Display_Illum_Max_Level Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsConst_Display_Illum_Max_Level
#  define Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsConst_Display_Illum_Max_Level(data) (*(data) = Rte_MemAbstractMdl_pp_SR_JobStatus_JobStatus_BsConst_Display_Illum_Max_Level, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_SR_JobStatus_JobStatus_BsConst_Display_Illum_Max_Level_SafeCopy1 Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsConst_Display_Illum_Max_Level_SafeCopy1
#  define Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsConst_Display_Illum_Max_Level_SafeCopy1(data) (*(data) = Rte_MemAbstractMdl_pp_SR_JobStatus_JobStatus_BsConst_Display_Illum_Max_Level_SafeCopy1, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_SR_JobStatus_JobStatus_BsConst_Display_Illum_Max_Level_SafeCopy2 Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsConst_Display_Illum_Max_Level_SafeCopy2
#  define Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsConst_Display_Illum_Max_Level_SafeCopy2(data) (*(data) = Rte_MemAbstractMdl_pp_SR_JobStatus_JobStatus_BsConst_Display_Illum_Max_Level_SafeCopy2, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_SR_JobStatus_JobStatus_BsConst_EngOffTimer_Element Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsConst_EngOffTimer_Element
#  define Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsConst_EngOffTimer_Element(data) (*(data) = Rte_MemAbstractMdl_pp_SR_JobStatus_JobStatus_BsConst_EngOffTimer_Element, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_SR_JobStatus_JobStatus_BsConst_FuelGauge_Element Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsConst_FuelGauge_Element
#  define Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsConst_FuelGauge_Element(data) (*(data) = Rte_MemAbstractMdl_pp_SR_JobStatus_JobStatus_BsConst_FuelGauge_Element, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_SR_JobStatus_JobStatus_BsConst_Lookup_Curve_HotSpot_Coef_X Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsConst_Lookup_Curve_HotSpot_Coef_X
#  define Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsConst_Lookup_Curve_HotSpot_Coef_X(data) (*(data) = Rte_MemAbstractMdl_pp_SR_JobStatus_JobStatus_BsConst_Lookup_Curve_HotSpot_Coef_X, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_SR_JobStatus_JobStatus_BsConst_Lookup_Curve_HotSpot_Coef_X_SafeCopy1 Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsConst_Lookup_Curve_HotSpot_Coef_X_SafeCopy1
#  define Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsConst_Lookup_Curve_HotSpot_Coef_X_SafeCopy1(data) (*(data) = Rte_MemAbstractMdl_pp_SR_JobStatus_JobStatus_BsConst_Lookup_Curve_HotSpot_Coef_X_SafeCopy1, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_SR_JobStatus_JobStatus_BsConst_Lookup_Curve_HotSpot_Coef_X_SafeCopy2 Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsConst_Lookup_Curve_HotSpot_Coef_X_SafeCopy2
#  define Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsConst_Lookup_Curve_HotSpot_Coef_X_SafeCopy2(data) (*(data) = Rte_MemAbstractMdl_pp_SR_JobStatus_JobStatus_BsConst_Lookup_Curve_HotSpot_Coef_X_SafeCopy2, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_SR_JobStatus_JobStatus_BsConst_Lookup_Curve_HotSpot_Coef_Y Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsConst_Lookup_Curve_HotSpot_Coef_Y
#  define Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsConst_Lookup_Curve_HotSpot_Coef_Y(data) (*(data) = Rte_MemAbstractMdl_pp_SR_JobStatus_JobStatus_BsConst_Lookup_Curve_HotSpot_Coef_Y, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_SR_JobStatus_JobStatus_BsConst_Lookup_Curve_HotSpot_Coef_Y_SafeCopy1 Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsConst_Lookup_Curve_HotSpot_Coef_Y_SafeCopy1
#  define Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsConst_Lookup_Curve_HotSpot_Coef_Y_SafeCopy1(data) (*(data) = Rte_MemAbstractMdl_pp_SR_JobStatus_JobStatus_BsConst_Lookup_Curve_HotSpot_Coef_Y_SafeCopy1, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_SR_JobStatus_JobStatus_BsConst_Lookup_Curve_HotSpot_Coef_Y_SafeCopy2 Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsConst_Lookup_Curve_HotSpot_Coef_Y_SafeCopy2
#  define Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsConst_Lookup_Curve_HotSpot_Coef_Y_SafeCopy2(data) (*(data) = Rte_MemAbstractMdl_pp_SR_JobStatus_JobStatus_BsConst_Lookup_Curve_HotSpot_Coef_Y_SafeCopy2, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_SR_JobStatus_JobStatus_BsConst_OilGauge_Element Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsConst_OilGauge_Element
#  define Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsConst_OilGauge_Element(data) (*(data) = Rte_MemAbstractMdl_pp_SR_JobStatus_JobStatus_BsConst_OilGauge_Element, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_SR_JobStatus_JobStatus_BsConst_PCB_Temperature_Sensor_Conv Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsConst_PCB_Temperature_Sensor_Conv
#  define Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsConst_PCB_Temperature_Sensor_Conv(data) (*(data) = Rte_MemAbstractMdl_pp_SR_JobStatus_JobStatus_BsConst_PCB_Temperature_Sensor_Conv, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_SR_JobStatus_JobStatus_BsConst_PCB_Temperature_Sensor_Conv_SafeCopy1 Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsConst_PCB_Temperature_Sensor_Conv_SafeCopy1
#  define Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsConst_PCB_Temperature_Sensor_Conv_SafeCopy1(data) (*(data) = Rte_MemAbstractMdl_pp_SR_JobStatus_JobStatus_BsConst_PCB_Temperature_Sensor_Conv_SafeCopy1, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_SR_JobStatus_JobStatus_BsConst_PCB_Temperature_Sensor_Conv_SafeCopy2 Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsConst_PCB_Temperature_Sensor_Conv_SafeCopy2
#  define Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsConst_PCB_Temperature_Sensor_Conv_SafeCopy2(data) (*(data) = Rte_MemAbstractMdl_pp_SR_JobStatus_JobStatus_BsConst_PCB_Temperature_Sensor_Conv_SafeCopy2, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_SR_JobStatus_JobStatus_BsConst_PWM_boost_bypass_duty Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsConst_PWM_boost_bypass_duty
#  define Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsConst_PWM_boost_bypass_duty(data) (*(data) = Rte_MemAbstractMdl_pp_SR_JobStatus_JobStatus_BsConst_PWM_boost_bypass_duty, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_SR_JobStatus_JobStatus_BsConst_PWM_boost_bypass_duty_SafeCopy1 Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsConst_PWM_boost_bypass_duty_SafeCopy1
#  define Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsConst_PWM_boost_bypass_duty_SafeCopy1(data) (*(data) = Rte_MemAbstractMdl_pp_SR_JobStatus_JobStatus_BsConst_PWM_boost_bypass_duty_SafeCopy1, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_SR_JobStatus_JobStatus_BsConst_PWM_boost_bypass_duty_SafeCopy2 Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsConst_PWM_boost_bypass_duty_SafeCopy2
#  define Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsConst_PWM_boost_bypass_duty_SafeCopy2(data) (*(data) = Rte_MemAbstractMdl_pp_SR_JobStatus_JobStatus_BsConst_PWM_boost_bypass_duty_SafeCopy2, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_SR_JobStatus_JobStatus_BsConst_PowerGauge_Element Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsConst_PowerGauge_Element
#  define Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsConst_PowerGauge_Element(data) (*(data) = Rte_MemAbstractMdl_pp_SR_JobStatus_JobStatus_BsConst_PowerGauge_Element, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_SR_JobStatus_JobStatus_BsConst_Power_Element Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsConst_Power_Element
#  define Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsConst_Power_Element(data) (*(data) = Rte_MemAbstractMdl_pp_SR_JobStatus_JobStatus_BsConst_Power_Element, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_SR_JobStatus_JobStatus_BsConst_RealTimeClock_Element Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsConst_RealTimeClock_Element
#  define Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsConst_RealTimeClock_Element(data) (*(data) = Rte_MemAbstractMdl_pp_SR_JobStatus_JobStatus_BsConst_RealTimeClock_Element, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_SR_JobStatus_JobStatus_BsConst_ServiceReminder_Element Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsConst_ServiceReminder_Element
#  define Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsConst_ServiceReminder_Element(data) (*(data) = Rte_MemAbstractMdl_pp_SR_JobStatus_JobStatus_BsConst_ServiceReminder_Element, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_SR_JobStatus_JobStatus_BsConst_SpeedoGauge_Element Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsConst_SpeedoGauge_Element
#  define Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsConst_SpeedoGauge_Element(data) (*(data) = Rte_MemAbstractMdl_pp_SR_JobStatus_JobStatus_BsConst_SpeedoGauge_Element, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_SR_JobStatus_JobStatus_BsConst_TachoGauge_Element Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsConst_TachoGauge_Element
#  define Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsConst_TachoGauge_Element(data) (*(data) = Rte_MemAbstractMdl_pp_SR_JobStatus_JobStatus_BsConst_TachoGauge_Element, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_SR_JobStatus_JobStatus_BsConst_TempGauge_Element Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsConst_TempGauge_Element
#  define Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsConst_TempGauge_Element(data) (*(data) = Rte_MemAbstractMdl_pp_SR_JobStatus_JobStatus_BsConst_TempGauge_Element, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_SR_JobStatus_JobStatus_BsConst_Temp_Threshold_Hysteresis_Derating Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsConst_Temp_Threshold_Hysteresis_Derating
#  define Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsConst_Temp_Threshold_Hysteresis_Derating(data) (*(data) = Rte_MemAbstractMdl_pp_SR_JobStatus_JobStatus_BsConst_Temp_Threshold_Hysteresis_Derating, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_SR_JobStatus_JobStatus_BsConst_Temp_Threshold_Hysteresis_Derating_SafeCopy1 Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsConst_Temp_Threshold_Hysteresis_Derating_SafeCopy1
#  define Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsConst_Temp_Threshold_Hysteresis_Derating_SafeCopy1(data) (*(data) = Rte_MemAbstractMdl_pp_SR_JobStatus_JobStatus_BsConst_Temp_Threshold_Hysteresis_Derating_SafeCopy1, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_SR_JobStatus_JobStatus_BsConst_Temp_Threshold_Hysteresis_Derating_SafeCopy2 Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsConst_Temp_Threshold_Hysteresis_Derating_SafeCopy2
#  define Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsConst_Temp_Threshold_Hysteresis_Derating_SafeCopy2(data) (*(data) = Rte_MemAbstractMdl_pp_SR_JobStatus_JobStatus_BsConst_Temp_Threshold_Hysteresis_Derating_SafeCopy2, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_SR_JobStatus_JobStatus_BsConst_Temperature_Sensor_Conv Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsConst_Temperature_Sensor_Conv
#  define Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsConst_Temperature_Sensor_Conv(data) (*(data) = Rte_MemAbstractMdl_pp_SR_JobStatus_JobStatus_BsConst_Temperature_Sensor_Conv, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_SR_JobStatus_JobStatus_BsConst_Temperature_Sensor_Conv_SafeCopy1 Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsConst_Temperature_Sensor_Conv_SafeCopy1
#  define Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsConst_Temperature_Sensor_Conv_SafeCopy1(data) (*(data) = Rte_MemAbstractMdl_pp_SR_JobStatus_JobStatus_BsConst_Temperature_Sensor_Conv_SafeCopy1, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_SR_JobStatus_JobStatus_BsConst_Temperature_Sensor_Conv_SafeCopy2 Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsConst_Temperature_Sensor_Conv_SafeCopy2
#  define Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsConst_Temperature_Sensor_Conv_SafeCopy2(data) (*(data) = Rte_MemAbstractMdl_pp_SR_JobStatus_JobStatus_BsConst_Temperature_Sensor_Conv_SafeCopy2, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_SR_JobStatus_JobStatus_BsConst_TripComputer_Element Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsConst_TripComputer_Element
#  define Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsConst_TripComputer_Element(data) (*(data) = Rte_MemAbstractMdl_pp_SR_JobStatus_JobStatus_BsConst_TripComputer_Element, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_SR_JobStatus_JobStatus_BsConst_Warning_Element Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsConst_Warning_Element
#  define Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsConst_Warning_Element(data) (*(data) = Rte_MemAbstractMdl_pp_SR_JobStatus_JobStatus_BsConst_Warning_Element, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_SR_JobStatus_JobStatus_BsCys_Certicificate_Element Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsCys_Certicificate_Element
#  define Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsCys_Certicificate_Element(data) (*(data) = Rte_MemAbstractMdl_pp_SR_JobStatus_JobStatus_BsCys_Certicificate_Element, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_SR_JobStatus_JobStatus_BsDiag_Dtc_Element Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsDiag_Dtc_Element
#  define Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsDiag_Dtc_Element(data) (*(data) = Rte_MemAbstractMdl_pp_SR_JobStatus_JobStatus_BsDiag_Dtc_Element, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_SR_JobStatus_JobStatus_BsDiag_ErrorRecord_Element Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsDiag_ErrorRecord_Element
#  define Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsDiag_ErrorRecord_Element(data) (*(data) = Rte_MemAbstractMdl_pp_SR_JobStatus_JobStatus_BsDiag_ErrorRecord_Element, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_SR_JobStatus_JobStatus_BsReten_Audio_Element Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsReten_Audio_Element
#  define Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsReten_Audio_Element(data) (*(data) = Rte_MemAbstractMdl_pp_SR_JobStatus_JobStatus_BsReten_Audio_Element, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_SR_JobStatus_JobStatus_BsReten_Communication_Element Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsReten_Communication_Element
#  define Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsReten_Communication_Element(data) (*(data) = Rte_MemAbstractMdl_pp_SR_JobStatus_JobStatus_BsReten_Communication_Element, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_SR_JobStatus_JobStatus_BsReten_Display_Element Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsReten_Display_Element
#  define Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsReten_Display_Element(data) (*(data) = Rte_MemAbstractMdl_pp_SR_JobStatus_JobStatus_BsReten_Display_Element, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_SR_JobStatus_JobStatus_BsReten_Gauges_Element Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsReten_Gauges_Element
#  define Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsReten_Gauges_Element(data) (*(data) = Rte_MemAbstractMdl_pp_SR_JobStatus_JobStatus_BsReten_Gauges_Element, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_SR_JobStatus_JobStatus_BsReten_Illumination_Element Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsReten_Illumination_Element
#  define Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsReten_Illumination_Element(data) (*(data) = Rte_MemAbstractMdl_pp_SR_JobStatus_JobStatus_BsReten_Illumination_Element, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_SR_JobStatus_JobStatus_BsReten_Odometer_Element Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsReten_Odometer_Element
#  define Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsReten_Odometer_Element(data) (*(data) = Rte_MemAbstractMdl_pp_SR_JobStatus_JobStatus_BsReten_Odometer_Element, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_SR_JobStatus_JobStatus_BsReten_Personalization_Element Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsReten_Personalization_Element
#  define Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsReten_Personalization_Element(data) (*(data) = Rte_MemAbstractMdl_pp_SR_JobStatus_JobStatus_BsReten_Personalization_Element, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_SR_JobStatus_JobStatus_BsReten_Power_Element Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsReten_Power_Element
#  define Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsReten_Power_Element(data) (*(data) = Rte_MemAbstractMdl_pp_SR_JobStatus_JobStatus_BsReten_Power_Element, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_SR_JobStatus_JobStatus_BsReten_RealTimeClock_Element Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsReten_RealTimeClock_Element
#  define Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsReten_RealTimeClock_Element(data) (*(data) = Rte_MemAbstractMdl_pp_SR_JobStatus_JobStatus_BsReten_RealTimeClock_Element, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_SR_JobStatus_JobStatus_BsReten_Tripcomputer_Element Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsReten_Tripcomputer_Element
#  define Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsReten_Tripcomputer_Element(data) (*(data) = Rte_MemAbstractMdl_pp_SR_JobStatus_JobStatus_BsReten_Tripcomputer_Element, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_SR_JobStatus_JobStatus_BsReten_Warning_Element Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsReten_Warning_Element
#  define Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsReten_Warning_Element(data) (*(data) = Rte_MemAbstractMdl_pp_SR_JobStatus_JobStatus_BsReten_Warning_Element, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_SR_JobStatus_JobStatus_BsRt_CusDlt_Element Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsRt_CusDlt_Element
#  define Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsRt_CusDlt_Element(data) (*(data) = Rte_MemAbstractMdl_pp_SR_JobStatus_JobStatus_BsRt_CusDlt_Element, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_SR_JobStatus_JobStatus_BsRt_FuelGauge_Element Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsRt_FuelGauge_Element
#  define Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsRt_FuelGauge_Element(data) (*(data) = Rte_MemAbstractMdl_pp_SR_JobStatus_JobStatus_BsRt_FuelGauge_Element, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_SR_JobStatus_JobStatus_BsRt_Illumination_Element Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsRt_Illumination_Element
#  define Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsRt_Illumination_Element(data) (*(data) = Rte_MemAbstractMdl_pp_SR_JobStatus_JobStatus_BsRt_Illumination_Element, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_SR_JobStatus_JobStatus_BsRt_Odometer_Element Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsRt_Odometer_Element
#  define Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsRt_Odometer_Element(data) (*(data) = Rte_MemAbstractMdl_pp_SR_JobStatus_JobStatus_BsRt_Odometer_Element, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_SR_JobStatus_JobStatus_BsRt_OilGauge_Element Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsRt_OilGauge_Element
#  define Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsRt_OilGauge_Element(data) (*(data) = Rte_MemAbstractMdl_pp_SR_JobStatus_JobStatus_BsRt_OilGauge_Element, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_SR_JobStatus_JobStatus_BsRt_Personalization_Element Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsRt_Personalization_Element
#  define Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsRt_Personalization_Element(data) (*(data) = Rte_MemAbstractMdl_pp_SR_JobStatus_JobStatus_BsRt_Personalization_Element, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_SR_JobStatus_JobStatus_BsRt_PowerGauge_Element Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsRt_PowerGauge_Element
#  define Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsRt_PowerGauge_Element(data) (*(data) = Rte_MemAbstractMdl_pp_SR_JobStatus_JobStatus_BsRt_PowerGauge_Element, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_SR_JobStatus_JobStatus_BsRt_RealTimeClock_Element Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsRt_RealTimeClock_Element
#  define Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsRt_RealTimeClock_Element(data) (*(data) = Rte_MemAbstractMdl_pp_SR_JobStatus_JobStatus_BsRt_RealTimeClock_Element, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_SR_JobStatus_JobStatus_BsRt_SpeedoGauge_Element Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsRt_SpeedoGauge_Element
#  define Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsRt_SpeedoGauge_Element(data) (*(data) = Rte_MemAbstractMdl_pp_SR_JobStatus_JobStatus_BsRt_SpeedoGauge_Element, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_SR_JobStatus_JobStatus_BsRt_TachoGauge_Element Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsRt_TachoGauge_Element
#  define Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsRt_TachoGauge_Element(data) (*(data) = Rte_MemAbstractMdl_pp_SR_JobStatus_JobStatus_BsRt_TachoGauge_Element, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_SR_JobStatus_JobStatus_BsRt_TempGauge_Element Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsRt_TempGauge_Element
#  define Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsRt_TempGauge_Element(data) (*(data) = Rte_MemAbstractMdl_pp_SR_JobStatus_JobStatus_BsRt_TempGauge_Element, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_SR_JobStatus_JobStatus_BsRt_TripComputer_Element Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsRt_TripComputer_Element
#  define Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsRt_TripComputer_Element(data) (*(data) = Rte_MemAbstractMdl_pp_SR_JobStatus_JobStatus_BsRt_TripComputer_Element, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_SR_JobStatus_JobStatus_BsRt_Warning_Element Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsRt_Warning_Element
#  define Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsRt_Warning_Element(data) (*(data) = Rte_MemAbstractMdl_pp_SR_JobStatus_JobStatus_BsRt_Warning_Element, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
...
#  define Rte_Read_rp_SR_JobStatus_JobStatus_BsShare_EcuPartNumber_Element Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsShare_EcuPartNumber_Element
#  define Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsShare_EcuPartNumber_Element(data) (*(data) = Rte_MemAbstractMdl_pp_SR_JobStatus_JobStatus_BsShare_EcuPartNumber_Element, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
...
#  define Rte_Read_rp_SR_JobStatus_JobStatus_BsShare_SwUpdFotaFinPrint_Element Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsShare_SwUpdFotaFinPrint_Element
#  define Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsShare_SwUpdFotaFinPrint_Element(data) (*(data) = Rte_MemAbstractMdl_pp_SR_JobStatus_JobStatus_BsShare_SwUpdFotaFinPrint_Element, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_SR_JobStatus_JobStatus_BsShare_SwUpdFotaMode_Element Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsShare_SwUpdFotaMode_Element
#  define Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsShare_SwUpdFotaMode_Element(data) (*(data) = Rte_MemAbstractMdl_pp_SR_JobStatus_JobStatus_BsShare_SwUpdFotaMode_Element, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_SR_JobStatus_JobStatus_BsShare_SwUpdFotaStatus_Element Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsShare_SwUpdFotaStatus_Element
#  define Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsShare_SwUpdFotaStatus_Element(data) (*(data) = Rte_MemAbstractMdl_pp_SR_JobStatus_JobStatus_BsShare_SwUpdFotaStatus_Element, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_SR_JobStatus_JobStatus_BsShare_SwUpdFotadecrypt_Element Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsShare_SwUpdFotadecrypt_Element
#  define Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsShare_SwUpdFotadecrypt_Element(data) (*(data) = Rte_MemAbstractMdl_pp_SR_JobStatus_JobStatus_BsShare_SwUpdFotadecrypt_Element, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_SR_JobStatus_JobStatus_BsShare_SwUpdReflash_Element Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsShare_SwUpdReflash_Element
#  define Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsShare_SwUpdReflash_Element(data) (*(data) = Rte_MemAbstractMdl_pp_SR_JobStatus_JobStatus_BsShare_SwUpdReflash_Element, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_SR_JobStatus_JobStatus_BsShare_VehicleConfig_Element Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsShare_VehicleConfig_Element
#  define Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsShare_VehicleConfig_Element(data) (*(data) = Rte_MemAbstractMdl_pp_SR_JobStatus_JobStatus_BsShare_VehicleConfig_Element, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_SR_JobStatus_JobStatus_BsShare_VisMeet_EOLEntry_Element Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsShare_VisMeet_EOLEntry_Element
#  define Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsShare_VisMeet_EOLEntry_Element(data) (*(data) = Rte_MemAbstractMdl_pp_SR_JobStatus_JobStatus_BsShare_VisMeet_EOLEntry_Element, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_SR_JobStatus_JobStatus_BsShare_VisMeet_Element Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsShare_VisMeet_Element
#  define Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_BsShare_VisMeet_Element(data) (*(data) = Rte_MemAbstractMdl_pp_SR_JobStatus_JobStatus_BsShare_VisMeet_Element, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
...
#  define Rte_Read_rp_SR_JobStatus_JobStatus_RefCys_Certicificate1_Element Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_RefCys_Certicificate1_Element
#  define Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_RefCys_Certicificate1_Element(data) (*(data) = Rte_MemAbstractMdl_pp_SR_JobStatus_JobStatus_RefCys_Certicificate1_Element, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_SR_JobStatus_JobStatus_RefCys_Certicificate_Element Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_RefCys_Certicificate_Element
#  define Rte_Read_CMeetCdd_rp_SR_JobStatus_JobStatus_RefCys_Certicificate_Element(data) (*(data) = Rte_MemAbstractMdl_pp_SR_JobStatus_JobStatus_RefCys_Certicificate_Element, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */


/**********************************************************************************************************************
 * Rte_Send_<p>_<d> (explicit S/R communication with isQueued = true)
 *********************************************************************************************************************/
#  define Rte_Send_pSR_DiagDIDRequest_DiagDIDRequestData Rte_Send_CMeetCdd_pSR_DiagDIDRequest_DiagDIDRequestData
#  define Rte_Send_pSR_DiagIOCtrlRequest_DiagIOCtrlRequestData Rte_Send_CMeetCdd_pSR_DiagIOCtrlRequest_DiagIOCtrlRequestData
#  define Rte_Send_pSR_DiagRoutineRequest_DiagRoutineRequestData Rte_Send_CMeetCdd_pSR_DiagRoutineRequest_DiagRoutineRequestData


/**********************************************************************************************************************
 * Rte_Write_<p>_<d> (explicit S/R communication with isQueued = false)
 *********************************************************************************************************************/
#  define Rte_Write_pp_SR_SleepReq_SleepReqData Rte_Write_CMeetCdd_pp_SR_SleepReq_SleepReqData
#  define Rte_Write_CMeetCdd_pp_SR_SleepReq_SleepReqData(data) (RTE_E_OK) /* PRQA S 3453 */ /* MD_MSR_19.7 */
...
# ifndef RTE_CORE
#  define RTE_RUNNABLE_CMeetCdd_DID_DiagAction CMeetCdd_DID_DiagAction
#  define RTE_RUNNABLE_CMeetCdd_Impl_MainFunction CMeetCdd_Impl_MainFunction
#  define RTE_RUNNABLE_CMeetCdd_Impl_OnCommand CMeetCdd_Impl_OnCommand
#  define RTE_RUNNABLE_CMeetCdd_Meet_Mgrdiagcdd_Action CMeetCdd_Meet_Mgrdiagcdd_Action
#  define RTE_RUNNABLE_CMeetCdd_RID_DiagAction CMeetCdd_RID_DiagAction
#  define RTE_RUNNABLE_CMeetCdd_Read_ManufModeStatus CMeetCdd_Read_ManufModeStatus
#  define RTE_RUNNABLE_CMeetCdd_Write_Mfg_Flag CMeetCdd_Write_Mfg_Flag
# endif
...
FUNC(void, CMeetCdd_CODE) CMeetCdd_Impl_MainFunction(void); /* PRQA S 0850, 3451 */ /* MD_MSR_19.8, MD_Rte_3451 */
...
#  define RTE_E_TI_Meet_Mgrdiagcdd_Action_E_NOT_OK (1U)

#  define RTE_E_TI_RID_DiagAction_E_NOT_OK (1U)

#  define RTE_E_TI_Read_ManufModeStatus_E_NOT_OK (1U)

#  define RTE_E_TI_Write_Mfg_Flag_E_NOT_OK (1U)
