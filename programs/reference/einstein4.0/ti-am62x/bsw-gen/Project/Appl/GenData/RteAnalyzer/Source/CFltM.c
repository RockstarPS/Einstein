 ...
 *       License:  CBD1800851
 *
 *   Description:  C-Code implementation template for SW-C <CFltM>
 *********************************************************************************************************************/
...
#include "Rte_CFltM.h" /* PRQA S 0857 */ /* MD_MSR_1.1_857 */
#include "TSC_CFltM.h"
...
static void CFltM_TestDefines(void);
 ...
 *   FLTM_FLSINTEGRITY_NOT_STARTED (0U)
 *   FLTM_FLSINTEGRITY_INPROGRESS (1U)
 *   FLTM_FLSINTEGRITY_COMPLETED_PASS (2U)
 *   FLTM_FLSINTEGRITY_COMPLETED_FAIL (3U)
 *
 *********************************************************************************************************************/
...
/**********************************************************************************************************************
 *
 * Runnable Entity Name: CFltM_Impl_MainFunction
 *
 ...
 *   Std_ReturnType Rte_Call_rp_CS_RstM_ClearResetHistory_RstM_ClearResetHistory(void)
 *     Synchronous Server Invocation. Timeout: None
 *     Returned Application Errors: RTE_E_TI_RstM_ClearResetHistory_E_NOT_OK
 *   Std_ReturnType Rte_Call_rp_CS_RstM_GetLastResetReason_RstM_GetLastResetReason(eFltM_FaultIdType *pFaultId)
 *     Synchronous Server Invocation. Timeout: None
 *     Returned Application Errors: RTE_E_TI_RstM_GetLastResetReason_E_NOT_OK
 *   Std_ReturnType Rte_Call_rp_CS_RstM_GetResetCount_RstM_GetResetCount(eFltM_FaultIdType FaultId, UInt8 *count)
 *     Synchronous Server Invocation. Timeout: None
 *     Returned Application Errors: RTE_E_TI_RstM_GetResetCount_E_NOT_OK
 *   Std_ReturnType Rte_Call_rp_CS_RstM_GetResetHistory_RstM_GetResetHistory(UInt8 *ResetHistory)
 *     Synchronous Server Invocation. Timeout: None
 *     Returned Application Errors: RTE_E_TI_RstM_GetResetHistory_E_NOT_OK
 *   Std_ReturnType Rte_Call_rp_CS_RstM_RequestSwReset_RstM_RequestSwReset(eFltM_FaultIdType FaultId, UInt8 *LogData, UInt16 LogLength)
 *     Synchronous Server Invocation. Timeout: None
 *     Returned Application Errors: RTE_E_TI_RstM_RequestSwReset_E_NOT_OK
 *
 *********************************************************************************************************************/
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of documentation area >>                  DO NOT CHANGE THIS COMMENT!
 * Symbol: CFltM_Impl_MainFunction_doc
 *********************************************************************************************************************/
...
FUNC(void, CFltM_CODE) CFltM_Impl_MainFunction(void) /* PRQA S 0850 */ /* MD_MSR_19.8 */
{
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of runnable implementation >>             DO NOT CHANGE THIS COMMENT!
 * Symbol: CFltM_Impl_MainFunction
 *********************************************************************************************************************/

  Std_ReturnType fct_status;
  boolean fct_error = 0;

  eFltM_FaultIdType Call_rp_CS_RstM_GetLastResetReason_RstM_GetLastResetReason_pFaultId = 0U;
  UInt8 Call_rp_CS_RstM_GetResetCount_RstM_GetResetCount_count = 0U;
  UInt8 Call_rp_CS_RstM_GetResetHistory_RstM_GetResetHistory_ResetHistory = 0U;
  UInt8 Call_rp_CS_RstM_RequestSwReset_RstM_RequestSwReset_LogData = 0U;

  /*************************************************
  * Direct Function Accesses
  *************************************************/

  fct_status = TSC_CFltM_Rte_Call_rp_CS_DemExt_SetEventStatus_DemExt_SetEventStatus(0U, 0U);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CFltM_Rte_Call_rp_CS_RstM_ClearResetHistory_RstM_ClearResetHistory();
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
    ...
    case RTE_E_TIMEOUT:
      fct_error = 1;
      break;
    case RTE_E_TI_RstM_ClearResetHistory_E_NOT_OK:
      fct_error = 1;
      break;
  }

  fct_status = TSC_CFltM_Rte_Call_rp_CS_RstM_GetLastResetReason_RstM_GetLastResetReason(&Call_rp_CS_RstM_GetLastResetReason_RstM_GetLastResetReason_pFaultId);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
    ...
    case RTE_E_TIMEOUT:
      fct_error = 1;
      break;
    case RTE_E_TI_RstM_GetLastResetReason_E_NOT_OK:
      fct_error = 1;
      break;
  }

  fct_status = TSC_CFltM_Rte_Call_rp_CS_RstM_GetResetCount_RstM_GetResetCount(0U, &Call_rp_CS_RstM_GetResetCount_RstM_GetResetCount_count);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
    ...
    case RTE_E_TIMEOUT:
      fct_error = 1;
      break;
    case RTE_E_TI_RstM_GetResetCount_E_NOT_OK:
      fct_error = 1;
      break;
  }

  fct_status = TSC_CFltM_Rte_Call_rp_CS_RstM_GetResetHistory_RstM_GetResetHistory(&Call_rp_CS_RstM_GetResetHistory_RstM_GetResetHistory_ResetHistory);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
    ...
    case RTE_E_TIMEOUT:
      fct_error = 1;
      break;
    case RTE_E_TI_RstM_GetResetHistory_E_NOT_OK:
      fct_error = 1;
      break;
  }

  fct_status = TSC_CFltM_Rte_Call_rp_CS_RstM_RequestSwReset_RstM_RequestSwReset(0U, &Call_rp_CS_RstM_RequestSwReset_RstM_RequestSwReset_LogData, 0U);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
    ...
    case RTE_E_TIMEOUT:
      fct_error = 1;
      break;
    case RTE_E_TI_RstM_RequestSwReset_E_NOT_OK:
      fct_error = 1;
      break;
  }
...
/**********************************************************************************************************************
 *
 * Runnable Entity Name: CFltM_Impl_OnCommand
 *
 * This runnable can be invoked concurrently (reentrant implementation).
 *
 *---------------------------------------------------------------------------------------------------------------------
 *
 * Executed if at least one of the following trigger conditions occurred:
 *   - triggered by server invocation for OperationPrototype <Impl_OnCommand> of PortPrototype <pp_CmpLibCmd_CFltM>
 *
 **********************************************************************************************************************
 *
 * Client/Server Interfaces:
 ...
 * Runnable prototype:
 * ===================
 *   Std_ReturnType CFltM_Impl_OnCommand(ECmpCmd cmdP)
 *
 **********************************************************************************************************************
 *
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of documentation area >>                  DO NOT CHANGE THIS COMMENT!
 * Symbol: CFltM_Impl_OnCommand_doc
 *********************************************************************************************************************/
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of runnable implementation >>             DO NOT CHANGE THIS COMMENT!
 * Symbol: CFltM_Impl_OnCommand (returns application error)
 *********************************************************************************************************************/
...
/**********************************************************************************************************************
 *
 * Runnable Entity Name: FltM_FlsIntegrity_GetStatus
 *
 * This runnable can be invoked concurrently (reentrant implementation).
 *
 *---------------------------------------------------------------------------------------------------------------------
 *
 * Executed if at least one of the following trigger conditions occurred:
 *   - triggered by server invocation for OperationPrototype <FltM_FlsIntegrity_GetStatus> of PortPrototype <pp_CS_FltM_FlsIntegrity_GetStatus>
 *
 **********************************************************************************************************************
 *
 * Client/Server Interfaces:
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of documentation area >>                  DO NOT CHANGE THIS COMMENT!
 * Symbol: FltM_FlsIntegrity_GetStatus_doc
 *********************************************************************************************************************/
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of runnable implementation >>             DO NOT CHANGE THIS COMMENT!
 * Symbol: FltM_FlsIntegrity_GetStatus
 *********************************************************************************************************************/
...
/**********************************************************************************************************************
 *
 * Runnable Entity Name: FltM_HandlePostReset
 *
 * This runnable can be invoked concurrently (reentrant implementation).
 *
 *---------------------------------------------------------------------------------------------------------------------
 *
 * Executed if at least one of the following trigger conditions occurred:
 *   - triggered by server invocation for OperationPrototype <FltM_HandlePostReset> of PortPrototype <pp_CS_FltM_HandlePostReset>
 *
 **********************************************************************************************************************
 *
 * Client/Server Interfaces:
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of documentation area >>                  DO NOT CHANGE THIS COMMENT!
 * Symbol: FltM_HandlePostReset_doc
 *********************************************************************************************************************/
...
/**********************************************************************************************************************
 *
 * Runnable Entity Name: FltM_ReportFault
 *
 * This runnable can be invoked concurrently (reentrant implementation).
 *
 *---------------------------------------------------------------------------------------------------------------------
 *
 * Executed if at least one of the following trigger conditions occurred:
 *   - triggered by server invocation for OperationPrototype <FltM_ReportFault> of PortPrototype <pp_CS_FltM_ReportFault>
 *
 **********************************************************************************************************************
 *
 * Client/Server Interfaces:
 ...
 * Runnable prototype:
 * ===================
 *   Std_ReturnType FltM_ReportFault(eFltM_FaultIdType FaultId, eFltM_FaultStatusType FaultStatus, UInt8 *LogData, UInt16 LogLength)
 *
 **********************************************************************************************************************
 *
 * Available Application Errors:
 * =============================
 *   RTE_E_TI_FltM_ReportFault_E_NOT_OK
 *
 *********************************************************************************************************************/
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of documentation area >>                  DO NOT CHANGE THIS COMMENT!
 * Symbol: FltM_ReportFault_doc
 *********************************************************************************************************************/
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of runnable implementation >>             DO NOT CHANGE THIS COMMENT!
 * Symbol: FltM_ReportFault (returns application error)
 *********************************************************************************************************************/
...
static void CFltM_TestDefines(void)
{
  ...
  eFltM_FaultStatusType Test_eFltM_FaultStatusType_V_1 = FLTM_NONE;
  eFltM_FaultStatusType Test_eFltM_FaultStatusType_V_2 = FLTM_INACTIVE;
  eFltM_FaultStatusType Test_eFltM_FaultStatusType_V_3 = FLTM_ACTIVE;
  eFltM_FaultStatusType Test_eFltM_FaultStatusType_V_4 = FLTM_CHANGED;

  eFltM_FlsIntegrityStatusType Test_eFltM_FlsIntegrityStatusType_V_1 = FLTM_FLSINTEGRITY_NOT_STARTED;
  eFltM_FlsIntegrityStatusType Test_eFltM_FlsIntegrityStatusType_V_2 = FLTM_FLSINTEGRITY_INPROGRESS;
  eFltM_FlsIntegrityStatusType Test_eFltM_FlsIntegrityStatusType_V_3 = FLTM_FLSINTEGRITY_COMPLETED_PASS;
  eFltM_FlsIntegrityStatusType Test_eFltM_FlsIntegrityStatusType_V_4 = FLTM_FLSINTEGRITY_COMPLETED_FAIL;
}
