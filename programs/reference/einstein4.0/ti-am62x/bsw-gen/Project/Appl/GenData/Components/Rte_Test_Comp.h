 ...
 * API prototypes
 *********************************************************************************************************************/
FUNC(Std_ReturnType, RTE_CODE) Rte_Read_Test_Comp_pSR_DisplayCurrentState_DisplayCurrentStateData(P2VAR(SDisplayCurrentState, AUTOMATIC, RTE_TEST_COMP_APPL_VAR) data); /* PRQA S 0850 */ /* MD_MSR_19.8 */
