 ...
 *       License:  CBD1800851
 *
 *   Description:  Application header file for SW-C <View_Speed>
 *********************************************************************************************************************/

/* double include prevention */
#ifndef _RTE_VIEW_SPEED_H
# define _RTE_VIEW_SPEED_H
...
#  define Rte_InitValue_pp_Display_speed_Value_Digital_Speed_Value (0U)
#  define Rte_InitValue_pp_SubDisplaySpeed_Value_SubDispSpeedVal (0U)
#  define Rte_InitValue_pp_SubSpeedUnit_Value_SubSpeedunit (0U)
...
#  define Rte_InitValue_rp_SPD_Selection_Table_Speed_Selection_Table (0U)
#  define Rte_InitValue_rp_SPD_Target2_Status_Spd_Target2_Status (0U)
#  define Rte_InitValue_rp_SPD_Target_Status_Spd_Target_Status (0U)
#  define Rte_InitValue_rp_SPD_Trim2_Status_Spd_Trim2_Status (0U)
#  define Rte_InitValue_rp_SPD_Trim_Status_Spd_Trim_Status (0U)
# endif
 ...
 *********************************************************************************************************************/
#  define Rte_Read_rpIgnSubstate_IgnitionSubstate Rte_Read_View_Speed_rpIgnSubstate_IgnitionSubstate
#  define Rte_Read_View_Speed_rpIgnSubstate_IgnitionSubstate(data) (*(data) = Rte_Ctrl_WSS_ppIgnSubstate_IgnitionSubstate, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_ClusterMode_WSSCurrentClusterMode Rte_Read_View_Speed_rp_ClusterMode_WSSCurrentClusterMode
#  define Rte_Read_View_Speed_rp_ClusterMode_WSSCurrentClusterMode(data) (*(data) = Rte_Ctrl_WSS_pp_ClusterMode_WSSCurrentClusterMode, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_Countrycode_Func_CountryCode_Func Rte_Read_View_Speed_rp_Countrycode_Func_CountryCode_Func
#  define Rte_Read_View_Speed_rp_Countrycode_Func_CountryCode_Func(data) (*(data) = 0U, ((Std_ReturnType)RTE_E_UNCONNECTED)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_Dcm_appStop_AppId Rte_Read_View_Speed_rp_Dcm_appStop_AppId
#  define Rte_Read_View_Speed_rp_Dcm_appStop_AppId(data) (*(data) = 0U, ((Std_ReturnType)RTE_E_UNCONNECTED)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_Diag_Digitalspeed_Diag_Digital_Speed_Value Rte_Read_View_Speed_rp_Diag_Digitalspeed_Diag_Digital_Speed_Value
#  define Rte_Read_View_Speed_rp_Diag_Digitalspeed_Diag_Digital_Speed_Value(data) (*(data) = 0U, ((Std_ReturnType)RTE_E_UNCONNECTED)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_DispDistanceUnit_DisplayUnit Rte_Read_View_Speed_rp_DispDistanceUnit_DisplayUnit
#  define Rte_Read_View_Speed_rp_DispDistanceUnit_DisplayUnit(data) (*(data) = 0U, ((Std_ReturnType)RTE_E_UNCONNECTED)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_SPD_SP1_In_Status_SP1_In_Status Rte_Read_View_Speed_rp_SPD_SP1_In_Status_SP1_In_Status
#  define Rte_Read_View_Speed_rp_SPD_SP1_In_Status_SP1_In_Status(data) (*(data) = Rte_Mdl_Speed_pp_SPD_SP1_In_Status_SP1_In_Status, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_SPD_Selection_Table_Speed_Selection_Table Rte_Read_View_Speed_rp_SPD_Selection_Table_Speed_Selection_Table
#  define Rte_Read_View_Speed_rp_SPD_Selection_Table_Speed_Selection_Table(data) (*(data) = Rte_Mdl_Speed_pp_SPD_Selection_Table_Speed_Selection_Table, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_SPD_Target2_Status_Spd_Target2_Status Rte_Read_View_Speed_rp_SPD_Target2_Status_Spd_Target2_Status
#  define Rte_Read_View_Speed_rp_SPD_Target2_Status_Spd_Target2_Status(data) (*(data) = Rte_Mdl_Speed_pp_SPD_Target2_Status_Spd_Target2_Status, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_SPD_Target_Status_Spd_Target_Status Rte_Read_View_Speed_rp_SPD_Target_Status_Spd_Target_Status
#  define Rte_Read_View_Speed_rp_SPD_Target_Status_Spd_Target_Status(data) (*(data) = Rte_Mdl_Speed_pp_SPD_Target_Status_Spd_Target_Status, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_SPD_Trim2_Status_Spd_Trim2_Status Rte_Read_View_Speed_rp_SPD_Trim2_Status_Spd_Trim2_Status
#  define Rte_Read_View_Speed_rp_SPD_Trim2_Status_Spd_Trim2_Status(data) (*(data) = Rte_Mdl_Speed_pp_SPD_Trim2_Status_Spd_Trim2_Status, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_SPD_Trim_Status_Spd_Trim_Status Rte_Read_View_Speed_rp_SPD_Trim_Status_Spd_Trim_Status
#  define Rte_Read_View_Speed_rp_SPD_Trim_Status_Spd_Trim_Status(data) (*(data) = Rte_Mdl_Speed_pp_SPD_Trim_Status_Spd_Trim_Status, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */


/**********************************************************************************************************************
 * Rte_Write_<p>_<d> (explicit S/R communication with isQueued = false)
 *********************************************************************************************************************/
#  define Rte_Write_pp_Display_speed_Value_Digital_Speed_Value Rte_Write_View_Speed_pp_Display_speed_Value_Digital_Speed_Value
#  define Rte_Write_View_Speed_pp_Display_speed_Value_Digital_Speed_Value(data) (Rte_View_Speed_pp_Display_speed_Value_Digital_Speed_Value = (data), ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Write_pp_SubDisplaySpeed_Value_SubDispSpeedVal Rte_Write_View_Speed_pp_SubDisplaySpeed_Value_SubDispSpeedVal
#  define Rte_Write_View_Speed_pp_SubDisplaySpeed_Value_SubDispSpeedVal(data) (Rte_View_Speed_pp_SubDisplaySpeed_Value_SubDispSpeedVal = (data), ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Write_pp_SubSpeedUnit_Value_SubSpeedunit Rte_Write_View_Speed_pp_SubSpeedUnit_Value_SubSpeedunit
#  define Rte_Write_View_Speed_pp_SubSpeedUnit_Value_SubSpeedunit(data) (RTE_E_OK) /* PRQA S 3453 */ /* MD_MSR_19.7 */
...
# ifndef RTE_CORE
#  define RTE_RUNNABLE_View_Speed_Init View_Speed_Init
#  define RTE_RUNNABLE_View_Speed_Task View_Speed_Task
# endif

FUNC(void, View_Speed_CODE) View_Speed_Init(void); /* PRQA S 0850 */ /* MD_MSR_19.8 */
FUNC(void, View_Speed_CODE) View_Speed_Task(void); /* PRQA S 0850, 3451 */ /* MD_MSR_19.8, MD_Rte_3451 */
