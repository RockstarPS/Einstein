 ...
 *       License:  CBD1800851
 *
 *   Description:  Application types header file for SW-C <SysTst>
 *********************************************************************************************************************/

/* double include prevention */
#ifndef _RTE_SYSTST_TYPE_H
# define _RTE_SYSTST_TYPE_H
