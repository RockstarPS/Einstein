 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *          File:  Rte_Mdl_wFuelLidOpen_Type.h
 *        Config:  BMW.dpa
 *   ECU-Project:  IC
 *
 ...
 *       License:  CBD1800851
 *
 *   Description:  Application types header file for SW-C <Mdl_wFuelLidOpen>
 *********************************************************************************************************************/

/* double include prevention */
#ifndef _RTE_MDL_WFUELLIDOPEN_TYPE_H
# define _RTE_MDL_WFUELLIDOPEN_TYPE_H
...
#endif /* _RTE_MDL_WFUELLIDOPEN_TYPE_H */
