 ...
 *       License:  CBD1800851
 *
 *   Description:  Application header file for SW-C <Mdl_Dim>
 *********************************************************************************************************************/

/* double include prevention */
#ifndef _RTE_MDL_DIM_H
# define _RTE_MDL_DIM_H
...
extern VAR(Boolean, RTE_VAR_INIT) Rte_Ctrl_Dim_pp_Ctrl_Ready_to_Sleep_Ready_to_Sleep; /* PRQA S 0850 */ /* MD_MSR_19.8 */
extern VAR(UInt8, RTE_VAR_INIT) Rte_Ctrl_Dim_pp_IlumDayNightRequired_IlumDayNightRequired; /* PRQA S 0850 */ /* MD_MSR_19.8 */
extern VAR(UInt8, RTE_VAR_INIT) Rte_Ctrl_Dim_pp_IlumDayNightStatus_Day_Night_Status; /* PRQA S 0850 */ /* MD_MSR_19.8 */
extern VAR(UInt8, RTE_VAR_INIT) Rte_Ctrl_Dim_pp_StopPwmUpdate_channel_id; /* PRQA S 0850 */ /* MD_MSR_19.8 */
...
#  define Rte_InitValue_pp_Illum_Transstep_Trans_Stepvlaue (0U)
#  define Rte_InitValue_pp_IlluminationDuty_DutyValue (0U)
#  define Rte_InitValue_pp_IlumDayNightRequired_ilumDNRequired (0U)
#  define Rte_InitValue_pp_IlumDayNightStatus_illumDNStatus (0U)
#  define Rte_InitValue_pp_IlumStep_IllumStepValue (0U)
#  define Rte_InitValue_pp_RGBStep_RGBStepValue (0U)
#  define Rte_InitValue_pp_RHDW_Dbc_RHDW_Dbc (0U)
#  define Rte_InitValue_pp_RHUP_Dbc_RHUP_Dbc (0U)
#  define Rte_InitValue_pp_RheoSwRaw_Status_RawdataStatus (0U)
#  define Rte_InitValue_pp_RheoSwStatus_SwitchStatus (0U)
#  define Rte_InitValue_pp_RheostatDayStep_RheostatDayStep (0U)
#  define Rte_InitValue_pp_RheostatNightStep_RheostatNightStep (0U)
#  define Rte_InitValue_pp_RheostatONSStatus_RheostatONSStatus (0U)
#  define Rte_InitValue_pp_RheostatSwType_RheostatSwType (0U)
#  define Rte_InitValue_pp_illumRheostatOnSTimer_Rheostat_OnSTime (0U)
#  define Rte_InitValue_pp_illumStarterstatus_StarterStatus_Out (0U)
#  define Rte_InitValue_pp_illum_rheostat_change_RheoUpdateVal (0U)
#  define Rte_InitValue_rpEtmSts_Illum_Status (0U)
#  define Rte_InitValue_rpEtmTTSts_IllumStatus (0U)
...
#  define Rte_InitValue_rp_Ctrl_Ready_to_Sleep_Ready_to_Sleep (FALSE)
#  define Rte_InitValue_rp_Dcm_stop_app_AppId (0U)
#  define Rte_InitValue_rp_Diag2F_Rheo_Diag_RheoStat (0U)
#  define Rte_InitValue_rp_EcoRunPresenceFlag_EcoRunPresenceFlag (0U)
#  define Rte_InitValue_rp_IlumDayNightRequired_IlumDayNightRequired (0U)
#  define Rte_InitValue_rp_IlumDayNightStatus_Day_Night_Status (0U)
#  define Rte_InitValue_rp_PowerTrain_State_PowerTrain_Flag (0U)
#  define Rte_InitValue_rp_StopPwmUpdate_channel_id (0U)
#  define Rte_InitValue_rp_TFTDisplayOn_TFTDisplayOn (0U)
#  define Rte_InitValue_rp_custom_reset_CurrentUserID (0U)
#  define Rte_InitValue_rp_custom_reset_CustomizeReset (0U)
#  define Rte_InitValue_rp_custom_reset_SettingResetResult (0U)
# endif
 ...
 * API prototypes
 *********************************************************************************************************************/
FUNC(Std_ReturnType, RTE_CODE) Rte_Write_Mdl_Dim_pp_IllumCtrl_Ip_IllumCtrl_Ip_Data(P2CONST(IllumCtrl_Ip, AUTOMATIC, RTE_MDL_DIM_APPL_DATA) data); /* PRQA S 0850 */ /* MD_MSR_19.8 */
 ...
 *********************************************************************************************************************/
#  define Rte_Read_rpEtmSts_Illum_Status Rte_Read_Mdl_Dim_rpEtmSts_Illum_Status
#  define Rte_Read_Mdl_Dim_rpEtmSts_Illum_Status(data) (*(data) = 0U, ((Std_ReturnType)RTE_E_UNCONNECTED)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rpEtmTTSts_IllumStatus Rte_Read_Mdl_Dim_rpEtmTTSts_IllumStatus
#  define Rte_Read_Mdl_Dim_rpEtmTTSts_IllumStatus(data) (*(data) = 0U, ((Std_ReturnType)RTE_E_UNCONNECTED)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rpIgnSubstate_IgnitionSubstate Rte_Read_Mdl_Dim_rpIgnSubstate_IgnitionSubstate
#  define Rte_Read_Mdl_Dim_rpIgnSubstate_IgnitionSubstate(data) (*(data) = Rte_Ctrl_WSS_ppIgnSubstate_IgnitionSubstate, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rpIllum_Etm_IllumStatus Rte_Read_Mdl_Dim_rpIllum_Etm_IllumStatus
#  define Rte_Read_Mdl_Dim_rpIllum_Etm_IllumStatus(data) (*(data) = 0U, ((Std_ReturnType)RTE_E_UNCONNECTED)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rpVehicleAppMode_WSSCurrentVehicleState Rte_Read_Mdl_Dim_rpVehicleAppMode_WSSCurrentVehicleState
#  define Rte_Read_Mdl_Dim_rpVehicleAppMode_WSSCurrentVehicleState(data) (*(data) = Rte_Ctrl_WSS_pp_VehicleAppMode_WSSCurrentVehicleState, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_ClusterMode_WSSCurrentClusterMode Rte_Read_Mdl_Dim_rp_ClusterMode_WSSCurrentClusterMode
#  define Rte_Read_Mdl_Dim_rp_ClusterMode_WSSCurrentClusterMode(data) (*(data) = Rte_Ctrl_WSS_pp_ClusterMode_WSSCurrentClusterMode, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_Ctrl_Ready_to_Sleep_Ready_to_Sleep Rte_Read_Mdl_Dim_rp_Ctrl_Ready_to_Sleep_Ready_to_Sleep
#  define Rte_Read_Mdl_Dim_rp_Ctrl_Ready_to_Sleep_Ready_to_Sleep(data) (*(data) = Rte_Ctrl_Dim_pp_Ctrl_Ready_to_Sleep_Ready_to_Sleep, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_Dcm_stop_app_AppId Rte_Read_Mdl_Dim_rp_Dcm_stop_app_AppId
#  define Rte_Read_Mdl_Dim_rp_Dcm_stop_app_AppId(data) (*(data) = 0U, ((Std_ReturnType)RTE_E_UNCONNECTED)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_Diag2F_Rheo_Diag_RheoStat Rte_Read_Mdl_Dim_rp_Diag2F_Rheo_Diag_RheoStat
#  define Rte_Read_Mdl_Dim_rp_Diag2F_Rheo_Diag_RheoStat(data) (*(data) = 0U, ((Std_ReturnType)RTE_E_UNCONNECTED)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_EcoRunPresenceFlag_EcoRunPresenceFlag Rte_Read_Mdl_Dim_rp_EcoRunPresenceFlag_EcoRunPresenceFlag
#  define Rte_Read_Mdl_Dim_rp_EcoRunPresenceFlag_EcoRunPresenceFlag(data) (*(data) = 0U, ((Std_ReturnType)RTE_E_UNCONNECTED)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_IlumDayNightRequired_IlumDayNightRequired Rte_Read_Mdl_Dim_rp_IlumDayNightRequired_IlumDayNightRequired
#  define Rte_Read_Mdl_Dim_rp_IlumDayNightRequired_IlumDayNightRequired(data) (*(data) = Rte_Ctrl_Dim_pp_IlumDayNightRequired_IlumDayNightRequired, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_IlumDayNightStatus_Day_Night_Status Rte_Read_Mdl_Dim_rp_IlumDayNightStatus_Day_Night_Status
#  define Rte_Read_Mdl_Dim_rp_IlumDayNightStatus_Day_Night_Status(data) (*(data) = Rte_Ctrl_Dim_pp_IlumDayNightStatus_Day_Night_Status, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_PowerTrain_State_PowerTrain_Flag Rte_Read_Mdl_Dim_rp_PowerTrain_State_PowerTrain_Flag
#  define Rte_Read_Mdl_Dim_rp_PowerTrain_State_PowerTrain_Flag(data) (*(data) = 0U, ((Std_ReturnType)RTE_E_UNCONNECTED)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_StopPwmUpdate_channel_id Rte_Read_Mdl_Dim_rp_StopPwmUpdate_channel_id
#  define Rte_Read_Mdl_Dim_rp_StopPwmUpdate_channel_id(data) (*(data) = Rte_Ctrl_Dim_pp_StopPwmUpdate_channel_id, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_TFTDisplayOn_TFTDisplayOn Rte_Read_Mdl_Dim_rp_TFTDisplayOn_TFTDisplayOn
#  define Rte_Read_Mdl_Dim_rp_TFTDisplayOn_TFTDisplayOn(data) (*(data) = Rte_Ctrl_WSS_pp_TFTDisplayOn_TFTDisplayOn, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_custom_reset_CurrentUserID Rte_Read_Mdl_Dim_rp_custom_reset_CurrentUserID
#  define Rte_Read_Mdl_Dim_rp_custom_reset_CurrentUserID(data) (*(data) = 0U, ((Std_ReturnType)RTE_E_UNCONNECTED)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_custom_reset_CustomizeReset Rte_Read_Mdl_Dim_rp_custom_reset_CustomizeReset
#  define Rte_Read_Mdl_Dim_rp_custom_reset_CustomizeReset(data) (*(data) = 0U, ((Std_ReturnType)RTE_E_UNCONNECTED)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_rp_custom_reset_SettingResetResult Rte_Read_Mdl_Dim_rp_custom_reset_SettingResetResult
#  define Rte_Read_Mdl_Dim_rp_custom_reset_SettingResetResult(data) (*(data) = 0U, ((Std_ReturnType)RTE_E_UNCONNECTED)) /* PRQA S 3453 */ /* MD_MSR_19.7 */


/**********************************************************************************************************************
 * Rte_Write_<p>_<d> (explicit S/R communication with isQueued = false)
 *********************************************************************************************************************/
#  define Rte_Write_pp_IllumCtrl_Ip_IllumCtrl_Ip_Data Rte_Write_Mdl_Dim_pp_IllumCtrl_Ip_IllumCtrl_Ip_Data
#  define Rte_Write_pp_Illum_Transstep_Trans_Stepvlaue Rte_Write_Mdl_Dim_pp_Illum_Transstep_Trans_Stepvlaue
#  define Rte_Write_Mdl_Dim_pp_Illum_Transstep_Trans_Stepvlaue(data) (RTE_E_OK) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Write_pp_IlluminationDuty_DutyValue Rte_Write_Mdl_Dim_pp_IlluminationDuty_DutyValue
#  define Rte_Write_Mdl_Dim_pp_IlluminationDuty_DutyValue(data) (RTE_E_OK) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Write_pp_IlumDayNightRequired_ilumDNRequired Rte_Write_Mdl_Dim_pp_IlumDayNightRequired_ilumDNRequired
#  define Rte_Write_Mdl_Dim_pp_IlumDayNightRequired_ilumDNRequired(data) (RTE_E_OK) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Write_pp_IlumDayNightStatus_illumDNStatus Rte_Write_Mdl_Dim_pp_IlumDayNightStatus_illumDNStatus
#  define Rte_Write_Mdl_Dim_pp_IlumDayNightStatus_illumDNStatus(data) (Rte_Mdl_Dim_pp_IlumDayNightStatus_illumDNStatus = (data), ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Write_pp_IlumStep_IllumStepValue Rte_Write_Mdl_Dim_pp_IlumStep_IllumStepValue
#  define Rte_Write_Mdl_Dim_pp_IlumStep_IllumStepValue(data) (Rte_Mdl_Dim_pp_IlumStep_IllumStepValue = (data), ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Write_pp_RGBStep_RGBStepValue Rte_Write_Mdl_Dim_pp_RGBStep_RGBStepValue
#  define Rte_Write_Mdl_Dim_pp_RGBStep_RGBStepValue(data) (RTE_E_OK) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Write_pp_RHDW_Dbc_RHDW_Dbc Rte_Write_Mdl_Dim_pp_RHDW_Dbc_RHDW_Dbc
#  define Rte_Write_Mdl_Dim_pp_RHDW_Dbc_RHDW_Dbc(data) (RTE_E_OK) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Write_pp_RHUP_Dbc_RHUP_Dbc Rte_Write_Mdl_Dim_pp_RHUP_Dbc_RHUP_Dbc
#  define Rte_Write_Mdl_Dim_pp_RHUP_Dbc_RHUP_Dbc(data) (RTE_E_OK) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Write_pp_RheoSwRaw_Status_RawdataStatus Rte_Write_Mdl_Dim_pp_RheoSwRaw_Status_RawdataStatus
#  define Rte_Write_Mdl_Dim_pp_RheoSwRaw_Status_RawdataStatus(data) (RTE_E_OK) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Write_pp_RheoSwStatus_SwitchStatus Rte_Write_Mdl_Dim_pp_RheoSwStatus_SwitchStatus
#  define Rte_Write_Mdl_Dim_pp_RheoSwStatus_SwitchStatus(data) (RTE_E_OK) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Write_pp_RheostatDayStep_RheostatDayStep Rte_Write_Mdl_Dim_pp_RheostatDayStep_RheostatDayStep
#  define Rte_Write_Mdl_Dim_pp_RheostatDayStep_RheostatDayStep(data) (Rte_Mdl_Dim_pp_RheostatDayStep_RheostatDayStep = (data), ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Write_pp_RheostatNightStep_RheostatNightStep Rte_Write_Mdl_Dim_pp_RheostatNightStep_RheostatNightStep
#  define Rte_Write_Mdl_Dim_pp_RheostatNightStep_RheostatNightStep(data) (Rte_Mdl_Dim_pp_RheostatNightStep_RheostatNightStep = (data), ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Write_pp_RheostatONSStatus_RheostatONSStatus Rte_Write_Mdl_Dim_pp_RheostatONSStatus_RheostatONSStatus
#  define Rte_Write_Mdl_Dim_pp_RheostatONSStatus_RheostatONSStatus(data) (RTE_E_OK) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Write_pp_RheostatSwType_RheostatSwType Rte_Write_Mdl_Dim_pp_RheostatSwType_RheostatSwType
#  define Rte_Write_Mdl_Dim_pp_RheostatSwType_RheostatSwType(data) (RTE_E_OK) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Write_pp_illumRheostatOnSTimer_Rheostat_OnSTime Rte_Write_Mdl_Dim_pp_illumRheostatOnSTimer_Rheostat_OnSTime
#  define Rte_Write_Mdl_Dim_pp_illumRheostatOnSTimer_Rheostat_OnSTime(data) (RTE_E_OK) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Write_pp_illumStarterstatus_StarterStatus_Out Rte_Write_Mdl_Dim_pp_illumStarterstatus_StarterStatus_Out
#  define Rte_Write_Mdl_Dim_pp_illumStarterstatus_StarterStatus_Out(data) (Rte_Mdl_Dim_pp_illumStarterstatus_StarterStatus_Out = (data), ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Write_pp_illum_rheostat_change_RheoUpdateVal Rte_Write_Mdl_Dim_pp_illum_rheostat_change_RheoUpdateVal
#  define Rte_Write_Mdl_Dim_pp_illum_rheostat_change_RheoUpdateVal(data) (Rte_Mdl_Dim_pp_illum_rheostat_change_RheoUpdateVal = (data), ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
...
#  define Rte_Call_rpUpdateDIMWarning_UpdateWarningStatus(arg1, arg2, arg3, arg4) (Ctrl_warning_UpdateWarningStatus(arg1, arg2, arg3, arg4), ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
...
#  define RTE_START_SEC_CTRL_DIM_APPL_CODE
#  include "MemMap.h" /* PRQA S 5087 */ /* MD_MSR_19.1 */
FUNC(void, RTE_CTRL_DIM_APPL_CODE) Ctrl_Dim_GetPwmCurrentDuty(UInt8 ChannelID, P2VAR(UInt16, AUTOMATIC, RTE_CTRL_DIM_APPL_VAR) Channel_Duty); /* PRQA S 0850 */ /* MD_MSR_19.8 */
#  define RTE_STOP_SEC_CTRL_DIM_APPL_CODE
#  include "MemMap.h" /* PRQA S 5087 */ /* MD_MSR_19.1 */

#  define Rte_Call_rp_Current_duty_GetPwmCurrentDuty(arg1, arg2) (Ctrl_Dim_GetPwmCurrentDuty(arg1, arg2), ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_GetNVM_IlluminationData_Get_BsConst_Audio_Element(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_GetNVM_IlluminationData_Get_BsConst_BsConst_Illumination_ReservedByte(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_GetNVM_IlluminationData_Get_BsConst_BsConst_Illumination_ReservedByte_SafeCopy1(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_GetNVM_IlluminationData_Get_BsConst_BsConst_Illumination_ReservedByte_SafeCopy2(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_GetNVM_IlluminationData_Get_BsConst_Communication_Element(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_GetNVM_IlluminationData_Get_BsConst_Compensation_Line_Shift_b(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_GetNVM_IlluminationData_Get_BsConst_Compensation_Line_Shift_b_SafeCopy1(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_GetNVM_IlluminationData_Get_BsConst_Compensation_Line_Shift_b_SafeCopy2(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_GetNVM_IlluminationData_Get_BsConst_Compensation_Line_Slope_m(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_GetNVM_IlluminationData_Get_BsConst_Compensation_Line_Slope_m_SafeCopy1(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_GetNVM_IlluminationData_Get_BsConst_Compensation_Line_Slope_m_SafeCopy2(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_GetNVM_IlluminationData_Get_BsConst_Derating_Backlight_Disable(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_GetNVM_IlluminationData_Get_BsConst_Derating_Backlight_Disable_SafeCopy1(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_GetNVM_IlluminationData_Get_BsConst_Derating_Backlight_Disable_SafeCopy2(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_GetNVM_IlluminationData_Get_BsConst_Display_Illum_Max_Level(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_GetNVM_IlluminationData_Get_BsConst_Display_Illum_Max_Level_SafeCopy1(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_GetNVM_IlluminationData_Get_BsConst_Display_Illum_Max_Level_SafeCopy2(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_GetNVM_IlluminationData_Get_BsConst_EngOffTimer_Element(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_GetNVM_IlluminationData_Get_BsConst_FuelGauge_Element(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_GetNVM_IlluminationData_Get_BsConst_Lookup_Curve_HotSpot_Coef_X(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_GetNVM_IlluminationData_Get_BsConst_Lookup_Curve_HotSpot_Coef_X_SafeCopy1(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_GetNVM_IlluminationData_Get_BsConst_Lookup_Curve_HotSpot_Coef_X_SafeCopy2(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_GetNVM_IlluminationData_Get_BsConst_Lookup_Curve_HotSpot_Coef_Y(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_GetNVM_IlluminationData_Get_BsConst_Lookup_Curve_HotSpot_Coef_Y_SafeCopy1(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_GetNVM_IlluminationData_Get_BsConst_Lookup_Curve_HotSpot_Coef_Y_SafeCopy2(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_GetNVM_IlluminationData_Get_BsConst_OilGauge_Element(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_GetNVM_IlluminationData_Get_BsConst_PCB_Temperature_Sensor_Conv(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_GetNVM_IlluminationData_Get_BsConst_PCB_Temperature_Sensor_Conv_SafeCopy1(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_GetNVM_IlluminationData_Get_BsConst_PCB_Temperature_Sensor_Conv_SafeCopy2(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_GetNVM_IlluminationData_Get_BsConst_PWM_boost_bypass_duty(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_GetNVM_IlluminationData_Get_BsConst_PWM_boost_bypass_duty_SafeCopy1(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_GetNVM_IlluminationData_Get_BsConst_PWM_boost_bypass_duty_SafeCopy2(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_GetNVM_IlluminationData_Get_BsConst_PowerGauge_Element(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_GetNVM_IlluminationData_Get_BsConst_Power_Element(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_GetNVM_IlluminationData_Get_BsConst_RealTimeClock_Element(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_GetNVM_IlluminationData_Get_BsConst_ServiceReminder_Element(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_GetNVM_IlluminationData_Get_BsConst_SpeedoGauge_Element(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_GetNVM_IlluminationData_Get_BsConst_TachoGauge_Element(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_GetNVM_IlluminationData_Get_BsConst_TempGauge_Element(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_GetNVM_IlluminationData_Get_BsConst_Temp_Threshold_Hysteresis_Derating(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_GetNVM_IlluminationData_Get_BsConst_Temp_Threshold_Hysteresis_Derating_SafeCopy1(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_GetNVM_IlluminationData_Get_BsConst_Temp_Threshold_Hysteresis_Derating_SafeCopy2(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_GetNVM_IlluminationData_Get_BsConst_Temperature_Sensor_Conv(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_GetNVM_IlluminationData_Get_BsConst_Temperature_Sensor_Conv_SafeCopy1(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_GetNVM_IlluminationData_Get_BsConst_Temperature_Sensor_Conv_SafeCopy2(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_GetNVM_IlluminationData_Get_BsConst_TripComputer_Element(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_GetNVM_IlluminationData_Get_BsConst_Warning_Element(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_GetNVM_IlluminationData_Get_BsCys_Certicificate_Element(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_GetNVM_IlluminationData_Get_BsDiag_Dtc_Element(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_GetNVM_IlluminationData_Get_BsDiag_ErrorRecord_Element(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_GetNVM_IlluminationData_Get_BsReten_Audio_Element(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_GetNVM_IlluminationData_Get_BsReten_Communication_Element(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_GetNVM_IlluminationData_Get_BsReten_Display_Element(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_GetNVM_IlluminationData_Get_BsReten_Gauges_Element(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_GetNVM_IlluminationData_Get_BsReten_Illumination_Element(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_GetNVM_IlluminationData_Get_BsReten_Odometer_Element(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_GetNVM_IlluminationData_Get_BsReten_Personalization_Element(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_GetNVM_IlluminationData_Get_BsReten_Power_Element(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_GetNVM_IlluminationData_Get_BsReten_RealTimeClock_Element(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_GetNVM_IlluminationData_Get_BsReten_Tripcomputer_Element(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_GetNVM_IlluminationData_Get_BsReten_Warning_Element(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_GetNVM_IlluminationData_Get_BsRt_CusDlt_Element(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_GetNVM_IlluminationData_Get_BsRt_FuelGauge_Element(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_GetNVM_IlluminationData_Get_BsRt_Illumination_Element(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_GetNVM_IlluminationData_Get_BsRt_Odometer_Element(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_GetNVM_IlluminationData_Get_BsRt_OilGauge_Element(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_GetNVM_IlluminationData_Get_BsRt_Personalization_Element(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_GetNVM_IlluminationData_Get_BsRt_PowerGauge_Element(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_GetNVM_IlluminationData_Get_BsRt_RealTimeClock_Element(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_GetNVM_IlluminationData_Get_BsRt_SpeedoGauge_Element(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_GetNVM_IlluminationData_Get_BsRt_TachoGauge_Element(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_GetNVM_IlluminationData_Get_BsRt_TempGauge_Element(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_GetNVM_IlluminationData_Get_BsRt_TripComputer_Element(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_GetNVM_IlluminationData_Get_BsRt_Warning_Element(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_GetNVM_IlluminationData_Get_BsShare_AssemblyManufacturingDate(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_GetNVM_IlluminationData_Get_BsShare_AssemblyPlantNumber(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_GetNVM_IlluminationData_Get_BsShare_EcuPartNumber_Element(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_GetNVM_IlluminationData_Get_BsShare_HWModification(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_GetNVM_IlluminationData_Get_BsShare_PCBSerialNumber(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_GetNVM_IlluminationData_Get_BsShare_ProductSerialNumber(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_GetNVM_IlluminationData_Get_BsShare_SMTManufacturingDate(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_GetNVM_IlluminationData_Get_BsShare_SMTPlantNumber(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_GetNVM_IlluminationData_Get_BsShare_SwUpdFotaFinPrint_Element(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_GetNVM_IlluminationData_Get_BsShare_SwUpdFotaMode_Element(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_GetNVM_IlluminationData_Get_BsShare_SwUpdFotaStatus_Element(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_GetNVM_IlluminationData_Get_BsShare_SwUpdFotadecrypt_Element(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_GetNVM_IlluminationData_Get_BsShare_SwUpdReflash_Element(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_GetNVM_IlluminationData_Get_BsShare_VehicleConfig_Element(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_GetNVM_IlluminationData_Get_BsShare_VisMeet_EOLEntry_Element(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_GetNVM_IlluminationData_Get_BsShare_VisMeet_Element(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_GetNVM_IlluminationData_Get_BsShare_VisteonPCBPartNumber(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_GetNVM_IlluminationData_Get_BsShare_VisteonPartNumber(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_GetNVM_IlluminationData_Get_RefCys_Certicificate1_Element(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_GetNVM_IlluminationData_Get_RefCys_Certicificate_Element(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
...
#  define RTE_START_SEC_CTRL_DIM_APPL_CODE
#  include "MemMap.h" /* PRQA S 5087 */ /* MD_MSR_19.1 */
FUNC(void, RTE_CTRL_DIM_APPL_CODE) Ctrl_Dim_GetPwmWithTime(IoHwAb_PwmSignalIdType ChannelID, UInt16 TargetDuty, UInt16 TargetTime); /* PRQA S 0850 */ /* MD_MSR_19.8 */
#  define RTE_STOP_SEC_CTRL_DIM_APPL_CODE
#  include "MemMap.h" /* PRQA S 5087 */ /* MD_MSR_19.1 */

#  define Rte_Call_rp_PwmWithTime_GetPwmWithTime(arg1, arg2, arg3) (Ctrl_Dim_GetPwmWithTime(arg1, arg2, arg3), ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define RTE_START_SEC_CTRL_DIM_APPL_CODE
#  include "MemMap.h" /* PRQA S 5087 */ /* MD_MSR_19.1 */
FUNC(void, RTE_CTRL_DIM_APPL_CODE) Ctrl_Dim_GetPwmWithTimeExp(IoHwAb_PwmSignalIdType ChannelID, UInt16 TargetDuty, UInt16 TargetTime); /* PRQA S 0850 */ /* MD_MSR_19.8 */
#  define RTE_STOP_SEC_CTRL_DIM_APPL_CODE
#  include "MemMap.h" /* PRQA S 5087 */ /* MD_MSR_19.1 */

#  define Rte_Call_rp_PwmWithTimeExp_GetPwmWithTimeExp(arg1, arg2, arg3) (Ctrl_Dim_GetPwmWithTimeExp(arg1, arg2, arg3), ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_SetNVM_IlluminationData_Set_BsConst_Audio_Element(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_SetNVM_IlluminationData_Set_BsConst_BsConst_Illumination_ReservedByte(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_SetNVM_IlluminationData_Set_BsConst_BsConst_Illumination_ReservedByte_SafeCopy1(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_SetNVM_IlluminationData_Set_BsConst_BsConst_Illumination_ReservedByte_SafeCopy2(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_SetNVM_IlluminationData_Set_BsConst_Communication_Element(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_SetNVM_IlluminationData_Set_BsConst_Compensation_Line_Shift_b(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_SetNVM_IlluminationData_Set_BsConst_Compensation_Line_Shift_b_SafeCopy1(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_SetNVM_IlluminationData_Set_BsConst_Compensation_Line_Shift_b_SafeCopy2(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_SetNVM_IlluminationData_Set_BsConst_Compensation_Line_Slope_m(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_SetNVM_IlluminationData_Set_BsConst_Compensation_Line_Slope_m_SafeCopy1(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_SetNVM_IlluminationData_Set_BsConst_Compensation_Line_Slope_m_SafeCopy2(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_SetNVM_IlluminationData_Set_BsConst_Derating_Backlight_Disable(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_SetNVM_IlluminationData_Set_BsConst_Derating_Backlight_Disable_SafeCopy1(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_SetNVM_IlluminationData_Set_BsConst_Derating_Backlight_Disable_SafeCopy2(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_SetNVM_IlluminationData_Set_BsConst_Display_Illum_Max_Level(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_SetNVM_IlluminationData_Set_BsConst_Display_Illum_Max_Level_SafeCopy1(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_SetNVM_IlluminationData_Set_BsConst_Display_Illum_Max_Level_SafeCopy2(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_SetNVM_IlluminationData_Set_BsConst_EngOffTimer_Element(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_SetNVM_IlluminationData_Set_BsConst_FuelGauge_Element(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_SetNVM_IlluminationData_Set_BsConst_Lookup_Curve_HotSpot_Coef_X(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_SetNVM_IlluminationData_Set_BsConst_Lookup_Curve_HotSpot_Coef_X_SafeCopy1(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_SetNVM_IlluminationData_Set_BsConst_Lookup_Curve_HotSpot_Coef_X_SafeCopy2(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_SetNVM_IlluminationData_Set_BsConst_Lookup_Curve_HotSpot_Coef_Y(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_SetNVM_IlluminationData_Set_BsConst_Lookup_Curve_HotSpot_Coef_Y_SafeCopy1(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_SetNVM_IlluminationData_Set_BsConst_Lookup_Curve_HotSpot_Coef_Y_SafeCopy2(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_SetNVM_IlluminationData_Set_BsConst_OilGauge_Element(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_SetNVM_IlluminationData_Set_BsConst_PCB_Temperature_Sensor_Conv(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_SetNVM_IlluminationData_Set_BsConst_PCB_Temperature_Sensor_Conv_SafeCopy1(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_SetNVM_IlluminationData_Set_BsConst_PCB_Temperature_Sensor_Conv_SafeCopy2(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_SetNVM_IlluminationData_Set_BsConst_PWM_boost_bypass_duty(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_SetNVM_IlluminationData_Set_BsConst_PWM_boost_bypass_duty_SafeCopy1(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_SetNVM_IlluminationData_Set_BsConst_PWM_boost_bypass_duty_SafeCopy2(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_SetNVM_IlluminationData_Set_BsConst_PowerGauge_Element(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_SetNVM_IlluminationData_Set_BsConst_Power_Element(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_SetNVM_IlluminationData_Set_BsConst_RealTimeClock_Element(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_SetNVM_IlluminationData_Set_BsConst_ServiceReminder_Element(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_SetNVM_IlluminationData_Set_BsConst_SpeedoGauge_Element(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_SetNVM_IlluminationData_Set_BsConst_TachoGauge_Element(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_SetNVM_IlluminationData_Set_BsConst_TempGauge_Element(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_SetNVM_IlluminationData_Set_BsConst_Temp_Threshold_Hysteresis_Derating(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_SetNVM_IlluminationData_Set_BsConst_Temp_Threshold_Hysteresis_Derating_SafeCopy1(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_SetNVM_IlluminationData_Set_BsConst_Temp_Threshold_Hysteresis_Derating_SafeCopy2(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_SetNVM_IlluminationData_Set_BsConst_Temperature_Sensor_Conv(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_SetNVM_IlluminationData_Set_BsConst_Temperature_Sensor_Conv_SafeCopy1(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_SetNVM_IlluminationData_Set_BsConst_Temperature_Sensor_Conv_SafeCopy2(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_SetNVM_IlluminationData_Set_BsConst_TripComputer_Element(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_SetNVM_IlluminationData_Set_BsConst_Warning_Element(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_SetNVM_IlluminationData_Set_BsCys_Certicificate_Element(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_SetNVM_IlluminationData_Set_BsDiag_Dtc_Element(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_SetNVM_IlluminationData_Set_BsDiag_ErrorRecord_Element(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_SetNVM_IlluminationData_Set_BsReten_Audio_Element(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_SetNVM_IlluminationData_Set_BsReten_Communication_Element(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_SetNVM_IlluminationData_Set_BsReten_Display_Element(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_SetNVM_IlluminationData_Set_BsReten_Gauges_Element(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_SetNVM_IlluminationData_Set_BsReten_Illumination_Element(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_SetNVM_IlluminationData_Set_BsReten_Odometer_Element(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_SetNVM_IlluminationData_Set_BsReten_Personalization_Element(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_SetNVM_IlluminationData_Set_BsReten_Power_Element(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_SetNVM_IlluminationData_Set_BsReten_RealTimeClock_Element(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_SetNVM_IlluminationData_Set_BsReten_Tripcomputer_Element(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_SetNVM_IlluminationData_Set_BsReten_Warning_Element(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_SetNVM_IlluminationData_Set_BsRt_CusDlt_Element(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_SetNVM_IlluminationData_Set_BsRt_FuelGauge_Element(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_SetNVM_IlluminationData_Set_BsRt_Illumination_Element(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_SetNVM_IlluminationData_Set_BsRt_Odometer_Element(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_SetNVM_IlluminationData_Set_BsRt_OilGauge_Element(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_SetNVM_IlluminationData_Set_BsRt_Personalization_Element(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_SetNVM_IlluminationData_Set_BsRt_PowerGauge_Element(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_SetNVM_IlluminationData_Set_BsRt_RealTimeClock_Element(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_SetNVM_IlluminationData_Set_BsRt_SpeedoGauge_Element(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_SetNVM_IlluminationData_Set_BsRt_TachoGauge_Element(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_SetNVM_IlluminationData_Set_BsRt_TempGauge_Element(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_SetNVM_IlluminationData_Set_BsRt_TripComputer_Element(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_SetNVM_IlluminationData_Set_BsRt_Warning_Element(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_SetNVM_IlluminationData_Set_BsShare_AssemblyManufacturingDate(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_SetNVM_IlluminationData_Set_BsShare_AssemblyPlantNumber(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_SetNVM_IlluminationData_Set_BsShare_EcuPartNumber_Element(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_SetNVM_IlluminationData_Set_BsShare_HWModification(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_SetNVM_IlluminationData_Set_BsShare_PCBSerialNumber(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_SetNVM_IlluminationData_Set_BsShare_ProductSerialNumber(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_SetNVM_IlluminationData_Set_BsShare_SMTManufacturingDate(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_SetNVM_IlluminationData_Set_BsShare_SMTPlantNumber(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_SetNVM_IlluminationData_Set_BsShare_SwUpdFotaFinPrint_Element(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_SetNVM_IlluminationData_Set_BsShare_SwUpdFotaMode_Element(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_SetNVM_IlluminationData_Set_BsShare_SwUpdFotaStatus_Element(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_SetNVM_IlluminationData_Set_BsShare_SwUpdFotadecrypt_Element(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_SetNVM_IlluminationData_Set_BsShare_SwUpdReflash_Element(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_SetNVM_IlluminationData_Set_BsShare_VehicleConfig_Element(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_SetNVM_IlluminationData_Set_BsShare_VisMeet_EOLEntry_Element(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_SetNVM_IlluminationData_Set_BsShare_VisMeet_Element(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_SetNVM_IlluminationData_Set_BsShare_VisteonPCBPartNumber(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_SetNVM_IlluminationData_Set_BsShare_VisteonPartNumber(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_SetNVM_IlluminationData_Set_RefCys_Certicificate1_Element(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_rp_SetNVM_IlluminationData_Set_RefCys_Certicificate_Element(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define RTE_START_SEC_CTRL_DIM_APPL_CODE
#  include "MemMap.h" /* PRQA S 5087 */ /* MD_MSR_19.1 */
FUNC(void, RTE_CTRL_DIM_APPL_CODE) Ctrl_Dim_GetPwmDirect(IoHwAb_PwmSignalIdType ChannelID, UInt16 TargetDuty); /* PRQA S 0850 */ /* MD_MSR_19.8 */
#  define RTE_STOP_SEC_CTRL_DIM_APPL_CODE
#  include "MemMap.h" /* PRQA S 5087 */ /* MD_MSR_19.1 */

#  define Rte_Call_rp_UpdatePwmDirect_GetPwmDirect(arg1, arg2) (Ctrl_Dim_GetPwmDirect(arg1, arg2), ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define RTE_START_SEC_CTRL_WSS_APPL_CODE
#  include "MemMap.h" /* PRQA S 5087 */ /* MD_MSR_19.1 */
...
# define Mdl_Dim_START_SEC_CODE
# include "Mdl_Dim_MemMap.h" /* PRQA S 5087 */ /* MD_MSR_19.1 */
...
# ifndef RTE_CORE
#  define RTE_RUNNABLE_Mdl_Dim_Init Mdl_Dim_Init
#  define RTE_RUNNABLE_Mdl_Dim_Task Mdl_Dim_Task
# endif

FUNC(void, Mdl_Dim_CODE) Mdl_Dim_Init(void); /* PRQA S 0850 */ /* MD_MSR_19.8 */
FUNC(void, Mdl_Dim_CODE) Mdl_Dim_Task(void); /* PRQA S 0850, 3451 */ /* MD_MSR_19.8, MD_Rte_3451 */

# define Mdl_Dim_STOP_SEC_CODE
# include "Mdl_Dim_MemMap.h" /* PRQA S 5087 */ /* MD_MSR_19.1 */
