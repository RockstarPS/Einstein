...
SECTIONS
{
    ...
    .bss.app(NOLOAD) : {} > APPIMAGE   /* Reserve space in RAM at APPIMAGE for temporarily loading the appimage */
    .bss.meta(NOLOAD) : {} > APPMETA   /* 128KB reserved for loading metadata */
}
...
MEMORY
{
    ...
    HSM_RAM  : ORIGIN = 0x43C00200 , LENGTH = 0x3e800 - 0x200
    ATCM :  ORIGIN = 0x78000000 , LENGTH = 0x8000

    /* This section is used by the SBL to temporarily load the appimage for authentication */
    APPIMAGE  : ORIGIN = 0x83000000 , LENGTH = 0x2800000
    APPMETA   : ORIGIN = 0x85800000 , LENGTH = 0x40000
}
