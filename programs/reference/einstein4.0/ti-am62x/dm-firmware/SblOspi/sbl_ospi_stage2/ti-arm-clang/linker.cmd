...
SECTIONS
{
    ...
    .dlt_buffer1_mem(NOLOAD) : {} > APP_DLT_BUFFER1
    .dlt_buffer2_mem(NOLOAD) : {} > APP_DLT_BUFFER2
    .bss.app_emmc_gip(NOLOAD) : {} > APP_EMMC_GIP_IMAGE
    .bss.app_nor_hsm(NOLOAD) : {} > APP_NOR_HSM_IMAGE
    .bss.app_nor_mcu(NOLOAD) : {} > APP_NOR_MCU_IMAGE
    .bss.ipc_vring_mem(NOLOAD) : {} > APP_IPC_SHARED_MEM
    .bss.meta(NOLOAD) : {} > APP_META
}
...
MEMORY
{
    ...
    APP_IPC_SHARED_MEM  : ORIGIN = 0x82B00000 , LENGTH = 0x100000

    APP_DLT_BUFFER1	    : ORIGIN = 0x82388000 , LENGTH = 0x800
    APP_DLT_BUFFER2	    : ORIGIN = 0x82388800 , LENGTH = 0x800

    /* This section is used by the SBL to temporarily load the appimage for authentication */
    APP_NOR_HSM_IMAGE	: ORIGIN = 0x83000000 , LENGTH = 0x200000
    APP_NOR_MCU_IMAGE	: ORIGIN = 0x83200000 , LENGTH = 0x800000
    APP_EMMC_GIP_IMAGE	: ORIGIN = 0x83A00000 , LENGTH = 0x1E00000
    APP_META		: ORIGIN = 0x85800000 , LENGTH = 0x20000
}
