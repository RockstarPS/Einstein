...
#define IOHWAB_NUM_ADC_INPUT                   2U
#endif

/**
* @brief Number of adc Groups configured
*/
#define IOHWAB_NUM_ADC_GROUP                    2U

/**
* @brief Adc multichannel MCAL group id
*/
#define IOHWAB_ADC_MULTICHANNEL_GROUP_ID         AdcConf_AdcGroup_AdcGroup_MULTICHANNEL
/**
