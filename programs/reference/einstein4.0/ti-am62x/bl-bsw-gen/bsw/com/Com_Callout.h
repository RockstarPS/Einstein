...
extern FUNC(boolean,COM_CALLOUT_CODE) METER_TX_NOTIFICATION_MSG (PduIdType PduId, P2VAR(PduInfoType,AUTOMATIC,COM_APPL_DATA) PduInfoPtr);

/* Receive message callout function */
extern FUNC(boolean,COM_CALLOUT_CODE) ECM_A109_RX_NOTIFICATION_MSG (PduIdType PduId,P2CONST(PduInfoType,AUTOMATIC,COM_APPL_CONST) PduInfoPtr);
