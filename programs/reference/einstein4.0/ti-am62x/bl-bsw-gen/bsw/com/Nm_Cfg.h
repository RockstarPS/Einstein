...
/*******************************************************************************************************************/
/* Software Version */
#define NM_CFG_SW_MAJOR_VERSION                               0u
#define NM_CFG_SW_MINOR_VERSION                               0u
#define NM_CFG_SW_PATCH_VERSION                               1u
/* Autosar Release */
...
#define NM_GLOBAL_COORDINATOR_TIME      5000U
...
#define NM_BUSNM_GENERIC_NM_SUPPORT     STD_OFF
...
typedef Std_ReturnType (*Nm_BusNmPassiveStartUp)(NetworkHandleType);
/*! @brief Defines the function prototype for the API to Get the state and the mode of the network management.*/
typedef Std_ReturnType (*Nm_BusNmGetStateFunctType)(NetworkHandleType,Nm_StateType*,Nm_ModeType*);
...
/*! @brief Defines the function prototype for the API to Request the network, since ECU needs to communicate on 
    the bus.*/
typedef Std_ReturnType (*Nm_BusNmNetworkRequestFunctType) (NetworkHandleType);
/*! @brief Defines the function prototype for the API to Release the network, since ECU doesn't have to communicate
    on the bus.*/
typedef Std_ReturnType (*Nm_BusNmNetworkReleaseFunctType)(NetworkHandleType);
#endif
...
typedef Std_ReturnType (*Nm_BusNmDisableCommunicationFunctType)(NetworkHandleType);
/*! @brief Defines the function prototype for the API to Enable the NM PDU transmission ability.*/
typedef Std_ReturnType (*Nm_BusNmEnableCommunicationFunctType)(NetworkHandleType);
#endif
...
typedef Std_ReturnType (*Nm_BusNmSetUserDataFunctType)(NetworkHandleType,const uint8*);
#endif
/*! @brief Defines the function prototype for the API to Get user data out of the most recently received NM PDU.*/
typedef Std_ReturnType (*Nm_BusNmGetUserDataFunctType)(NetworkHandleType,uint8*);
#endif
...
/*! @brief Defines the function prototype for the API to Get node identifier out of the last successfully received
    NM-message.*/
typedef Std_ReturnType (*Nm_BusNmGetNodeIdentifierFunctType)(NetworkHandleType,uint8*);
/*! @brief Defines the function prototype for the API to Get node identifier configured for the local node.*/
typedef Std_ReturnType (*Nm_BusNmGetLocalNodeIdentifierFunctType)(NetworkHandleType,uint8*);
#endif
...
typedef Std_ReturnType (*Nm_BusNmRepeatMessageRequestFunctType)(NetworkHandleType);
#endif
...
/*! @brief Defines the function prototype for the API to Get the whole PDU data out of the most recently 
    received NM PDU. */
typedef Std_ReturnType (*Nm_BusNmGetPduDataFunctType)(NetworkHandleType,uint8*);
#endif
#if(NM_PDU_RX_INDICATION_ENABLED == STD_ON)
/*! @brief Defines the function prototype for the API to notify reception of NM message.*/
typedef void (*Nm_BusNmPduRxIndicationCallOutFunctType)(NetworkHandleType);
#endif
...
typedef Std_ReturnType (*Nm_BusNmCheckRemoteSleepIndicationFunctType)(NetworkHandleType,boolean*);
#endif
...
/*! @brief Defines the function prototype for the API to Set the NM Coordinator Sleep Ready bit in the Control
    Bit Vector.*/
typedef Std_ReturnType (*Nm_BusNmSetSleepReadyBitFunctType)(NetworkHandleType,boolean);
/*! @brief Defines the function prototype for the API to Request bus synchronization.*/
typedef Std_ReturnType (*Nm_BusNmRequestBusSynchronizationFunctType)(NetworkHandleType);
#endif
