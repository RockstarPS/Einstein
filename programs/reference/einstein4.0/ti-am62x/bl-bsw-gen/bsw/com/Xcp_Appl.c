...
*   @file Xcp_Appl.c
*   @ingroup Xcp
*   @brief This file provides the project specific implementation for the Xcp processing. The Xcp core uses the API
*   provided by this file to process the requested commands.
********************************************************************************************************************/
/********************************************************************************************************************
*  HEADER INCLUDES                                                                                                  *
********************************************************************************************************************/
...
********************************************************************************************************************/
FUNC(uint8, XCP_CODE) Xcp_ApplGetSeed( uint8 Resource, P2VAR(uint8, AUTOMATIC, XCP_APPL_DATA) SeedPtr )
{
    return 0;
}
/********************************************************************************************************************
*   @brief      This service is called by the Xcp to unlock the resources based on the key received
*   @param[in]  KeyPtr  pointer to the Key buffer  
...
{
    /* TODO: Memcopy to be done on address granuality , current implementation using the byte wise copy */
    /* copy data by byte wise */
    Xcp_UtilMemCopy(Dst,(uint8 *)Src,Size);
...
)
{
    /* TODO: Memcopy to be done on address granuality , current implementation using the byte wise copy */
    /* copy data by byte wise */
    Xcp_UtilMemCopy((uint8 *)Dst,(uint8 *)Src,Size);
    return (uint8)XCP_CMD_OK;
}
/********************************************************************************************************************
...
*   @param[in]  PageAddressMappinInfoPtr  pointer to the page address mapping information buffer
********************************************************************************************************************/
...
*   @param[in]  PagePropertyPtr  pointer to get the page property 
*   @param[in]  PageInitSegmentPtr  pointer to get the page init segment value 
********************************************************************************************************************/
...
( 
    P2CONST(uint8, AUTOMATIC, XCP_APPL_VAR) ProgramData,
...
/********************************************************************************************************************
*   @brief      This service is called by the Xcp to process the DAQ Resume status
*   @param[in]  XcpChannel xcp channel id
