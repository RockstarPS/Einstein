...
VAR(CanIf_CtrlInfoType,CANIF_VAR_NO_INIT) CanIf_CtrlInfo[CANIF_NUM_OF_CAN_CONTROLLERS];
...
VAR(CanIf_NotifStatusType,CANIF_VAR_NO_INIT)  CanIf_TxNotifyStatus[CANIF_NUM_OF_TX_PDU];
#endif
#if (CANIF_PUBLIC_READ_RX_PDU_NOTIFY_STATUS_API == STD_ON)
/*! @brief It contains the CanIf Rx Indication Notify Status */
VAR(CanIf_NotifStatusType,CANIF_VAR_NO_INIT)  CanIf_RxNotifyStatus[CANIF_NUM_OF_RX_PDU];
#endif
#if (CANIF_PUBLIC_TX_BUFFERING == STD_ON)
/*! @brief It contains the CanIf Tx fifo Status */
VAR(CanIf_TxBufferFifoStatusType,CANIF_VAR_NO_INIT)  CanIf_TxBufferFifoStatus[CANIF_NUM_OF_TX_FIFO];
/*! @brief It contains the CanIf Tx fifo element info */
VAR(CanIf_TxBufferFifoElementType,CANIF_VAR_NO_INIT)  CanIf_TxBufferFifoElement[CANIF_NUM_OF_TX_FIFO_ELEMENTS];
#endif
#if (CANIF_PUBLIC_READ_RX_PDU_DATA_API == STD_ON)
/*! @brief It contains the CanIf Rx buffer element info */
VAR(CanIf_RxBufferConfigType,CANIF_VAR_NO_INIT)  CanIf_RxBuffer[CANIF_MAX_RX_BUFFER_SIZE];
#endif

#if (CANIF_PUBLIC_SET_DYNAMIC_TX_ID_API == STD_ON)
/*! @brief It contains the CanIf dynamic pdu info */
VAR(CanIf_DynamicPduConfigType,CANIF_VAR_NO_INIT)  CanIf_DynamicPduConfig[CANIF_NUM_OF_TX_DYNAMIC_PDU];
#endif
...
VAR(boolean,CANIF_VAR_NO_INIT)  CanIf_WakeupDetected[CANIF_NUM_OF_CAN_CONTROLLERS];
#endif
...
VAR(uint8,CANIF_VAR_NO_INIT)  CanIf_RxReceiveBuffer[CANIF_MAX_RX_BUFFER_SIZE * CANIF_CFG_RX_MAXVALIDRXDLC];
/*! @brief It indicates the current Rx buffer index */
VAR(uint8,CANIF_VAR_NO_INIT)  CanIf_RxBufferIndex;
#endif
...
*/
CONST(CanIf_MailBoxConfigType,CANIF_CONFIG_DATA) CanIf_MailBoxConfig[CANIF_NUM_OF_MAILBOX] =
{
    { 0U ,0U ,CANIF_CANID_TYPE_STANDARD ,0U,CANIF_CAN_HANDLE_TYPE_FULL_CAN ,CANIF_CAN_OBJECT_TYPE_TRANSMIT , 0U},/* Mailbox 0 - BODY11_5E2 */
    { 0U ,0U ,CANIF_CANID_TYPE_STANDARD ,0U,CANIF_CAN_HANDLE_TYPE_FULL_CAN ,CANIF_CAN_OBJECT_TYPE_TRANSMIT , CANIF_NUM_OF_TX_BUFFERS},/* Mailbox 0 - BODY11_5E2 */
    { 0U ,0U ,CANIF_CANID_TYPE_STANDARD ,0U,CANIF_CAN_HANDLE_TYPE_FULL_CAN ,CANIF_CAN_OBJECT_TYPE_TRANSMIT , CANIF_NUM_OF_TX_BUFFERS},/* Mailbox 0 - BODY11_5E2 */
    { 0U ,3U ,CANIF_CANID_TYPE_STANDARD ,0U,CANIF_CAN_HANDLE_TYPE_BASIC_CAN ,CANIF_CAN_OBJECT_TYPE_RECEIVE , CANIF_NUM_OF_TX_BUFFERS},/* Mailbox 3 - CAN0 Std BASIC Rx mailbox */
    { 0U ,0U ,CANIF_CANID_TYPE_STANDARD ,0U,CANIF_CAN_HANDLE_TYPE_BASIC_CAN ,CANIF_CAN_OBJECT_TYPE_RECEIVE , CANIF_NUM_OF_TX_BUFFERS},/* Mailbox 4 - CAN1 Std BASIC Rx mailbox */
};

/*! @brief Defines the function config for the receive notification function */
CONST(CanIf_RxNotificationFunctType,CANIF_CONFIG_DATA) CanIf_RxNotificationFunctConfig[CANIF_NUM_OF_RX_NOTIFICATION_FUNCTION]=
{
 ...
 */
CONST(CanIf_RxPduIdConfigType,CANIF_CONFIG_DATA)  CanIf_RxPduIdConfig[CANIF_NUM_OF_RX_PDU]=
{
    { 0x101,  8U, PDUR_SRC_BODY_CNTRL7,         0U,  0U  },    /* 0 BODY_CNTRL7 */
    { 0x101,  8U, PDUR_SRC_EXTERNAL_LIGHTS,     0U,  0U  },    /* 1 EXTERNAL_LIGHTS */
    { 0x700,  64U, CANTP_PDU_E4_DIAG_PHY_REQ,    1U,  0U  },    /* 2 E4_DIAG_PHY_REQ */
    { 0x7DF,  64U, CANTP_PDU_E4_DIAG_FUNC_REQ,   1U,  0U  },    /* 3 E4_DIAG_FUNC_REQ */
};

/*! @brief Defines the CanIf transmit confirmation function configuration .*/
CONST(CanIf_TxConfirmationFunctType,CANIF_CONFIG_DATA) CanIf_TxConfirmationFunctConfig[CANIF_NUM_OF_TX_CONFIRMATION_FUNCTION] =
{
...
/*! @brief Defines the CanIf Receive PDU configuration .
    ...
    TxTriggerTransmitFunctId    : function Id for trigger transmit
                                  Enabled only if CANIF_TRIGGER_TRANSMIT_SUPPORT is STD_ON
*/
CONST(CanIf_TxPduIdConfigType,CANIF_CONFIG_DATA) CanIf_TxPduIdConfig[CANIF_NUM_OF_TX_PDU] =
{	 { 0x100, 8U, PDUR_SRC_CLIMATIC_PANEL,   1U, CANIF_TX_PDU_CAN_ID_TYPE_STANDARD_CAN, 0U , CANIF_NUM_OF_TX_BUFFERS },    /* CLIMATIC_PANEL */
     { 0x608, 64U, CANTP_PDU_E4_DIAG_RES,     0U, CANIF_TX_PDU_CAN_ID_TYPE_STANDARD_FD_CAN, 1U , 0U },       /* E4_DIAG_RES */
};
...
*/
CONST(CanIf_TxBufferConfigType,CANIF_CONFIG_DATA) CanIf_TxBufferConfig[CANIF_NUM_OF_TX_BUFFERS]=
{
    {   1u,  1u,  10u,   0u,  CANIF_TX_BUFFER_HANDLING_TYPE_FIFO,  0u}
};
...
*/
CONST(CanIf_TxBufferFifoConfigType,CANIF_CONFIG_DATA) CanIf_TxBufferFifoConfig[CANIF_NUM_OF_TX_FIFO]=
{
    {   0u,   9u,   10u }    
};
#endif
...
/*! @brief Defines the configuration of CAN driver API's used by the CanIf module 
    ...
    CanGetControllerModeFunctPtr        : the function for CAN get controller mode API of the CAN driver
                                          Enabled only if ASR version is 4.3
*/
CONST(CanIf_CanDrvFunctConfigType,CANIF_CONFIG_DATA)  CanIf_CanDrvFunctConfig[CANIF_NUM_OF_CAN_DRIVERS]=
{
    {
...
*/
CONST(CanIf_CtrlIdtoCanDrvFunctMapConfigType,CANIF_CONFIG_DATA) CanIf_CtrlIdtoCanDrvFunctMapConfig[CANIF_NUM_OF_CAN_CONTROLLERS] =
{
    /* CanDrvFunctId */
    0U
};
...
CONST(CanIf_CtrlIdtoTrcvDrvMapConfigType,CANIF_CONFIG_DATA)  CanIf_CtrlIdtoTrcvDrvMapConfig[CANIF_NUM_OF_CAN_CONTROLLERS] =
{
    ...
    {CANIF_NO_CAN_TRANSCEIVER_ID ,FALSE }
};
#endif
/*! @brief Defines the configuration for the mode indication functions to the user.
    ...
    UserCurrentIcomConfigurationFunctPtr    : the function for indicating indicating current Icom configuration
                                              ...
                                              Enabled only if CANIF_PUBLIC_ICOM_SUPPORT is STD_ON
*/
CONST(CanIf_UserCallbackConfigType,CANIF_CONFIG_DATA) CanIf_UserCallbackConfig=
{
...
*/
CONST(CanIf_WakeUpConfigType,CANIF_CONFIG_DATA) CanIf_WakeUpConfig[CANIF_CFG_MAX_WAKEUPSOURCES]= 
{
    {
        32UL,
        0U,
...
CONST(CanIf_TxTriggerTransmitFunctType,CANIF_CONFIG_DATA) CanIf_TxTriggerTransmitFunctConfig[CANIF_NUM_OF_TX_TRIGGER_TRANSMIT]=
{
...
*/
CONST(CanIf_RxHashTableType,CANIF_CONFIG_DATA)  CanIf_RxHashTableMailBox20[CANIF_RX_HASH_TABLE_MAILBOX20_SIZE]=
{
	/* RxCanId, RxPduId */
	{	0x100, 20 }
};
...
*/
CONST(CanIf_RxHashTableConfigType,CANIF_CONFIG_DATA) CanIf_RxHashTableConfig[CANIF_RX_NUM_OF_HASH_TABLE] =
{
...
CONST(uint32,CANIF_CONFIG_DATA) CanIf_RxCanIdMaskConfig[CANIF_NUM_OF_RX_CAN_ID_MASKS]=
{
	0x7FFU,
	0x1FFFFFFFU
};	
...
CONST(uint32,CANIF_CONFIG_DATA) CanIf_TxCanIdMaskConfig[CANIF_NUM_OF_TX_CAN_ID_MASKS]=
{
	0x7FFU,
	0x1FFFFFFFU
};
