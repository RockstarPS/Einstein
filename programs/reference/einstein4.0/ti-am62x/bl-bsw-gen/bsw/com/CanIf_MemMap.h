...
*    @brief This files contains the memory map for the CanIf module.The file should be included in MemMap.h file.
*    @defgroup CanIfConfiguration
*    @brief This files contains the memory map for the CanIf module.The file should be included in MemMap.h file.
********************************************************************************************************************/
#ifndef CANIF_MEMMAP_H
#define CANIF_MEMMAP_H
...
/* Local scope */
#ifdef CANIF_START_SEC_VAR_INIT_LOCAL_UNSPECIFIED
/* Enter here a #pragma command for opening the specified section eg #pragma ghs section bss = ".bswdata" */
# undef CANIF_START_SEC_VAR_INIT_LOCAL_UNSPECIFIED
/* Remove this common define if specific section is configured  */
# define START_SEC_VAR_INIT_UNSPECIFIED
#endif

#ifdef CANIF_STOP_SEC_VAR_INIT_LOCAL_UNSPECIFIED
/* Enter here a #pragma command for closing the specified section , eg #pragma ghs section bss = default*/
# undef CANIF_STOP_SEC_VAR_INIT_LOCAL_UNSPECIFIED
/* Remove this common define if specific section is configured  */
# define STOP_SEC_VAR
#endif

#ifdef CANIF_START_SEC_VAR_INIT_LOCAL_8
/* Enter here a #pragma command for opening the specified section eg #pragma ghs section bss = ".bswdata" */
# undef CANIF_START_SEC_VAR_INIT_LOCAL_8
/* Remove this common define if specific section is configured  */
# define START_SEC_VAR_INIT_8
#endif

#ifdef CANIF_STOP_SEC_VAR_INIT_LOCAL_8
/* Enter here a #pragma command for closing the specified section , eg #pragma ghs section bss = default*/
# undef CANIF_STOP_SEC_VAR_INIT_LOCAL_8
/* Remove this common define if specific section is configured  */
# define STOP_SEC_VAR
#endif
