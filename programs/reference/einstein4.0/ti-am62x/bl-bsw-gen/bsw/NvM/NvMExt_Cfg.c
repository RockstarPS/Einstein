...
const NvM_BlockIdType Phase2BlockIdList[NUM_OF_PHASE_2_BLOCKS] = 
    {
        ...
        NvMConf_NvMBlockDescriptor_NvBlockSwComponentTypeNVBlockDescriptor_BsReten_VisDlt,
    };
...
const NvM_BlockIdType Phase3BlockIdList[NUM_OF_PHASE_3_BLOCKS] = 
    {
        ...
        NvMConf_NvMBlockDescriptor_NvBlockSwComponentTypeNVBlockDescriptor_BsShare_VisMeet,
        NvMConf_NvMBlockDescriptor_NvBlockSwComponentTypeNVBlockDescriptor_BsFuSa_Warning,
        NvMConf_NvMBlockDescriptor_NvBlockSwComponentTypeNVBlockDescriptor_BsFuSa_Display,
