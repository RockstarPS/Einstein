...
/*  ValidationTimeInMs,        ComMChannel,             WakeupSrc */             \
    {ECUM_NO_VALIDATION,     ECUM_NO_COMM_CHANNEL},  /*ECUM_WKSOURCE_POWER*/    \
    {ECUM_NO_VALIDATION,     ECUM_NO_COMM_CHANNEL},  /*ECUM_WKSOURCE_RESET*/    \
    {ECUM_NO_VALIDATION,     ECUM_NO_COMM_CHANNEL},  /*ECUM_WKSOURCE_INTERNAL_RESET*/    \
    {ECUM_NO_VALIDATION,     ECUM_NO_COMM_CHANNEL},  /*ECUM_WKSOURCE_INTERNAL_WDG*/    \
    {ECUM_NO_VALIDATION,     ECUM_NO_COMM_CHANNEL},  /*ECUM_WKSOURCE_EXTERNAL_WDG*/    \
    {ECUM_NO_VALIDATION,     ECUM_NO_COMM_CHANNEL},  /*ECUM_WKSOURCE_WAKEUP_RESET*/    \
    {ECUM_NO_VALIDATION,     ECUM_NO_COMM_CHANNEL},   /*ECUM_WKSOURCE_RTC*/      \
    {ECUM_NO_VALIDATION,     ECUM_NO_COMM_CHANNEL}   /*ECUM_WKSOURCE_CAN*/
...
#define ECUM_SLEEP_MODE_LIST \
        {(EcuM_WakeupSourceType)0xFFuL, ECUM_SLEEP_MODE_MCU_REF, FALSE},\
        {(EcuM_WakeupSourceType)0x1FuL, ECUM_SLEEP_MODE_MCU_REF, TRUE},\
