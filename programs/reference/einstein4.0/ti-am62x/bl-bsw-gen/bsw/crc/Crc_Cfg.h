...
#define CRC_CALCULATECRC8_ENABLE  		 STD_ON
#define CRC_CALCULATECRC8H2F_ENABLE  	 STD_ON
#define CRC_CALCULATECRC16_ENABLE  		 STD_ON
#define CRC_CALCULATECRC32_ENABLE  		 STD_ON
#define CRC_CALCULATECRC32P4_ENABLE 	 STD_ON
#define CRC_CALCULATECRC64_ENABLE 	     STD_ON
