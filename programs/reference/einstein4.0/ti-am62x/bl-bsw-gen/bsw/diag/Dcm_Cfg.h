...
#define Dcm_KeepNonDefaultSessionActive               STD_ON
...
#define DCMEXT_MAINFUNCTION                     DcmExt_MainFunction
...
#define DCM_11S_PRE_CONDITION_CHECK             DcmExt_Vehicle_Condition_check_1
...
#define DCM_35S_PRE_CONDITION_CHECK             DcmExt_Vehicle_Condition_check
...
#define DCM_37S_PRE_CONDITION_CHECK				DcmExt_ProcessRequestTransferExit
...
#define RequestIndication_0_Indication          DcmExt_RequestIndication_0
...
#define DcmDslDiagRespMaxNumRespPend            0xFFu
#define DcmDslDiagRespOnSecondDeclinedRequest   TRUE

/*
 * DcmDslProtocol
 */
#define DcmDslBufferSize                        (uint16)5120
...
#define DcmNumOfSIDSupported                    (uint8)20
#define DcmNumOfRIDSupported                    (uint8)7
#define DcmNumOfDIDSupported                    (uint16)15
...
#define No_of_security_level                    (1)
#define NO_OF_SUPPORTTED_SESSIONS               (4)

#define NO_OF_SUPPORTTED_COM_CONTROL            1
...
#define NO_OF_CONFIRMATION_NOTIFICATION         (2)
#define DCM_ZERO 0
...
#define S27_FAIL_COUNT_TIME_MS                  (10000)
#define S27_FAIL_COUNT                          (2)
#define S27_REATTEMPT_COUNT                     (1)
...
#define DcmDspNumOfDidOpInfo                    21
#define DcmDsdNumOfStateRef                      9
#define DcmDspNumOfDidSignalInfo                 9
#define DcmDspNumOfRidSignalInfo                 7
#define DidNumOfOpFunc                           2
#define RidNumOfOpFunc                           1
#define Svc11NumOfSubFunc                        1
...
#define DcmNumofClientSupported                 0x01u
...
#define DCM_SVC_35_SUPPORT_ENABLED              STD_ON
...
#define NO_OF_REQUEST_NOTIFICATION              (2)
#endif
...
Design Information  :
**************************************************************************/
extern Std_ReturnType DcmExt_ProcessRequestDownload(Dcm_OpStatusType OpStatus, uint8 DataFormatIdentifier, uint32 MemoryAddress, uint32 MemorySize,
    uint32* BlockLength, Dcm_NegativeResponseCodeType* ErrorCode);
    
/**************************************************************************
Function name   : Dcm_ReturnWriteMemoryType DcmExt_WriteMemory
...
extern Dcm_ReturnWriteMemoryType DcmExt_WriteMemory (Dcm_OpStatusType OpStatus,uint8 MemoryIdentifier,uint32 MemoryAddress,uint32 MemorySize,
...
**************************************************************************/
extern Dcm_ReturnReadMemoryType DcmExt_ReadMemory(Dcm_OpStatusType OpStatus, uint8 MemoryIdentifier,
...
Description     : Callout function.
                  ...
                  process
**************************************************************************/
extern Std_ReturnType DcmExt_ProcessRequestTransferExit(Dcm_OpStatusType OpStatus, Dcm_MsgContextType *pMsgContext, Dcm_NegativeResponseCodeType* ErrorCode);
#endif
...
extern Std_ReturnType DcmExt_60DiagProcess(Dcm_OpStatusType OpStatus,  Dcm_MsgContextType *pMsgContext, Dcm_NegativeResponseCodeType *NegRes);
...
extern Std_ReturnType DcmExt_SecLevel3GetSeed(Dcm_OpStatusType OpStatus, Dcm_MsgType Buff,  uint8 SubFunction, Dcm_NegativeResponseCodeType *NegRes, Dcm_SesCtrlType Session);
extern Std_ReturnType DcmExt_SecLevel3CmpKey(Dcm_OpStatusType OpStatus, Dcm_MsgType Buff,   uint8 SubFunction, Dcm_NegativeResponseCodeType *NegRes, Dcm_SesCtrlType Session);
...
extern Std_ReturnType DI_Rid_Diag_Action(Dcm_OpStatusType OpStatus, uint8 eDcmExt_IOCtrl, Dcm_DspRidIdentifierTableType Rid, \
                                         const Dcm_MsgLenType ReqLength, Dcm_MsgType Buff, Dcm_MsgLenType* Length, Dcm_NegativeResponseCodeType* NegRes);
...
// #include "Os.h"
// #define Dcm_EnterCriticalSection()  SuspendAllInterrupts()
// #define Dcm_ExitCriticalSection()   ResumeAllInterrupts()
...
extern Std_ReturnType DcmExt_Diag_Condition_check(Dcm_MsgContextType *pMsgContext, Dcm_NegativeResponseCodeType *NegRes);
extern Std_ReturnType DcmExt_Prog_Condition_check(Dcm_MsgContextType *pMsgContext, Dcm_NegativeResponseCodeType *NegRes);
extern Std_ReturnType DcmExt_Vehicle_Condition_check(Dcm_MsgContextType *pMsgContext, Dcm_NegativeResponseCodeType *NegRes);
extern Std_ReturnType DcmExt_Vehicle_Condition_check_1(Dcm_MsgContextType *pMsgContext, Dcm_NegativeResponseCodeType *NegRes);
extern Std_ReturnType DcmExt_Vehicle_SpeedCondition_check(Dcm_OpStatusType OpStatus, Dcm_MsgContextType *pMsgContext, Dcm_NegativeResponseCodeType *NegRes);
extern Std_ReturnType DcmExt_3DStatus_Vehicle_Condition_check(Dcm_MsgContextType *pMsgContext, Dcm_NegativeResponseCodeType *NegRes);
extern Std_ReturnType DcmExt_28SVehicle_Condition_check(Dcm_MsgContextType *pMsgContext, Dcm_NegativeResponseCodeType *NegRes);
...
#if((DcmDsdRequestManufacturerNotificationEnabled == STD_ON) || (DcmDsdRequestSupplierNotificationEnabled == STD_ON))
extern Std_ReturnType DcmExt_RequestIndication_0(uint8 SID, uint8* RequestData, uint16 RequestDataSize, uint8 ReqType, uint16 SourceAddress, 
                                                 uint8* RespData, uint16* RespDataSize, Dcm_NegativeResponseCodeType* ErrorCode );
extern Std_ReturnType DcmExt_RequestIndication_1(uint8 SID, uint8* RequestData, uint16 RequestDataSize, uint8 ReqType, uint16 SourceAddress, 
                                                 uint8* RespData, uint16* RespDataSize, Dcm_NegativeResponseCodeType* ErrorCode );
#endif
