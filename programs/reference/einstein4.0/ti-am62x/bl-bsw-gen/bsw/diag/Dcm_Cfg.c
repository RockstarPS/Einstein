...
const Dcm_DsdSidTabServiceInfoType Dcm_DsdSidTabServiceInfo[DcmNumOfSIDSupported] =
{
  ...
  {Dcm_10ServiceProcess ,0x03 ,0x02 ,0x08},
  {Dcm_11ServiceProcess ,0x03 ,0x02 ,0x08},
  {Dcm_22ServiceProcess ,0x02 ,0x03 ,0x08},
  {Dcm_23ServiceProcess ,0x00 ,0x0A ,0x04},
  {Dcm_2EServiceProcess ,0x00 ,0x00 ,0x04},
  {Dcm_2FServiceProcess ,0x00 ,0x04 ,0x04},
  {Dcm_31ServiceProcess ,0x00 ,0x04 ,0x04},
  {Dcm_3DServiceProcess ,0x00 ,0x0B ,0x04},
  {Dcm_3EServiceProcess ,0x01 ,0x02 ,0x08},
  {Dcm_27ServiceProcess ,0x01 ,0x02 ,0x08},
  {Dcm_28ServiceProcess ,0x01 ,0x00 ,0x04},
  {Dcm_34ServiceProcess ,0x00 ,0x02 ,0x04},
  {Dcm_35ServiceProcess ,0x00 ,0x02 ,0x04},
  {Dcm_36ServiceProcess ,0x00 ,0x00 ,0x04},
  {Dcm_37ServiceProcess ,0x00 ,0x00 ,0x04},
  {Dcm_14ServiceProcess ,0x00 ,0x00 ,0x04},
  {Dcm_19ServiceProcess ,0x03 ,0x00 ,0x04},
  {Dcm_85ServiceProcess ,0x01 ,0x00 ,0x04},
};
...
const Dcm_DsdStateRefType Dcm_DsdStateRef[DcmDsdNumOfStateRef] =
{
    ...
    */
    /* Security bits:
        ...
        4 - Other
    */
    /* ----------------|-ID-|-|+|-|------Sessions-----|-|+|-|------Sec Level------|  */
    /* ----------------|----|     |Bit4|Bit3|Bit2|Bit1|     |Bit4|Bit3|Bit2|-Bit1-|  */
    /* ----------------|----|-----|--------------|----|-----|---------------------|  */
    {0x01u, 0x01u}, /* |0x00|     |----|----|----|0x01|     |----|----|----|NO SEC|  */
    {0x01u, 0x02u}, /* |0x01|     |----|----|----|0x01|     |----|----|-L1-|------|  */
    {0x01u, 0x03u}, /* |0x02|     |----|----|----|0x01|     |----|----|-L1-|NO SEC|  */
    {0x02u, 0x01u}, /* |0x03|     |----|----|0x02|----|     |----|----|----|NO SEC|  */
    {0x02u, 0x02u}, /* |0x04|     |----|----|0x02|----|     |----|----|-L1-|------|  */
    {0x02u, 0x03u}, /* |0x05|     |----|----|0x02|----|     |----|----|-L1-|NO SEC|  */
    {0x03u, 0x01u}, /* |0x06|     |----|----|0x02|0x01|     |----|----|----|NO SEC|  */
    {0x03u, 0x02u}, /* |0x07|     |----|----|0x02|0x01|     |----|----|-L1-|------|  */
    {0x03u, 0x03u}, /* |0x08|     |----|----|0x02|0x01|     |----|----|-L1-|NO SEC|  */
    /* ----------------|----|     |-------------------|     |---------------------|  */
    /* ----------------|-ID-|-|+|-|------Sessions-----|-|+|-|------Sec Level------|  */
};
...
const XXX_IndicationType ServiceRequestIndicationTable[NO_OF_REQUEST_NOTIFICATION] =
{
	...
	{RequestIndication_1_Indication}
};
...
const Dcm_DsdSubService10Type Dcm_DsdSubService10[NO_OF_SUPPORTTED_SESSIONS] =
{
  ...
  {Dcm_01DefaultProcess,     0x01, 0x08},
  {Dcm_02PgmProcess,         0x02, 0x08},
  {Dcm_03ExtnDiagProcess,    0x03, 0x08},
};
...
const Dcm_DsdSubService11Type Dcm_DsdSubService11[Svc11NumOfSubFunc] =
{
  ...
  {DcmExt_PerformReset_001, 0x08,        0x01},
};
...
const Dcm_DsdSubService27Type Dcm_DsdSubService27[No_of_security_level*2] =
{
    /* SubServiceFnc, SubServiceId, Req_Length, Resp_Length, State_Ref */
		{DcmExt_SecLevel1GetSeed, 0x01, 1, 16, 0x08},
		{DcmExt_SecLevel1CmpKey,  0x02, 17, 2, 0x08}
};
...
const Dcm_DsdSubService19Type Dcm_DsdSubService19[Svc19NumOfsubFunc] =
{
  ...
  {Dcm_DspService19_01Processor,0x01,2,4},
  {Dcm_DspService19_02Processor,0x02,2,4},
#endif
#if (DCM_SVC_19_03_SUPPORT_ENABLED == STD_ON)
  {Dcm_DspService19_03Processor,0x03,2,4},
#endif
#if (DCM_SVC_19_04_SUPPORT_ENABLED == STD_ON)
  {Dcm_DspService19_04Processor,0x04,2,4},
#endif
#if (DCM_SVC_19_06_SUPPORT_ENABLED == STD_ON)
  {Dcm_DspService19_06Processor,0x06,2,4},
#endif
#if (DCM_SVC_19_07_SUPPORT_ENABLED == STD_ON)
  {Dcm_DspService19_07Processor,0x07,3,4},
#endif
#if (DCM_SVC_19_08_SUPPORT_ENABLED == STD_ON)
  {Dcm_DspService19_08Processor,0x08,3,4},
#endif
#if (DCM_SVC_19_09_SUPPORT_ENABLED == STD_ON)
  {Dcm_DspService19_09Processor,0x09,4,4},
#endif
#if (DCM_SVC_19_0A_SUPPORT_ENABLED == STD_ON)
  {Dcm_DspService19_0AProcessor,0x0A,1,4},
#endif
#if (DCM_SVC_19_0C_SUPPORT_ENABLED == STD_ON)
  {Dcm_DspService19_0CProcessor,0x0C,1,4},
#endif
#if (DCM_SVC_19_0E_SUPPORT_ENABLED == STD_ON)
  {Dcm_DspService19_0EProcessor,0x0E,1,4},
#endif
#if (DCM_SVC_19_14_SUPPORT_ENABLED == STD_ON)
  {Dcm_DspService19_14Processor,0x14,1,4}
#endif
};
...
const Dcm_DspDidInfoType Dcm_DspDidInfo[DcmNumOfDIDSupported] =
{
  ...
  {0, 0x01, TRUE}, //0x1111 - Read
  {1, 0x01, FALSE}, //0x2222 - Read
  {2, 0x01, FALSE}, //0x3333 - Read
  {3, 0x03, TRUE}, //0x4444 - Read & Write
  {5, 0x03, TRUE}, //0x5555 - Read & Write
  {7, 0x03, TRUE}, //0x6666 - Read & Write
  {9, 0x04, TRUE}, //0x7777 - Control
  {10, 0x04, TRUE}, //0x8888- Control
  {11, 0x04, TRUE},//0x9999 - Control
  {12, 0x02, TRUE},//0xAAAA - Write
  {13, 0x02, TRUE},//0xBBBB - Write
  {14, 0x02, TRUE},//0xCCCC - Write
  {15, 0x05, TRUE}, //0xDDDD- Read & Control
  {17, 0x05, TRUE}, //0xEEEE- Read & Control
  {19, 0x05, TRUE} //0xFFFF-  Read & Control
};
...
const Dcm_DspDidOpInfoType Dcm_DspDidOpInfo[DcmDspNumOfDidOpInfo] =
{
  ...
  {0x03, 0x03, 0x04, 0x0, 0x01}, //0x1111 - Read
  {0x03, 0x03, 0x04, 0x0, 0x01}, //0x2222 - Read
  {0x03, 0x03, 0x04, 0x0, 0x01}, //0x3333 - Read
  {0x03, 0x03, 0x04, 0x0, 0x01}, //0x4444 - Read
  {0x03, 0x03, 0x04, 0x0, 0x01}, //0x4444 - Write
  {0x03, 0x03, 0x04, 0x0, 0x01}, //0x5555 - Read
  {0x03, 0x03, 0x04, 0x0, 0x01}, //0x5555 - Write
  {0x03, 0x03, 0x04, 0x0, 0x01}, //0x6666 - Read
  {0x03, 0x03, 0x04, 0x0, 0x01}, //0x6666 - Write
  {0x03, 0x03, 0x04, 0x0, 0x09}, //0x7777 - Control STAdjutment & RCTEcu
  {0x02, 0x02, 0x04, 0x0, 0x09}, //0x8888 - Control STAdjutment & RCTEcu
  {0x01, 0x01, 0x04, 0x0, 0x09}, //0x9999 - Control STAdjutment & RCTEcu
  {0x03, 0x03, 0x04, 0x0, 0x01}, //0xAAAA - Write
  {0x03, 0x03, 0x04, 0x0, 0x01}, //0xBBBB - Write
  {0x03, 0x03, 0x04, 0x0, 0x01}, //0xCCCC - Write
  {0x03, 0x03, 0x04, 0x0, 0x01}, //0xDDDD - Read
  {0x03, 0x03, 0x04, 0x0, 0x09}, //0xDDDD - Control STAdjutment & RCTEcu
  {0x03, 0x03, 0x04, 0x0, 0x01}, //0xEEEE - Read
  {0x03, 0x03, 0x04, 0x0, 0x09}, //0xEEEE - Control STAdjutment & RCTEcu
  {0x03, 0x03, 0x04, 0x0, 0x01}, //0xFFFF - Read
  {0x03, 0x03, 0x04, 0x0, 0x09}  //0xFFFF - Control STAdjutment & RCTEcu
};
...
const Dcm_DspRidInfoType Dcm_DspRidInfo[DcmNumOfRIDSupported] =
{
  ...
  { 0, 0x04, 0x07, 0x01}, // RID 0x0F0C
  { 1, 0x04, 0x01, 0x01}, // RID 0xFF00
  { 2, 0x04, 0x05, 0x01}, // RID 0xFF01
  { 3, 0x04, 0x05, 0x01}, // RID 0xFE00
  { 3, 0x04, 0x05, 0x01}, // RID 0xFE01
  { 3, 0x04, 0x05, 0x01}, // RID 0xFE02
  { 3, 0x04, 0x05, 0x01}, // RID 0xFE03
};
...
const Dcm_DspRidSignalInfoType Dcm_DspRidSignalInfo[DcmDspNumOfRidSignalInfo] =
{
  ...
  { 0, 0x8, 0x8, 0x1, 0x1, 0x01},
  { 0, 0x8, 0x8, 0x1, 0x1, 0x01},// // Start 0xFF01
  { 0, 0x188, 0x188, 0x1, 0x1, 0x01}, // Start 0xFF01
  { 0, 0x0, 0x0, 0x1, 0x1, 0x01},// Start 0xFE00, 0xFE01, 0xFE02, 0xFE03
};
...
const Dcm_PduIdChannelType Dcm_PduIdChannel[DcmNumofClientSupported] =
{
  ...
  {1 , DCM_PDU_ISO_KOMBI_RESP ,0, 14, DEM_DCM_CLIENT}
};
