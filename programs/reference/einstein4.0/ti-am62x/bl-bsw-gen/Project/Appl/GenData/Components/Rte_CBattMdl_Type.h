 ...
 *       License:  CBD1800851
 *
 *   Description:  Application types header file for SW-C <CBattMdl>
 *********************************************************************************************************************/

/* double include prevention */
#ifndef _RTE_CBATTMDL_TYPE_H
# define _RTE_CBATTMDL_TYPE_H
