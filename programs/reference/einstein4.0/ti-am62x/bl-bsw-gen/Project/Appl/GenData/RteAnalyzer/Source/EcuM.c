 ...
 *   EcuMConf_EcuMFixedUserConfig_EcuMUserConfig_CTRL_App (0U)
 *
 *********************************************************************************************************************/
 ...
 *********************************************************************************************************************/
  ...
  **********************************************************/
  ...
  fct_status = TSC_EcuM_Rte_Switch_currentMode_currentMode(RTE_MODE_EcuM_Mode_STARTUP);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_EcuM_Rte_SwitchAck_currentMode_currentMode();
  switch (fct_status)
  {
    case RTE_E_NO_DATA:
      fct_error = 1;
 ...
 *
 * Executed if at least one of the following trigger conditions occurred:
 *   - triggered by server invocation for OperationPrototype <GetStateWrapper> of PortPrototype <StateRequest_EcuMConf_EcuMFixedUserConfig_EcuMUserConfig_CTRL_App>
 *
 **********************************************************************************************************************
 *
 * Runnable prototype:
...
FUNC(Std_ReturnType, EcuM_CODE) EcuM_GetStateWrapper(EcuM_UserType parg0, P2VAR(EcuM_StateType, AUTOMATIC, RTE_ECUM_APPL_VAR) state) /* PRQA S 0850 */ /* MD_MSR_19.8 */
{
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of runnable implementation >>             DO NOT CHANGE THIS COMMENT!
 ...
 *
 * Executed if at least one of the following trigger conditions occurred:
 *   - triggered by server invocation for OperationPrototype <ReleasePOSTRUN> of PortPrototype <StateRequest_EcuMConf_EcuMFixedUserConfig_EcuMUserConfig_CTRL_App>
 *
 **********************************************************************************************************************
 *
 * Runnable prototype:
...
FUNC(Std_ReturnType, EcuM_CODE) EcuM_ReleasePOST_RUN(EcuM_UserType parg0) /* PRQA S 0850 */ /* MD_MSR_19.8 */
{
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of runnable implementation >>             DO NOT CHANGE THIS COMMENT!
 ...
 *
 * Executed if at least one of the following trigger conditions occurred:
 *   - triggered by server invocation for OperationPrototype <ReleaseRUN> of PortPrototype <StateRequest_EcuMConf_EcuMFixedUserConfig_EcuMUserConfig_CTRL_App>
 *
 **********************************************************************************************************************
 *
 * Runnable prototype:
...
FUNC(Std_ReturnType, EcuM_CODE) EcuM_ReleaseRUN(EcuM_UserType parg0) /* PRQA S 0850 */ /* MD_MSR_19.8 */
{
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of runnable implementation >>             DO NOT CHANGE THIS COMMENT!
 ...
 *
 * Executed if at least one of the following trigger conditions occurred:
 *   - triggered by server invocation for OperationPrototype <RequestPOSTRUN> of PortPrototype <StateRequest_EcuMConf_EcuMFixedUserConfig_EcuMUserConfig_CTRL_App>
 *
 **********************************************************************************************************************
 *
 * Runnable prototype:
...
FUNC(Std_ReturnType, EcuM_CODE) EcuM_RequestPOST_RUN(EcuM_UserType parg0) /* PRQA S 0850 */ /* MD_MSR_19.8 */
{
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of runnable implementation >>             DO NOT CHANGE THIS COMMENT!
 ...
 *
 * Executed if at least one of the following trigger conditions occurred:
 *   - triggered by server invocation for OperationPrototype <RequestRUN> of PortPrototype <StateRequest_EcuMConf_EcuMFixedUserConfig_EcuMUserConfig_CTRL_App>
 *
 **********************************************************************************************************************
 *
 * Runnable prototype:
...
FUNC(Std_ReturnType, EcuM_CODE) EcuM_RequestRUN(EcuM_UserType parg0) /* PRQA S 0850 */ /* MD_MSR_19.8 */
{
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of runnable implementation >>             DO NOT CHANGE THIS COMMENT!
...
static void EcuM_TestDefines(void)
{
  ...
  EcuM_UserType Test_EcuM_UserType_V_1 = EcuMConf_EcuMFixedUserConfig_EcuMUserConfig_CTRL_App;
