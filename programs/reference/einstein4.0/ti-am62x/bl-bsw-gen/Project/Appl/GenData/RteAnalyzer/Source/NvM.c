 ...
 *   - triggered by server invocation for OperationPrototype <EraseBlock> of PortPrototype <PS_NvBlockSwComponentTypeNVBlockDescriptor_BsFuSa_Audio>
 *   - triggered by server invocation for OperationPrototype <EraseBlock> of PortPrototype <PS_NvBlockSwComponentTypeNVBlockDescriptor_BsFuSa_Communication>
 *   - triggered by server invocation for OperationPrototype <EraseBlock> of PortPrototype <PS_NvBlockSwComponentTypeNVBlockDescriptor_BsFuSa_Config>
 *   - triggered by server invocation for OperationPrototype <EraseBlock> of PortPrototype <PS_NvBlockSwComponentTypeNVBlockDescriptor_BsFuSa_Display>
 *   - triggered by server invocation for OperationPrototype <EraseBlock> of PortPrototype <PS_NvBlockSwComponentTypeNVBlockDescriptor_BsFuSa_Power>
 *   - triggered by server invocation for OperationPrototype <EraseBlock> of PortPrototype <PS_NvBlockSwComponentTypeNVBlockDescriptor_BsFuSa_Warning>
 *   - triggered by server invocation for OperationPrototype <EraseBlock> of PortPrototype <PS_NvBlockSwComponentTypeNVBlockDescriptor_BsFusa_Fota>
 ...
 *   - triggered by server invocation for OperationPrototype <EraseBlock> of PortPrototype <PS_NvBlockSwComponentTypeNVBlockDescriptor_BsReten_VisDlt>
 ...
 *   - triggered by server invocation for OperationPrototype <GetDataIndex> of PortPrototype <PS_NvBlockSwComponentTypeNVBlockDescriptor_BsFuSa_Audio>
 *   - triggered by server invocation for OperationPrototype <GetDataIndex> of PortPrototype <PS_NvBlockSwComponentTypeNVBlockDescriptor_BsFuSa_Communication>
 *   - triggered by server invocation for OperationPrototype <GetDataIndex> of PortPrototype <PS_NvBlockSwComponentTypeNVBlockDescriptor_BsFuSa_Config>
 *   - triggered by server invocation for OperationPrototype <GetDataIndex> of PortPrototype <PS_NvBlockSwComponentTypeNVBlockDescriptor_BsFuSa_Display>
 *   - triggered by server invocation for OperationPrototype <GetDataIndex> of PortPrototype <PS_NvBlockSwComponentTypeNVBlockDescriptor_BsFuSa_Power>
 *   - triggered by server invocation for OperationPrototype <GetDataIndex> of PortPrototype <PS_NvBlockSwComponentTypeNVBlockDescriptor_BsFuSa_Warning>
 *   - triggered by server invocation for OperationPrototype <GetDataIndex> of PortPrototype <PS_NvBlockSwComponentTypeNVBlockDescriptor_BsFusa_Fota>
 ...
 *   - triggered by server invocation for OperationPrototype <GetDataIndex> of PortPrototype <PS_NvBlockSwComponentTypeNVBlockDescriptor_BsReten_VisDlt>
 ...
 *   - triggered by server invocation for OperationPrototype <GetErrorStatus> of PortPrototype <PS_NvBlockSwComponentTypeNVBlockDescriptor_BsFuSa_Audio>
 *   - triggered by server invocation for OperationPrototype <GetErrorStatus> of PortPrototype <PS_NvBlockSwComponentTypeNVBlockDescriptor_BsFuSa_Communication>
 *   - triggered by server invocation for OperationPrototype <GetErrorStatus> of PortPrototype <PS_NvBlockSwComponentTypeNVBlockDescriptor_BsFuSa_Config>
 *   - triggered by server invocation for OperationPrototype <GetErrorStatus> of PortPrototype <PS_NvBlockSwComponentTypeNVBlockDescriptor_BsFuSa_Display>
 *   - triggered by server invocation for OperationPrototype <GetErrorStatus> of PortPrototype <PS_NvBlockSwComponentTypeNVBlockDescriptor_BsFuSa_Power>
 *   - triggered by server invocation for OperationPrototype <GetErrorStatus> of PortPrototype <PS_NvBlockSwComponentTypeNVBlockDescriptor_BsFuSa_Warning>
 *   - triggered by server invocation for OperationPrototype <GetErrorStatus> of PortPrototype <PS_NvBlockSwComponentTypeNVBlockDescriptor_BsFusa_Fota>
 ...
 *   - triggered by server invocation for OperationPrototype <GetErrorStatus> of PortPrototype <PS_NvBlockSwComponentTypeNVBlockDescriptor_BsReten_VisDlt>
 ...
 *   - triggered by server invocation for OperationPrototype <InvalidateNvBlock> of PortPrototype <PS_NvBlockSwComponentTypeNVBlockDescriptor_BsFuSa_Audio>
 *   - triggered by server invocation for OperationPrototype <InvalidateNvBlock> of PortPrototype <PS_NvBlockSwComponentTypeNVBlockDescriptor_BsFuSa_Communication>
 *   - triggered by server invocation for OperationPrototype <InvalidateNvBlock> of PortPrototype <PS_NvBlockSwComponentTypeNVBlockDescriptor_BsFuSa_Config>
 *   - triggered by server invocation for OperationPrototype <InvalidateNvBlock> of PortPrototype <PS_NvBlockSwComponentTypeNVBlockDescriptor_BsFuSa_Display>
 *   - triggered by server invocation for OperationPrototype <InvalidateNvBlock> of PortPrototype <PS_NvBlockSwComponentTypeNVBlockDescriptor_BsFuSa_Power>
 *   - triggered by server invocation for OperationPrototype <InvalidateNvBlock> of PortPrototype <PS_NvBlockSwComponentTypeNVBlockDescriptor_BsFuSa_Warning>
 *   - triggered by server invocation for OperationPrototype <InvalidateNvBlock> of PortPrototype <PS_NvBlockSwComponentTypeNVBlockDescriptor_BsFusa_Fota>
 ...
 *   - triggered by server invocation for OperationPrototype <InvalidateNvBlock> of PortPrototype <PS_NvBlockSwComponentTypeNVBlockDescriptor_BsReten_VisDlt>
 ...
 *     Synchronous Service Invocation. Timeout: None
 *   Std_ReturnType Rte_Call_NvM_RpNotifyJobEnd_NvBlockSwComponentTypeNVBlockDescriptor_BsFuSa_Audio_JobFinished(NvM_ServiceIdType ServiceId, NvM_RequestResultType JobResult)
 *     Synchronous Service Invocation. Timeout: None
 *   Std_ReturnType Rte_Call_NvM_RpNotifyJobEnd_NvBlockSwComponentTypeNVBlockDescriptor_BsFuSa_Communication_JobFinished(NvM_ServiceIdType ServiceId, NvM_RequestResultType JobResult)
 *     Synchronous Service Invocation. Timeout: None
 *   Std_ReturnType Rte_Call_NvM_RpNotifyJobEnd_NvBlockSwComponentTypeNVBlockDescriptor_BsFuSa_Config_JobFinished(NvM_ServiceIdType ServiceId, NvM_RequestResultType JobResult)
 *     Synchronous Service Invocation. Timeout: None
 *   Std_ReturnType Rte_Call_NvM_RpNotifyJobEnd_NvBlockSwComponentTypeNVBlockDescriptor_BsFuSa_Display_JobFinished(NvM_ServiceIdType ServiceId, NvM_RequestResultType JobResult)
 *     Synchronous Service Invocation. Timeout: None
 *   Std_ReturnType Rte_Call_NvM_RpNotifyJobEnd_NvBlockSwComponentTypeNVBlockDescriptor_BsFuSa_Power_JobFinished(NvM_ServiceIdType ServiceId, NvM_RequestResultType JobResult)
 *     Synchronous Service Invocation. Timeout: None
 *   Std_ReturnType Rte_Call_NvM_RpNotifyJobEnd_NvBlockSwComponentTypeNVBlockDescriptor_BsFuSa_Warning_JobFinished(NvM_ServiceIdType ServiceId, NvM_RequestResultType JobResult)
 *     Synchronous Service Invocation. Timeout: None
 *   Std_ReturnType Rte_Call_NvM_RpNotifyJobEnd_NvBlockSwComponentTypeNVBlockDescriptor_BsFusa_Fota_JobFinished(NvM_ServiceIdType ServiceId, NvM_RequestResultType JobResult)
 *     Synchronous Service Invocation. Timeout: None
 ...
 *     Synchronous Service Invocation. Timeout: None
 *   Std_ReturnType Rte_Call_NvM_RpNotifyJobEnd_NvBlockSwComponentTypeNVBlockDescriptor_BsReten_VisDlt_JobFinished(NvM_ServiceIdType ServiceId, NvM_RequestResultType JobResult)
 *     Synchronous Service Invocation. Timeout: None
 ...
 *********************************************************************************************************************/
  ...
  **********************************************************/
  ...
  {
    FncPtrType NvM_FctPtr; /* PRQA S 3408 */ /* MD_Rte_TestCode */
    NvM_FctPtr = (FncPtrType)TSC_NvM_Rte_Call_NvM_RpNotifyJobEnd_NvBlockSwComponentTypeNVBlockDescriptor_BsFuSa_Audio_JobFinished; /* PRQA S 0313 */ /* MD_Rte_TestCode */
  }
  fct_status = TSC_NvM_Rte_Call_NvM_RpNotifyJobEnd_NvBlockSwComponentTypeNVBlockDescriptor_BsFuSa_Audio_JobFinished(0U, 0U);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  {
    FncPtrType NvM_FctPtr; /* PRQA S 3408 */ /* MD_Rte_TestCode */
    NvM_FctPtr = (FncPtrType)TSC_NvM_Rte_Call_NvM_RpNotifyJobEnd_NvBlockSwComponentTypeNVBlockDescriptor_BsFuSa_Communication_JobFinished; /* PRQA S 0313 */ /* MD_Rte_TestCode */
  }
  fct_status = TSC_NvM_Rte_Call_NvM_RpNotifyJobEnd_NvBlockSwComponentTypeNVBlockDescriptor_BsFuSa_Communication_JobFinished(0U, 0U);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  {
    FncPtrType NvM_FctPtr; /* PRQA S 3408 */ /* MD_Rte_TestCode */
    NvM_FctPtr = (FncPtrType)TSC_NvM_Rte_Call_NvM_RpNotifyJobEnd_NvBlockSwComponentTypeNVBlockDescriptor_BsFuSa_Config_JobFinished; /* PRQA S 0313 */ /* MD_Rte_TestCode */
  }
  fct_status = TSC_NvM_Rte_Call_NvM_RpNotifyJobEnd_NvBlockSwComponentTypeNVBlockDescriptor_BsFuSa_Config_JobFinished(0U, 0U);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  {
    FncPtrType NvM_FctPtr; /* PRQA S 3408 */ /* MD_Rte_TestCode */
    NvM_FctPtr = (FncPtrType)TSC_NvM_Rte_Call_NvM_RpNotifyJobEnd_NvBlockSwComponentTypeNVBlockDescriptor_BsFuSa_Display_JobFinished; /* PRQA S 0313 */ /* MD_Rte_TestCode */
  }
  fct_status = TSC_NvM_Rte_Call_NvM_RpNotifyJobEnd_NvBlockSwComponentTypeNVBlockDescriptor_BsFuSa_Display_JobFinished(0U, 0U);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  {
    FncPtrType NvM_FctPtr; /* PRQA S 3408 */ /* MD_Rte_TestCode */
    NvM_FctPtr = (FncPtrType)TSC_NvM_Rte_Call_NvM_RpNotifyJobEnd_NvBlockSwComponentTypeNVBlockDescriptor_BsFuSa_Power_JobFinished; /* PRQA S 0313 */ /* MD_Rte_TestCode */
  }
  fct_status = TSC_NvM_Rte_Call_NvM_RpNotifyJobEnd_NvBlockSwComponentTypeNVBlockDescriptor_BsFuSa_Power_JobFinished(0U, 0U);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  {
    FncPtrType NvM_FctPtr; /* PRQA S 3408 */ /* MD_Rte_TestCode */
    NvM_FctPtr = (FncPtrType)TSC_NvM_Rte_Call_NvM_RpNotifyJobEnd_NvBlockSwComponentTypeNVBlockDescriptor_BsFuSa_Warning_JobFinished; /* PRQA S 0313 */ /* MD_Rte_TestCode */
  }
  fct_status = TSC_NvM_Rte_Call_NvM_RpNotifyJobEnd_NvBlockSwComponentTypeNVBlockDescriptor_BsFuSa_Warning_JobFinished(0U, 0U);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  {
    FncPtrType NvM_FctPtr; /* PRQA S 3408 */ /* MD_Rte_TestCode */
    NvM_FctPtr = (FncPtrType)TSC_NvM_Rte_Call_NvM_RpNotifyJobEnd_NvBlockSwComponentTypeNVBlockDescriptor_BsFusa_Fota_JobFinished; /* PRQA S 0313 */ /* MD_Rte_TestCode */
  }
  fct_status = TSC_NvM_Rte_Call_NvM_RpNotifyJobEnd_NvBlockSwComponentTypeNVBlockDescriptor_BsFusa_Fota_JobFinished(0U, 0U);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  {
    FncPtrType NvM_FctPtr; /* PRQA S 3408 */ /* MD_Rte_TestCode */
    NvM_FctPtr = (FncPtrType)TSC_NvM_Rte_Call_NvM_RpNotifyJobEnd_NvBlockSwComponentTypeNVBlockDescriptor_BsReten_VisDlt_JobFinished; /* PRQA S 0313 */ /* MD_Rte_TestCode */
  }
  fct_status = TSC_NvM_Rte_Call_NvM_RpNotifyJobEnd_NvBlockSwComponentTypeNVBlockDescriptor_BsReten_VisDlt_JobFinished(0U, 0U);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
 ...
 *   - triggered by server invocation for OperationPrototype <ReadBlock> of PortPrototype <PS_NvBlockSwComponentTypeNVBlockDescriptor_BsFuSa_Audio>
 *   - triggered by server invocation for OperationPrototype <ReadBlock> of PortPrototype <PS_NvBlockSwComponentTypeNVBlockDescriptor_BsFuSa_Communication>
 *   - triggered by server invocation for OperationPrototype <ReadBlock> of PortPrototype <PS_NvBlockSwComponentTypeNVBlockDescriptor_BsFuSa_Config>
 *   - triggered by server invocation for OperationPrototype <ReadBlock> of PortPrototype <PS_NvBlockSwComponentTypeNVBlockDescriptor_BsFuSa_Display>
 *   - triggered by server invocation for OperationPrototype <ReadBlock> of PortPrototype <PS_NvBlockSwComponentTypeNVBlockDescriptor_BsFuSa_Power>
 *   - triggered by server invocation for OperationPrototype <ReadBlock> of PortPrototype <PS_NvBlockSwComponentTypeNVBlockDescriptor_BsFuSa_Warning>
 *   - triggered by server invocation for OperationPrototype <ReadBlock> of PortPrototype <PS_NvBlockSwComponentTypeNVBlockDescriptor_BsFusa_Fota>
 ...
 *   - triggered by server invocation for OperationPrototype <ReadBlock> of PortPrototype <PS_NvBlockSwComponentTypeNVBlockDescriptor_BsReten_VisDlt>
 ...
 *   - triggered by server invocation for OperationPrototype <RestoreBlockDefaults> of PortPrototype <PS_NvBlockSwComponentTypeNVBlockDescriptor_BsFuSa_Audio>
 *   - triggered by server invocation for OperationPrototype <RestoreBlockDefaults> of PortPrototype <PS_NvBlockSwComponentTypeNVBlockDescriptor_BsFuSa_Communication>
 *   - triggered by server invocation for OperationPrototype <RestoreBlockDefaults> of PortPrototype <PS_NvBlockSwComponentTypeNVBlockDescriptor_BsFuSa_Config>
 *   - triggered by server invocation for OperationPrototype <RestoreBlockDefaults> of PortPrototype <PS_NvBlockSwComponentTypeNVBlockDescriptor_BsFuSa_Display>
 *   - triggered by server invocation for OperationPrototype <RestoreBlockDefaults> of PortPrototype <PS_NvBlockSwComponentTypeNVBlockDescriptor_BsFuSa_Power>
 *   - triggered by server invocation for OperationPrototype <RestoreBlockDefaults> of PortPrototype <PS_NvBlockSwComponentTypeNVBlockDescriptor_BsFuSa_Warning>
 *   - triggered by server invocation for OperationPrototype <RestoreBlockDefaults> of PortPrototype <PS_NvBlockSwComponentTypeNVBlockDescriptor_BsFusa_Fota>
 ...
 *   - triggered by server invocation for OperationPrototype <RestoreBlockDefaults> of PortPrototype <PS_NvBlockSwComponentTypeNVBlockDescriptor_BsReten_VisDlt>
 ...
 *   - triggered by server invocation for OperationPrototype <SetBlockProtection> of PortPrototype <PAdmin_NvBlockSwComponentTypeNVBlockDescriptor_BsFuSa_Audio>
 *   - triggered by server invocation for OperationPrototype <SetBlockProtection> of PortPrototype <PAdmin_NvBlockSwComponentTypeNVBlockDescriptor_BsFuSa_Communication>
 *   - triggered by server invocation for OperationPrototype <SetBlockProtection> of PortPrototype <PAdmin_NvBlockSwComponentTypeNVBlockDescriptor_BsFuSa_Config>
 *   - triggered by server invocation for OperationPrototype <SetBlockProtection> of PortPrototype <PAdmin_NvBlockSwComponentTypeNVBlockDescriptor_BsFuSa_Display>
 *   - triggered by server invocation for OperationPrototype <SetBlockProtection> of PortPrototype <PAdmin_NvBlockSwComponentTypeNVBlockDescriptor_BsFuSa_Power>
 *   - triggered by server invocation for OperationPrototype <SetBlockProtection> of PortPrototype <PAdmin_NvBlockSwComponentTypeNVBlockDescriptor_BsFuSa_Warning>
 *   - triggered by server invocation for OperationPrototype <SetBlockProtection> of PortPrototype <PAdmin_NvBlockSwComponentTypeNVBlockDescriptor_BsFusa_Fota>
 ...
 *   - triggered by server invocation for OperationPrototype <SetBlockProtection> of PortPrototype <PAdmin_NvBlockSwComponentTypeNVBlockDescriptor_BsReten_VisDlt>
 ...
 *   - triggered by server invocation for OperationPrototype <SetDataIndex> of PortPrototype <PS_NvBlockSwComponentTypeNVBlockDescriptor_BsFuSa_Audio>
 *   - triggered by server invocation for OperationPrototype <SetDataIndex> of PortPrototype <PS_NvBlockSwComponentTypeNVBlockDescriptor_BsFuSa_Communication>
 *   - triggered by server invocation for OperationPrototype <SetDataIndex> of PortPrototype <PS_NvBlockSwComponentTypeNVBlockDescriptor_BsFuSa_Config>
 *   - triggered by server invocation for OperationPrototype <SetDataIndex> of PortPrototype <PS_NvBlockSwComponentTypeNVBlockDescriptor_BsFuSa_Display>
 *   - triggered by server invocation for OperationPrototype <SetDataIndex> of PortPrototype <PS_NvBlockSwComponentTypeNVBlockDescriptor_BsFuSa_Power>
 *   - triggered by server invocation for OperationPrototype <SetDataIndex> of PortPrototype <PS_NvBlockSwComponentTypeNVBlockDescriptor_BsFuSa_Warning>
 *   - triggered by server invocation for OperationPrototype <SetDataIndex> of PortPrototype <PS_NvBlockSwComponentTypeNVBlockDescriptor_BsFusa_Fota>
 ...
 *   - triggered by server invocation for OperationPrototype <SetDataIndex> of PortPrototype <PS_NvBlockSwComponentTypeNVBlockDescriptor_BsReten_VisDlt>
 ...
 *   - triggered by server invocation for OperationPrototype <SetRamBlockStatus> of PortPrototype <PS_NvBlockSwComponentTypeNVBlockDescriptor_BsFuSa_Audio>
 *   - triggered by server invocation for OperationPrototype <SetRamBlockStatus> of PortPrototype <PS_NvBlockSwComponentTypeNVBlockDescriptor_BsFuSa_Communication>
 *   - triggered by server invocation for OperationPrototype <SetRamBlockStatus> of PortPrototype <PS_NvBlockSwComponentTypeNVBlockDescriptor_BsFuSa_Config>
 *   - triggered by server invocation for OperationPrototype <SetRamBlockStatus> of PortPrototype <PS_NvBlockSwComponentTypeNVBlockDescriptor_BsFuSa_Display>
 *   - triggered by server invocation for OperationPrototype <SetRamBlockStatus> of PortPrototype <PS_NvBlockSwComponentTypeNVBlockDescriptor_BsFuSa_Power>
 *   - triggered by server invocation for OperationPrototype <SetRamBlockStatus> of PortPrototype <PS_NvBlockSwComponentTypeNVBlockDescriptor_BsFuSa_Warning>
 *   - triggered by server invocation for OperationPrototype <SetRamBlockStatus> of PortPrototype <PS_NvBlockSwComponentTypeNVBlockDescriptor_BsFusa_Fota>
 ...
 *   - triggered by server invocation for OperationPrototype <SetRamBlockStatus> of PortPrototype <PS_NvBlockSwComponentTypeNVBlockDescriptor_BsReten_VisDlt>
 ...
 *   - triggered by server invocation for OperationPrototype <WriteBlock> of PortPrototype <PS_NvBlockSwComponentTypeNVBlockDescriptor_BsFuSa_Audio>
 *   - triggered by server invocation for OperationPrototype <WriteBlock> of PortPrototype <PS_NvBlockSwComponentTypeNVBlockDescriptor_BsFuSa_Communication>
 *   - triggered by server invocation for OperationPrototype <WriteBlock> of PortPrototype <PS_NvBlockSwComponentTypeNVBlockDescriptor_BsFuSa_Config>
 *   - triggered by server invocation for OperationPrototype <WriteBlock> of PortPrototype <PS_NvBlockSwComponentTypeNVBlockDescriptor_BsFuSa_Display>
 *   - triggered by server invocation for OperationPrototype <WriteBlock> of PortPrototype <PS_NvBlockSwComponentTypeNVBlockDescriptor_BsFuSa_Power>
 *   - triggered by server invocation for OperationPrototype <WriteBlock> of PortPrototype <PS_NvBlockSwComponentTypeNVBlockDescriptor_BsFuSa_Warning>
 *   - triggered by server invocation for OperationPrototype <WriteBlock> of PortPrototype <PS_NvBlockSwComponentTypeNVBlockDescriptor_BsFusa_Fota>
 ...
 *   - triggered by server invocation for OperationPrototype <WriteBlock> of PortPrototype <PS_NvBlockSwComponentTypeNVBlockDescriptor_BsReten_VisDlt>
