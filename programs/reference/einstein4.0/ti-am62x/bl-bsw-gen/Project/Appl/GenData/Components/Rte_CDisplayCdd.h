...
FUNC(void, DisplayCdd_CODE) CDisplayCdd_GetGammaCorrectionStatus(P2VAR(EGammaCorrectionStatus, AUTOMATIC, RTE_CDISPLAYCDD_APPL_VAR) GmaCrStatus); /* PRQA S 0850 */ /* MD_MSR_19.8 */
FUNC(Std_ReturnType, DisplayCdd_CODE) CDisplayCdd_GetStatus(EDisplayType DeviceId, P2VAR(EDisplayCddStatus, AUTOMATIC, RTE_CDISPLAYCDD_APPL_VAR) DeviceStatus, P2VAR(EDisplayPowerState, AUTOMATIC, RTE_CDISPLAYCDD_APPL_VAR) DisplayPowerState); /* PRQA S 0850 */ /* MD_MSR_19.8 */
FUNC(void, DisplayCdd_CODE) CDisplayCdd_I2cSeqEndCallback(void); /* PRQA S 0850 */ /* MD_MSR_19.8 */
FUNC(void, DisplayCdd_CODE) CDisplayCdd_Impl_MainFunction(void); /* PRQA S 0850, 3451 */ /* MD_MSR_19.8, MD_Rte_3451 */
FUNC(Std_ReturnType, DisplayCdd_CODE) CDisplayCdd_Impl_OnCommand(ECmpCmd cmdP); /* PRQA S 0850 */ /* MD_MSR_19.8 */
FUNC(Std_ReturnType, DisplayCdd_CODE) CDisplayCdd_SetGammaCorrection(P2VAR(UInt8, AUTOMATIC, RTE_CDISPLAYCDD_APPL_VAR) GmaSetPtr, UInt8 datalength); /* PRQA S 0850 */ /* MD_MSR_19.8 */
FUNC(Std_ReturnType, DisplayCdd_CODE) CDisplayCdd_SetState(EDisplayType DeviceID, EDisplayPowerState PowerState); /* PRQA S 0850 */ /* MD_MSR_19.8 */
