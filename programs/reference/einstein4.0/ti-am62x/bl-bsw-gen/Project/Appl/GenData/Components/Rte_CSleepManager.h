...
#  define Rte_Write_CSleepManager_ppSR_SleepStatus_SleepManager_SleepStatus(data) (Rte_CSleepManager_ppSR_SleepStatus_SleepManager_SleepStatus = (data), ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
