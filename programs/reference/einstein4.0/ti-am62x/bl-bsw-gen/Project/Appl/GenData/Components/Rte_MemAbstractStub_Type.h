 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *          File:  Rte_MemAbstractStub_Type.h
 *        Config:  BMW.dpa"
 ...
 *       License:  CBD1800851
 *
 *   Description:  Application types header file for SW-C <MemAbstractStub>
 *********************************************************************************************************************/

/* double include prevention */
#ifndef _RTE_MEMABSTRACTSTUB_TYPE_H
# define _RTE_MEMABSTRACTSTUB_TYPE_H
...
#endif /* _RTE_MEMABSTRACTSTUB_TYPE_H */
