...
#  define Rte_Read_rpSR_SleepStatus_SleepManager_SleepStatus Rte_Read_DmnMgr_rpSR_SleepStatus_SleepManager_SleepStatus
#  define Rte_Read_DmnMgr_rpSR_SleepStatus_SleepManager_SleepStatus(data) (*(data) = Rte_CSleepManager_ppSR_SleepStatus_SleepManager_SleepStatus, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
