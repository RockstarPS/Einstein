 ...
 *       License:  CBD1800851
 *
 *   Description:  Application types header file for SW-C <EcuAppM>
 *********************************************************************************************************************/

/* double include prevention */
#ifndef _RTE_ECUAPPM_TYPE_H
# define _RTE_ECUAPPM_TYPE_H
