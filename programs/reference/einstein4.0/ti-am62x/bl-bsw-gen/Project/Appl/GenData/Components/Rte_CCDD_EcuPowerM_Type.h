 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *          File:  Rte_CCDD_EcuPowerM_Type.h
 *        Config:  BMW.dpa
 ...
 *       License:  CBD1800851
 *
 *   Description:  Application types header file for SW-C <CCDD_EcuPowerM>
 *********************************************************************************************************************/

/* double include prevention */
#ifndef _RTE_CCDD_ECUPOWERM_TYPE_H
# define _RTE_CCDD_ECUPOWERM_TYPE_H
...
#endif /* _RTE_CCDD_ECUPOWERM_TYPE_H */
