...
void TSC_BswCallbacks()
{
    ...
    (void)Rte_SetMirror_NvBlockSwComponentType_NVBlockDescriptor_BsFuSa_Audio(buffer);
    (void)Rte_GetMirror_NvBlockSwComponentType_NVBlockDescriptor_BsFuSa_Audio(buffer);

    (void)Rte_SetMirror_NvBlockSwComponentType_NVBlockDescriptor_BsFuSa_Communication(buffer);
    (void)Rte_GetMirror_NvBlockSwComponentType_NVBlockDescriptor_BsFuSa_Communication(buffer);

    (void)Rte_SetMirror_NvBlockSwComponentType_NVBlockDescriptor_BsFuSa_Config(buffer);
    (void)Rte_GetMirror_NvBlockSwComponentType_NVBlockDescriptor_BsFuSa_Config(buffer);

    (void)Rte_SetMirror_NvBlockSwComponentType_NVBlockDescriptor_BsFuSa_Display(buffer);
    (void)Rte_GetMirror_NvBlockSwComponentType_NVBlockDescriptor_BsFuSa_Display(buffer);

    (void)Rte_SetMirror_NvBlockSwComponentType_NVBlockDescriptor_BsFuSa_Power(buffer);
    (void)Rte_GetMirror_NvBlockSwComponentType_NVBlockDescriptor_BsFuSa_Power(buffer);

    (void)Rte_SetMirror_NvBlockSwComponentType_NVBlockDescriptor_BsFuSa_Warning(buffer);
    (void)Rte_GetMirror_NvBlockSwComponentType_NVBlockDescriptor_BsFuSa_Warning(buffer);

    (void)Rte_SetMirror_NvBlockSwComponentType_NVBlockDescriptor_BsFusa_Fota(buffer);
    (void)Rte_GetMirror_NvBlockSwComponentType_NVBlockDescriptor_BsFusa_Fota(buffer);
    ...
    (void)Rte_SetMirror_NvBlockSwComponentType_NVBlockDescriptor_BsReten_VisDlt(buffer);
    (void)Rte_GetMirror_NvBlockSwComponentType_NVBlockDescriptor_BsReten_VisDlt(buffer);
