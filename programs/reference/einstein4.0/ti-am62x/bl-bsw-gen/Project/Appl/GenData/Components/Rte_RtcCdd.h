...
#  define RTE_RUNNABLE_pp_CmpLibCmd_CRTCCdd_Impl_OnCommand pp_CmpLibCmd_CRTCCdd_Impl_OnCommand
# endif
...
FUNC(Std_ReturnType, RtcCdd_CODE) pp_CmpLibCmd_CRTCCdd_Impl_OnCommand(ECmpCmd cmdP); /* PRQA S 0850 */ /* MD_MSR_19.8 */
