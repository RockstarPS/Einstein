...
/// Start of user code : Header user code for file upd_doip_adapter_component.cpp
...
bool UpdDoipAdapterComponent::onInit()
{
	bool ret = Component::onInit();;

/// Start of user code : User code for function onInit in file upd_doip_adapter_component.cpp
...
bool UpdDoipAdapterComponent::onExit()
{
	bool ret = Component::onExit();

/// Start of user code : User code for function onExit in file upd_doip_adapter_component.cpp
...
bool UpdDoipAdapterComponent::onStart()
{
	bool ret = Component::onStart();

/// Start of user code : User code for function onStart in file upd_doip_adapter_component.cpp
...
bool UpdDoipAdapterComponent::onStop()
{
	bool ret = Component::onStop();

/// Start of user code : User code for function onStop in file upd_doip_adapter_component.cpp
...
void UpdDoipAdapterComponent::worker()
{
/// Start of user code : User code for function worker in file upd_doip_adapter_component.cpp

/// End of user code
}

void UpdDoipAdapterComponent::onReceiveDoIPDownloadRequest(DoIPDownloadRequest const  & msg)
{
/// Start of user code : User code for function onReceiveDoIPDownloadRequest in file upd_doip_adapter_component.cpp
...
void UpdDoipAdapterComponent::periodicTask()
{
	DoIPTransferHandlingTask();
}

void UpdDoipAdapterComponent::DoIPTransferHandlingTask(void)
{
...
void UpdDoipAdapterComponent::DoIP_sendResponse(uint32 Sid, uint8 ErrorCode, uint32 RespLength, uint8* data )
{
...
/// Start of user code : Footer user code for file upd_doip_adapter_component.cpp
