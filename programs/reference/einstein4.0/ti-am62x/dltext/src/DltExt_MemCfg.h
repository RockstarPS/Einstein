...
#define DLTEXT_TOTAL_NUM_OF_RESET_HISTORY       5u
#define DLTEXT_LAST_APP_HISTORY_NUM             8u
...
#define DLTEXT_MAX_NVM_SIZE             (uint8)(128u)
#define DLTEXT_ADDITIONAL_RESET_INFO_SIZE       12u
