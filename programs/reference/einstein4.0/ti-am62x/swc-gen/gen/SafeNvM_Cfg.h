...
#define SAFENVM_DTC_HOOK()                   SafeNvMErrorHook()
/*****************************************************************************
*                                 EXTERN                          *
 ******************************************************************************/
extern void SafeNvMErrorHook(void);
void SafeNvM_AsilRam_CopyTo_RteSafeRam(void);
extern const NvMSafeBlockConfigType NvMSafe_Blockconfig[NUM_OF_SAFE_NVM_BLKS];

extern void OnDre_SafeNvM_Illumination(void);
extern void MemAbstractMdl_Safe_NotifyJobEnd_BsConst_Illumination(NvM_ServiceIdType ServiceId, NvM_RequestResultType JobResult);
extern void MemAbstractMdl_Safe_NotifyJobEnd_BsConst_Illumination_Copy1(NvM_ServiceIdType ServiceId, NvM_RequestResultType JobResult);
extern void MemAbstractMdl_Safe_NotifyJobEnd_BsConst_Illumination_Copy2(NvM_ServiceIdType ServiceId, NvM_RequestResultType JobResult);
