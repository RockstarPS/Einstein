...
Gpt_ConfigType* Gpt_GetConfigData(void);
...
#define TMEXT_GET_CURRENT_TIME_IN_US           (Gpt_GetTimeElapsed (GptConf_GptChannelConfiguration_MCU_TIMER1))/TM_EXT_TIMER_FRQ //msavariy need to change todo
...
#define cGPT_TIMER 					GptConf_GptChannelConfiguration_MCU_TIMER1 //msavariy - need to change todo


/**
* @brief Timer Rollover or max count value
*/
#define cTIMER_ROLLOVER_VALUE 		0xFFFFFFFEUL
