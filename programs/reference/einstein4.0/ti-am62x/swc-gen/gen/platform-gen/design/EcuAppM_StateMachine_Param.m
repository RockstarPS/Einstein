...
EcuAppM_GroupConfigType.Elements = [wakeupSourceMask  deactivationType failSafeTimeout attributes];
...
EcuAppM_GroupConfigData.Value = struct('wakeupSourceMask',{0xFF 0xFF 0x0F 0x10 0x20},'deactivationType',{1 0 0 0 0},'failSafeTimeout',{20 20 20 20 20},'attributes',{0 0 0 0 0});
