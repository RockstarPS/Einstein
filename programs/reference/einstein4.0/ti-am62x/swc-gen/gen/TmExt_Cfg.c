...
//----------------------------------------------------------------------------------------------------------------------
#define SWCGEN_DATA_START
#include "MemMap.h"

#define SWCGEN_DATA_END
#include "MemMap.h"
...
#define SWCGEN_CONST_END
#include "MemMap.h"

#define SWCGEN_CODE_SEC_START
#include "MemMap.h"
...
void TmExt_UpdateFreeRunningCounter( void )
{
    ...
    if(FreeRunningCounter < 0xFFFFFFFFU)
    {
	    FreeRunningCounter++;
    }
}
#define SWCGEN_CODE_SEC_END
#include "MemMap.h"
