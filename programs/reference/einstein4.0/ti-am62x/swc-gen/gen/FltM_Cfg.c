...
const FltM_DemConfigType FltM_DemConfig[FLTM_MAX_NUM_FAULTS] =
{
  ...
  /* [FLTM_DEM_CFG_PERIODIC_READBACK_FAIL] */                { FALSE, 0U }
#if (FLTM_SAME_FAULT_RESET_LOOP_HW_TEST_ENABLE == STD_ON)
  ,
  /* [FLTM_DEM_CFG_HW_TEST_RESERVED] */                      { FALSE, 0U }
#endif
};
...
const FltM_ResetPolicyConfigType FltM_ResetPolicyConfig[FLTM_NUM_RESET_POLICY_CFG] =
{
  ...
  /* [FLTM_RESET_POLICY_RESET_ALWAYS] Continous reset*/
  { FLTM_RESET_POLICY_RESET_ALWAYS, 255U},
...
const FltM_ActionConfigType FltM_ActionConfig[FLTM_NUM_ACTION_CFG] =
{
  ...
  { NULL_PTR, FltMExt_SameFaultHwTestFinalAction, NULL_PTR }
#endif
};
...
const FltM_FaultConfigType FltM_FaultConfig[FLTM_MAX_NUM_FAULTS] =
{
  ...
  { POWER_SUPPLY_FAULT,                       FLTM_SEVERITY_CFG_FATAL, FLTM_DEBOUNCE_CFG_IMMEDIATE,  FLTM_LOG_CFG_FATAL_DLT, FLTM_DEM_CFG_POWER_SUPPLY_FAULT,                        FLTM_RESET_POLICY_CFG_RESET_UNTIL_FINAL_ACTION_TH3,     FLTM_ACTION_CFG_NONE },
  ...
  { FLTM_E_PMIC_ABIST_FAIL,                   FLTM_SEVERITY_CFG_ERROR, FLTM_DEBOUNCE_CFG_IMMEDIATE,  FLTM_LOG_CFG_ERROR_DLT, FLTM_DEM_CFG_PMIC_ABIST_FAIL,                           FLTM_RESET_POLICY_CFG_RESET_UNTIL_FINAL_ACTION_TH3,     FLTM_ACTION_CFG_INITIAL_FINAL_RECOVERY },
  ...
  { PERIODIC_READBACK_FAIL,                   FLTM_SEVERITY_CFG_FATAL, FLTM_DEBOUNCE_CFG_IMMEDIATE,  FLTM_LOG_CFG_FATAL_DLT, FLTM_DEM_CFG_PERIODIC_READBACK_FAIL,                     FLTM_RESET_POLICY_CFG_RESET_UNTIL_FINAL_ACTION_TH3,     FLTM_ACTION_CFG_INITIAL_FINAL_RECOVERY }
#if (FLTM_SAME_FAULT_RESET_LOOP_HW_TEST_ENABLE == STD_ON)
  ,
  { FLTM_SAME_FAULT_HW_TEST_FAULT_ID,           FLTM_SEVERITY_CFG_FATAL, FLTM_DEBOUNCE_CFG_IMMEDIATE,  FLTM_LOG_CFG_FATAL_DLT, FLTM_DEM_CFG_HW_TEST_RESERVED,                          FLTM_RESET_POLICY_CFG_RESET_UNTIL_FINAL_ACTION_TH3,     FLTM_ACTION_CFG_HW_TEST_FINAL }
#endif
};
