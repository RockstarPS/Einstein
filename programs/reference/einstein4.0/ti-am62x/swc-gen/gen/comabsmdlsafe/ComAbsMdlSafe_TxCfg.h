...
extern Std_ReturnType Rte_Write_TrustecSWC_PP_TX_SG_COM_HS_SG_COM_HS(P2CONST(SG_COM_HS, AUTOMATIC, RTE_TRUSTECSWC_APPL_DATA) data, P2VAR(Rte_TransformerError, AUTOMATIC, RTE_TRUSTECSWC_APPL_VAR) transformerError); 
typedef struct
{
...
extern Std_ReturnType ComAbsMdlSafe_TxCanPutTo_COM_HS_Core(tSafeTxSignalId id, const uint8 *pSignalValue);

/********************************************************************************************************************
 *  PUBLIC FUNCTION PROTOTYPE
 ********************************************************************************************************************/
extern Std_ReturnType ComAbsMdlSafe_TxCanSetSig_Battery_Voltage(const uint8 *pSignalValue);
...
/* SignalEnum SignalEnumValue SignalNameInDbc MessageName
   eBattery_VoltageOut    0     Battery_Voltage    SG_COM_HS
*/
