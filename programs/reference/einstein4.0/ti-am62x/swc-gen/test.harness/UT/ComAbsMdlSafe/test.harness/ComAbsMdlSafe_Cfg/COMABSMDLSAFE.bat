...
echo environment build COMABSMDLSAFE.env >> commands.tmp
echo /E:COMABSMDLSAFE tools script run COMABSMDLSAFE.tst >> commands.tmp
echo /E:COMABSMDLSAFE execute batch >> commands.tmp
echo /E:COMABSMDLSAFE reports custom management COMABSMDLSAFE_management_report.html >> commands.tmp
