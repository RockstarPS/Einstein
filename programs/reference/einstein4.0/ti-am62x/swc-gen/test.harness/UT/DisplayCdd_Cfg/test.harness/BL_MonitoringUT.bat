...
echo options TESTABLE_SOURCE_DIR ..\dep\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR ..\src\ >> commands.tmp
echo environment build BL_UT.env >> commands.tmp
echo /E:BL_UT tools script run BL_UT.tst >> commands.tmp
echo /E:BL_UT execute batch >> commands.tmp
echo /E:BL_UT tools import_coverage BL_UT.cvr >> commands.tmp
echo /E:BL_UT reports custom management BL_UT_management_report.html >> commands.tmp
