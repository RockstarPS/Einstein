...
namespace ImGui
{
    ...
    IMGUI_API void          ImageMip(ImTextureID user_texture_id, const ImVec2& size, const unsigned int miplevel = 0U, const ImVec2& uv0 = ImVec2(0, 0), const ImVec2& uv1 = ImVec2(1, 1), const ImVec4& tint_col = ImVec4(1, 1, 1, 1), const ImVec4& border_col = ImVec4(0, 0, 0, 0));
...
struct ImDrawCmd
{
    ...
    unsigned int    MipLevel;           // 4-8  // Mipmap level to use uncase of Image
...
struct ImDrawList
{
    ...
    IMGUI_API void  SetTextureMip(unsigned int p_miplevel)
    {
        _CmdHeader.MipLevel = p_miplevel;
    }
