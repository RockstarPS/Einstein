...
#ifndef rdf_scg_node_h
#define rdf_scg_node_h

#include "rdf_types.h"

namespace rendercore_engine
{
    class rdf_scg_display;
    /// \ingroup Loader
    /// @{

    /// rdf scg node class, extending gfx3d scg node
	class rdf_scg_node: public gfx3d_scg_node
	{
    private:
	...
	public:
		...
		rdf_scg_node(const int32_t p_node_index, rdf_scg_display* const p_dsp, gfx3d_scg_node * const p_parent);
        virtual ~rdf_scg_node();
		///	gets the node type
		static mdl_nodeType_E GetNodeType(const rdf_node* const p_node);
