...
//
//  Filename    : rdfbin_scg_3dtext_node.h
//  Description :  3d text node for scg where data from rdf binary will be loaded
//  Created on  : 1-Sep-2021 by ssharm20@visteon.com
///////////////////////////////////////////////////////////////////////////////
/// @file  rdfbin_scg_3dtext_node.h
///	\brief 	    3d text node for scg where data from rdf binary will be loaded
#ifndef rdfbin_scg_3dtext_node_h
#define rdfbin_scg_3dtext_node_h
...
namespace rendercore_engine
{
	...
	/// </summary>
	class rdfbin_scg_3dtext_node: public gfx3d_scg_3dtext_node
	{
    private:
        int32_t lnodeIndex;
    protected:
    ...
    public:
		/// constructor
		rdfbin_scg_3dtext_node(const int32_t p_node_index, rdfbin_scg_display* const p_dsp, gfx3d_scg_node * const p_parent);
		virtual ~rdfbin_scg_3dtext_node();
	};
    /// @}
}
