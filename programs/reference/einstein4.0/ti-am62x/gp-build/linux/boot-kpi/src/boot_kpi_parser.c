...
const char* kpi_id_to_str(te_KPI_ID_t id)
{
    ...
    case KPI_ID_SBL_S2_MAIN_ETH_APP_TS_IPC:            return "Stage 2 ETH_APP_TS_IPC Done.";
    case KPI_ID_SBL_S2_MAIN_ETH_APP_TS_ETH_PORT:       return "Stage 2 ETH_APP_TS_ETH_PORT Done.";
    case KPI_ID_SBL_S2_MAIN_ETH_APP_TS_HOST_PORT:      return "Stage 2 ETH_APP_TS_HOST_PORT Done.";
    case KPI_ID_SBL_S2_MAIN_ETH_APP_TS_TCPIP:          return "Stage 2 ETH_APP_TS_TCPIP Done.";
    case KPI_ID_SBL_S2_MAIN_ETH_APP_TS_PTP:            return "Stage 2 ETH_APP_TS_PTP Done.";
    ...
    case KPI_ID_VIP_FIRST_CAN_MSGOUT:                  return "First CAN Message out.";
    case KPI_ID_VIP_FIRST_CHIMES_PLAY:                 return "First Chimes Play.";
    case KPI_ID_VIP_UCL_LINKUP:                        return "UCL Link Up Communication.";
    ...
    // GIP HMI
    case KPI_ID_GIP_SAFE_HMI_START:                      return "Safe HMI Service PreStart.";
    case KPI_ID_GIP_SAFE_HMI_END:                        return "Safe HMI Service PostEnd.";
    case KPI_ID_GIP_FULL_HMI_START:                    return "Full HMI Service PreStart";
    case KPI_ID_GIP_FULL_HMI:                          return "Full HMI Start.";
    case KPI_ID_GIP_FULL_HMI_END:                      return "Full HMI Service PostEnd";
    case KPI_ID_GIP_SAFEHMI_BEFORE_FIRST_RENDER:        return "Safe HMI Before First Render.";
    case KPI_ID_GIP_SAFEHMI_AFTER_FIRST_RENDER:         return "Safe HMI After First Render.";
    case KPI_ID_GIP_MAINHMI_BEFORE_FIRST_RENDER:        return "Main HMI Before First Render.";
    case KPI_ID_GIP_MAINHMI_AFTER_FIRST_RENDER:         return "Main HMI After First Render.";
    case KPI_ID_GIP_MAINHMI_WAIT_FOR_RENDER_DONE:       return "Main HMI Wait For Render Done.";
