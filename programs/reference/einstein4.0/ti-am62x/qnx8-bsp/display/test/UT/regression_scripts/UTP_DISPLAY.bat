...
echo environment build UTP_DISPLAY.env >> commands.tmp
echo /E:UTP_DISPLAY tools script run UTP_DISPLAY.tst >> commands.tmp
echo /E:UTP_DISPLAY execute batch >> commands.tmp
echo /E:UTP_DISPLAY reports custom management UTP_DISPLAY_management_report.html >> commands.tmp
