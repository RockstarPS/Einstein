...
// ********************************************
// Memory regions for QNX, consult DDR map
// ********************************************

//AM62P includes two DDR data regions: 2GB at 0x8000_0000 and 2GB at 0x8_8000_0000
#define IDK_DDR0_BASE   0x85900000ul // Some memory reserved for VIP and other purposes, align to 1MB
#define IDK_DDR0_SIZE   (MEG(2048-0x59))  /* 2GB minus */

#define IDK_DDR1_BASE   0x80000000ul
#define IDK_DDR1_SIZE (MEG(0x23)) /* 35MB DDR1, region is too short for DDR0 */

#define IDK_DDR2_BASE   0x880000000ul
#define IDK_DDR2_SIZE (MEG(2048)) /* 2GB */
