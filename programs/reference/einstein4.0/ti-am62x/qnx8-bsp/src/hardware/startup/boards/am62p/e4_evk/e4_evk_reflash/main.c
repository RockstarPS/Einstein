...
/* Reboot callout */
static const struct callout_slot callouts[] = {
    { CALLOUT_SLOT( reboot, _ti_sci ) },
};
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.1.0/trunk/hardware/startup/boards/am62p/evm/main.c $ $Rev: 988992 $")
#endif
