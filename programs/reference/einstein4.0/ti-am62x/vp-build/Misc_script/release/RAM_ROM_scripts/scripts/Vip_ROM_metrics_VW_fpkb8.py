...
def GenerateReport():
    ...
    file_path = os.path.join(dir_path, '/home/jenkins/workspace/VW_DI_fpkb8/VW_MY2022_FPKB8_IC_EP28877_Quality/programs/vw/my2022/fpkb8/vp-build/Misc_Scripts/RAM_ROM_scripts/scripts/results/Vip_ROM_Report.html')
    #print(file_path)
    ...
    with open(file_path, 'w') as myFile:
        ...
        myFile.write('<tr bgcolor="#FDF5E6" ><td>Vip_ROM_metrics_VW_fpkb8.py</td><td align="center">%.2f</td>' %memSize);
...
dir_path = os.path.dirname(sys.path[0])
file_path = os.path.join(dir_path, '/home/jenkins/workspace/VW_DI_fpkb8/VW_MY2022_FPKB8_IC_EP28877_Quality/programs/vw/my2022/fpkb8/vp-build/Misc_Scripts/RAM_ROM_scripts/scripts/results/vip_ROM.csv')
#print(file_path)
