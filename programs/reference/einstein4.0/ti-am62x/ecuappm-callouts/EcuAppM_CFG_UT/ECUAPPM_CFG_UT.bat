...
echo options TESTABLE_SOURCE_DIR C:\bmalgeka\DmnMgr_UT\programs\reference\einstein4.0\ti-am62x\ecuappm-callouts\src\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR C:\bmalgeka\DmnMgr_UT\programs\reference\einstein4.0\ti-am62x\ecuappm-callouts\EcuAppM_UT\UT_Stubs\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR C:\bmalgeka\DmnMgr_UT\programs\reference\einstein4.0\ti-am62x\vp-build\stubs\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR C:\bmalgeka\DmnMgr_UT\programs\reference\einstein4.0\ti-am62x\vp-build\stubs\Bsw_Stubs\AsrGnrl\inc\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR C:\bmalgeka\DmnMgr_UT\programs\reference\einstein4.0\ti-am62x\bsw-gen\Project\Appl\GenData\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR C:\bmalgeka\DmnMgr_UT\programs\reference\einstein4.0\ti-am62x\bsw-gen\Project\Appl\GenData\Components\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR C:\bmalgeka\DmnMgr_UT\cluster-platform\turing\bsw\EcuAppM\include\ >> commands.tmp
echo environment build ECUAPPM_CFG_UT.env >> commands.tmp
echo /E:ECUAPPM_CFG_UT tools script run ECUAPPM_CFG_UT.tst >> commands.tmp
echo /E:ECUAPPM_CFG_UT execute batch >> commands.tmp
echo /E:ECUAPPM_CFG_UT reports custom management ECUAPPM_CFG_UT_management_report.html >> commands.tmp
