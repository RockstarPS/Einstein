...
public:   
    ...
    ///
    virtual bool isPermmitedBySecurityLevel(CUdsServiceHandlerIf::ESecurityMask_t permittedSecurity);
	...
	void onReceiveDKMsgInstallerUdsVerifyResp(InstallerUdsVerifyResp & msg);

    void onReceiveDkMsgInstallerUdsDigestReadResp(InstallerUdsDigestReadResp & msg);

    void onReceiveDkMsgInstallerUdsDigestWriteResp(InstallerUdsDigestWriteResp & msg);
