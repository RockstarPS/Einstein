...
#define I2C_CHANNEL_CONFIG_PARAM \
    ...
    {3, I2C_RTC,          RtcCdd_I2cEndNotification, I2C_FAST_MODE, 9, 5, 7}
...
const Pinmux_PerCfg_t gPinMux_Pmic_Dio_To_I2C_Cfg[3U] = {
...
const Pinmux_PerCfg_t gPinMux_Pmic_I2C_To_Dio_Cfg[3U] = {
...
const Pinmux_PerCfg_t gPinMux_Pmic_I2C_To_DioIn_Cfg[3U] = {
        /* MCU_I2C0 pin config */
    /* MCU_I2C0_SCL -> MCU_I2C0_SCL (E11) */
    {
        PIN_MCU_I2C0_SCL,
...
const Pinmux_PerCfg_t gPinMux_IoExp_Dio_To_I2C_Cfg[3U] = {
...
/* PinMux configuration for I2C to convert as DIO Output */
const Pinmux_PerCfg_t gPinMux_IoExp_I2C_To_Dio_Cfg[3U] = {
...
/* PinMux configuration for I2C to convert as DIO Input */
const Pinmux_PerCfg_t gPinMux_IoExp_I2C_To_DioIn_Cfg[3U] = {
        /* I2C3 pin config */
    /* I2C3_SCL -> UART0_CTSn (A23) */
    {
        PIN_UART0_CTSN,
