...
typedef struct
{
    ...
    uint8 scll;
    /* === HS Second-Phase timing (only used when TransferMode == I2C_HIGHSPEED_MODE) === */
    /* High Speed Low Phase Over Sampling Value for Clock generation */
    uint8 hsscll;
    /* High Speed Low Phase Over Sampling Value for Clock generation */
    uint8 hssclh;
...
extern const Pinmux_PerCfg_t gPinMux_Pmic_Dio_To_I2C_Cfg[3U];
extern const Pinmux_PerCfg_t gPinMux_Pmic_I2C_To_Dio_Cfg[3U];
extern const Pinmux_PerCfg_t gPinMux_Pmic_I2C_To_DioIn_Cfg[3U];
extern const Pinmux_PerCfg_t gPinMux_IoExp_Dio_To_I2C_Cfg[3U];
extern const Pinmux_PerCfg_t gPinMux_IoExp_I2C_To_Dio_Cfg[3U];
extern const Pinmux_PerCfg_t gPinMux_IoExp_I2C_To_DioIn_Cfg[3U];
/*****************************************************************************
*                               Functions                                    *
******************************************************************************/
