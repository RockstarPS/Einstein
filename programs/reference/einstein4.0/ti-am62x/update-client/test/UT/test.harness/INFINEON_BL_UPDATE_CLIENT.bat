...
echo options TESTABLE_SOURCE_DIR C:\VCAST\Environments\ >> commands.tmp
echo environment build INFINEON_BL_UPDATE_CLIENT.env >> commands.tmp
echo /E:INFINEON_BL_UPDATE_CLIENT tools script run INFINEON_BL_UPDATE_CLIENT.tst >> commands.tmp
echo /E:INFINEON_BL_UPDATE_CLIENT execute batch >> commands.tmp
echo /E:INFINEON_BL_UPDATE_CLIENT reports custom management INFINEON_BL_UPDATE_CLIENT_management_report.html >> commands.tmp
