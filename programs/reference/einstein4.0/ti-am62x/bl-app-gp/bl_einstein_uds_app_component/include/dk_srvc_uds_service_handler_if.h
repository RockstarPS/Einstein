...
public:
    ...
    typedef enum
    {
        ...
        ESecurityLevel_L3,          ///< It defines the value of security level Three.
    ...
    typedef struct
    {
        ...
        uint32_t mSupportedSecurityMask; ///< It defines the security mask supported by the service.
