...
bool BlEinsteinUdsAppComponent::onInit()
{
...
/// End of user code
    ...
    printf("BlEinsteinUdsAppComponentInit \r\n");
...
bool BlEinsteinUdsAppComponent::onExit()
{
...
bool BlEinsteinUdsAppComponent::onStart()
{
...
bool BlEinsteinUdsAppComponent::onStop()
{
...
void BlEinsteinUdsAppComponent::worker()
{
...
void BlEinsteinUdsAppComponent::onReceiveUdsServiceReqIndication(UdsServiceReqIndication const  & msg)
{
...
void BlEinsteinUdsAppComponent::onReceiveUdsTimeout(UdsTimeout const  & msg)
{
...
void BlEinsteinUdsAppComponent::onReceiveUdsServiceResponseTransmitConfirmation(UdsServiceResponseTransmitConfirmation const  & msg)
{
...
/*
void BlEinsteinUdsAppComponent::onReceiveGipDiagResponse(GipDiagResponse const  & msg)
{
...
void BlEinsteinUdsAppComponent::periodicTask(void)
{
    /*LOGV(&gUdsBlServicesLogContext,"CUdsBlServiceManagerComp::periodicTask " );*/
    mUdsServiceManagerInstance.periodicTask();
}

void BlEinsteinUdsAppComponent::onReceiveDoIPDownloadResponse(DoIPDownloadResponse const  & msg)
{
...
void BlEinsteinUdsAppComponent::iniHandler(void)
{
    bool parserStatus;
    bool pathListStatus;
