...
//
//---------------------------------------------------------------------------------------------------------------------
#ifndef EINS_UDS_APPL_COMPONENT_H
#define EINS_UDS_APPL_COMPONENT_H
...
private:
/// Start of user code : User code for file eins_uds_appl_component.h
...
#endif //EINS_UDS_APPL_COMPONENT_H
