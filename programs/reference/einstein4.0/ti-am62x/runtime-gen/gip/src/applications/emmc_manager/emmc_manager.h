...
#include "emmc_manager_thread_ids.h"

using namespace dk::runtime;

class EmmcManager : public dk::runtime::core::Application
{
public:
    template <typename T1 = dk::runtime::core::Container *, typename... T2>
    EmmcManager(const char * const pAppName, const T1 c, T2... cList) : Application(pAppName)
    {
    ...
    //Send APIs
    void sendEmmcErrorNotifier(EmmcErrorNotifier const & msg);
};

extern EmmcManager gApp;
