...
// Date: Tue Nov 04 11:44:23 IST 2025
// User: PSIVAKU7
// System: GIP
...
extern EinsUdsApplComponent oEinsUdsApplComponent;
extern DoipComponent oDoipComponent;
extern UpdUclAdapterComponent oUpdUclAdapterComponent;
extern UpdDoipAdapterComponent oUpdDoipAdapterComponent;

bool diag_app_gp::onInit()
{
    ( void ) Application::onInit();
    LOGV(nullptr, "diag_app_gp::onInit");
    return true;
}

bool diag_app_gp::onExit()
{
    ( void ) Application::onExit();
    LOGV(nullptr, "diag_app_gp::onExit");
    return true;
}

bool diag_app_gp::onStart()
{
    ( void ) Application::onStart();
    LOGV(nullptr, "diag_app_gp::onStart");
    threads.start(TID_gApp_runDispatchQueue);
    threads.start(TID_gApp_runIpcMessagePump);
    threads.start(TID_DiagAppGpCon_runMessagePump);
    return true;
}

bool diag_app_gp::onStop()
{
    ( void ) Application::onStop();
    LOGV(nullptr, "diag_app_gp::onStop");
    threads.stop(TID_DiagAppGpCon_runMessagePump);
    threads.stop(TID_gApp_runIpcMessagePump);
    threads.stop(TID_gApp_runDispatchQueue);
    return true;
}

int32_t diag_app_gp::onRun()
{
    ( void ) Application::onRun();
    LOGV(nullptr, "diag_app_gp::onRun");
    ( void ) mWdgIf.start(1000U);
    while (getIsRunning())
    {
        oUdsCoreComponent.worker();
        oEinsUdsApplComponent.worker();
        oDoipComponent.worker();
        oUpdUclAdapterComponent.worker();
        oUpdDoipAdapterComponent.worker();
...
void diag_app_gp::sendDoipDiagDataTransferRequest(DoipDiagDataTransferRequest const & msg)
{
...
void diag_app_gp::sendUdsTimeout(UdsTimeout const & msg)
{
    static uint8_t msgCnt = 0U;
    msgCnt++;
...
void diag_app_gp::sendUdsServiceResponseTransmitConfirmation(UdsServiceResponseTransmitConfirmation const & msg)
{
    static uint8_t msgCnt = 0U;
    msgCnt++;
...
void diag_app_gp::sendUdsServiceReqIndication(UdsServiceReqIndication const & msg)
{
    static uint8_t msgCnt = 0U;
    msgCnt++;
...
void diag_app_gp::sendDoipSetParams(DoipSetParams const & msg)
{
    static uint8_t msgCnt = 0U;
    msgCnt++;

    //Local Routing. Generated if an component inside the application is expecting this message
    MsgSerializer * const pMsgSer = new MsgSerializer(DK_MSG_DOIPSETPARAMS, COMPID_OEINSUDSAPPLCOMPONENT, msgCnt);
...
void diag_app_gp::sendDoipDiagPowerModeStatus(DoipDiagPowerModeStatus const & msg)
{
    static uint8_t msgCnt = 0U;
    msgCnt++;

    //Local Routing. Generated if an component inside the application is expecting this message
    MsgSerializer * const pMsgSer = new MsgSerializer(DK_MSG_DOIPDIAGPOWERMODESTATUS, COMPID_OEINSUDSAPPLCOMPONENT, msgCnt);
...
void diag_app_gp::sendUdsServiceResponseTransmitRequest(UdsServiceResponseTransmitRequest const & msg)
{
    static uint8_t msgCnt = 0U;
    msgCnt++;

    //Local Routing. Generated if an component inside the application is expecting this message
    MsgSerializer * const pMsgSer = new MsgSerializer(DK_MSG_UDSSERVICERESPONSETRANSMITREQUEST, COMPID_OEINSUDSAPPLCOMPONENT, msgCnt);
...
void diag_app_gp::sendUdsServiceSetTimings(UdsServiceSetTimings const & msg)
{
    static uint8_t msgCnt = 0U;
    msgCnt++;

    //Local Routing. Generated if an component inside the application is expecting this message
    MsgSerializer * const pMsgSer = new MsgSerializer(DK_MSG_UDSSERVICESETTIMINGS, COMPID_OEINSUDSAPPLCOMPONENT, msgCnt);
...
void diag_app_gp::sendGipDiagRequest(GipDiagRequest const & msg)
{
    static uint8_t msgCnt = 0U;
    msgCnt++;
    ...
    std::shared_ptr<MsgSerializer> pMsgSerIpc = std::make_shared<MsgSerializer>(DK_MSG_GIPDIAGREQUEST, COMPID_OEINSUDSAPPLCOMPONENT, msgCnt);
...
void diag_app_gp::sendDoIPDownloadRequest(DoIPDownloadRequest const & msg)
{
    static uint8_t msgCnt = 0U;
    msgCnt++;

    //Local Routing. Generated if an component inside the application is expecting this message
    MsgSerializer * const pMsgSer = new MsgSerializer(DK_MSG_DOIPDOWNLOADREQUEST, COMPID_OEINSUDSAPPLCOMPONENT, msgCnt);
...
void diag_app_gp::sendDoipDiagDataIndication(DoipDiagDataIndication const & msg)
{
    static uint8_t msgCnt = 0U;
    msgCnt++;
...
void diag_app_gp::sendDoipDiagDataConfirmation(DoipDiagDataConfirmation const & msg)
{
    static uint8_t msgCnt = 0U;
    msgCnt++;
...
void diag_app_gp::sendUpdateShortServiceResp(UpdateShortServiceResp const & msg)
{
    static uint8_t msgCnt = 0U;
    msgCnt++;
    ...
    //IPC Routing. Generated if an component outside the application is expecting this message
    std::shared_ptr<MsgSerializer> pMsgSerIpc = std::make_shared<MsgSerializer>(DK_MSG_UPDATESHORTSERVICERESP, COMPID_OUPDUCLADAPTERCOMPONENT, msgCnt);
...
void diag_app_gp::sendDoIPDownloadResponse(DoIPDownloadResponse const & msg)
{
    static uint8_t msgCnt = 0U;
    msgCnt++;

    //Local Routing. Generated if an component inside the application is expecting this message
    MsgSerializer * const pMsgSer = new MsgSerializer(DK_MSG_DOIPDOWNLOADRESPONSE, COMPID_OUPDDOIPADAPTERCOMPONENT, msgCnt);
