...
//
//---------------------------------------------------------------------------------------------------------------------
#ifndef VIDEO_MGR_APP_H
#define VIDEO_MGR_APP_H

#include "dk_logger.h"
#include "dk_runtime_application.h"
#include "dk_runtime_messages.h"
#include "dk_runtime_types.h"
#include "video_mgr_app_thread_ids.h"

using namespace dk::runtime;

class VideoMgrApp : public dk::runtime::core::Application
{
public:
    template <typename T1 = dk::runtime::core::Container *, typename... T2>
    VideoMgrApp(const char * const pAppName, const T1 c, T2... cList) : Application(pAppName)
    {
...
extern VideoMgrApp gApp;
#endif //VIDEO_MGR_APP_H
