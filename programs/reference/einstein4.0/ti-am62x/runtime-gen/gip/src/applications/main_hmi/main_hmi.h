...
#include "main_hmi_thread_ids.h"

using namespace dk::runtime;

class MainHMI : public dk::runtime::core::Application
{
public:
    template <typename T1 = dk::runtime::core::Container *, typename... T2>
    MainHMI(const char * const pAppName, const T1 c, T2... cList) : Application(pAppName)
    {
