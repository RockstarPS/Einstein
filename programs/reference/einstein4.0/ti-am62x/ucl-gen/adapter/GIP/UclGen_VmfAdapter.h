...
#define HealthGetStatus_MID    ((uint16)0xE400u)
#define HealthStatusReport_MID    ((uint16)0xE500u)
...
#define PowerReportCompState_MID    ((uint16)0xC101u)
#define PowerSystemState_MID    ((uint16)0xC000u)
#define PowerSystemStateReqChange_MID    ((uint16)0xC100u)
#define PowerSystemStateReqWakeLock_MID    ((uint16)0xC102u)
...
#define PowerSystemStateReqWakeLock_BufferSize    ((uint16)5u)
#define PowerSystemStateReqWakeLock_BufferSizeWithSignalIds    ((uint16)(PowerSystemStateReqWakeLock_BufferSize + 2u))
#define PowerReportCompState_BufferSize    ((uint16)1u)
#define PowerReportCompState_BufferSizeWithSignalIds    ((uint16)(PowerReportCompState_BufferSize + 1u))
#define UclErrorNotify_BufferSize    ((uint16)4u)
#define UclErrorNotify_BufferSizeWithSignalIds    ((uint16)(UclErrorNotify_BufferSize + 1u))
#define UclLinkStatus_BufferSize    ((uint16)4u)
#define UclLinkStatus_BufferSizeWithSignalIds    ((uint16)(UclLinkStatus_BufferSize + 1u))
...
#define HealthGetStatus_BufferSize    ((uint16)1u)
#define HealthGetStatus_BufferSizeWithSignalIds    ((uint16)(HealthGetStatus_BufferSize + 1u))
#define HealthStatusReport_BufferSize    ((uint16)262u)
#define HealthStatusReport_BufferSizeWithSignalIds    ((uint16)(HealthStatusReport_BufferSize + 3u))
...
uint8 UclGen_Read_PowerSystemStateReqWakeLock(uint8 *pMsgBuff, uint16 *pBytesCopied, EUclILAdapterDataType returnType);
uint8 UclGen_Read_PowerReportCompState(uint8 *pMsgBuff, uint16 *pBytesCopied, EUclILAdapterDataType returnType);
uint8 UclGen_Read_UclErrorNotify(uint8 *pMsgBuff, uint16 *pBytesCopied, EUclILAdapterDataType returnType);
uint8 UclGen_Read_UclLinkStatus(uint8 *pMsgBuff, uint16 *pBytesCopied, EUclILAdapterDataType returnType);
...
uint8 UclGen_Read_HealthGetStatus(uint8 *pMsgBuff, uint16 *pBytesCopied, EUclILAdapterDataType returnType);
uint8 UclGen_Read_HealthStatusReport(uint8 *pMsgBuff, uint16 *pBytesCopied, EUclILAdapterDataType returnType);
...
#define UclVmfMsgQueueCount 11u
