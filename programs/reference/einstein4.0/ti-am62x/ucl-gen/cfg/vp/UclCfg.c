...
static void UclALPhyInst_0_DummyHw_IUclALHwCbk_TransmitComplete(void) {UclALPhyMailboxASR_Impl_IUclALHwCbk_TransmitComplete(&UclALPhyInst_0, (0)); }
static void UclALPhyInst_0_DummyHw_IUclALHwCbk_ReceiveComplete(void) {UclALPhyMailboxASR_Impl_IUclALHwCbk_ReceiveComplete(&UclALPhyInst_0, (0)); }
static void UclALPhyInst_0_DummyHw_IUclALHwCbk_GpioChanged(uint32 gpioNum) { UclALPhyMailboxASR_Impl_IUclALHwCbk_GpioChanged(&UclALPhyInst_0, (0), gpioNum); }
