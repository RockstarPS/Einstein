...
///---------------------------------------------------------------------------------------------------------------------
#ifdef __QNX__
extern SUclALDebugSloggerCfg UclALDebugCfg_0;
#else
...
#ifdef __QNX__
static SUclALDebugSloggerInst UclALDebugInst_0 = {
...
#ifdef __QNX__
static void UclALDebugInst_0_UclSysInst_0_IUclALDebug_Initialize(void) {UclALDebugSlogger_Impl_IUclALDebug_Initialize(&UclALDebugInst_0, (0)); }
static void UclALDebugInst_0_UclSysInst_0_IUclALDebug_Log(EUclALDebugLevel level, char8 *pTag, char8 *pMsg) { UclALDebugSlogger_Impl_IUclALDebug_Log(&UclALDebugInst_0, (0), level, pTag, pMsg); }
static void UclALDebugInst_0_UclSysInst_0_IUclALDebug_SetLevel(EUclALDebugLevel level) { UclALDebugSlogger_Impl_IUclALDebug_SetLevel(&UclALDebugInst_0, (0), level); }
static void UclALDebugInst_0_UclSysInst_0_IUclALDebug_Shutdown(void) {UclALDebugSlogger_Impl_IUclALDebug_Shutdown(&UclALDebugInst_0, (0)); }
#else
