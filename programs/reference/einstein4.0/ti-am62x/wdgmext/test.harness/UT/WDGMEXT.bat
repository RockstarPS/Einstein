...
echo environment build WDGMEXT.env >> commands.tmp
echo /E:WDGMEXT tools script run WDGMEXT.tst >> commands.tmp
echo /E:WDGMEXT execute batch >> commands.tmp
echo /E:WDGMEXT tools import_coverage WDGMEXT.cvr >> commands.tmp
echo /E:WDGMEXT reports custom management WDGMEXT_management_report.html >> commands.tmp
