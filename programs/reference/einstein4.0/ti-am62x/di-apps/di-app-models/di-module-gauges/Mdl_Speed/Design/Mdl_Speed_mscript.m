...
% ******************* Adding AutoSar Port pp_SPD_SP1_In_Statusand Interface TI_SPD_SP1_In_Status *****************

%% Add Sender/Receiver Interface to the Application SWC's
%add Sender/Receiver Interface
InterfaceType = 'SenderReceiverInterface';
InterfaceName = 'TI_SPD_SP1_In_Status_pp_SPD_SP1_In_Status' ; % This is a TI name inside the UML
% Add interface to AUTOSAR interface Package
addPackageableElement(arProps,InterfaceType,ifPkg,InterfaceName,'IsService',false);

%add a Sender Port under Atomic Component
SenderPortName = 'pp_SPD_SP1_In_Status';
add(arProps,aswcPath{1},'SenderPorts',SenderPortName,'Interface',InterfaceName);

% ******************* Complete Adding AutoSar Port pp_SPD_SP1_In_Statusand Interface TI_SPD_SP1_In_Status *****************

% ******************* Adding AutoSar attribute SP1_In_Status as element *****************

%add an inport in simulink to map with receiver port of the Application SWC
Sl_SR_PortName = 'pp_SPD_SP1_In_Status_SP1_In_Status';
blockoffsetop = 1;
...
% ******************* Adding AutoSar Port pp_SPD_Target_Statusand Interface TI_SPD_Target_Status *****************

%% Add Sender/Receiver Interface to the Application SWC's
%add Sender/Receiver Interface
InterfaceType = 'SenderReceiverInterface';
InterfaceName = 'TI_SPD_Target_Status_pp_SPD_Target_Status' ; % This is a TI name inside the UML
% Add interface to AUTOSAR interface Package
addPackageableElement(arProps,InterfaceType,ifPkg,InterfaceName,'IsService',false);

%add a Sender Port under Atomic Component
SenderPortName = 'pp_SPD_Target_Status';
add(arProps,aswcPath{1},'SenderPorts',SenderPortName,'Interface',InterfaceName);

% ******************* Complete Adding AutoSar Port pp_SPD_Target_Statusand Interface TI_SPD_Target_Status *****************

% ******************* Adding AutoSar attribute Spd_Target_Status as element *****************

%add an inport in simulink to map with receiver port of the Application SWC
Sl_SR_PortName = 'pp_SPD_Target_Status_Spd_Target_Status';
blockoffsetop = 2;
PositionArray = [(leftoffset*10) (blockoffsetop * topoffset)  (leftoffset*10+30) ((blockoffsetop * topoffset)+20)];
HandleSR = add_block('simulink/Ports & Subsystems/Out1', [model_name '/' 'output'], 'Name', Sl_SR_PortName,'Position',PositionArray);
%Set Simulink inport properties
...
% ******************* Adding AutoSar Port pp_SPD_Trim_Statusand Interface TI_SPD_Trim_Status *****************

%% Add Sender/Receiver Interface to the Application SWC's
%add Sender/Receiver Interface
InterfaceType = 'SenderReceiverInterface';
InterfaceName = 'TI_SPD_Trim_Status_pp_SPD_Trim_Status' ; % This is a TI name inside the UML
% Add interface to AUTOSAR interface Package
addPackageableElement(arProps,InterfaceType,ifPkg,InterfaceName,'IsService',false);

%add a Sender Port under Atomic Component
SenderPortName = 'pp_SPD_Trim_Status';
add(arProps,aswcPath{1},'SenderPorts',SenderPortName,'Interface',InterfaceName);

% ******************* Complete Adding AutoSar Port pp_SPD_Trim_Statusand Interface TI_SPD_Trim_Status *****************

% ******************* Adding AutoSar attribute Spd_Trim_Status as element *****************

%add an inport in simulink to map with receiver port of the Application SWC
Sl_SR_PortName = 'pp_SPD_Trim_Status_Spd_Trim_Status';
blockoffsetop = 3;
PositionArray = [(leftoffset*10) (blockoffsetop * topoffset)  (leftoffset*10+30) ((blockoffsetop * topoffset)+20)];
HandleSR = add_block('simulink/Ports & Subsystems/Out1', [model_name '/' 'output'], 'Name', Sl_SR_PortName,'Position',PositionArray);
%Set Simulink inport properties
...
% ******************* Adding AutoSar Port pp_SPD_Target2_Statusand Interface TI_SPD_Target2_Status *****************

%% Add Sender/Receiver Interface to the Application SWC's
%add Sender/Receiver Interface
InterfaceType = 'SenderReceiverInterface';
InterfaceName = 'TI_SPD_Target2_Status_pp_SPD_Target2_Status' ; % This is a TI name inside the UML
% Add interface to AUTOSAR interface Package
addPackageableElement(arProps,InterfaceType,ifPkg,InterfaceName,'IsService',false);

%add a Sender Port under Atomic Component
SenderPortName = 'pp_SPD_Target2_Status';
add(arProps,aswcPath{1},'SenderPorts',SenderPortName,'Interface',InterfaceName);

% ******************* Complete Adding AutoSar Port pp_SPD_Target2_Statusand Interface TI_SPD_Target2_Status *****************

% ******************* Adding AutoSar attribute Spd_Target2_Status as element *****************

%add an inport in simulink to map with receiver port of the Application SWC
Sl_SR_PortName = 'pp_SPD_Target2_Status_Spd_Target2_Status';
blockoffsetop = 4;
PositionArray = [(leftoffset*10) (blockoffsetop * topoffset)  (leftoffset*10+30) ((blockoffsetop * topoffset)+20)];
HandleSR = add_block('simulink/Ports & Subsystems/Out1', [model_name '/' 'output'], 'Name', Sl_SR_PortName,'Position',PositionArray);
%Set Simulink inport properties
...
% ******************* Adding AutoSar Port pp_SPD_Trim2_Statusand Interface TI_SPD_Trim2_Status *****************

%% Add Sender/Receiver Interface to the Application SWC's
%add Sender/Receiver Interface
InterfaceType = 'SenderReceiverInterface';
InterfaceName = 'TI_SPD_Trim2_Status_pp_SPD_Trim2_Status' ; % This is a TI name inside the UML
% Add interface to AUTOSAR interface Package
addPackageableElement(arProps,InterfaceType,ifPkg,InterfaceName,'IsService',false);

%add a Sender Port under Atomic Component
SenderPortName = 'pp_SPD_Trim2_Status';
add(arProps,aswcPath{1},'SenderPorts',SenderPortName,'Interface',InterfaceName);

% ******************* Complete Adding AutoSar Port pp_SPD_Trim2_Statusand Interface TI_SPD_Trim2_Status *****************

% ******************* Adding AutoSar attribute Spd_Trim2_Status as element *****************

%add an inport in simulink to map with receiver port of the Application SWC
Sl_SR_PortName = 'pp_SPD_Trim2_Status_Spd_Trim2_Status';
blockoffsetop = 5;
PositionArray = [(leftoffset*10) (blockoffsetop * topoffset)  (leftoffset*10+30) ((blockoffsetop * topoffset)+20)];
HandleSR = add_block('simulink/Ports & Subsystems/Out1', [model_name '/' 'output'], 'Name', Sl_SR_PortName,'Position',PositionArray);
%Set Simulink inport properties
...
% ******************* Adding AutoSar Port pp_SPD_Selection_Tableand Interface TI_SPD_Selection_Table *****************

%% Add Sender/Receiver Interface to the Application SWC's
%add Sender/Receiver Interface
InterfaceType = 'SenderReceiverInterface';
InterfaceName = 'TI_SPD_Selection_Table_pp_SPD_Selection_Table' ; % This is a TI name inside the UML
% Add interface to AUTOSAR interface Package
addPackageableElement(arProps,InterfaceType,ifPkg,InterfaceName,'IsService',false);

%add a Sender Port under Atomic Component
SenderPortName = 'pp_SPD_Selection_Table';
add(arProps,aswcPath{1},'SenderPorts',SenderPortName,'Interface',InterfaceName);

% ******************* Complete Adding AutoSar Port pp_SPD_Selection_Tableand Interface TI_SPD_Selection_Table *****************

% ******************* Adding AutoSar attribute Speed_Selection_Table as element *****************

%add an inport in simulink to map with receiver port of the Application SWC
Sl_SR_PortName = 'pp_SPD_Selection_Table_Speed_Selection_Table';
blockoffsetop = 6;
PositionArray = [(leftoffset*10) (blockoffsetop * topoffset)  (leftoffset*10+30) ((blockoffsetop * topoffset)+20)];
HandleSR = add_block('simulink/Ports & Subsystems/Out1', [model_name '/' 'output'], 'Name', Sl_SR_PortName,'Position',PositionArray);
%Set Simulink inport properties
...
%%********** Adding TI TI_CS_LinearInterpolation***** Adding CS Port  rp_CS_LinerInterpolation**********

InterfaceType = 'ClientServerInterface'; 
InterfaceName = 'TI_CS_LinearInterpolation';
addPackageableElement(arProps,InterfaceType,ifPkg,InterfaceName,'IsService',false);
ClientPortName = 'rp_CS_LinerInterpolation';
add(arProps,aswcPath{1},'ClientPorts',ClientPortName,'Interface',InterfaceName);
%%********** Finish Adding TI TI_CS_LinearInterpolation***** Finish Adding CS Port  rp_CS_LinerInterpolation**********

%%***** ADDING CS VARIABLE HOLDING TI Get_LinearInterpolateWord*****
Sl_CS_Operation = 'Get_LinearInterpolateWord';
%%***** COMPLETE ADDING TI VARIABLE 

%%***** ADDING OPERATION Get_LinearInterpolateWord*****
ArgumentIn0 = 'lookupvalue' ;

ArgumentOut0 = 'ptr_table' ;
ArgumentOut1 = 'Ptr_Lin_Return' ;

Operation_prototype = '[ptr_table,Ptr_Lin_Return ] = Get_LinearInterpolateWord( lookupvalue)'; 
blockoffset = 93;
PositionArray = [leftoffset (blockoffset * topoffset)  (leftoffset+200) ((blockoffset * topoffset)+100)];
fnCaller = add_block('simulink/User-Defined Functions/Function Caller', [CodeGenblockpath '/' 'caller'], 'Name', Sl_CS_Operation,'Position',PositionArray);
set_param(fnCaller, 'FunctionPrototype', Operation_prototype);
set_param(fnCaller, 'InputArgumentSpecifications', ' uint16(1)');
set_param(fnCaller, 'OutputArgumentSpecifications', ' uint16(1) ,uint16(1)');
set_param(fnCaller,'BackgroundColor', 'lightBlue');
add(arProps,[ifPkg '/' InterfaceName], 'Operations', Sl_CS_Operation);
...
%autosar.api.syncModel(model_name);
%mapFunctionCaller(slMap,Sl_CS_Operation,ClientPortName,Sl_CS_Operation);
%%***** COMPLETED ADDING OPERATION Get_LinearInterpolateWord******

%%***** ADDING CS VARIABLE HOLDING TI Get_LinearInterpolateByte*****
Sl_CS_Operation = 'Get_LinearInterpolateByte';
%%***** COMPLETE ADDING TI VARIABLE 

%%***** ADDING OPERATION Get_LinearInterpolateByte*****
ArgumentIn0 = 'lookupvalue' ;

ArgumentOut0 = 'ptr_table' ;
ArgumentOut1 = 'Ptr_Lin_Return' ;

Operation_prototype = '[ptr_table,Ptr_Lin_Return ] = Get_LinearInterpolateByte( lookupvalue)'; 
blockoffset = 94;
PositionArray = [leftoffset (blockoffset * topoffset)  (leftoffset+200) ((blockoffset * topoffset)+100)];
fnCaller = add_block('simulink/User-Defined Functions/Function Caller', [CodeGenblockpath '/' 'caller'], 'Name', Sl_CS_Operation,'Position',PositionArray);
set_param(fnCaller, 'FunctionPrototype', Operation_prototype);
...
%autosar.api.syncModel(model_name);
%mapFunctionCaller(slMap,Sl_CS_Operation,ClientPortName,Sl_CS_Operation);
%%***** COMPLETED ADDING OPERATION Get_LinearInterpolateByte******

%%***** ADDING CS VARIABLE HOLDING TI Get_LinearInterpolateSByte*****
Sl_CS_Operation = 'Get_LinearInterpolateSByte';
%%***** COMPLETE ADDING TI VARIABLE 

%%***** ADDING OPERATION Get_LinearInterpolateSByte*****
ArgumentIn0 = 'lookupvalue' ;

ArgumentOut0 = 'ptr_table' ;
ArgumentOut1 = 'Ptr_Lin_Return' ;

Operation_prototype = '[ptr_table,Ptr_Lin_Return ] = Get_LinearInterpolateSByte( lookupvalue)'; 
blockoffset = 95;
PositionArray = [leftoffset (blockoffset * topoffset)  (leftoffset+200) ((blockoffset * topoffset)+100)];
fnCaller = add_block('simulink/User-Defined Functions/Function Caller', [CodeGenblockpath '/' 'caller'], 'Name', Sl_CS_Operation,'Position',PositionArray);
set_param(fnCaller, 'FunctionPrototype', Operation_prototype);
set_param(fnCaller, 'InputArgumentSpecifications', ' int8(1)');
set_param(fnCaller, 'OutputArgumentSpecifications', ' int8(1) ,int8(1)');
set_param(fnCaller,'BackgroundColor', 'lightBlue');
add(arProps,[ifPkg '/' InterfaceName], 'Operations', Sl_CS_Operation);
...
%autosar.api.syncModel(model_name);
%mapFunctionCaller(slMap,Sl_CS_Operation,ClientPortName,Sl_CS_Operation);
%%***** COMPLETED ADDING OPERATION Get_LinearInterpolateSByte******

%%***** ADDING CS VARIABLE HOLDING TI Get_LinearInterpolateSWord*****
Sl_CS_Operation = 'Get_LinearInterpolateSWord';
%%***** COMPLETE ADDING TI VARIABLE 

%%***** ADDING OPERATION Get_LinearInterpolateSWord*****
ArgumentIn0 = 'lookupvalue' ;

ArgumentOut0 = 'ptr_table' ;
ArgumentOut1 = 'Ptr_Lin_Return' ;

Operation_prototype = '[ptr_table,Ptr_Lin_Return ] = Get_LinearInterpolateSWord( lookupvalue)'; 
blockoffset = 96;
PositionArray = [leftoffset (blockoffset * topoffset)  (leftoffset+200) ((blockoffset * topoffset)+100)];
fnCaller = add_block('simulink/User-Defined Functions/Function Caller', [CodeGenblockpath '/' 'caller'], 'Name', Sl_CS_Operation,'Position',PositionArray);
set_param(fnCaller, 'FunctionPrototype', Operation_prototype);
set_param(fnCaller, 'InputArgumentSpecifications', ' int16(1)');
set_param(fnCaller, 'OutputArgumentSpecifications', ' int16(1) ,int16(1)');
set_param(fnCaller,'BackgroundColor', 'lightBlue');
add(arProps,[ifPkg '/' InterfaceName], 'Operations', Sl_CS_Operation);
...
%autosar.api.syncModel(model_name);
%mapFunctionCaller(slMap,Sl_CS_Operation,ClientPortName,Sl_CS_Operation);
%%***** COMPLETED ADDING OPERATION Get_LinearInterpolateSWord******

%%********** Adding TI TI_IOHWAB_GetAdc***** Adding CS Port  rpIoHwAb_ADC**********

InterfaceType = 'ClientServerInterface'; 
InterfaceName = 'TI_IOHWAB_GetAdc';
addPackageableElement(arProps,InterfaceType,ifPkg,InterfaceName,'IsService',false);
ClientPortName = 'rpIoHwAb_ADC';
add(arProps,aswcPath{1},'ClientPorts',ClientPortName,'Interface',InterfaceName);
%%********** Finish Adding TI TI_IOHWAB_GetAdc***** Finish Adding CS Port  rpIoHwAb_ADC**********
...
%%***** ADDING CS VARIABLE HOLDING TI Mdl_Speed_Init*****
Sl_CS_Operation = 'Mdl_Speed_Init';
%%***** COMPLETE ADDING TI VARIABLE 

%%***** ADDING OPERATION Mdl_Speed_Init*****


Operation_prototype = 'Mdl_Speed_Init( )'; 
