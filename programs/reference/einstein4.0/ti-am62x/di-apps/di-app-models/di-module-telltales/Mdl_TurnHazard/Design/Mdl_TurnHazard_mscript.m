...
RunnableName = ['Mdl_TurnHazard_Task']; 
...
if ~verLessThan('matlab', '9.13')
set_param(model_name,'SetExecutionDomain', 'on');
set_param(model_name,'ExecutionDomainType','Export');
end
...
% ******************* Adding AutoSar Port rpCS_ChimeRequestand Interface TIChimeRequest_dummy *****************

%% Add Sender/Receiver Interface to the Application SWC's
%add Sender/Receiver Interface
InterfaceType = 'SenderReceiverInterface';
InterfaceName = 'TIChimeRequest_dummy_rpCS_ChimeRequest' ; % This is a TI name inside the UML
% Add interface to AUTOSAR interface Package
addPackageableElement(arProps,InterfaceType,ifPkg,InterfaceName,'IsService',false);

%add a Receiver Port under Atomic Component
receiverPortName = 'rpCS_ChimeRequest';
add(arProps,aswcPath{1},'ReceiverPorts',receiverPortName,'Interface',InterfaceName);

% ******************* Complete Adding AutoSar Port rpCS_ChimeRequestand Interface TIChimeRequest_dummy *****************

% ******************* Adding AutoSar attribute Chime_Request as element *****************

%add an inport in simulink to map with receiver port of the Application SWC
Sl_SR_PortName = 'rpCS_ChimeRequest_Chime_Request';
blockoffset = 10;
PositionArray = [leftoffset (blockoffset * topoffset)  (leftoffset+30) ((blockoffset * topoffset)+20)];
HandleSR = add_block('simulink/Ports & Subsystems/In1', [model_name '/' 'input'], 'Name', Sl_SR_PortName, 'Position',PositionArray);
%Set Simulink inport properties
set_param(HandleSR,'PortDimensions','1');
set_param(HandleSR,'OutDataTypeStr', 'EChimeID');
set_param(HandleSR,'BackgroundColor', 'lightBlue');
HandleSR = add_block('simulink/Ports & Subsystems/In1', [Apprunnablepath '/' 'input'], 'Name', Sl_SR_PortName, 'Position',PositionArray);
set_param(HandleSR,'PortDimensions','1');
set_param(HandleSR,'OutDataTypeStr', 'EChimeID');
...
set_param(HandleSR,'BackgroundColor', 'lightBlue');
% Add the element 
element1 = 'Chime_Request';
% Link the element and the AutoSar Interface. 
add(arProps,[ifPkg '/' InterfaceName], 'DataElements', element1,'SwCalibrationAccess',swCalibValue);   
% Map Simulink inport to Receive port of the Atomic Component
mapInport(slMap,Sl_SR_PortName,receiverPortName,element1,'ExplicitReceive');

% ******************* Complete Adding AutoSar attribute Chime_Request as element *****************

% ******************* Adding AutoSar Port rpCS_ChimeVolumeand Interface if_CS_SndCtrlVolumeRequest_dummy *****************

%% Add Sender/Receiver Interface to the Application SWC's
%add Sender/Receiver Interface
InterfaceType = 'SenderReceiverInterface';
InterfaceName = 'if_CS_SndCtrlVolumeRequest_dummy_rpCS_ChimeVolume' ; % This is a TI name inside the UML
% Add interface to AUTOSAR interface Package
addPackageableElement(arProps,InterfaceType,ifPkg,InterfaceName,'IsService',false);

%add a Receiver Port under Atomic Component
receiverPortName = 'rpCS_ChimeVolume';
add(arProps,aswcPath{1},'ReceiverPorts',receiverPortName,'Interface',InterfaceName);

% ******************* Complete Adding AutoSar Port rpCS_ChimeVolumeand Interface if_CS_SndCtrlVolumeRequest_dummy *****************

% ******************* Adding AutoSar attribute UpdateChimeVolume as element *****************

%add an inport in simulink to map with receiver port of the Application SWC
Sl_SR_PortName = 'rpCS_ChimeVolume_UpdateChimeVolume';
blockoffset = 11;
PositionArray = [leftoffset (blockoffset * topoffset)  (leftoffset+30) ((blockoffset * topoffset)+20)];
HandleSR = add_block('simulink/Ports & Subsystems/In1', [model_name '/' 'input'], 'Name', Sl_SR_PortName, 'Position',PositionArray);
%Set Simulink inport properties
...
set_param(HandleSR,'BackgroundColor', 'lightBlue');
% Add the element 
element1 = 'UpdateChimeVolume';
% Link the element and the AutoSar Interface. 
add(arProps,[ifPkg '/' InterfaceName], 'DataElements', element1,'SwCalibrationAccess',swCalibValue);   
% Map Simulink inport to Receive port of the Atomic Component
mapInport(slMap,Sl_SR_PortName,receiverPortName,element1,'ExplicitReceive');

% ******************* Complete Adding AutoSar attribute UpdateChimeVolume as element *****************

% ******************* Adding AutoSar Port rpCS_NvmFlashCustBzrand Interface TI_CS_NVM_Adapter_GetNVM_FlashCustBuzzerSPL_Dummy *****************

%% Add Sender/Receiver Interface to the Application SWC's
%add Sender/Receiver Interface
InterfaceType = 'SenderReceiverInterface';
InterfaceName = 'TI_CS_NVM_Adapter_GetNVM_FlashCustBuzzerSPL_Dummy_rpCS_NvmFlashCustBzr' ; % This is a TI name inside the UML
% Add interface to AUTOSAR interface Package
addPackageableElement(arProps,InterfaceType,ifPkg,InterfaceName,'IsService',false);

%add a Receiver Port under Atomic Component
receiverPortName = 'rpCS_NvmFlashCustBzr';
add(arProps,aswcPath{1},'ReceiverPorts',receiverPortName,'Interface',InterfaceName);

% ******************* Complete Adding AutoSar Port rpCS_NvmFlashCustBzrand Interface TI_CS_NVM_Adapter_GetNVM_FlashCustBuzzerSPL_Dummy *****************

% ******************* Adding AutoSar attribute Nvmdata as element *****************

%add an inport in simulink to map with receiver port of the Application SWC
Sl_SR_PortName = 'rpCS_NvmFlashCustBzr_Nvmdata';
blockoffset = 12;
PositionArray = [leftoffset (blockoffset * topoffset)  (leftoffset+30) ((blockoffset * topoffset)+20)];
HandleSR = add_block('simulink/Ports & Subsystems/In1', [model_name '/' 'input'], 'Name', Sl_SR_PortName, 'Position',PositionArray);
%Set Simulink inport properties
...
% ******************* Complete Adding AutoSar attribute Nvmdata as element *****************

% ******************* Adding AutoSar Port pp_TurnHazard_LeftInd_Stsand Interface TIUpdateTelltaleStatus *****************

%% Add Sender/Receiver Interface to the Application SWC's
%add Sender/Receiver Interface
InterfaceType = 'SenderReceiverInterface';
InterfaceName = 'TIUpdateTelltaleStatus_pp_TurnHazard_LeftInd_Sts' ; % This is a TI name inside the UML
% Add interface to AUTOSAR interface Package
addPackageableElement(arProps,InterfaceType,ifPkg,InterfaceName,'IsService',false);

%add a Sender Port under Atomic Component
SenderPortName = 'pp_TurnHazard_LeftInd_Sts';
add(arProps,aswcPath{1},'SenderPorts',SenderPortName,'Interface',InterfaceName);

% ******************* Complete Adding AutoSar Port pp_TurnHazard_LeftInd_Stsand Interface TIUpdateTelltaleStatus *****************

% ******************* Adding AutoSar attribute CurrentTelltaleStatus as element *****************

%add an inport in simulink to map with receiver port of the Application SWC
Sl_SR_PortName = 'pp_TurnHazard_LeftInd_Sts_CurrentTelltaleStatus';
blockoffsetop = 1;
...
% ******************* Adding AutoSar Port pp_TurnHazard_TurnL_Stsand Interface TI_SR_TurnHazard_TurnL_Status *****************

%% Add Sender/Receiver Interface to the Application SWC's
%add Sender/Receiver Interface
InterfaceType = 'SenderReceiverInterface';
InterfaceName = 'TI_SR_TurnHazard_TurnL_Status_pp_TurnHazard_TurnL_Sts' ; % This is a TI name inside the UML
% Add interface to AUTOSAR interface Package
addPackageableElement(arProps,InterfaceType,ifPkg,InterfaceName,'IsService',false);

%add a Sender Port under Atomic Component
SenderPortName = 'pp_TurnHazard_TurnL_Sts';
add(arProps,aswcPath{1},'SenderPorts',SenderPortName,'Interface',InterfaceName);

% ******************* Complete Adding AutoSar Port pp_TurnHazard_TurnL_Stsand Interface TI_SR_TurnHazard_TurnL_Status *****************

% ******************* Adding AutoSar attribute LeftIndicatorSts as element *****************

%add an inport in simulink to map with receiver port of the Application SWC
Sl_SR_PortName = 'pp_TurnHazard_TurnL_Sts_LeftIndicatorSts';
blockoffsetop = 2;
PositionArray = [(leftoffset*10) (blockoffsetop * topoffset)  (leftoffset*10+30) ((blockoffsetop * topoffset)+20)];
HandleSR = add_block('simulink/Ports & Subsystems/Out1', [model_name '/' 'output'], 'Name', Sl_SR_PortName,'Position',PositionArray);
%Set Simulink inport properties
set_param(HandleSR,'PortDimensions','-1');
set_param(HandleSR,'OutDataTypeStr', 'TurnStates');
set_param(HandleSR,'BackgroundColor', 'lightBlue');
HandleSR = add_block('simulink/Ports & Subsystems/In1', [VariantOutputblockpath '/' 'input'], 'Name', [Sl_SR_PortName '_in'],'Position',PositionArray);
set_param(HandleSR,'PortDimensions','1');
set_param(HandleSR,'OutDataTypeStr', 'TurnStates');
...
set_param(HandleSR,'BackgroundColor', 'lightBlue');
% Add the element 
element1 = 'LeftIndicatorSts';
% Link the element and the AutoSar Interface. 
add(arProps,[ifPkg '/' InterfaceName], 'DataElements', element1,'SwCalibrationAccess',swCalibValue);   
% Map Simulink OutPort to Sender port of the Atomic Component
mapOutport(slMap,Sl_SR_PortName,SenderPortName,element1,'ExplicitSend');

% ******************* Complete Adding AutoSar attribute LeftIndicatorSts as element *****************

% ******************* Adding AutoSar Port pp_TurnHazard_TurnR_Stsand Interface TI_SR_TurnHazard_TurnR_Status *****************

%% Add Sender/Receiver Interface to the Application SWC's
%add Sender/Receiver Interface
InterfaceType = 'SenderReceiverInterface';
InterfaceName = 'TI_SR_TurnHazard_TurnR_Status_pp_TurnHazard_TurnR_Sts' ; % This is a TI name inside the UML
% Add interface to AUTOSAR interface Package
addPackageableElement(arProps,InterfaceType,ifPkg,InterfaceName,'IsService',false);

%add a Sender Port under Atomic Component
SenderPortName = 'pp_TurnHazard_TurnR_Sts';
add(arProps,aswcPath{1},'SenderPorts',SenderPortName,'Interface',InterfaceName);

% ******************* Complete Adding AutoSar Port pp_TurnHazard_TurnR_Stsand Interface TI_SR_TurnHazard_TurnR_Status *****************

% ******************* Adding AutoSar attribute RightIndicatorSts as element *****************

%add an inport in simulink to map with receiver port of the Application SWC
Sl_SR_PortName = 'pp_TurnHazard_TurnR_Sts_RightIndicatorSts';
blockoffsetop = 3;
PositionArray = [(leftoffset*10) (blockoffsetop * topoffset)  (leftoffset*10+30) ((blockoffsetop * topoffset)+20)];
HandleSR = add_block('simulink/Ports & Subsystems/Out1', [model_name '/' 'output'], 'Name', Sl_SR_PortName,'Position',PositionArray);
%Set Simulink inport properties
...
set_param(HandleSR,'BackgroundColor', 'lightBlue');
% Add the element 
element1 = 'RightIndicatorSts';
% Link the element and the AutoSar Interface. 
add(arProps,[ifPkg '/' InterfaceName], 'DataElements', element1,'SwCalibrationAccess',swCalibValue);   
% Map Simulink OutPort to Sender port of the Atomic Component
mapOutport(slMap,Sl_SR_PortName,SenderPortName,element1,'ExplicitSend');

% ******************* Complete Adding AutoSar attribute RightIndicatorSts as element *****************

% ******************* Adding AutoSar Port pp_TurnHazard_RightInd_Stsand Interface TIUpdateTelltaleStatus *****************

%% Add Sender/Receiver Interface to the Application SWC's
%add Sender/Receiver Interface
InterfaceType = 'SenderReceiverInterface';
InterfaceName = 'TIUpdateTelltaleStatus_pp_TurnHazard_RightInd_Sts' ; % This is a TI name inside the UML
% Add interface to AUTOSAR interface Package
addPackageableElement(arProps,InterfaceType,ifPkg,InterfaceName,'IsService',false);

%add a Sender Port under Atomic Component
SenderPortName = 'pp_TurnHazard_RightInd_Sts';
add(arProps,aswcPath{1},'SenderPorts',SenderPortName,'Interface',InterfaceName);

% ******************* Complete Adding AutoSar Port pp_TurnHazard_RightInd_Stsand Interface TIUpdateTelltaleStatus *****************

% ******************* Adding AutoSar attribute CurrentTelltaleStatus as element *****************

%add an inport in simulink to map with receiver port of the Application SWC
Sl_SR_PortName = 'pp_TurnHazard_RightInd_Sts_CurrentTelltaleStatus';
blockoffsetop = 4;
PositionArray = [(leftoffset*10) (blockoffsetop * topoffset)  (leftoffset*10+30) ((blockoffsetop * topoffset)+20)];
HandleSR = add_block('simulink/Ports & Subsystems/Out1', [model_name '/' 'output'], 'Name', Sl_SR_PortName,'Position',PositionArray);
%Set Simulink inport properties
...
%%********** Adding TI TI_IOHWAB_GetDIn***** Adding CS Port  rpCS_IoHwAbInp**********

InterfaceType = 'ClientServerInterface'; 
InterfaceName = 'TI_IOHWAB_GetDIn';
addPackageableElement(arProps,InterfaceType,ifPkg,InterfaceName,'IsService',false);
ClientPortName = 'rpCS_IoHwAbInp';
add(arProps,aswcPath{1},'ClientPorts',ClientPortName,'Interface',InterfaceName);
%%********** Finish Adding TI TI_IOHWAB_GetDIn***** Finish Adding CS Port  rpCS_IoHwAbInp**********
...
%%***** ADDING CS VARIABLE HOLDING TI Mdl_TurnHazard_Init*****
Sl_CS_Operation = 'Mdl_TurnHazard_Init';
%%***** COMPLETE ADDING TI VARIABLE 

%%***** ADDING OPERATION Mdl_TurnHazard_Init*****


Operation_prototype = 'Mdl_TurnHazard_Init( )'; 
