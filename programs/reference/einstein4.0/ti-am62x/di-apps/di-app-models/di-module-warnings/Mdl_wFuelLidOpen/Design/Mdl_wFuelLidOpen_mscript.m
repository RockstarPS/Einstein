...
RunnableName = ['Mdl_wFuelLidOpen_Task']; 
...
%%********** Adding TI TI_Ctrl_Warning_UpdateWarningStatus***** Adding CS Port  rpUpdateFuelLidOpenWarning**********

InterfaceType = 'ClientServerInterface'; 
InterfaceName = 'TI_Ctrl_Warning_UpdateWarningStatus';
addPackageableElement(arProps,InterfaceType,ifPkg,InterfaceName,'IsService',false);
ClientPortName = 'rpUpdateFuelLidOpenWarning';
add(arProps,aswcPath{1},'ClientPorts',ClientPortName,'Interface',InterfaceName);
%%********** Finish Adding TI TI_Ctrl_Warning_UpdateWarningStatus***** Finish Adding CS Port  rpUpdateFuelLidOpenWarning**********
...
%%********** Adding TI if_CS_ComAbsRx***** Adding CS Port  rp_CS_RxCanAdapterMdl**********

InterfaceType = 'ClientServerInterface'; 
InterfaceName = 'if_CS_ComAbsRx';
addPackageableElement(arProps,InterfaceType,ifPkg,InterfaceName,'IsService',false);
ClientPortName = 'rp_CS_RxCanAdapterMdl';
add(arProps,aswcPath{1},'ClientPorts',ClientPortName,'Interface',InterfaceName);
%%********** Finish Adding TI if_CS_ComAbsRx***** Finish Adding CS Port  rp_CS_RxCanAdapterMdl**********
...
%%***** ADDING CS VARIABLE HOLDING TI Mdl_wFuelLidOpen_Init*****
Sl_CS_Operation = 'Mdl_wFuelLidOpen_Init';
%%***** COMPLETE ADDING TI VARIABLE 

%%***** ADDING OPERATION Mdl_wFuelLidOpen_Init*****


Operation_prototype = 'Mdl_wFuelLidOpen_Init( )'; 
