...
% ******************* Adding AutoSar Port rp_TT_PRND_blinkand Interface TIIndicatorStatusUpdt *****************

%% Add Sender/Receiver Interface to the Application SWC's
%add Sender/Receiver Interface
InterfaceType = 'SenderReceiverInterface';
InterfaceName = 'TIIndicatorStatusUpdt_rp_TT_PRND_blink' ; % This is a TI name inside the UML
% Add interface to AUTOSAR interface Package
addPackageableElement(arProps,InterfaceType,ifPkg,InterfaceName,'IsService',false);

%add a Receiver Port under Atomic Component
receiverPortName = 'rp_TT_PRND_blink';
add(arProps,aswcPath{1},'ReceiverPorts',receiverPortName,'Interface',InterfaceName);

% ******************* Complete Adding AutoSar Port rp_TT_PRND_blinkand Interface TIIndicatorStatusUpdt *****************

% ******************* Adding AutoSar attribute TIUpdateIndicatorStatus as element *****************

%add an inport in simulink to map with receiver port of the Application SWC
Sl_SR_PortName = 'rp_TT_PRND_blink_TIUpdateIndicatorStatus';
blockoffset = 11;
PositionArray = [leftoffset (blockoffset * topoffset)  (leftoffset+30) ((blockoffset * topoffset)+20)];
HandleSR = add_block('simulink/Ports & Subsystems/In1', [model_name '/' 'input'], 'Name', Sl_SR_PortName, 'Position',PositionArray);
%Set Simulink inport properties
...
set_param(HandleSR,'BackgroundColor', 'lightBlue');
% Add the element 
element1 = 'TIUpdateIndicatorStatus';
% Link the element and the AutoSar Interface. 
add(arProps,[ifPkg '/' InterfaceName], 'DataElements', element1,'SwCalibrationAccess',swCalibValue);   
% Map Simulink inport to Receive port of the Atomic Component
mapInport(slMap,Sl_SR_PortName,receiverPortName,element1,'ExplicitReceive');

% ******************* Complete Adding AutoSar attribute TIUpdateIndicatorStatus as element *****************
...
% ******************* Adding AutoSar Port rp_PowerTrainStateand Interface TI_MVC_PowerTrain_State_Dummy *****************

%% Add Sender/Receiver Interface to the Application SWC's
%add Sender/Receiver Interface
InterfaceType = 'SenderReceiverInterface';
InterfaceName = 'TI_MVC_PowerTrain_State_Dummy_rp_PowerTrainState' ; % This is a TI name inside the UML
% Add interface to AUTOSAR interface Package
addPackageableElement(arProps,InterfaceType,ifPkg,InterfaceName,'IsService',false);

%add a Receiver Port under Atomic Component
receiverPortName = 'rp_PowerTrainState';
add(arProps,aswcPath{1},'ReceiverPorts',receiverPortName,'Interface',InterfaceName);

% ******************* Complete Adding AutoSar Port rp_PowerTrainStateand Interface TI_MVC_PowerTrain_State_Dummy *****************

% ******************* Adding AutoSar attribute PowerTrain_Flag as element *****************

%add an inport in simulink to map with receiver port of the Application SWC
Sl_SR_PortName = 'rp_PowerTrainState_PowerTrain_Flag';
blockoffset = 13;
PositionArray = [leftoffset (blockoffset * topoffset)  (leftoffset+30) ((blockoffset * topoffset)+20)];
HandleSR = add_block('simulink/Ports & Subsystems/In1', [model_name '/' 'input'], 'Name', Sl_SR_PortName, 'Position',PositionArray);
%Set Simulink inport properties
...
% ******************* Adding AutoSar Port rp_HMI_Ready_Statusand Interface TI_SR_HMIReadyStatus *****************

%% Add Sender/Receiver Interface to the Application SWC's
%add Sender/Receiver Interface
InterfaceType = 'SenderReceiverInterface';
InterfaceName = 'TI_SR_HMIReadyStatus_rp_HMI_Ready_Status' ; % This is a TI name inside the UML
% Add interface to AUTOSAR interface Package
addPackageableElement(arProps,InterfaceType,ifPkg,InterfaceName,'IsService',false);

%add a Receiver Port under Atomic Component
receiverPortName = 'rp_HMI_Ready_Status';
add(arProps,aswcPath{1},'ReceiverPorts',receiverPortName,'Interface',InterfaceName);

% ******************* Complete Adding AutoSar Port rp_HMI_Ready_Statusand Interface TI_SR_HMIReadyStatus *****************

% ******************* Adding AutoSar attribute HMI_ReadyStatus as element *****************

%add an inport in simulink to map with receiver port of the Application SWC
Sl_SR_PortName = 'rp_HMI_Ready_Status_HMI_ReadyStatus';
blockoffset = 14;
PositionArray = [leftoffset (blockoffset * topoffset)  (leftoffset+30) ((blockoffset * topoffset)+20)];
HandleSR = add_block('simulink/Ports & Subsystems/In1', [model_name '/' 'input'], 'Name', Sl_SR_PortName, 'Position',PositionArray);
%Set Simulink inport properties
set_param(HandleSR,'PortDimensions','1');
set_param(HandleSR,'OutDataTypeStr', 'HMIReadySts_Type');
set_param(HandleSR,'BackgroundColor', 'lightBlue');
HandleSR = add_block('simulink/Ports & Subsystems/In1', [Apprunnablepath '/' 'input'], 'Name', Sl_SR_PortName, 'Position',PositionArray);
set_param(HandleSR,'PortDimensions','1');
set_param(HandleSR,'OutDataTypeStr', 'HMIReadySts_Type');
...
set_param(HandleSR,'BackgroundColor', 'lightBlue');
% Add the element 
element1 = 'HMI_ReadyStatus';
% Link the element and the AutoSar Interface. 
add(arProps,[ifPkg '/' InterfaceName], 'DataElements', element1,'SwCalibrationAccess',swCalibValue);   
% Map Simulink inport to Receive port of the Atomic Component
mapInport(slMap,Sl_SR_PortName,receiverPortName,element1,'ExplicitReceive');

% ******************* Complete Adding AutoSar attribute HMI_ReadyStatus as element *****************

% ******************* Adding AutoSar Port pp_Shift_Positionand Interface TI_ShiftPosition *****************

%% Add Sender/Receiver Interface to the Application SWC's
%add Sender/Receiver Interface
InterfaceType = 'SenderReceiverInterface';
InterfaceName = 'TI_ShiftPosition_pp_Shift_Position' ; % This is a TI name inside the UML
% Add interface to AUTOSAR interface Package
addPackageableElement(arProps,InterfaceType,ifPkg,InterfaceName,'IsService',false);

%add a Sender Port under Atomic Component
SenderPortName = 'pp_Shift_Position';
add(arProps,aswcPath{1},'SenderPorts',SenderPortName,'Interface',InterfaceName);

% ******************* Complete Adding AutoSar Port pp_Shift_Positionand Interface TI_ShiftPosition *****************

% ******************* Adding AutoSar attribute ShiftPosition as element *****************

%add an inport in simulink to map with receiver port of the Application SWC
Sl_SR_PortName = 'pp_Shift_Position_ShiftPosition';
blockoffsetop = 1;
...
%Set Simulink inport properties
set_param(HandleSR,'PortDimensions','-1');
set_param(HandleSR,'OutDataTypeStr', 'ShiftPosition');
set_param(HandleSR,'BackgroundColor', 'lightBlue');
...
% ******************* Complete Adding AutoSar attribute ShiftPosition as element *****************

% ******************* Adding AutoSar Port pp_Shift_ModeIndand Interface TI_ShiftIndicator *****************

%% Add Sender/Receiver Interface to the Application SWC's
%add Sender/Receiver Interface
InterfaceType = 'SenderReceiverInterface';
InterfaceName = 'TI_ShiftIndicator_pp_Shift_ModeInd' ; % This is a TI name inside the UML
% Add interface to AUTOSAR interface Package
addPackageableElement(arProps,InterfaceType,ifPkg,InterfaceName,'IsService',false);

%add a Sender Port under Atomic Component
SenderPortName = 'pp_Shift_ModeInd';
add(arProps,aswcPath{1},'SenderPorts',SenderPortName,'Interface',InterfaceName);

% ******************* Complete Adding AutoSar Port pp_Shift_ModeIndand Interface TI_ShiftIndicator *****************

% ******************* Adding AutoSar attribute ShiftModeIndicator as element *****************

%add an inport in simulink to map with receiver port of the Application SWC
Sl_SR_PortName = 'pp_Shift_ModeInd_ShiftModeIndicator';
blockoffsetop = 2;
PositionArray = [(leftoffset*10) (blockoffsetop * topoffset)  (leftoffset*10+30) ((blockoffsetop * topoffset)+20)];
HandleSR = add_block('simulink/Ports & Subsystems/Out1', [model_name '/' 'output'], 'Name', Sl_SR_PortName,'Position',PositionArray);
%Set Simulink inport properties
set_param(HandleSR,'PortDimensions','-1');
set_param(HandleSR,'OutDataTypeStr', 'ShiftPositionInd');
set_param(HandleSR,'BackgroundColor', 'lightBlue');
HandleSR = add_block('simulink/Ports & Subsystems/In1', [VariantOutputblockpath '/' 'input'], 'Name', [Sl_SR_PortName '_in'],'Position',PositionArray);
set_param(HandleSR,'PortDimensions','1');
set_param(HandleSR,'OutDataTypeStr', 'ShiftPositionInd');
...
set_param(HandleSR,'BackgroundColor', 'lightBlue');
% Add the element 
element1 = 'ShiftModeIndicator';
% Link the element and the AutoSar Interface. 
add(arProps,[ifPkg '/' InterfaceName], 'DataElements', element1,'SwCalibrationAccess',swCalibValue);   
% Map Simulink OutPort to Sender port of the Atomic Component
mapOutport(slMap,Sl_SR_PortName,SenderPortName,element1,'ExplicitSend');

% ******************* Complete Adding AutoSar attribute ShiftModeIndicator as element *****************

% ******************* Adding AutoSar Port pp_ShiftPositionDisplayand Interface TI_SR_ShiftPositionDisplay *****************

%% Add Sender/Receiver Interface to the Application SWC's
%add Sender/Receiver Interface
InterfaceType = 'SenderReceiverInterface';
InterfaceName = 'TI_SR_ShiftPositionDisplay_pp_ShiftPositionDisplay' ; % This is a TI name inside the UML
% Add interface to AUTOSAR interface Package
addPackageableElement(arProps,InterfaceType,ifPkg,InterfaceName,'IsService',false);

%add a Sender Port under Atomic Component
SenderPortName = 'pp_ShiftPositionDisplay';
add(arProps,aswcPath{1},'SenderPorts',SenderPortName,'Interface',InterfaceName);

% ******************* Complete Adding AutoSar Port pp_ShiftPositionDisplayand Interface TI_SR_ShiftPositionDisplay *****************

% ******************* Adding AutoSar attribute ShiftPositionDisplay as element *****************

%add an inport in simulink to map with receiver port of the Application SWC
Sl_SR_PortName = 'pp_ShiftPositionDisplay_ShiftPositionDisplay';
blockoffsetop = 3;
PositionArray = [(leftoffset*10) (blockoffsetop * topoffset)  (leftoffset*10+30) ((blockoffsetop * topoffset)+20)];
HandleSR = add_block('simulink/Ports & Subsystems/Out1', [model_name '/' 'output'], 'Name', Sl_SR_PortName,'Position',PositionArray);
%Set Simulink inport properties
...
set_param(HandleSR,'BackgroundColor', 'lightBlue');
% Add the element 
element1 = 'ShiftPositionDisplay';
% Link the element and the AutoSar Interface. 
add(arProps,[ifPkg '/' InterfaceName], 'DataElements', element1,'SwCalibrationAccess',swCalibValue);   
% Map Simulink OutPort to Sender port of the Atomic Component
mapOutport(slMap,Sl_SR_PortName,SenderPortName,element1,'ExplicitSend');

% ******************* Complete Adding AutoSar attribute ShiftPositionDisplay as element *****************

% ******************* Adding AutoSar Port pp_Shiftpos_ePRNDL_Statusand Interface TI_SR_Shiftpos_Data *****************

%% Add Sender/Receiver Interface to the Application SWC's
%add Sender/Receiver Interface
InterfaceType = 'SenderReceiverInterface';
InterfaceName = 'TI_SR_Shiftpos_Data_pp_Shiftpos_ePRNDL_Status' ; % This is a TI name inside the UML
% Add interface to AUTOSAR interface Package
addPackageableElement(arProps,InterfaceType,ifPkg,InterfaceName,'IsService',false);

%add a Sender Port under Atomic Component
SenderPortName = 'pp_Shiftpos_ePRNDL_Status';
add(arProps,aswcPath{1},'SenderPorts',SenderPortName,'Interface',InterfaceName);

% ******************* Complete Adding AutoSar Port pp_Shiftpos_ePRNDL_Statusand Interface TI_SR_Shiftpos_Data *****************

% ******************* Adding AutoSar attribute ShiftPos_Data as element *****************

%add an inport in simulink to map with receiver port of the Application SWC
Sl_SR_PortName = 'pp_Shiftpos_ePRNDL_Status_ShiftPos_Data';
blockoffsetop = 4;
PositionArray = [(leftoffset*10) (blockoffsetop * topoffset)  (leftoffset*10+30) ((blockoffsetop * topoffset)+20)];
HandleSR = add_block('simulink/Ports & Subsystems/Out1', [model_name '/' 'output'], 'Name', Sl_SR_PortName,'Position',PositionArray);
%Set Simulink inport properties
set_param(HandleSR,'PortDimensions','-1');
set_param(HandleSR,'OutDataTypeStr', 'Bus:ShiftposData_Type');
set_param(HandleSR,'BackgroundColor', 'lightBlue');
HandleSR = add_block('simulink/Ports & Subsystems/In1', [VariantOutputblockpath '/' 'input'], 'Name', [Sl_SR_PortName '_in'],'Position',PositionArray);
set_param(HandleSR,'PortDimensions','1');
set_param(HandleSR,'OutDataTypeStr', 'Bus:ShiftposData_Type');
...
% Bus creator
blockoffsetop = 2;
BusName = 'ShiftPos_Data';
BusObjectName = ShiftposData_Type;
...
% Add the element 
element1 = 'ShiftPos_Data';
% Link the element and the AutoSar Interface. 
add(arProps,[ifPkg '/' InterfaceName], 'DataElements', element1,'SwCalibrationAccess',swCalibValue);   
% Map Simulink OutPort to Sender port of the Atomic Component
mapOutport(slMap,Sl_SR_PortName,SenderPortName,element1,'ExplicitSend');

% ******************* Complete Adding AutoSar attribute ShiftPos_Data as element *****************

% ******************* Adding AutoSar Port pp_Shiftpos_ShiftPosIndStatusand Interface ShiftPosIndStatus *****************

%% Add Sender/Receiver Interface to the Application SWC's
%add Sender/Receiver Interface
InterfaceType = 'SenderReceiverInterface';
InterfaceName = 'ShiftPosIndStatus_pp_Shiftpos_ShiftPosIndStatus' ; % This is a TI name inside the UML
% Add interface to AUTOSAR interface Package
addPackageableElement(arProps,InterfaceType,ifPkg,InterfaceName,'IsService',false);

%add a Sender Port under Atomic Component
SenderPortName = 'pp_Shiftpos_ShiftPosIndStatus';
add(arProps,aswcPath{1},'SenderPorts',SenderPortName,'Interface',InterfaceName);

% ******************* Complete Adding AutoSar Port pp_Shiftpos_ShiftPosIndStatusand Interface ShiftPosIndStatus *****************

% ******************* Adding AutoSar attribute ShiftPosIndStatusData as element *****************

%add an inport in simulink to map with receiver port of the Application SWC
Sl_SR_PortName = 'pp_Shiftpos_ShiftPosIndStatus_ShiftPosIndStatusData';
blockoffsetop = 5;
PositionArray = [(leftoffset*10) (blockoffsetop * topoffset)  (leftoffset*10+30) ((blockoffsetop * topoffset)+20)];
HandleSR = add_block('simulink/Ports & Subsystems/Out1', [model_name '/' 'output'], 'Name', Sl_SR_PortName,'Position',PositionArray);
%Set Simulink inport properties
set_param(HandleSR,'PortDimensions','-1');
set_param(HandleSR,'OutDataTypeStr', 'Bus:SShiftPosIndStatus');
set_param(HandleSR,'BackgroundColor', 'lightBlue');
HandleSR = add_block('simulink/Ports & Subsystems/In1', [VariantOutputblockpath '/' 'input'], 'Name', [Sl_SR_PortName '_in'],'Position',PositionArray);
set_param(HandleSR,'PortDimensions','1');
set_param(HandleSR,'OutDataTypeStr', 'Bus:SShiftPosIndStatus');
...
% Bus creator
blockoffsetop = 2;
BusName = 'ShiftPosIndStatusData';
BusObjectName = SShiftPosIndStatus;
BusBlockName = [BusName '_creator'];
PositionArray = [(leftoffset*5) (topoffset)  (leftoffset*5+10) ((topoffset)+300)];
HandleSR = add_block('simulink/Signal Routing/Bus Creator', [Apprunnablepath '/' 'Bus'], 'Name', BusBlockName,'Position',PositionArray);
set_param(HandleSR,'OutDataTypeStr', 'Bus:SShiftPosIndStatus');
...
add_line(Apprunnablepath, [BusBlockName '/1'], [Sl_SR_PortName '/1' ],'autorouting', 'on'); 
% Add the element 
element1 = 'ShiftPosIndStatusData';
% Link the element and the AutoSar Interface. 
add(arProps,[ifPkg '/' InterfaceName], 'DataElements', element1,'SwCalibrationAccess',swCalibValue);   
% Map Simulink OutPort to Sender port of the Atomic Component
mapOutport(slMap,Sl_SR_PortName,SenderPortName,element1,'ExplicitSend');

% ******************* Complete Adding AutoSar attribute ShiftPosIndStatusData as element *****************
...
%%***** ADDING CS VARIABLE HOLDING TI Mdl_Gear_Init*****
Sl_CS_Operation = 'Mdl_Gear_Init';
%%***** COMPLETE ADDING TI VARIABLE 

%%***** ADDING OPERATION Mdl_Gear_Init*****


Operation_prototype = 'Mdl_Gear_Init( )'; 
