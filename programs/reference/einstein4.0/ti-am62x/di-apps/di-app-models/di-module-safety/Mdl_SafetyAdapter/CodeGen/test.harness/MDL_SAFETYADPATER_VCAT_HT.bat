...
echo options TESTABLE_SOURCE_DIR ..\src(1)\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR .\ >> commands.tmp
echo environment build TOYOTA_MDL_SAFETYADPATER_VCAT_HT.env >> commands.tmp
echo /E:TOYOTA_MDL_SAFETYADPATER_VCAT_HT tools script run TOYOTA_MDL_SAFETYADPATER_VCAT_HT.tst >> commands.tmp
echo /E:TOYOTA_MDL_SAFETYADPATER_VCAT_HT execute batch >> commands.tmp
echo /E:TOYOTA_MDL_SAFETYADPATER_VCAT_HT reports custom management TOYOTA_MDL_SAFETYADPATER_VCAT_HT_management_report.html >> commands.tmp
