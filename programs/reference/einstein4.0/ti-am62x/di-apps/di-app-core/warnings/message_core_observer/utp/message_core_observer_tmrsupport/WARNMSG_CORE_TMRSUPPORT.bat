...
echo environment build WARNMSG_CORE_TMRSUPPORT.env >> commands.tmp
echo /E:WARNMSG_CORE_TMRSUPPORT tools script run WARNMSG_CORE_TMRSUPPORT.tst >> commands.tmp
echo /E:WARNMSG_CORE_TMRSUPPORT execute batch >> commands.tmp
echo /E:WARNMSG_CORE_TMRSUPPORT reports custom management WARNMSG_CORE_TMRSUPPORT_management_report.html >> commands.tmp
