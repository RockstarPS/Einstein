...
echo environment build CTRL_WARNING.env >> commands.tmp
echo /E:CTRL_WARNING tools script run CTRL_WARNING.tst >> commands.tmp
echo /E:CTRL_WARNING execute batch >> commands.tmp
echo /E:CTRL_WARNING reports custom management CTRL_WARNING_management_report.html >> commands.tmp
