...
**
**==========================================================================*/
#define warn_msgStore_C

/*==========================================================================*/
/*  I N C L U D E   F I L E S                                               */
/*==========================================================================*/
#include "system.h"
#include "warn_msgStore.h"
#include "warn_msgStore.cfg"
...
**==========================================================================*/
{
    if (MessageID < MSG_NUM_MESSAGES)
    {
        ...
        if(inst < MSG_NUM_INSTANCES)
        {
            if ((TESTBIT(thisMessage->Options, (UINT32)MSG_OPTION_STORE)) && (thisMessage->Category < MSG_NUM_MESSAGE_CATEGORIES))
            {
                /*------------------------------------------------------------------*/
