...
echo environment build CTRL_TELLTALE.env >> commands.tmp
echo /E:CTRL_TELLTALE  tools update mcdc >> commands.tmp
echo /E:CTRL_TELLTALE tools script run CTRL_TELLTALE.tst >> commands.tmp
echo /E:CTRL_TELLTALE execute batch >> commands.tmp
echo /E:CTRL_TELLTALE reports custom management CTRL_TELLTALE_management_report.html >> commands.tmp
