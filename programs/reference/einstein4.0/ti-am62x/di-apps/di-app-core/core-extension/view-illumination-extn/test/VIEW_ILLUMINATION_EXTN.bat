...
echo environment build VIEW_ILLUMINATION_EXTN.env >> commands.tmp
echo /E:VIEW_ILLUMINATION_EXTN tools script run VIEW_ILLUMINATION_EXTN.tst >> commands.tmp
echo /E:VIEW_ILLUMINATION_EXTN execute batch >> commands.tmp
echo /E:VIEW_ILLUMINATION_EXTN reports custom management VIEW_ILLUMINATION_EXTN_management_report.html >> commands.tmp
