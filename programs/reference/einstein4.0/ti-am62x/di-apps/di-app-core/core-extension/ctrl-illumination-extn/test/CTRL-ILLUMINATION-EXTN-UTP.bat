...
echo options VCAST_DEPENDENCY_CACHE_DIR C:\\Illumination control\\VIEW-ILLUMINATION-EXTN-UTP >> commands.tmp
...
echo options VCAST_REPOSITORY C:\\Users\\aelango6\\Documents\\PAG EBOX >> commands.tmp
...
echo options TESTABLE_SOURCE_DIR C:\Diag_App_SDD_UTP\Source\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR C:\Diag_App_SDD_UTP\Stubs\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR C:\Diag_App_SDD_UTP\Stubs\GenData\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR C:\Diag_App_SDD_UTP\Stubs\GenData\Components\ >> commands.tmp
echo environment build CTRL-ILLUMINATION-EXTN-UTP.env >> commands.tmp
echo /E:CTRL-ILLUMINATION-EXTN-UTP tools script run CTRL-ILLUMINATION-EXTN-UTP.tst >> commands.tmp
echo /E:CTRL-ILLUMINATION-EXTN-UTP execute batch >> commands.tmp
echo /E:CTRL-ILLUMINATION-EXTN-UTP tools import_coverage CTRL-ILLUMINATION-EXTN-UTP.cvr >> commands.tmp
echo /E:CTRL-ILLUMINATION-EXTN-UTP reports custom management CTRL-ILLUMINATION-EXTN-UTP_management_report.html >> commands.tmp
