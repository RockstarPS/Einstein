...
echo options VCAST_DEPENDENCY_CACHE_DIR C:\\Illumination control\\CTRL-ILLUMINATION-UTP >> commands.tmp
...
echo environment build CTRL-ILLUMINATION.env >> commands.tmp
echo /E:CTRL-ILLUMINATION tools script run CTRL-ILLUMINATION.tst >> commands.tmp
echo /E:CTRL-ILLUMINATION execute batch >> commands.tmp
echo /E:CTRL-ILLUMINATION tools import_coverage CTRL-ILLUMINATION.cvr >> commands.tmp
echo /E:CTRL-ILLUMINATION reports custom management CTRL-ILLUMINATION_management_report.html >> commands.tmp
