...
echo options VCAST_DEPENDENCY_CACHE_DIR C:\\Illumination control\\VIEW-IILUMINATION-UTP >> commands.tmp
...
echo environment build VIEW-IILUMINATION-UTP.env >> commands.tmp
echo /E:VIEW-IILUMINATION-UTP tools script run VIEW-IILUMINATION-UTP.tst >> commands.tmp
echo /E:VIEW-IILUMINATION-UTP execute batch >> commands.tmp
echo /E:VIEW-IILUMINATION-UTP tools import_coverage VIEW-IILUMINATION-UTP.cvr >> commands.tmp
echo /E:VIEW-IILUMINATION-UTP reports custom management VIEW-IILUMINATION-UTP_management_report.html >> commands.tmp
