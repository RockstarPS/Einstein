...
echo environment build MEET_GP_APP_UT.env >> commands.tmp
echo /E:MEET_GP_APP_UT tools script run MEET_GP_APP_UT.tst >> commands.tmp
echo /E:MEET_GP_APP_UT execute batch >> commands.tmp
echo /E:MEET_GP_APP_UT tools import_coverage MEET_GP_APP_UT.cvr >> commands.tmp
echo /E:MEET_GP_APP_UT reports custom full MEET_GP_APP_UT_full_report.html >> commands.tmp
