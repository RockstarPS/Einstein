...
//
//---------------------------------------------------------------------------------------------------------------------
#ifndef BL_EINSTEIN_UDS_APP_COMPONENT_H
#define BL_EINSTEIN_UDS_APP_COMPONENT_H
...
class BlEinsteinUdsAppComponent : public dk::runtime::core::Component
{
public:
    explicit BlEinsteinUdsAppComponent(std::map<dk::runtime::core::mid_t, dk::runtime::core::func_t> * const pMsgMap, const char * const cmpId) : Component(pMsgMap, cmpId)
    {
    }

    virtual ~BlEinsteinUdsAppComponent()
    {
    }
...
private:
/// Start of user code : User code for file bl_einstein_uds_app_component.h
...
#endif //BL_EINSTEIN_UDS_APP_COMPONENT_H
