...
extern FUNC(Std_ReturnType, CCDD_EcuPowerM_CODE) EcuPowerM_RequestPower(	VAR(uint8, AUTOMATIC) device,
																   	VAR(uint8, AUTOMATIC) request);
extern FUNC(void, ECUPOWERM_CODE) EcuPowerM_MainFunction(void);
extern FUNC(Std_ReturnType,CCDD_EcuPowerM_CODE) EcuPowerM_GetDeviceStatus(	VAR(uint8, AUTOMATIC) device,
