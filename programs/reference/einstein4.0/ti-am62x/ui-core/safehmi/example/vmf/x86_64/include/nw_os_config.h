...
#include <sys/netmgr.h>     /* missing in Einstein VGW nw_gw_timer.c */
#include <sys/syspage.h>    /* missing in Einstein VGW nw_gw_timer.c */
...
#if defined (DC15) || defined (D544) || defined (P2D3)
