...
//typedef unsigned16 pid_t;
/* register as a client to the vmf-server */
DLL_EXPORT vmf_client_id_t nw_vmf_connect(const char *p_my_process_name,
                                          void *ctrl,
                                          signed32 collector_timeout,
...
DLL_EXPORT vmf_client_id_t nw_vmf_connect_async(const char *p_my_process_name,unsigned16 message_queue_size,unsigned16 message_size,
...
DLL_EXPORT vmf_ret_t nw_vmf_send_basic_p2p  (vmf_client_id_t vmf_client_id,vmf_basic_msg_t * vmf_msg);
/* To send a vmf-basic-msg */
...
DLL_EXPORT signed16  nw_vmf_timed_receive    (vmf_client_id_t vmf_client_id,vmf_msg_t * vmf_msg, unsigned16 vmf_msg_length, unsigned16 ms_timeout);
/* To receive a vmf-basic-msg */
DLL_EXPORT signed16  nw_vmf_receive_basic    (vmf_client_id_t vmf_client_id,vmf_basic_msg_t * p_vmf_basic_msg, unsigned16  vmf_msg_length);
