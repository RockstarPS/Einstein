...
#define VMF_SYSINFO_CTRL_PROFILER_START_LOAD_REQ (VMF_SYSINFO_START +2)     /* start transferring load for given pid */
#define VMF_SYSINFO_CTRL_PROFILER_STOP_LOAD_REQ  (VMF_SYSINFO_START +3)     /* stop transferring load for given pid */
...
#define VMF_SYSINFO_DATA_PROFILER_PID_NAME_RESP  (VMF_SYSINFO_START +6)     /* response with a name for a given pid  */
#define VMF_SHM_IPC_STATUS_START                 (VMF_SYSINFO_START +7)     /* request a name for a given pid*/
#define VMF_SHM_IPC_STATUS_POOLS                 (VMF_SYSINFO_START +8)     /* transfer of shm ipc pool status */
#define VMF_SHM_IPC_STATUS_QUEUES                (VMF_SYSINFO_START +9)     /* transfer of shm ipc queue status */
#define VMF_SHM_IPC_STATUS_QUEUE_NAME            (VMF_SYSINFO_START +10)    /* transfer of shm ipc queue name */
