...
// ============================================================================
// 
//  Name:           ux_safehmi_rectangle.h
// 
//  Description:    safeHMI Rectangle class definitions
// 
...
// 
// ============================================================================
#ifndef UX_SAFEHMI_RECTANGLE_H
#define UX_SAFEHMI_RECTANGLE_H
...
{
  /// <summary>
  /// Perform rendering of Rectangle element
  /// </summary>
  class ux_safehmi_rectangle :public ux_safehmi_item
  {
  public:
    /// <summary>
    /// Overloaded constructor
    /// </summary>
    ux_safehmi_rectangle(const int32_t px, const int32_t py, const int32_t pwidth, const int32_t pheight, const bool pvisible,
