...
echo environment build IMXRT_FT_UT.env >> commands.tmp
echo /E:IMXRT_FT_UT tools script run IMXRT_FT_UT.tst >> commands.tmp
echo /E:IMXRT_FT_UT execute batch >> commands.tmp
echo /E:IMXRT_FT_UT reports custom management IMXRT_FT_UT_management_report.html >> commands.tmp
