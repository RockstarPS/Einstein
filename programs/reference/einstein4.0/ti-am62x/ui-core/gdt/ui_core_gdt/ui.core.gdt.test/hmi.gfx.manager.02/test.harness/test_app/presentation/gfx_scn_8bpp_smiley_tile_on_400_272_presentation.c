...
**============================================================================
**
** Name:           gfx_scn_8bpp_smiley_tile_on_400_272_presentation.c
**
...
**
**==========================================================================*/
#define GFX_SCN_8BPP_SMILEY_TILE_ON_400_272_PRESENTATION_C
 ...
 ** Updated:          
 **==========================================================================*/
void scn_8bpp_smiley_tile_on_400_272_presentation_handler(LSH_PRESN_HANDLER_STATUS_T *p_presen_hndl_status_SP)
{
    if(p_presen_hndl_status_SP->presentation_status == LSH_ACTIVATED_STATUS)
    {
         hmi_gfx_mgr02_if_set_screen(GFX_SCN_8BPP_SMILEY_TILE_ON_400_272, 1);
		 hmi_gfx_mgr02_if_set_text(GFX_CMD_EXECUTION, L"8bpp smiley tile Test");
		 hmi_gfx_mgr02_if_set_text(GFX_EXE_ELEM_PROPERTY, L"1 image");
         l_anim_present = 0;
    }
    ...
    {
        hmi_gfx_mgr02_if_set_screen(GFX_SCN_8BPP_SMILEY_TILE_ON_400_272, 0);
    }
    else
    {
    }
