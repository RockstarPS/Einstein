 ...
 ** Updated:          
 **==========================================================================*/
void scn_visible_layer_prsnt_hndlr(LSH_PRESN_HANDLER_STATUS_T *p_presen_hndl_status_SP)
{
    if(p_presen_hndl_status_SP->presentation_status == LSH_ACTIVATED_STATUS)
    {
         ...
         hmi_gfx_mgr02_if_set_screen(GFX_NEW_SCREENS_1, 1);
         l_anim_present = 0;
    }
    ...
    {
       hmi_gfx_mgr02_if_set_screen(GFX_NEW_SCREENS_1, 0);
    }
    else
    {
    }
