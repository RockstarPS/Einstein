...
# if !defined(_ALLOCA_H) && !defined(_GHS_LOCALE_H) && !defined(_GHS_MALLOC_H) && \
    ...
    !defined(_GHS_WCHAR_H) && !defined(_GHS_WMEMCHR_H) && !defined(_GHS_UCHAR_H) && \
    !defined(__INTEGRITY) && !defined(INT_178B)
...
# elif defined(__LLONG_BIT) && __PTR_BIT > __LONG_BIT
#    define NULL (0LL)		/* long is smaller than pointer on this target */
...
#  if defined(__LLONG_BIT) && __PTR_BIT > __LONG_BIT
