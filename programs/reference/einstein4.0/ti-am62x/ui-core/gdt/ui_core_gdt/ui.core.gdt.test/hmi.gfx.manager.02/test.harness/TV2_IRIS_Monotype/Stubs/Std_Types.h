...
#if (STD_VENDOR_ID != PLATFORM_VENDOR_ID)
...
#error "Software Version Numbers of Std_Types.h and Platform_Types.h are different"
#endif

#if (STD_VENDOR_ID != COMPILER_VENDOR_ID)
    #error "Std_Types.h and Compiler.h have different vendor ids"
#endif
...
#endif
/* Check if current file and Compiler.h header file are of the same Software version */
    ...
    #error "Software Version Numbers of Std_Types.h and Compiler.h are different"
#endif
...
/**
* @brief Return code for pending status.
* @implements SymbolDefinitions_enumeration
*/
#define E_PENDING	0x02
