...
void*		realloc(void *, size_t)
                __attribute__((__format__(__memset__,1,2),warn_unused_result));
...
/* These routines, structures, and variables are not supported for general use.
 */
#if defined(__ELF)
typedef struct {
    uintptr_t     addr;
...
extern size_t __ghs_MallocMapPreallocSize;
#endif
