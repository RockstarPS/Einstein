...
GFX_MGR02_ILOC_DATA l_wdgt_text_animation_offset, l_text_animation_offset;
...
void widget_text_presentation_handler(LSH_PRESN_HANDLER_STATUS_T *p_presen_hndl_status_SP)
{
    if(p_presen_hndl_status_SP->presentation_status == LSH_ACTIVATED_STATUS)
    {
         ...
         l_wdgt_text_animation_offset.x = l_text_animation_offset.x =0;
         l_wdgt_text_animation_offset.y = l_text_animation_offset.y =0;
         hmi_gfx_mgr02_if_get_obj_pos(GFX_BPP8_LJ_HOR_PINK_RED_TEXT_0_ANIM, &l_text_animation);
         hmi_gfx_mgr02_if_get_obj_pos(GFX_BPP8_CJ_HOR_WHITE_GREEN_TEXT_1_ANIM, &l_wdgt_text_animation);
    }
    ...
    static UINT8 cmd_step =0;
     switch(cmd_step)
         {
         case 0:
             l_text_animation_offset.y--;
             if(l_wdgt_text_animation_offset.y <= -75)
                 {cmd_step = 1;}
             l_wdgt_text_animation_offset.y--;
             break;
         case 1:
             l_text_animation_offset.y++;
             if(l_wdgt_text_animation.y >= 65)
                 {cmd_step = 2;}l_wdgt_text_animation.y++;
             break;
         case 2:
        ...
        hmi_gfx_mgr02_if_set_screen(GFX_SCN_WIDGET_TEXT, 1);
        hmi_gfx_mgr02_if_set_obj_pos_y(GFX_BPP8_CJ_HOR_WHITE_GREEN_TEXT_1_ANIM,l_wdgt_text_animation.y + l_wdgt_text_animation_offset.y);
        hmi_gfx_mgr02_if_set_obj_pos_y(GFX_BPP8_CJ_HOR_WHITE_GREEN_TEXT_1_ANIM,l_text_animation.y + l_text_animation_offset.y);
        hmi_gfx_mgr02_if_set_obj_pos_y(GFX_BPP8_LJ_HOR_PINK_RED_TEXT_0_ANIM, l_text_animation.y + l_text_animation_offset.y);
    }
