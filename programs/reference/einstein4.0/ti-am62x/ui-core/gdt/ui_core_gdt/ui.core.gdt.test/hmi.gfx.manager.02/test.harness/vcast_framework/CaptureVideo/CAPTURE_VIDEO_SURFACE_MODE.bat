...
echo environment build CAPTURE_VIDEO_SURFACE_MODE.env >> commands.tmp
echo /E:CAPTURE_VIDEO_SURFACE_MODE tools script run CAPTURE_VIDEO_SURFACE_MODE.tst >> commands.tmp
echo /E:CAPTURE_VIDEO_SURFACE_MODE execute batch >> commands.tmp
echo /E:CAPTURE_VIDEO_SURFACE_MODE reports custom management CAPTURE_VIDEO_SURFACE_MODE_management_report.html >> commands.tmp
