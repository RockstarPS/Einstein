...
**============================================================================
**
** Name:           gfx_scn_8bpp_smiley_presentation.c
**
...
**
**==========================================================================*/
#define GFX_SCN_8BPP_SMILEY_PRESENTATION_C
 ...
 ** Updated:          
 **==========================================================================*/
void scn_8bpp_smiley_presentation_handler(LSH_PRESN_HANDLER_STATUS_T *p_presen_hndl_status_SP)
{
    if(p_presen_hndl_status_SP->presentation_status == LSH_ACTIVATED_STATUS)
    {
         hmi_gfx_mgr02_if_set_screen(GFX_SCN_8BPP_SMILEY, 1);
         //hmi_gfx_mgr02_if_set_screen(GFX_SCN_1BPP_BMP, 1);
		 hmi_gfx_mgr02_if_set_text(GFX_CMD_EXECUTION, L"8bpp smiley BMP Test");
    ...
    {
        hmi_gfx_mgr02_if_set_screen(GFX_SCN_8BPP_SMILEY, 0);
    }
    else
    {
    }
