...
echo options C_DEFINE_LIST CYT3DLABHS LBO_OTF_FEATURE_CC NUNIT_TESTING >> commands.tmp
...
echo options TESTABLE_SOURCE_DIR ..\..\..\..\ui.core.gdt.test\hmi.gfx.manager.02\test.harness\TV2_IRIS_Monotype\Stubs\autogen\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR ..\..\..\..\ui.core.gdt.test\hmi.gfx.manager.02\test.harness\TV2_IRIS_Monotype\Stubs\cfg\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR ..\..\..\..\ui.core.gdt.test\hmi.gfx.manager.02\test.harness\TV2_IRIS_Monotype\Stubs\cfg\iceapple\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR ..\..\..\..\ui.core.gdt.test\hmi.gfx.manager.02\test.harness\TV2_IRIS_Monotype\Stubs\ >> commands.tmp
...
echo options TESTABLE_SOURCE_DIR ..\..\..\..\..\..\services\ui.core.services\third_party\monotype\iType\product\source\common\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR ..\..\..\..\..\..\services\ui.core.services\third_party\monotype\iType\product\source\port\clang\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR ..\..\..\..\..\..\services\ui.core.services\third_party\monotype\iType\tools_ghs_multi\includes\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR ..\..\..\..\..\..\services\ui.core.services\third_party\monotype\wtle\include\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR ..\..\..\..\..\..\services\ui.core.services\third_party\monotype\wtle\port\arm920\ >> commands.tmp
