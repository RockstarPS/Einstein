...
**============================================================================
**
** Name:           gfx_scn_4bpp_alpha_map_presentation.c
**
...
**
**==========================================================================*/
#define GFX_SCN_4BPP_ALPHA_MAP_PRESENTATION_C
 ...
 ** Updated:          
 **==========================================================================*/
void scn_4bpp_alpha_map_presentation_handler(LSH_PRESN_HANDLER_STATUS_T *p_presen_hndl_status_SP)
{
    if(p_presen_hndl_status_SP->presentation_status == LSH_ACTIVATED_STATUS)
    {
         hmi_gfx_mgr02_if_set_screen(GFX_SCN_4BPP_ALPHA_MAP, 1);
         hmi_gfx_mgr02_if_set_obj_fg_color(GFX_IMG_4BPP_ALPHA_ANIM,0xFF0000);
         hmi_gfx_mgr02_if_set_obj_alpha(GFX_IMG_4BPP_ALPHA_ANIM, alpha);
         hmi_gfx_mgr02_if_set_text(GFX_CMD_EXECUTION,L"4BPP Alpha Mask");
    ...
    else if(p_presen_hndl_status_SP->presentation_status == LSH_REFRESH_STATUS)
    {
        hmi_gfx_mgr02_if_set_screen(GFX_SCN_4BPP_ALPHA_MAP, 1);
        if(l_anim_present == 0){
        alpha--; if(alpha == 0){l_anim_present = 1;}}
        else if(l_anim_present == 1){
        alpha++;if(alpha == 255){l_anim_present = 2;}}
        else
        {}
        hmi_gfx_mgr02_if_set_obj_alpha(GFX_IMG_4BPP_ALPHA_ANIM, alpha);
        if(l_anim_present < 2)
    ...
    {
        hmi_gfx_mgr02_if_set_screen(GFX_SCN_4BPP_ALPHA_MAP, 0);
    }
    else
    {
    }
