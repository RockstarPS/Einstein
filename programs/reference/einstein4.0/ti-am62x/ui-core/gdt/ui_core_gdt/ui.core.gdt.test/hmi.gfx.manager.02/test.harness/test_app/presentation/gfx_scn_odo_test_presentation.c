...
**
**==========================================================================*/
#define GFX_SCN_SPLASH_ANIM_PRESENTATION_C
 ...
 ** Updated:          
 **==========================================================================*/
void odo_test_presentation_handler(LSH_PRESN_HANDLER_STATUS_T *p_presen_hndl_status_SP)
{
    if(p_presen_hndl_status_SP->presentation_status == LSH_ACTIVATED_STATUS)
    {
         hmi_gfx_mgr02_if_set_screen(GFX_SCN_ODO_TEST, 1);
         hmi_gfx_mgr02_if_select_dimage(GFX_ACC_CAR_ICON_DIST, 1);
         ...
         hmi_gfx_mgr02_if_set_text(GFX_TXT_ODOMETER_VALUE, L"999999.8 Mi");
         l_anim_present = 0;
    }
    ...
    {
        hmi_gfx_mgr02_if_set_screen(GFX_SCN_ODO_TEST, 0);
    }
    else
    {
    }
