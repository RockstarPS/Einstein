...
echo environment build CACHE_VCAST_HT.env >> commands.tmp
echo /E:CACHE_VCAST_HT tools script run CACHE_VCAST_HT.tst >> commands.tmp
echo /E:CACHE_VCAST_HT execute batch >> commands.tmp
echo /E:CACHE_VCAST_HT reports custom management CACHE_VCAST_HT_management_report.html >> commands.tmp
