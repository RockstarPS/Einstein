 ...
 ** Updated:          
 **==========================================================================*/
 UINT8 scn_main_sts_event_handlr(LSH_EVENT_HANDLER_STATUS_T *p_event_hndl_status_SP)
{
 ...
 ** Updated:          
 **==========================================================================*/
UINT8 scn_trip_b_event_handlr(LSH_EVENT_HANDLER_STATUS_T *p_event_hndl_status_SP)
{
   switch(p_event_hndl_status_SP->button_command)
   {
      case START_ANIM_COMMAND:     printf("GFX_SCN_SPLASH_ANIM - START_ANIM_COMMAND - (ButtonID_OK,    ButtonState_Pressed)\n");
 ...
 ** Updated:          
 **==========================================================================*/
UINT8 scn_trip_a_event_handlr(LSH_EVENT_HANDLER_STATUS_T *p_event_hndl_status_SP)
{
   switch(p_event_hndl_status_SP->button_command)
   {
      case START_ANIM_COMMAND:     printf("GFX_SCN_SPLASH_ANIM - START_ANIM_COMMAND - (ButtonID_OK,    ButtonState_Pressed)\n");
...
UINT8 scn_fill_ev_hndlr(LSH_EVENT_HANDLER_STATUS_T *p_event_hndl_status_SP)
{
   switch(p_event_hndl_status_SP->button_command)
   {
      case START_ANIM_COMMAND:     printf("GFX_SCN_SPLASH_ANIM - START_ANIM_COMMAND - (ButtonID_OK,    ButtonState_Pressed)\n");
...
void scn_fill_focus_hndlr(LSH_FOCUS_HANDLER_STATUS_T  *p_focus_hndl_status_SP)
{
...
**
**============================================================================
** CMS Rev 01       27-Aug-2012  ASHEKHAR
