...
echo environment build IMXRT_HT.env >> commands.tmp
echo /E:IMXRT_HT tools script run IMXRT_HT.tst >> commands.tmp
echo /E:IMXRT_HT execute batch >> commands.tmp
echo /E:IMXRT_HT reports custom management IMXRT_HT_management_report.html >> commands.tmp
