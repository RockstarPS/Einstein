...
**============================================================================
**
** Name:           gfx_scn_openvg_test_presentation.c
**
...
**
**==========================================================================*/
#define GFX_SCN_OPENVG_TEST_PRESENTATION_C
 ...
 ** Updated:          
 **==========================================================================*/
void scn_openvg_test_presentation_handler(LSH_PRESN_HANDLER_STATUS_T *p_presen_hndl_status_SP)
{
#if 0
    if(p_presen_hndl_status_SP->presentation_status == LSH_ACTIVATED_STATUS)
    {
         hmi_gfx_mgr02_if_set_screen(GFX_SCN_OPENVG_TEST, 1);
		 GfxManagerSendEvent(GFX_OPENVG_TEST_SCREEN,  GFX_ACTIVATE_SCREEN_EV);
         GfxManagerSendText(GFX_OPENVGIMG2, L"BMPImage");
         GfxManagerSendText(GFX_OPENVGIMG1, L"SVGImage");
         l_anim_present = 0;
    }
    ...
    {
        hmi_gfx_mgr02_if_set_screen(GFX_SCN_OPENVG_TEST, 0);
    }
    else
    {
    }
