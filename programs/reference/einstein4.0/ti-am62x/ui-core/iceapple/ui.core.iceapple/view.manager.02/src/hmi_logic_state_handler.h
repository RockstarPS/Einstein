...
#include "hmi_logic_state_handler.inc"
 ...
 #if defined(GFX_PIX_FORMAT)
  #if (GFX_PIX_FORMAT == GFX_2BPP) || (GFX_PIX_FORMAT == GFX_4BPP) || (GFX_PIX_FORMAT == GFX_1BPP)
...
*/
#define LSH_LOST_FOCUS_STATUS       (0x01u)
#define LSH_GOT_FOCUS_STATUS        (0x02u)
/* 
** LSH_GOT_FOCUS_CLR_STATUS - ~LSH_GOT_FOCUS_STATUS.
** If the value of LSH_GOT_FOCUS_STATUS macro is changed,corresponding changes
** needs to be done here also. This change is done to fix the below coverity warning
** Parse warning (PW.INTEGER_TRUNCATED)
** 1. integer_truncated: integer conversion resulted in truncation
*/
#define LSH_GOT_FOCUS_CLR_STATUS    (0xFDu)
#define LSH_DEACTIVATED_STATUS      (0x04u)
#define LSH_ACTIVATED_STATUS        (0x08u)
#define LSH_REFRESH_STATUS          (0x0Cu)
#define LSH_ANIM_COMPLETE_STATUS    (0x10u)
#define LSH_ANIM_STARTED_STATUS     (0x20u)
#define LSH_UNASSIGNED_STATUS       (0x40u)
#define LSH_INVALID_STATUS          (0x80u) /*0x80 is a reserved for the INVALID so don't use it */
...
*/
typedef UINT8 (LSH_EVENT_HANDLER_T)(LSH_EVENT_HANDLER_STATUS_T *p_event_hndl_status_SP);
#define LSH_NULL_EVENT_HANDLER   ((LSH_EVENT_HANDLER_T *)LSH_NULL_PTR)
...
*/
#ifndef LSH_CUSTOM_BTN_ID_MASK_CFG
...
/* TVM programs */
  ...
  #define LSH_ANIM_MASK_CLEAR      (0xFF7F)
  ...
  #define LSH_GET_COMMAND(id, sts) (((UINT16)((UINT32)(id) << 8UL))|(sts))  
#else
/* other programs */
  #define LSH_ID_MASK              (0x7FF0)
  #define LSH_ANIM_MASK            (0x8000U)
  #define LSH_ANIM_MASK_CLEAR      (0x7FFFU)
  #define LSH_STATUS_MASK          (0x000F)
  #define LSH_GET_ID(x)            (((x) & LSH_ID_MASK) >> 4)
  #define LSH_IS_ANIM(x)           (((x) & LSH_ANIM_MASK) == LSH_ANIM_MASK)
  #define LSH_GET_STATUS(x)        ((x) & LSH_STATUS_MASK)
  #define LSH_GET_COMMAND(id, sts) (((UINT16)((UINT32)(id) << 4UL))|(sts))
#endif /* #if LSH_BTN_ID_MASK_CFG */
#endif /* #if LSH_BTN_ID_MASK_CFG */
#endif /* #ifndef LSH_BTN_ID_MASK_CFG */

/*
** LSH_STATE_ID - type to hold the logic state ID. Logic state ID can range from 0 to 
**                254. 255 is reserved for the case when we have 254 ID's, 255 will
**                indicate the number of logical states
*/

#define LSH_VM_STATE_ID(client_id, logic_id) (((UINT16)((UINT32)(client_id)<< 8UL)) | ((UINT16)(logic_id)))
#define LSH_GET_STATE_ID(vm_state_id)        ((LSH_STATE_ID_T)(((UINT16)0x00FF) & (vm_state_id)))
#define LSH_GET_CLIENT_ID(vm_state_id)       ((UINT8)((vm_state_id)>>((UINT16)0x0008)))
...
*/
typedef void (LSH_FOCUS_HANDLER_T)(LSH_FOCUS_HANDLER_STATUS_T *p_focus_hndl_status_SP);
#define LSH_NULL_FOCUS_HANDLER ((LSH_FOCUS_HANDLER_T *)LSH_NULL_PTR)

#ifdef LSH_FOCUS_STATUS_FOR_ALL_SCREEN
extern void LSH_FOCUS_STATUS_FOR_ALL_SCREEN(LSH_FOCUS_HANDLER_STATUS_T  *p_focus_hndl_status_SP);
#endif

#ifdef LSH_UNFREEZE_BUTTON_EVENT_HANDLER
extern void LSH_UNFREEZE_BUTTON_EVENT_HANDLER(LSH_EVENT_HANDLER_STATUS_T * p_btn_command_id);
#endif 
/*
...
*/
typedef void (LSH_PRESN_HANDLER_T)(LSH_PRESN_HANDLER_STATUS_T *p_presen_hndl_status_SP);
#define LSH_NULL_PRESN_HANDLER ((LSH_PRESN_HANDLER_T *)LSH_NULL_PTR)
...
*/
#if !defined(LSH_ANIMATION_SUPPORT_ENABLED)
  /* creating dummy functions to get it go incase no animation support needed */
  #define hmi_lsh_start_animation(p_state_id, p_anim_id) (FALSE)
  #define hmi_lsh_stop_animation(p_state_id, p_anim_id)
  #define ANIM_MAX_ID     (254)
  #define ANIM_ABORT_ID   (255)
...
#define ANIM_ABORT_ID (GFX_NUM_ANIMATIONS+1)
  ...
  typedef struct
  {
	UINT8 logic_active_anim_id;
	UINT8 logic_deactivate_anim_id;
	UINT8 graphic_active_anim_id;
  }LSH_ANIM_STATE_ID;
#else
...
#ifndef HMI_UNUSED_VAR
#define HMI_UNUSED_VAR(X)  (void)(X)
#endif
/*============================================================================
...
extern UINT32 hmi_lsh_start_animation(UINT32 p_state_id, UINT32 p_anim_id);
extern void   hmi_lsh_stop_animation(UINT32 p_state_id, UINT32 p_anim_id);
extern BOOLEAN  hmi_lsh_inspect_animation_status(UINT8 p_prio_U8, UINT32 p_layer_id_U32);
extern BOOLEAN  hmi_lsh_inspect_scr_animation_status(LSH_STATE_ID_T p_logic_state_id_U8, UINT8 p_client_id_U8);
extern void hmi_lsh_inspect_state_animation_id(UINT8 p_prio_U8, UINT32 p_layer_id_U32, LSH_ANIM_STATE_ID * const p_state);
extern UINT8 hmi_lsh_get_screen_priority(LSH_STATE_ID_T p_logic_state_id_U8);
#endif


extern void  hmi_lsh_task(void);
extern void  hmi_lsh_task_ext(UINT16 p_logic_state_id_U16);
extern void  hmi_lsh_freeze_button_events(LSH_STATE_ID_T p_logic_state_id_U16);
extern void  hmi_lsh_freeze_button_events_ext(LSH_STATE_ID_T p_logic_state_id_U16, UINT8 p_client_id_U8);
...
extern void  hmi_lsh_remap_button_events_ext(UINT16 p_button_id_U16, LSH_STATE_ID_T p_target_ls_id, UINT8 p_client_id_U8);
...
**============================================================================
**
** CMS Rev 1.15     18-Jul-17    arajase2
...
**
** CMS Rev 1.14     18-Mar-2016    APERUMAL
** QAC warning fix (The value of the result is always the right operand )
** for Honda Thaa.Removed & operation of logic_id with 0xFF
** since it is of type LSH_STATE_ID which varies from 0 to 255
**
** CMS Rev 1.13     1-Sep-2015    NKRISHN9
** Added hmi_lsh_inspect_state_animation_id interface. 
**
** CMS Rev 1.12     26-1-2014    nkrishn9
** client id is removed for macro when animation not supported.
**
** CMS Rev 1.11     26-1-2014    nkrishn9
** LSH_BTN_ID_MASK_CFG and LSH_FOCUS_STATUS_FOR_ALL_SCREEN configurations are defined.
** external interface for freeze button_events_ext and remap_button_events_ext defined 
** to support client id in button event handler.
**
...
** different client id but same logic id cases, add and remove same logic state id 
** is handled.
**
