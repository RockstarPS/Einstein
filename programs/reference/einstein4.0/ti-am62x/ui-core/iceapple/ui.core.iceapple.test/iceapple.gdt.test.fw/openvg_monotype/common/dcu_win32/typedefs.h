/**************************************************************************
  Visteon modified version of the original Freescale version
  P. Morris Sept. 16, 2009                  
    The main change is to eliminate the include of stdint.h, which was
    causing QAC to issue level 9 messages.
    What was necessary for stdint.h was moved to this file.
    Additional items may have to be moved in the future.  
 **************************************************************************/
