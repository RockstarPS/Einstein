...
#define SYS_MALLOC(a)   MemAlloc(a)
#define SYS_REALLOC(a,b) MemRealloc(a,b)
#define SYS_FREE(a) MemFree(a)
...
#define SYS_ATOF(a) atof(a)
#define SYS_STRSTR(a,b) strstr(a,b)
#define SYS_FGETS(a,b,c) fgets(a,b,c)
