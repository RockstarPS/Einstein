...
EXTERN_pfx TIMER kernel_sw_timers[ MAX_SW_TIMER_ID ] ;
...
EXTERN_pfx void  _KernelStart13BitTimer(UWORD timeout_time, UBYTE timer_id);
EXTERN_pfx UBYTE _KernelCheck13BitTimer(UBYTE timer_id);
