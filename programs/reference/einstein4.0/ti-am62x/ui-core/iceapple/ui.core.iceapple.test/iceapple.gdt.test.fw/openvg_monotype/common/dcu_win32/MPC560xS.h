...
/****************************************************************************/
    struct SSCM_tag {
        ...
        } ERROR_REG;                       /* Error Configuration Register */
...
/* Former declaration included to allow backwards compatibility
        union {
            vuint32_t R;
            struct {
                vuint32_t PERIPH:32;
...
/****************************************************************************/
    struct I2C_tag {
        ...
        vuint16_t dummy[2];    /* prevent compiler from putting this structure into .sbss instead of named segment */
    };                                 /* end of I2C_tag */
/****************************************************************************/
/*                             MODULE : MPU                                 */
/****************************************************************************/
