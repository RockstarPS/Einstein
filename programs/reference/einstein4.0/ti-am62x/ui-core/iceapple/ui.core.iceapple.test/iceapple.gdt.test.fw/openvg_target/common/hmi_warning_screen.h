...
SIF_STATUS hmi_msg_warn_get_status(UINT16 *Data, UINT16 Qualifier,UINT8 inst);
SIF_STATUS hmi_msg_app_wrn_notify_status_cb(UINT16 *Data, UINT16 Qualifier,UINT8 inst);
