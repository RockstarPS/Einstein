...
#define POPUP_TYPE_KEYPAD
#define POPUP_TYPE_PROGRESSBAR
#define POPUP_TYPE_ACK


#define L_POPUP_LAYER0_ID                                                       (0U)
#define L_POPUP_LAYER1_ID                                                       (1U)
#define POPUP_MAX_LAYERS                                                        (2U)
...
#define L0_WARNING_POPUP_ID                                                     (0U)
#define L1_INFO_POPUP_ID                                                        (1U)
#define L1_ACK_POPUP_ID                                                         (2U)
#define L1_KEYPAD_POPUP_ID                                                      (3U)
#define L1_PROGRESS_POPUP_ID                                                    (4U)
#define L_POPUP_MAX_COUNT                                                       (5U)
...
extern UINT8 scr_warning_popup_event_handler(LSH_EVENT_HANDLER_STATUS_T const *p_event_hndl_status_SP);
extern void scr_warning_popup_focus_handler(LSH_FOCUS_HANDLER_STATUS_T const *p_focus_hndl_status_SP);
extern void  scr_warning_popup_presentation_handler(LSH_PRESN_HANDLER_STATUS_T const *p_presn_hndl_status_SP);
extern UINT8 scr_info_popup_event_handler(LSH_EVENT_HANDLER_STATUS_T const *p_event_hndl_status_SP);
extern void scr_info_popup_focus_handler(LSH_FOCUS_HANDLER_STATUS_T const *p_focus_hndl_status_SP);
extern void  scr_info_popup_presentation_handler(LSH_PRESN_HANDLER_STATUS_T const *p_presn_hndl_status_SP);
extern UINT8 scr_ack_popup_event_handler(LSH_EVENT_HANDLER_STATUS_T const *p_event_hndl_status_SP);
extern void scr_ack_popup_focus_handler(LSH_FOCUS_HANDLER_STATUS_T const *p_focus_hndl_status_SP);
extern void  scr_ack_popup_presentation_handler(LSH_PRESN_HANDLER_STATUS_T const *p_presn_hndl_status_SP);
extern UINT8 scr_keypad_popup_event_handler(LSH_EVENT_HANDLER_STATUS_T const *p_event_hndl_status_SP);
extern void scr_keypad_popup_focus_handler(LSH_FOCUS_HANDLER_STATUS_T const *p_focus_hndl_status_SP);
extern void  scr_keypad_popup_presentation_handler(LSH_PRESN_HANDLER_STATUS_T const *p_presn_hndl_status_SP);
extern UINT8 scr_progress_popup_event_handler(LSH_EVENT_HANDLER_STATUS_T const *p_event_hndl_status_SP);
extern void scr_progress_popup_focus_handler(LSH_FOCUS_HANDLER_STATUS_T const *p_focus_hndl_status_SP);
extern void  scr_progress_popup_presentation_handler(LSH_PRESN_HANDLER_STATUS_T const *p_presn_hndl_status_SP);
extern void hmi_progress_popup_status_handler(POPUP_EVENTS p_event_e);
