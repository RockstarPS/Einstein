...
static BOOLEAN hmi_general_wrng_sw_active(void);
static BOOLEAN hmi_general_wrng2_sw_active(void);
static BOOLEAN hmi_general_wrng3_sw_active(void);
...
const SWITCH_EVENT_TABLE_ENTRY dm_switch_array[DM_SWITCH_NUM_ENTRY_IN_CFG_TBL] =
{
  ...
  {
    hmi_general_wrng_sw_active,            /* switch_active(),   */
    1,                                     /* callback,          */
    1,                                     /* max_switch_events, */
    _BTN_EV(BTN_ID_GENWRNG,BTN_EV_PRESS),      /* press_event,       */
    {
      {
        _SW_TO_MS(2000),                    /* held_time          */
        _BTN_EV(BTN_ID_GENWRNG, BTN_EV_RELEASE),/* rel_event          */
        _BTN_EV(BTN_ID_GENWRNG, BTN_EV_HELD)    /* held_event         */
      }
    },
    {
      _SW_TO_MS(200),                      /* repeat_held_time   */
      _SW_TO_MS(200),                      /* repeat_held_time   */
      _BTN_EV(BTN_ID_GENWRNG, BTN_EV_REPEAT)   /* repeat_event       */
    }
  },
  {
    hmi_general_wrng2_sw_active,            /* switch_active(),   */
    1,                                     /* callback,          */
    1,                                     /* max_switch_events, */
    _BTN_EV(BTN_ID_GENWRNG2,BTN_EV_PRESS),      /* press_event,       */
    {
      {
        _SW_TO_MS(2000),                    /* held_time          */
        _BTN_EV(BTN_ID_GENWRNG2, BTN_EV_RELEASE),/* rel_event          */
        _BTN_EV(BTN_ID_GENWRNG2, BTN_EV_HELD)    /* held_event         */
      }
    },
    {
      _SW_TO_MS(200),                      /* repeat_held_time   */
      _SW_TO_MS(200),                      /* repeat_held_time   */
      _BTN_EV(BTN_ID_GENWRNG2, BTN_EV_REPEAT)   /* repeat_event       */
    }
  },
	  {
    hmi_general_wrng3_sw_active,            /* switch_active(),   */
    1,                                     /* callback,          */
    1,                                     /* max_switch_events, */
    _BTN_EV(BTN_ID_GENWRNG3,BTN_EV_PRESS),      /* press_event,       */
    {
      {
        _SW_TO_MS(2000),                    /* held_time          */
        _BTN_EV(BTN_ID_GENWRNG3, BTN_EV_RELEASE),/* rel_event          */
        _BTN_EV(BTN_ID_GENWRNG3, BTN_EV_HELD)    /* held_event         */
      }
    },
    {
      _SW_TO_MS(200),                      /* repeat_held_time   */
      _SW_TO_MS(200),                      /* repeat_held_time   */
      _BTN_EV(BTN_ID_GENWRNG3, BTN_EV_REPEAT)   /* repeat_event       */
    }
  }
};
