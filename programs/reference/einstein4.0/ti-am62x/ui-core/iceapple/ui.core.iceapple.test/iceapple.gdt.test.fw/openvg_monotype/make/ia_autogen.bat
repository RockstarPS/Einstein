...
SET APP_PATH=%WS_ROOT%\ui.core.iceapple.test\iceapple.gdt.test.fw\openvg_monotype
...
xcopy %APP_PATH%\common\fs_config.h %WS_ROOT%\ui.core.gdt.font.libs\iType\product\source\common
