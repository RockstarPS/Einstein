...
Parameters           : None
******************************************************************************/
UINT8 scr_info_popup_event_handler(LSH_EVENT_HANDLER_STATUS_T const *p_event_hndl_status_SP)
{
...
Parameters           : None
******************************************************************************/
void scr_info_popup_focus_handler(LSH_FOCUS_HANDLER_STATUS_T const *p_focus_hndl_status_SP)
{
...
Parameters           : None
******************************************************************************/
void scr_info_popup_presentation_handler(LSH_PRESN_HANDLER_STATUS_T const *p_presen_hndl_status_SP)
{
	if(p_presen_hndl_status_SP->presentation_status == LSH_ACTIVATED_STATUS)
	{
		hmi_gfx_mgr02_if_set_sid(GFX_TXT_INFO_POPUP,SID_INFO_POPUP);
...
Parameters           : None
******************************************************************************/
UINT8 scr_progress_popup_event_handler(LSH_EVENT_HANDLER_STATUS_T const *p_event_hndl_status_SP)
{
	if(p_event_hndl_status_SP->button_command == LSH_GET_COMMAND(BTN_ID_ENTER, BTN_EV_PRESS))
	{
...
Parameters           : None
******************************************************************************/
void scr_progress_popup_focus_handler(LSH_FOCUS_HANDLER_STATUS_T const *p_focus_hndl_status_SP)
{
...
Parameters           : None
******************************************************************************/
void scr_progress_popup_presentation_handler(LSH_PRESN_HANDLER_STATUS_T const *p_presen_hndl_status_SP)
{
	...
	if(p_presen_hndl_status_SP->presentation_status != LSH_DEACTIVATED_STATUS)
	{
		 ...
		 hmi_gfx_mgr02_if_set_sid(GFX_TXT_PROGRESS,SID_PROGRESS_POPUP);
		 hmi_gfx_mgr02_if_select_dimage(GFX_DIMG_PROGRESS,fl_prog_bar_cnt_U8);
		 hmi_gfx_mgr02_if_set_screen(p_presen_hndl_status_SP->logic_state_id, 1);
	}
	else{
	   hmi_gfx_mgr02_if_set_screen(p_presen_hndl_status_SP->logic_state_id, 0);
...
Parameters           : None
******************************************************************************/
UINT8 scr_ack_popup_event_handler(LSH_EVENT_HANDLER_STATUS_T const *p_event_hndl_status_SP)
{
	if(p_event_hndl_status_SP->button_command == LSH_GET_COMMAND(BTN_ID_ENTER, BTN_EV_PRESS))
	{
...
Parameters           : None
******************************************************************************/
void scr_ack_popup_focus_handler(LSH_FOCUS_HANDLER_STATUS_T const *p_focus_hndl_status_SP)
{
...
Parameters           : None
******************************************************************************/
void scr_ack_popup_presentation_handler(LSH_PRESN_HANDLER_STATUS_T const *p_presen_hndl_status_SP)
{
	if(p_presen_hndl_status_SP->presentation_status != LSH_DEACTIVATED_STATUS)
	{
		 hmi_gfx_mgr02_if_set_sid(GFX_TXT_ACK_POPUP,SID_ACK_POPUP); 
		 hmi_gfx_mgr02_if_set_screen(p_presen_hndl_status_SP->logic_state_id, 1);
	}
	else
	{
...
Parameters           : None
******************************************************************************/
UINT8 scr_keypad_popup_event_handler(LSH_EVENT_HANDLER_STATUS_T const *p_event_hndl_status_SP)
{
...
Parameters           : None
******************************************************************************/
void scr_keypad_popup_focus_handler(LSH_FOCUS_HANDLER_STATUS_T const *p_focus_hndl_status_SP)
{
...
Parameters           : None
******************************************************************************/
void scr_keypad_popup_presentation_handler(LSH_PRESN_HANDLER_STATUS_T const *p_presen_hndl_status_SP)
{
	UINT8 keypadcounter;
  HMI_CHAR keypad_data[10+1];
	...
	if(p_presen_hndl_status_SP->presentation_status != LSH_DEACTIVATED_STATUS)
	{
		 hmi_gfx_mgr02_if_set_sid(GFX_TXT_KEYPAD_TEXT,SID_KEYPAD_POPUP); 
		 hmi_gfx_mgr02_if_set_text(GFX_TXT_KEYPAD_ENTRY,fl_keypad_content.entry); 		 
		 hmi_gfx_mgr02_if_set_screen(p_presen_hndl_status_SP->logic_state_id, 1);
	}
	else{
	   hmi_gfx_mgr02_if_set_screen(p_presen_hndl_status_SP->logic_state_id, 0);
...
Parameters           : None
******************************************************************************/
UINT8 scr_warning_popup_event_handler(LSH_EVENT_HANDLER_STATUS_T const *p_event_hndl_status_SP)
{
	if(p_event_hndl_status_SP->button_command == LSH_GET_COMMAND(BTN_ID_ENTER, BTN_EV_PRESS))
	{
		//(void)msg_SequencerAction(BTN_ID_ENTER,0);
	}
	return(LSH_STATUS_NONE);
}
...
Parameters           : None
******************************************************************************/
void scr_warning_popup_focus_handler(LSH_FOCUS_HANDLER_STATUS_T const *p_focus_hndl_status_SP)
{
    if(p_focus_hndl_status_SP->focus_status & LSH_GOT_FOCUS_STATUS){
	  printf("Got Focus Status : %d\n", p_focus_hndl_status_SP->logic_state_id);
		msg_SequencerShow(0); 
...
Parameters           : None
******************************************************************************/
void scr_warning_popup_presentation_handler(LSH_PRESN_HANDLER_STATUS_T const *p_presen_hndl_status_SP)
{
	MSG_VIEWINFO_T retData = {0};

	if(p_presen_hndl_status_SP->presentation_status == LSH_ACTIVATED_STATUS)
	{
        msg_SequencerGetAlertInfo(&retData,0);
		hmi_gfx_mgr02_if_select_dwidget(GFX_DWDG_WRNG,retData.Id);
        hmi_gfx_mgr02_if_set_sid(msg_config_table[retData.Id].Line1_Text_ID, msg_config_table[retData.Id].Line_1_SID);
 		hmi_gfx_mgr02_if_set_screen(p_presen_hndl_status_SP->logic_state_id, 1);
		
        msg_SequencerGetAlertInfo(&retData,1);
		hmi_gfx_mgr02_if_select_dwidget(GFX_DWDG_WRNG_0,(retData.Id-3));
        hmi_gfx_mgr02_if_set_sid(msg_config_table[retData.Id-3].Line1_Text_ID, msg_config_table[retData.Id-3].Line_1_SID);
 		hmi_gfx_mgr02_if_set_screen(p_presen_hndl_status_SP->logic_state_id, 1);
	}
	else if(p_presen_hndl_status_SP->presentation_status == LSH_REFRESH_STATUS){
	}
