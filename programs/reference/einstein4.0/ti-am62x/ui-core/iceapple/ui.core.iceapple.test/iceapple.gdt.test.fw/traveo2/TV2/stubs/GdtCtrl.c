...
#elif GFX_MGR02_NUM_LAYERS > 1
    (void)LSH_ADD_STATE((UINT8)GFX_SCR_ADAS, (UINT8)ANIM_MAX_ID);

 /*   GFX_SCR_MAIN = (0)
      , GFX_SCR_ROOT_MENU = (1)
      , GFX_SCR_MAIN_MENU = (2)
      , GFX_SCR_INVERTED_TEXT = (3)
      , GFX_SCR_TEST = (4)
      , GFX_SCR_TEST_0 = (5)
      , GFX_SCR_TXT_AUTOMATION = (6)
      , GFX_SCR_ALIGNED_WIDGET = (7)
      , GFX_SCR_ADAS = (8)
      , GFX_SCR_MAIN_HUD = (9)*/


    //(void)LSH_ADD_STATE((UINT8)GFX_SCR_MAIN, (UINT8)ANIM_MAX_ID);
    (void)LSH_ADD_STATE((UINT8)GFX_SCR_MAIN_HUD, (UINT8)ANIM_MAX_ID);
    ...
    //(void)LSH_ADD_STATE((UINT8)GFX_SCR_SAMPLE, (UINT8)ANIM_MAX_ID);
    (void)LSH_ADD_STATE((UINT8)GFX_SCR_TXT_AUTOMATION, (UINT8)ANIM_MAX_ID);
#elif defined GFX_MGR02_TV2_FREETYPE
    (void)LSH_ADD_STATE((UINT8)GFX_SCR_TXT_AUTOMATION, (UINT8)ANIM_MAX_ID);
#endif
    return E_OK;
}
