...
UINT8 hmi_lsh_default_button_event_handler(LSH_EVENT_HANDLER_STATUS_T * p_btn_command_id){
   if(p_btn_command_id->button_command == LSH_GET_COMMAND(BTN_ID_POWER, BTN_EV_PRESS)){
   	  //LSH_ADD_STATE(GFX_SCR_STARTUP, GFX_OPEN_ANIM);
	  LSH_ADD_STATE(GFX_SCR_STARTUP, GFX_NEW_ANIMATIONS_1);
   }
...
BOOLEAN HMI_GFX_MGR_BUF_Gfx_Build_Update(void * const fb_pointer)
{
	return 0;
}
/*============================================================================
