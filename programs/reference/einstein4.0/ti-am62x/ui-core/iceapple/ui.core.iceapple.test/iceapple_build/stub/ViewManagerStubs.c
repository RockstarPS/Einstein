...
UINT32 hmi_lsh_start_animation(UINT32 p_priority, UINT32 p_state_id, UINT32 p_anim_id, UINT32 p_client_id)
{
   if(p_state_id > 2)
   return(0);
   else
...
void hmi_lsh_stop_animation(UINT32 p_priority, UINT32 p_state_id, UINT32 p_anim_id, UINT32 p_client_id)
{
}
