...
#define DEACTIVATE_POPUP(x)                 l_pp_id_sts_bit_U8[(x/(UINT8)8)]=((l_pp_id_sts_bit_U8[(x/(UINT8)8)]) & (UINT8)(~(UINT8)((UINT8)1<<(x%(UINT8)8))))
#define POPUP_ACTIVE(x)                     (((l_pp_id_sts_bit_U8[(x/(UINT8)8)]) & (UINT8)((UINT8)1<<(x%(UINT8)8))) == ((UINT8)1<<(UINT8)(x%(UINT8)8)))
...
#define DEACTIVATE_LSH_POPUP(x)             l_pp_id_lsh_sts_bit_U8[(x/(UINT8)8)]=((l_pp_id_lsh_sts_bit_U8[(x/(UINT8)8)]) & (UINT8)(~(UINT8)((UINT8)1<<(x%(UINT8)8))))
#define POPUP_SELF_DEACTIVTION(x)           (lc_popup_config_table[x].self_deactivate_pp==SELF_DEACTIVATION)
...
#define DISABLE_TIMER_STATUS(x)             l_pp_id_tmr_bit_U8[(x/(UINT8)8)]=((l_pp_id_tmr_bit_U8[(x/(UINT8)8)]) & (UINT8)(~(UINT8)((UINT8)1<<(x%(UINT8)8))))
...
#define CLEAR_MIN_TIMER_DEACTIVATE_PENDING(x) l_min_tmr_bit_U8_ptr[(x/(UINT8)8)]=((l_min_tmr_bit_U8_ptr[(x/(UINT8)8)]) & (UINT8)(~(UINT8)((UINT8)1<<(x%(UINT8)8))))
#define MIN_TIMER_DEACTIVATE_PENDING(x)     (((l_min_tmr_bit_U8_ptr[(x/(UINT8)8)]) & (UINT8)((UINT8)1<<(x%(UINT8)8))) == ((UINT8)1<<(x%(UINT8)8)))

#define TIMERTYPE_RESTART(x)                (lc_popup_config_table[x].timer==RESTART_TIMER)
#define TIMERTYPE_ALLOWTO_EXPIRE(x)         (lc_popup_config_table[x].timer==ALLOW_TO_EXPIRE)

#define DEACTIVATE_ACTIVE_PP(x)             (lc_popup_config_table[x].deactivate_active_pp==DEACTIVATION_ENABLED)
...
#ifndef POPUP_NOTIFY_CB_NULL_HANDLER_T
typedef void (POPUP_NOTIFY_CB_POPUP_STATE_HANDLER_T) (POPUP_STATES);
#define POPUP_NOTIFY_CB_NULL_HANDLER_T  ((POPUP_NOTIFY_CB_POPUP_STATE_HANDLER_T *)0)
#endif
...
typedef void BOOLEAN (POPUP_VALIDATE_HANDLER_T)(POPUP_ID, HMI_CHAR *, UINT8);
