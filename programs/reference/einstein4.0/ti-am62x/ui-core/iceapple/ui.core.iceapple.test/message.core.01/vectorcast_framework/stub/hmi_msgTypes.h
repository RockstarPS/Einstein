...
#define MSG_START_SW_TIMER(timeout, timer)  hmi_stub_timer_start(timeout, timer)
#define MSG_CLEAR_SW_TIMER(timer)           hmi_stub_timer_stop(timer)
#define MSG_CHECK_SW_TIMER(timer)           hmi_stub_timer_check(timer)

#if 0
#if defined ENABLE_PRIVATE_TIMERS
/* Private timers */
#define HMI_START_SW_TIMER(timeout, timer)  StartTimer(timeout, timer)
#define HMI_CLEAR_SW_TIMER(timer)           ClearTimer(timer)
#define HMI_CHECK_SW_TIMER(timer)           CheckTimer(timer)

#else
/* Kernal timers */
#define HMI_START_SW_TIMER(timeout, timer)  KernelStart13BitTimer(timeout, timer)
#define HMI_CLEAR_SW_TIMER(timer)           KernelClear13BitTimer(timer)
#define HMI_CHECK_SW_TIMER(timer)           KernelCheck13BitTimer(timer)
#endif /* ENABLE_PRIVATE_TIMERS */
...
#define MSG_ACKNOWLEDGE_ALL_BUTTON_EVENT    (0x0012)
