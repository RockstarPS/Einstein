...
echo options C_DEFINE_LIST const= LSH_ANIMATION_SUPPORT_ENABLED >> commands.tmp
...
echo options TESTABLE_SOURCE_DIR ..\..\..\ui.core.iceapple\message.core.01\src\ >> commands.tmp
echo environment build MENU_CORE.env >> commands.tmp
echo /E:MENU_CORE tools script run MENU_CORE.tst >> commands.tmp
echo /E:MENU_CORE execute batch >> commands.tmp
echo /E:MENU_CORE reports custom management MENU_CORE_management_report.html >> commands.tmp
