...
echo environment build SIGCDD_CDD_UT_VCAST_HT.env >> commands.tmp
echo /E:SIGCDD_CDD_UT_VCAST_HT tools script run SIGCDD_CDD_UT_VCAST_HT.tst >> commands.tmp
echo /E:SIGCDD_CDD_UT_VCAST_HT execute batch >> commands.tmp
echo /E:SIGCDD_CDD_UT_VCAST_HT reports custom management SIGCDD_CDD_UT_VCAST_HT_management_report.html >> commands.tmp
