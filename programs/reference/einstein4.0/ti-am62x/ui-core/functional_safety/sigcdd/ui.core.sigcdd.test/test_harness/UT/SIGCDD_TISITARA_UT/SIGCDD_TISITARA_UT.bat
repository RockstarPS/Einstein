...
echo options C_DEFINE_LIST GFX_USE_TIDSS_DRIVER SOC_AM62PX SOC_AM62P >> commands.tmp
...
echo options TESTABLE_SOURCE_DIR ..\..\..\..\ui.core.sigcdd\SigCdd\src\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR ..\..\..\..\ui.core.sigcdd\SigMgrCdd\src\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR ..\..\..\..\ui.core.sigcdd\SigIfCdd\src\ >> commands.tmp
echo environment build SIGCDD_TISITARA_UT.env >> commands.tmp
echo /E:SIGCDD_TISITARA_UT tools script run SIGCDD_TISITARA_UT.tst >> commands.tmp
echo /E:SIGCDD_TISITARA_UT execute batch >> commands.tmp
echo /E:SIGCDD_TISITARA_UT reports custom management SIGCDD_TISITARA_UT_management_report.html >> commands.tmp
