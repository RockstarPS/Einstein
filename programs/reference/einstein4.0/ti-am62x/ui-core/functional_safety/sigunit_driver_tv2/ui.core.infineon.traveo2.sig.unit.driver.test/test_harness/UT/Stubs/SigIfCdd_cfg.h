...
GFXREG_DISENGCFG_SIGSELECT_SIG_SELECT_FRAMEGEN
GFXREG_DISENGCFG_SIGSELECT_SIG_SELECT_GAMMACOR
GFXREG_DISENGCFG_SIGSELECT_SIG_SELECT_DITHER  
*/

#define SIG_UNIT0_INPUT     (UINT8)GFXREG_DISENGCFG_SIGSELECT_SIG_SELECT_FRAMEGEN


#define SIG_UNIT1_INPUT     (UINT8)GFXREG_DISENGCFG_SIGSELECT_SIG_SELECT_FRAMEGEN
...
#define SIG0_PANIC_COLOUR    ((UINT32)0x00FFFF80)
#define SIG1_PANIC_COLOUR    ((UINT32)0x00FFFF80)
