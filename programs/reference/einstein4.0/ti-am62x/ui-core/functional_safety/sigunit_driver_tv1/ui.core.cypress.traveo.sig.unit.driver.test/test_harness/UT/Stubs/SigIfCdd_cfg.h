...
/* Number of Display Controllers Units*/
#define NUM_OF_DCUS             2 /*Cypress has 2 DCUs*/
...
/*
Input for Signature units
MM_GDC_IRIS_DISENG_DISENGCFG_SIG_SELECT0_FRAMEGEN
MM_GDC_IRIS_DISENG_DISENGCFG_SIG_SELECT0_GAMMACOR
MM_GDC_IRIS_DISENG_DISENGCFG_SIG_SELECT0_DITHER  
*/

#define SIG_UNIT0_INPUT     (UINT8)DISENG_DISENGCFG_SIG_SELECT0_FRAMEGEN

/*
MM_GDC_IRIS_DISENG_DISENGCFG_SIG_SELECT1_FRAMEGEN
MM_GDC_IRIS_DISENG_DISENGCFG_SIG_SELECT1_GAMMACOR
MM_GDC_IRIS_DISENG_DISENGCFG_SIG_SELECT1_DITHER
*/

#define SIG_UNIT1_INPUT     (UINT8)DISENG_DISENGCFG_SIG_SELECT1_FRAMEGEN


/*Panic Colour
Set the Panic colour(UINT32) as RGBA format where Alpha is a 1 Bit(MSB) and other colour components are 8bits each.
For example to set white colour as panic colour, the value is 0xFFFFFF80.
*/

/*
** If application wants no panic color replace then update alph value with 0 as
** 	0xFFFFFF00
*/

#define SIG0_PANIC_COLOUR    ((UINT32)0xFFFFFF00U)  /* Misra  Fix 10734373 */
#define SIG1_PANIC_COLOUR    ((UINT32)0xFFFFFF00U)
...
*/
#define SIG0_ERROR_THRESHOLD_VALUE              (UINT8)33
