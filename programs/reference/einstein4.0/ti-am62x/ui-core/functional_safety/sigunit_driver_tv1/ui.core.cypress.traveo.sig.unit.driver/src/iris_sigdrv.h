...
** \file     iris_sigdrv.h
**
** \brief    API Interface of Signature Unit
**
...
#ifndef IRIS_SIGDRV_H
#define IRIS_SIGDRV_H
...
**==========================================================================*/
#if 0		  /* Disabled here since same is defined in Rte_types.h */
typedef struct
{
...
/*!
\brief Clears the Periodic measurement for Signature unit #0
\param void
\retval void
*/
...
/*! 
\brief programs the windows of Sig unit#0 configurations in to shadow registers 
\param void
\retval void
*/
EXTERN_SIGDRV void iris_sigdrv_sig0_ldcfg(uint8_t shld);
/*! 
...
/*! \brief Disable win0 for CRC calculation
\param void
\retval void
*/
EXTERN_SIGDRV void iris_sigdrv_sig0_disable_win0(void); 
/*
