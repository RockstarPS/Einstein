...
echo options TESTABLE_SOURCE_DIR ..\..\..\..\public\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR ..\..\..\..\..\..\hsm-drv\IpcDriver\m4\public\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR ..\..\..\..\..\..\hsm-drv\vHsmCrypt\include\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR ..\..\..\..\..\vHsmCryptoApplication\m4\public\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR ..\..\..\..\..\..\..\..\..\..\cluster-platform\turing\ti\hsmcarepackage\hsm\include\common\lib\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR ..\..\..\..\..\..\hsm-cfg\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR ..\..\..\..\..\..\..\..\..\..\cluster-platform\turing\ti\hsmcarepackage\hsm\include\hs\ >> commands.tmp
echo options TESTABLE_SOURCE_DIR ..\..\..\..\..\..\..\..\..\..\cluster-platform\turing\ti\hsmcarepackage\hsm\include\common\ >> commands.tmp
echo environment build HSM_APP_VHSMKEYSTORE_HT.env >> commands.tmp
echo /E:HSM_APP_VHSMKEYSTORE_HT tools script run HSM_APP_VHSMKEYSTORE_HT.tst >> commands.tmp
echo /E:HSM_APP_VHSMKEYSTORE_HT execute batch >> commands.tmp
echo /E:HSM_APP_VHSMKEYSTORE_HT tools import_coverage HSM_APP_VHSMKEYSTORE_HT.cvr >> commands.tmp
echo /E:HSM_APP_VHSMKEYSTORE_HT reports custom management HSM_APP_VHSMKEYSTORE_HT_management_report.html >> commands.tmp
